...
// UnimplementedFTSServer must be embedded to have
...
func (UnimplementedFTSServer) testEmbeddedByValue()             {}
...
func RegisterFTSServer(s grpc.ServiceRegistrar, srv FTSServer) {
	// If the following call pancis, it indicates UnimplementedFTSServer was
