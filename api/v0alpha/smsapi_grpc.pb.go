...
// UnimplementedSmsApiServer must be embedded to have
...
func (UnimplementedSmsApiServer) testEmbeddedByValue()                {}
...
func RegisterSmsApiServer(s grpc.ServiceRegistrar, srv SmsApiServer) {
	// If the following call pancis, it indicates UnimplementedSmsApiServer was
