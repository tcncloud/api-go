...
// UnimplementedAnaServer must be embedded to have
...
func (UnimplementedAnaServer) testEmbeddedByValue()             {}
...
func RegisterAnaServer(s grpc.ServiceRegistrar, srv AnaServer) {
	// If the following call pancis, it indicates UnimplementedAnaServer was
