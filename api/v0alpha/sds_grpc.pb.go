...
func (c *sdsClient) GetAgentResponseData(ctx context.Context, in *GetAgentResponseDataReq, opts ...grpc.CallOption) (*GetAgentResponseDataRes, error) {
	...
	err := c.cc.Invoke(ctx, Sds_GetAgentResponseData_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sdsClient) GetCall(ctx context.Context, in *GetCallReq, opts ...grpc.CallOption) (*CallObject, error) {
	out := new(CallObject)
	err := c.cc.Invoke(ctx, Sds_GetCall_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sdsClient) UpdateAgentResponseData(ctx context.Context, in *UpdateAgentResponseDataReq, opts ...grpc.CallOption) (*UpdateAgentResponseDataRes, error) {
	...
	err := c.cc.Invoke(ctx, Sds_UpdateAgentResponseData_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sdsClient) UpdateVoicemailBox(ctx context.Context, in *UpdateVoicemailBoxReq, opts ...grpc.CallOption) (*UpdateVoicemailBoxRes, error) {
	...
	err := c.cc.Invoke(ctx, Sds_UpdateVoicemailBox_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSdsServer must be embedded to have forward compatible implementations.
