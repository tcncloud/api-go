...
func file_api_v0alpha_acd_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_v0alpha_acd_proto_msgTypes[118].Exporter = func(v any, i int) any {
			switch v := v.(*ValidateFieldReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_v0alpha_acd_proto_msgTypes[119].Exporter = func(v any, i int) any {
			switch v := v.(*ValidateFieldRes); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
