...
const (
	ProjectApi_CreateProject_FullMethodName               = "/api.v0alpha.ProjectApi/CreateProject"
	ProjectApi_ListProjects_FullMethodName                = "/api.v0alpha.ProjectApi/ListProjects"
	ProjectApi_EditProjectById_FullMethodName             = "/api.v0alpha.ProjectApi/EditProjectById"
	ProjectApi_CloseProjectById_FullMethodName            = "/api.v0alpha.ProjectApi/CloseProjectById"
	ProjectApi_GetProjectById_FullMethodName              = "/api.v0alpha.ProjectApi/GetProjectById"
	ProjectApi_CreateCannedMessage_FullMethodName         = "/api.v0alpha.ProjectApi/CreateCannedMessage"
	ProjectApi_ListCannedMessages_FullMethodName          = "/api.v0alpha.ProjectApi/ListCannedMessages"
	ProjectApi_UpdateCannedMessage_FullMethodName         = "/api.v0alpha.ProjectApi/UpdateCannedMessage"
	ProjectApi_GetCannedMessageById_FullMethodName        = "/api.v0alpha.ProjectApi/GetCannedMessageById"
	ProjectApi_DeleteCannedMessageById_FullMethodName     = "/api.v0alpha.ProjectApi/DeleteCannedMessageById"
	ProjectApi_CreateCannedMessageGroup_FullMethodName    = "/api.v0alpha.ProjectApi/CreateCannedMessageGroup"
	ProjectApi_ListCannedMessageGroups_FullMethodName     = "/api.v0alpha.ProjectApi/ListCannedMessageGroups"
	ProjectApi_UpdateCannedMessageGroup_FullMethodName    = "/api.v0alpha.ProjectApi/UpdateCannedMessageGroup"
	ProjectApi_DeleteCannedMessageGroup_FullMethodName    = "/api.v0alpha.ProjectApi/DeleteCannedMessageGroup"
	ProjectApi_ListCannedMessagesByGroupId_FullMethodName = "/api.v0alpha.ProjectApi/ListCannedMessagesByGroupId"
	ProjectApi_GetCannedMessageGroupById_FullMethodName   = "/api.v0alpha.ProjectApi/GetCannedMessageGroupById"
)
...
var ProjectApi_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.v0alpha.ProjectApi",
	...
	Metadata: "api/v0alpha/project.proto",
}
