...
func NewP3ApiHandler(svc P3ApiHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle(P3ApiListAgentSkillsProcedure, connect_go.NewUnaryHandler(
	...
	mux.Handle(P3ApiListExtendedCallHistoryProcedure, connect_go.NewServerStreamHandler(
	...
	mux.Handle(P3ApiGetActivityLogHistoryProcedure, connect_go.NewServerStreamHandler(
