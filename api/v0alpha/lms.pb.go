...
func file_api_v0alpha_lms_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_v0alpha_lms_proto_msgTypes[180].Exporter = func(v any, i int) any {
	...
	file_api_v0alpha_lms_proto_msgTypes[153].OneofWrappers = []any{
	...
	file_api_v0alpha_lms_proto_msgTypes[182].OneofWrappers = []any{
	...
	file_api_v0alpha_lms_proto_msgTypes[186].OneofWrappers = []any{
