...
const (
	Acs_CreateScript_FullMethodName         = "/api.v0alpha.Acs/CreateScript"
	Acs_UpdateScript_FullMethodName         = "/api.v0alpha.Acs/UpdateScript"
	Acs_GetScriptById_FullMethodName        = "/api.v0alpha.Acs/GetScriptById"
	Acs_ListScripts_FullMethodName          = "/api.v0alpha.Acs/ListScripts"
	Acs_SaveResponses_FullMethodName        = "/api.v0alpha.Acs/SaveResponses"
	Acs_GetResponses_FullMethodName         = "/api.v0alpha.Acs/GetResponses"
	Acs_CreateRule_FullMethodName           = "/api.v0alpha.Acs/CreateRule"
	Acs_UpdateRules_FullMethodName          = "/api.v0alpha.Acs/UpdateRules"
	Acs_ListRules_FullMethodName            = "/api.v0alpha.Acs/ListRules"
	Acs_CreateRegexEvaluator_FullMethodName = "/api.v0alpha.Acs/CreateRegexEvaluator"
	Acs_UpdateRegexEvaluator_FullMethodName = "/api.v0alpha.Acs/UpdateRegexEvaluator"
	Acs_ListRegexEvaluators_FullMethodName  = "/api.v0alpha.Acs/ListRegexEvaluators"
	Acs_DeleteRule_FullMethodName           = "/api.v0alpha.Acs/DeleteRule"
	Acs_GetScript_FullMethodName            = "/api.v0alpha.Acs/GetScript"
)
...
var Acs_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/v0alpha/acs.proto",
}
