...
import (
	...
	v1 "github.com/tcncloud/api-go/api/services/pbx/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	PBXServiceName = "api.services.pbx.v1.PBXService"
)
...
const (
	...
	// RPC.
	PBXServiceQueryPbxUsersProcedure = "/api.services.pbx.v1.PBXService/QueryPbxUsers"
	// PBXServiceQueryRingGroupsProcedure is the fully-qualified name of the PBXService's
	// QueryRingGroups RPC.
	PBXServiceQueryRingGroupsProcedure = "/api.services.pbx.v1.PBXService/QueryRingGroups"
	// PBXServiceUpdatePbxUserProcedure is the fully-qualified name of the PBXService's UpdatePbxUser
	// RPC.
	PBXServiceUpdatePbxUserProcedure = "/api.services.pbx.v1.PBXService/UpdatePbxUser"
	// PBXServiceUpdateRingGroupProcedure is the fully-qualified name of the PBXService's
	// UpdateRingGroup RPC.
	PBXServiceUpdateRingGroupProcedure = "/api.services.pbx.v1.PBXService/UpdateRingGroup"
	// PBXServiceCreateRingGroupProcedure is the fully-qualified name of the PBXService's
	// CreateRingGroup RPC.
	PBXServiceCreateRingGroupProcedure = "/api.services.pbx.v1.PBXService/CreateRingGroup"
	// PBXServiceDeleteRingGroupProcedure is the fully-qualified name of the PBXService's
	// DeleteRingGroup RPC.
	PBXServiceDeleteRingGroupProcedure = "/api.services.pbx.v1.PBXService/DeleteRingGroup"
	// PBXServiceAssignRandomExtensionProcedure is the fully-qualified name of the PBXService's
	// AssignRandomExtension RPC.
	PBXServiceAssignRandomExtensionProcedure = "/api.services.pbx.v1.PBXService/AssignRandomExtension"
)

// PBXServiceClient is a client for the api.services.pbx.v1.PBXService service.
...
// NewPBXServiceClient constructs a client for the api.services.pbx.v1.PBXService service. By
...
// QueryPbxUsers calls api.services.pbx.v1.PBXService.QueryPbxUsers.
...
// QueryRingGroups calls api.services.pbx.v1.PBXService.QueryRingGroups.
...
// UpdatePbxUser calls api.services.pbx.v1.PBXService.UpdatePbxUser.
...
// UpdateRingGroup calls api.services.pbx.v1.PBXService.UpdateRingGroup.
...
// CreateRingGroup calls api.services.pbx.v1.PBXService.CreateRingGroup.
...
// DeleteRingGroup calls api.services.pbx.v1.PBXService.DeleteRingGroup.
...
// AssignRandomExtension calls api.services.pbx.v1.PBXService.AssignRandomExtension.
...
// PBXServiceHandler is an implementation of the api.services.pbx.v1.PBXService service.
...
func NewPBXServiceHandler(svc PBXServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/api.services.pbx.v1.PBXService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedPBXServiceHandler) QueryPbxUsers(context.Context, *connect_go.Request[v1.QueryPbxUsersRequest]) (*connect_go.Response[v1.QueryPbxUsersResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.services.pbx.v1.PBXService.QueryPbxUsers is not implemented"))
}
...
func (UnimplementedPBXServiceHandler) QueryRingGroups(context.Context, *connect_go.Request[v1.QueryRingGroupsRequest]) (*connect_go.Response[v1.QueryRingGroupsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.services.pbx.v1.PBXService.QueryRingGroups is not implemented"))
}
...
func (UnimplementedPBXServiceHandler) UpdatePbxUser(context.Context, *connect_go.Request[v1.UpdatePbxUserRequest]) (*connect_go.Response[v1.UpdatePbxUserResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.services.pbx.v1.PBXService.UpdatePbxUser is not implemented"))
}
...
func (UnimplementedPBXServiceHandler) UpdateRingGroup(context.Context, *connect_go.Request[v1.UpdateRingGroupRequest]) (*connect_go.Response[v1.UpdateRingGroupResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.services.pbx.v1.PBXService.UpdateRingGroup is not implemented"))
}
...
func (UnimplementedPBXServiceHandler) CreateRingGroup(context.Context, *connect_go.Request[v1.CreateRingGroupRequest]) (*connect_go.Response[v1.CreateRingGroupResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.services.pbx.v1.PBXService.CreateRingGroup is not implemented"))
}
...
func (UnimplementedPBXServiceHandler) DeleteRingGroup(context.Context, *connect_go.Request[v1.DeleteRingGroupRequest]) (*connect_go.Response[v1.DeleteRingGroupResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.services.pbx.v1.PBXService.DeleteRingGroup is not implemented"))
}
...
func (UnimplementedPBXServiceHandler) AssignRandomExtension(context.Context, *connect_go.Request[v1.AssignRandomExtensionRequest]) (*connect_go.Response[v1.AssignRandomExtensionResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.services.pbx.v1.PBXService.AssignRandomExtension is not implemented"))
}
