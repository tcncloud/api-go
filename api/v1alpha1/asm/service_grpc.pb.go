...
// UnimplementedAsmApiServer must be embedded to have
...
func (UnimplementedAsmApiServer) testEmbeddedByValue()                {}
...
func RegisterAsmApiServer(s grpc.ServiceRegistrar, srv AsmApiServer) {
	// If the following call pancis, it indicates UnimplementedAsmApiServer was
