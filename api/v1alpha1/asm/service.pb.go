...
const file_api_v1alpha1_asm_service_proto_rawDesc = "" +
	"\n" +
	"\x1eapi/v1alpha1/asm/service.proto\x12\x10api.v1alpha1.asm\x1a\x17annotations/authz.proto\x1a\x15api/commons/acd.proto\x1a\x15api/commons/asm.proto\x1a\x1bapi/commons/auth/user.proto\x1a\x17api/commons/event.proto\x1a\x1dapi/commons/omnichannel.proto\x1a\x1cgoogle/api/annotations.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\x84\x02\n" +
	"\x10CreateSessionReq\x12$\n" +
	"\x0ehunt_group_sid\x18\x01 \x01(\x03R\fhuntGroupSid\x12F\n" +
	"\x06skills\x18\x02 \x03(\v2..api.v1alpha1.asm.CreateSessionReq.SkillsEntryR\x06skills\x12G\n" +
	"\x0fsubsession_type\x18\x03 \x01(\x0e2\x1e.api.commons.AsmSubsessionTypeR\x0esubsessionType\x1a9\n" +
	"\vSkillsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\"\xba\x01\n" +
	"\x10CreateSessionRes\x12&\n" +
	"\x0fasm_session_sid\x18\x01 \x01(\x03R\rasmSessionSid\x12*\n" +
	"\x11voice_session_sid\x18\x02 \x01(\x03R\x0fvoiceSessionSid\x12R\n" +
	"\x12voice_registration\x18\x03 \x01(\v2#.api.v1alpha1.asm.VoiceRegistrationR\x11voiceRegistration\"\xe4\x01\n" +
	...
	"\x14expiration_timestamp\x18\a \x01(\x03R\x13expirationTimestamp\"\\\n" +
	"\x13StreamAgentStateReq\x12&\n" +
	"\x0fasm_session_sid\x18\x01 \x01(\x03R\rasmSessionSid\x12\x1d\n" +
	"\n" +
	"keep_alive\x18\x02 \x01(\bR\tkeepAlive\"\x1c\n" +
	"\x1aManagerStreamAgentStateReq\"\xff\x02\n" +
	"\fGetStatusReq\x12&\n" +
	"\x0fasm_session_sid\x18\x01 \x01(\x03R\rasmSessionSid\x12,\n" +
	"\x12perform_keep_alive\x18\x02 \x01(\bR\x10performKeepAlive\x127\n" +
	"\x18perform_get_queued_calls\x18\x03 \x01(\bR\x15performGetQueuedCalls\x12.\n" +
	"\x13perform_get_message\x18\x04 \x01(\bR\x11performGetMessage\x12:\n" +
	"\x19minimum_message_timestamp\x18\x05 \x01(\x03R\x17minimumMessageTimestamp\x12\x16\n" +
	"\x06skills\x18\x06 \x03(\tR\x06skills\x12*\n" +
	"\x06events\x18\a \x03(\v2\x12.api.commons.EventR\x06events\x120\n" +
	"\x14agent_pbx_extensions\x18\b \x03(\tR\x12agentPbxExtensions\"P\n" +
	"\fGetStatusRes\x12@\n" +
	"\fvoice_status\x18\x01 \x01(\v2\x1d.api.v1alpha1.asm.VoiceStatusR\vvoiceStatus\"\xf1\x06\n" +
	"\vVoiceStatus\x12\x16\n" +
	...
	"\x14keep_alive_succeeded\x18\r \x01(\bR\x12keepAliveSucceeded\x12\x18\n" +
	"\amessage\x18\x0e \x01(\tR\amessage\x12+\n" +
	"\x11message_timestamp\x18\x0f \x01(\x03R\x10messageTimestamp\x12@\n" +
	"\fqueued_calls\x18\x10 \x01(\v2\x1d.api.v1alpha1.asm.QueuedCallsR\vqueuedCalls\x120\n" +
	"\x14caller_was_suspended\x18\x11 \x01(\bR\x12callerWasSuspended\x12F\n" +
	"\x10transfer_members\x18\x12 \x03(\v2\x1b.api.commons.TransferMemberR\x0ftransferMembers\x12-\n" +
	"\x05alert\x18\x13 \x01(\v2\x17.api.commons.AgentAlertR\x05alert\x12?\n" +
	"\x1dagent_peer_is_direct_to_agent\x18\x14 \x01(\bR\x18agentPeerIsDirectToAgent\x12$\n" +
	"\x0eagent_is_muted\x18\x15 \x01(\bR\fagentIsMuted\"\xbd\x05\n" +
	"\vQueuedCalls\x12X\n" +
	"\x11agent_queue_calls\x18\x10 \x03(\v2,.api.v1alpha1.asm.QueuedCalls.QueuedCallDataR\x0fagentQueueCalls\x12P\n" +
	"\ron_hold_calls\x18\x11 \x03(\v2,.api.v1alpha1.asm.QueuedCalls.QueuedCallDataR\vonHoldCalls\x12I\n" +
	"\thqm_calls\x18\x12 \x03(\v2,.api.v1alpha1.asm.QueuedCalls.QueuedCallDataR\bhqmCalls\x1a\xb6\x03\n" +
	...
	"\x18queued_notification_type\x18\t \x01(\x0e2#.api.commons.QueuedNotificationTypeR\x16queuedNotificationType\"O\n" +
	"\rEndSessionReq\x12&\n" +
	...
	"\x0fasm_session_end\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\rasmSessionEnd\x12C\n" +
	"\rvoice_session\x18\x06 \x01(\v2\x1e.api.v1alpha1.asm.VoiceSessionR\fvoiceSession\"\xce\x01\n" +
	"\fVoiceSession\x12*\n" +
	...
	"\x11voice_session_end\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\x0fvoiceSessionEnd\"\xac\x02\n" +
	"\x13SwitchSubsessionReq\x12&\n" +
	"\x0fasm_session_sid\x18\x01 \x01(\x03R\rasmSessionSid\x12$\n" +
	"\x0ehunt_group_sid\x18\x02 \x01(\x03R\fhuntGroupSid\x12I\n" +
	"\x06skills\x18\x03 \x03(\v21.api.v1alpha1.asm.SwitchSubsessionReq.SkillsEntryR\x06skills\x12A\n" +
	"\fchannel_type\x18\x04 \x01(\x0e2\x1e.api.commons.AsmSubsessionTypeR\vchannelType\x1a9\n" +
	"\vSkillsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\x12voice_registration\x18\x02 \x01(\v2#.api.v1alpha1.asm.VoiceRegistrationR\x11voiceRegistration\"\x8e\t\n" +
	"\fConversation\x12-\n" +
	"\x10conversation_sid\x18\x06 \x01(\x03B\x020\x01R\x0fconversationSid\x12V\n" +
	"\x19conversation_created_time\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\x17conversationCreatedTime\x12W\n" +
	"\x1aassigned_last_updated_time\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\x17assignedLastUpdatedTime\x12P\n" +
	"\x13conversation_status\x18\t \x01(\x0e2\x1f.api.commons.ConversationStatusR\x12conversationStatus\x12;\n" +
	"\fchannel_type\x18\n" +
	" \x01(\x0e2\x18.api.commons.ChannelTypeR\vchannelType\x12Q\n" +
	"\rcustomer_info\x18\v \x01(\v2,.api.commons.ConversationCustomerInformationR\fcustomerInfo\x12F\n" +
	"\x11last_message_time\x18\f \x01(\v2\x1a.google.protobuf.TimestampR\x0flastMessageTime\x12<\n" +
	"\x06skills\x18\r \x01(\v2$.api.v1alpha1.asm.ConversationSkillsR\x06skills\x12[\n" +
	"\x11assignment_status\x18\x0e \x01(\x0e2..api.commons.AgentConversationAssignmentStatusR\x10assignmentStatus\x12U\n" +
	"\x0fassignment_type\x18\x0f \x01(\x0e2,.api.commons.AgentConversationAssignmentTypeR\x0eassignmentType\x12;\n" +
	"\fsla_timeouts\x18\x10 \x01(\v2\x18.api.commons.SLATimeoutsR\vslaTimeouts\x12f\n" +
	"\x1bconversation_collected_data\x18\x11 \x01(\v2&.api.commons.ConversationCollectedDataR\x19conversationCollectedData\x12Q\n" +
	"\x17last_message_group_time\x18\x12 \x01(\v2\x1a.google.protobuf.TimestampR\x14lastMessageGroupTime\x12R\n" +
	"\x17last_message_group_type\x18\x13 \x01(\x0e2\x1b.api.commons.OmniSenderTypeR\x14lastMessageGroupType\x126\n" +
	"\btask_sid\x18\x14 \x01(\v2\x1b.google.protobuf.Int64ValueR\ataskSid\"\x99\x01\n" +
	"\x12ConversationSkills\x12H\n" +
	"\x06skills\x18\x01 \x03(\v20.api.v1alpha1.asm.ConversationSkills.SkillsEntryR\x06skills\x1a9\n" +
	"\vSkillsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\bR\x05value:\x028\x01\"\x8c\x02\n" +
	"\x18AssignNewConversationReq\x12&\n" +
	"\x0fasm_session_sid\x18\x01 \x01(\x03R\rasmSessionSid\x12N\n" +
	"\x06skills\x18\x02 \x03(\v26.api.v1alpha1.asm.AssignNewConversationReq.SkillsEntryR\x06skills\x12=\n" +
	"\rchannel_types\x18\x03 \x03(\x0e2\x18.api.commons.ChannelTypeR\fchannelTypes\x1a9\n" +
	"\vSkillsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\"\x81\x01\n" +
	"\x18AssignNewConversationRes\x12B\n" +
	"\fconversation\x18\x01 \x01(\v2\x1e.api.v1alpha1.asm.ConversationR\fconversation\x12!\n" +
	"\freference_id\x18\x02 \x01(\tR\vreferenceId\"\x0f\n" +
	"\rListAgentsReq\"H\n" +
	"\rListAgentsRes\x127\n" +
	"\x06agents\x18\x01 \x03(\v2\x1f.api.commons.DashboardAgentInfoR\x06agents\"\xe4\x02\n" +
	"\x1fSetConversationCollectedDataReq\x12-\n" +
	"\x10conversation_sid\x18\x01 \x01(\x03B\x020\x01R\x0fconversationSid\x12;\n" +
	"\fchannel_type\x18\x02 \x01(\x0e2\x18.api.commons.ChannelTypeR\vchannelType\x12k\n" +
	"\x0ecollected_data\x18\x03 \x03(\v2D.api.v1alpha1.asm.SetConversationCollectedDataReq.CollectedDataEntryR\rcollectedData\x12&\n" +
	"\x0fasm_session_sid\x18\x04 \x01(\x03R\rasmSessionSid\x1a@\n" +
	"\x12CollectedDataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"!\n" +
	"\x1fSetConversationCollectedDataRes\"\xe2\x02\n" +
	"\x14ListConversationsReq\x12&\n" +
	"\x0fasm_session_sid\x18\x01 \x01(\x03R\rasmSessionSid\x12R\n" +
	"\x12authenticated_user\x18\x02 \x01(\v2#.api.commons.auth.AuthenticatedUserR\x11authenticatedUser\x12\x17\n" +
	"\auser_id\x18\x03 \x01(\tR\x06userId\x12;\n" +
	"\bstatuses\x18\x04 \x03(\x0e2\x1f.api.commons.ConversationStatusR\bstatuses\x129\n" +
	"\n" +
	"field_mask\x18\x05 \x01(\v2\x1a.google.protobuf.FieldMaskR\tfieldMask\x12=\n" +
	"\rchannel_types\x18\x06 \x03(\x0e2\x18.api.commons.ChannelTypeR\fchannelTypes\"\x83\x01\n" +
	...
	"\x0fasm_session_sid\x18\x01 \x01(\x03R\rasmSessionSid\x12=\n" +
	"\rchannel_types\x18\x02 \x03(\x0e2\x18.api.commons.ChannelTypeR\fchannelTypes\x12I\n" +
	"\x06skills\x18\x03 \x03(\v21.api.v1alpha1.asm.GetQueuesDetailsReq.SkillsEntryR\x06skills\x1a9\n" +
	"\vSkillsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\"f\n" +
	"\rPushEventsReq\x12&\n" +
	"\x0fasm_session_sid\x18\x01 \x01(\x03R\rasmSessionSid\x12-\n" +
	"\x06events\x18\x02 \x03(\v2\x15.api.commons.AsmEventR\x06events\"\x0f\n" +
	"\rPushEventsRes\"\xdf\x01\n" +
	"\x0eEnableVoiceReq\x12&\n" +
	"\x0fasm_session_sid\x18\x01 \x01(\x03R\rasmSessionSid\x12$\n" +
	"\x0ehunt_group_sid\x18\x02 \x01(\x03R\fhuntGroupSid\x12D\n" +
	"\x06skills\x18\x03 \x03(\v2,.api.v1alpha1.asm.EnableVoiceReq.SkillsEntryR\x06skills\x1a9\n" +
	"\vSkillsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\"\x90\x01\n" +
	"\x0eEnableVoiceRes\x12*\n" +
	"\x11voice_session_sid\x18\x01 \x01(\x03R\x0fvoiceSessionSid\x12R\n" +
	"\x12voice_registration\x18\x02 \x01(\v2#.api.v1alpha1.asm.VoiceRegistrationR\x11voiceRegistration\"\xe1\x01\n" +
	"\x0fDisableVoiceReq\x12&\n" +
	"\x0fasm_session_sid\x18\x01 \x01(\x03R\rasmSessionSid\x12$\n" +
	"\x0ehunt_group_sid\x18\x02 \x01(\x03R\fhuntGroupSid\x12E\n" +
	"\x06skills\x18\x03 \x03(\v2-.api.v1alpha1.asm.DisableVoiceReq.SkillsEntryR\x06skills\x1a9\n" +
	"\vSkillsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\"\x11\n" +
	"\x0fDisableVoiceRes2\xc1\f\n" +
	"\x06AsmApi\x12\x91\x01\n" +
	"\rCreateSession\x12\".api.v1alpha1.asm.CreateSessionReq\x1a\".api.v1alpha1.asm.CreateSessionRes\"8\xba\xb8\x91\x02\x02\x18\x01\x82\xd3\xe4\x93\x02+:\x01*\"&/api/v1alpha1/asm/asmapi/createsession\x12\x81\x01\n" +
	"\tGetStatus\x12\x1e.api.v1alpha1.asm.GetStatusReq\x1a\x1e.api.v1alpha1.asm.GetStatusRes\"4\xba\xb8\x91\x02\x02\x18\x01\x82\xd3\xe4\x93\x02':\x01*\"\"/api/v1alpha1/asm/asmapi/getstatus\x12\x85\x01\n" +
	"\n" +
	"EndSession\x12\x1f.api.v1alpha1.asm.EndSessionReq\x1a\x1f.api.v1alpha1.asm.EndSessionRes\"5\xba\xb8\x91\x02\x02\x18\x01\x82\xd3\xe4\x93\x02(:\x01*\"#/api/v1alpha1/asm/asmapi/endsession\x12\x97\x01\n" +
	"\x11GetCurrentSession\x12&.api.v1alpha1.asm.GetCurrentSessionReq\x1a\x1c.api.v1alpha1.asm.AsmSession\"<\xba\xb8\x91\x02\x02\x18\x01\x82\xd3\xe4\x93\x02/:\x01*\"*/api/v1alpha1/asm/asmapi/getcurrentsession\x12\x9d\x01\n" +
	"\x10SwitchSubsession\x12%.api.v1alpha1.asm.SwitchSubsessionReq\x1a%.api.v1alpha1.asm.SwitchSubsessionRes\";\xba\xb8\x91\x02\x02\x18\x01\x82\xd3\xe4\x93\x02.:\x01*\")/api/v1alpha1/asm/asmapi/switchsubsession\x12\xa4\x01\n" +
	...
	"\x03\b\xac\x02\x82\xd3\xe4\x93\x02/:\x01*\"*/api/v1alpha1/asm/asmapi/listconversations\x12\xb4\x01\n" +
	"\x15AssignNewConversation\x12*.api.v1alpha1.asm.AssignNewConversationReq\x1a*.api.v1alpha1.asm.AssignNewConversationRes\"C\xba\xb8\x91\x02\x05\n" +
	"\x03\b\xac\x02\x82\xd3\xe4\x93\x023:\x01*\"./api/v1alpha1/asm/asmapi/assignnewconversation\x12\x88\x01\n" +
	"\n" +
	"ListAgents\x12\x1f.api.v1alpha1.asm.ListAgentsReq\x1a\x1f.api.v1alpha1.asm.ListAgentsRes\"8\xba\xb8\x91\x02\x05\n" +
	"\x03\b\xb0\t\x82\xd3\xe4\x93\x02(:\x01*\"#/api/v1alpha1/asm/asmapi/listagents\x12\xd5\x01\n" +
	"\x1cSetConversationCollectedData\x121.api.v1alpha1.asm.SetConversationCollectedDataReq\x1a1.api.v1alpha1.asm.SetConversationCollectedDataRes\"O\xba\xb8\x91\x02\n" +
	"\n" +
	"\x03\b\xac\x02\n" +
	"\x03\b\xb0\t\x82\xd3\xe4\x93\x02::\x01*\"5/api/v1alpha1/asm/asmapi/setconversationcollecteddata\x12\x9b\x01\n" +
	"\x10GetQueuesDetails\x12%.api.v1alpha1.asm.GetQueuesDetailsReq\x1a .api.commons.GetQueuesDetailsRes\">\xba\xb8\x91\x02\x05\n" +
	"\x03\b\xac\x02\x82\xd3\xe4\x93\x02.:\x01*\")/api/v1alpha1/asm/asmapi/getqueuesdetailsB\xb3\x01\n" +
	"\x14com.api.v1alpha1.asmB\fServiceProtoP\x01Z+github.com/tcncloud/api-go/api/v1alpha1/asm\xa2\x02\x03AVA\xaa\x02\x10Api.V1alpha1.Asm\xca\x02\x10Api\\V1alpha1\\Asm\xe2\x02\x1cApi\\V1alpha1\\Asm\\GPBMetadata\xea\x02\x12Api::V1alpha1::Asmb\x06proto3"
