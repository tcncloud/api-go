...
func file_api_v1alpha1_integrationspublic_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_v1alpha1_integrationspublic_service_proto_msgTypes[20].Exporter = func(v any, i int) any {
		...
		file_api_v1alpha1_integrationspublic_service_proto_msgTypes[23].Exporter = func(v any, i int) any {
