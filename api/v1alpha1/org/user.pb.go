...
const file_api_v1alpha1_org_user_proto_rawDesc = "" +
	...
	"\borg_name\x18\x04 \x01(\tR\aorgName\x12L\n" +
	"\n" +
	"hunt_group\x18\x05 \x01(\v2-.api.v1alpha1.org.GetMyUserResponse.HuntGroupR\thuntGroup\x12.\n" +
	...
	"\x13p3_permission_group\x18\t \x01(\v2\".api.commons.org.P3PermissionGroupR\x11p3PermissionGroup\x12e\n" +
	"\x13agent_profile_group\x18\n" +
	" \x01(\v25.api.v1alpha1.org.GetMyUserResponse.AgentProfileGroupR\x11agentProfileGroup\x12.\n" +
	...
	"\x12time_zone_override\x18\x04 \x01(\v2\x1c.api.commons.TimeZoneWrapperR\x10timeZoneOverride\x12J\n" +
	"\n" +
	"hunt_group\x18\x05 \x01(\v2+.api.v1alpha1.org.GetUserResponse.HuntGroupR\thuntGroup\x12.\n" +
	"\x06labels\x18\x06 \x03(\v2\x16.api.commons.org.LabelR\x06labels\x12.\n" +
	"\x06skills\x18\a \x03(\v2\x16.api.commons.org.SkillR\x06skills\x12M\n" +
	"\x11permission_groups\x18\b \x03(\v2 .api.commons.org.PermissionGroupR\x10permissionGroups\x12R\n" +
	"\x13p3_permission_group\x18\t \x01(\v2\".api.commons.org.P3PermissionGroupR\x11p3PermissionGroup\x12c\n" +
	"\x13agent_profile_group\x18\n" +
	" \x01(\v23.api.v1alpha1.org.GetUserResponse.AgentProfileGroupR\x11agentProfileGroup\x12\x19\n" +
	...
	"\busername\x18\r \x01(\tR\busername\x12\x1c\n" +
	"\tdelegated\x18\x03 \x01(\bR\tdelegated\x12\x19\n" +
	"\borg_name\x18\x04 \x01(\tR\aorgName\x12Q\n" +
	"\n" +
	"hunt_group\x18\x05 \x01(\v22.api.v1alpha1.org.GetUserByOrgIdResponse.HuntGroupR\thuntGroup\x12.\n" +
	"\x06labels\x18\x06 \x03(\v2\x16.api.commons.org.LabelR\x06labels\x12.\n" +
	"\x06skills\x18\a \x03(\v2\x16.api.commons.org.SkillR\x06skills\x12M\n" +
	"\x11permission_groups\x18\b \x03(\v2 .api.commons.org.PermissionGroupR\x10permissionGroups\x12R\n" +
	"\x13p3_permission_group\x18\t \x01(\v2\".api.commons.org.P3PermissionGroupR\x11p3PermissionGroup\x12j\n" +
	"\x13agent_profile_group\x18\n" +
	" \x01(\v2:.api.v1alpha1.org.GetUserByOrgIdResponse.AgentProfileGroupR\x11agentProfileGroup\x12.\n" +
	...
	"\x11ListAgentsRequest\"\x83\v\n" +
	"\x12ListAgentsResponse\x12I\n" +
	"\x06agents\x18\x01 \x03(\v21.api.v1alpha1.org.ListAgentsResponse.AgentDetailsR\x06agents\x1a\xa1\n" +
	"\n" +
	...
	"\x0elogin_disabled\x18\a \x01(\bR\rloginDisabled\x12Z\n" +
	"\n" +
	"hunt_group\x18\b \x01(\v2;.api.v1alpha1.org.ListAgentsResponse.AgentDetails.HuntGroupR\thuntGroup\x12.\n" +
	...
	"\flast_updated\x18\x12 \x01(\v2\x1a.google.protobuf.TimestampR\vlastUpdated\x12s\n" +
	"\x13agent_profile_group\x18\x13 \x01(\v2C.api.v1alpha1.org.ListAgentsResponse.AgentDetails.AgentProfileGroupR\x11agentProfileGroup\x12\x14\n" +
	...
	"\x0farchived_filter\x18\x02 \x01(\x0e2$.api.commons.UserArchivedStateFilterR\x0earchivedFilter\"\xd9\x02\n" +
	...
	"\tlast_name\x18\x03 \x01(\tB\x02\x18\x01R\blastName\x12\x1e\n" +
	"\busername\x18\x04 \x01(\tB\x02\x18\x01R\busername\x12D\n" +
	"\x05users\x18\x05 \x03(\v2..api.v1alpha1.org.ListPublicUsersResponse.UserR\x05users\x1aw\n" +
	"\x04User\x12\x17\n" +
	...
	"\x11ListUsersResponse\x12E\n" +
	"\x05users\x18\x01 \x03(\v2/.api.v1alpha1.org.ListUsersResponse.UserDetailsR\x05users\x1a\xd2\x03\n" +
	...
	"\x06labels\x18\n" +
	" \x03(\v2\x16.api.commons.org.LabelR\x06labels\x12#\n" +
	"\raccount_owner\x18\v \x01(\bR\faccountOwner\x12\x14\n" +
	"\x05agent\x18\f \x01(\bR\x05agent\x12\x1b\n" +
	"\ttrust_ids\x18\r \x03(\tR\btrustIds\x123\n" +
	"\bmfa_info\x18\x0e \x01(\v2\x18.api.commons.org.MfaInfoR\amfaInfo\x12%\n" +
	"\x0eemail_verified\x18\x0f \x01(\bR\remailVerified\"\x7f\n" +
	"\x17ListUsersByOrgIdRequest\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x12M\n" +
	"\x0farchived_filter\x18\x02 \x01(\x0e2$.api.commons.UserArchivedStateFilterR\x0earchivedFilter\"\xd8\x04\n" +
	"\x18ListUsersByOrgIdResponse\x12L\n" +
	"\x05users\x18\x01 \x03(\v26.api.v1alpha1.org.ListUsersByOrgIdResponse.UserDetailsR\x05users\x1a\xed\x03\n" +
	"\vUserDetails\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x15\n" +
	...
	"\x0farchived_filter\x18\x03 \x01(\x0e2$.api.commons.UserArchivedStateFilterR\x0earchivedFilter\"\xbf\x04\n" +
	"\x19ListUsersByRegionResponse\x12M\n" +
	"\x05users\x18\x01 \x03(\v27.api.v1alpha1.org.ListUsersByRegionResponse.UserDetailsR\x05users\x1a\xd2\x03\n" +
	"\vUserDetails\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x15\n" +
	"\x06org_id\x18\x02 \x01(\tR\x05orgId\x12\x1d\n" +
	"\n" +
	...
	"\ttrust_ids\x18\r \x03(\tR\btrustIds\x123\n" +
	"\bmfa_info\x18\x0e \x01(\v2\x18.api.commons.org.MfaInfoR\amfaInfo\x12%\n" +
	"\x0eemail_verified\x18\x0f \x01(\bR\remailVerified\"\xa8\x03\n" +
	...
	"defaultApp\x12^\n" +
	"\x1blocale_preferences_override\x18\x05 \x01(\v2\x1e.api.commons.LocalePreferencesR\x19localePreferencesOverride\x128\n" +
	"\x18play_notification_sounds\x18\x06 \x01(\bR\x16playNotificationSounds\x12\x1d\n" +
	"\n" +
	"field_mask\x18\n" +
	" \x03(\tR\tfieldMask\"\x16\n" +
	...
	"\x1aGetUserSessionDataResponse\x12E\n" +
	"\x04user\x18\x01 \x01(\v21.api.v1alpha1.org.GetUserSessionDataResponse.UserR\x04user\x12\x19\n" +
	...
	"\x12locale_preferences\x18\a \x01(\v2\x1e.api.commons.LocalePreferencesR\x11localePreferences\x12\x1d\n" +
	"\n" +
	"billing_id\x18\b \x01(\tR\tbillingId\x1a\xa9\x0e\n" +
	"\x04User\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x15\n" +
	"\x06org_id\x18\x02 \x01(\tR\x05orgId\x12\x1a\n" +
	"\busername\x18\x03 \x01(\tR\busername\x123\n" +
	"\x16p3_permission_group_id\x18\x04 \x01(\tR\x13p3PermissionGroupId\x12(\n" +
	"\x10partner_agent_id\x18\b \x01(\tR\x0epartnerAgentId\x12i\n" +
	"\x0eregion_sid_map\x18\n" +
	" \x03(\v2C.api.v1alpha1.org.GetUserSessionDataResponse.User.RegionSidMapEntryR\fregionSidMap\x12%\n" +
	...
	"\tlast_name\x18\x14 \x01(\tR\blastName\x124\n" +
	"\acreated\x18\x15 \x01(\v2\x1a.google.protobuf.TimestampR\acreated\x12=\n" +
	"\flast_updated\x18\x16 \x01(\v2\x1a.google.protobuf.TimestampR\vlastUpdated\x126\n" +
	"\x17password_reset_required\x18\x17 \x01(\bR\x15passwordResetRequired\x12A\n" +
	"\rconnection_id\x18\x18 \x01(\v2\x1c.google.protobuf.StringValueR\fconnectionId\x12J\n" +
	"\x12time_zone_override\x18\x19 \x01(\v2\x1c.api.commons.TimeZoneWrapperR\x10timeZoneOverride\x120\n" +
	"\x14permission_group_ids\x18\x1a \x03(\tR\x12permissionGroupIds\x12\x1b\n" +
	"\ttrust_ids\x18\x1b \x03(\tR\btrustIds\x12R\n" +
	"\x13default_application\x18\x1c \x01(\x0e2!.api.commons.OperatorApplicationsR\x12defaultApplication\x12$\n" +
	"\x0euser_caller_id\x18\x1d \x01(\tR\fuserCallerId\x123\n" +
	"\x16agent_profile_group_id\x18\x1e \x01(\tR\x13agentProfileGroupId\x12\x14\n" +
	"\x05agent\x18\x1f \x01(\bR\x05agent\x12#\n" +
	"\raccount_owner\x18  \x01(\bR\faccountOwner\x12?\n" +
	"\rmfa_timestamp\x18! \x01(\v2\x1a.google.protobuf.TimestampR\fmfaTimestamp\x12J\n" +
	"\x13password_reset_date\x18\" \x01(\v2\x1a.google.protobuf.TimestampR\x11passwordResetDate\x12^\n" +
	"\x1blocale_preferences_override\x18# \x01(\v2\x1e.api.commons.LocalePreferencesR\x19localePreferencesOverride\x12R\n" +
	"\x17access_token_expiration\x18$ \x01(\v2\x1a.google.protobuf.TimestampR\x15accessTokenExpiration\x128\n" +
	"\x18play_notification_sounds\x18% \x01(\bR\x16playNotificationSounds\x1ae\n" +
	"\n" +
	"RegionSids\x12\x1b\n" +
	...
	"\x05value\x18\x02 \x01(\v2<.api.v1alpha1.org.GetUserSessionDataResponse.User.RegionSidsR\x05value:\x028\x01J\x04\b\x12\x10\x13R\n" +
	"enable_mfa\"3\n" +
	...
	"\atimeout\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\atimeout\"[\n" +
	"\x11SetMfaTypeRequest\x12,\n" +
	"\x04info\x18\x03 \x01(\v2\x18.api.commons.org.MfaInfoR\x04infoJ\x04\b\x01\x10\x02J\x04\b\x02\x10\x03R\x03otpR\auser_id\"\x14\n" +
	"\x12SetMfaTypeResponse\"N\n" +
	"\x13SetMyMfaTypeRequest\x12,\n" +
	"\x04info\x18\x02 \x01(\v2\x18.api.commons.org.MfaInfoR\x04infoJ\x04\b\x01\x10\x02R\x03otp\"\x16\n" +
	...
	"duoEnabled\x12!\n" +
	"\ftotp_enabled\x18\x04 \x01(\bR\vtotpEnabled\"\x1b\n" +
	...
	"\x14user_allowed_ips_map\x18\x01 \x03(\v2D.api.v1alpha1.org.ListUsersAllowedIpsResponse.UserAllowedIpsMapEntryR\x11userAllowedIpsMap\x1a~\n" +
	"\x16UserAllowedIpsMapEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12N\n" +
	"\x05value\x18\x02 \x01(\v28.api.v1alpha1.org.ListUsersAllowedIpsResponse.AllowedIpsR\x05value:\x028\x01\x1a\x1e\n" +
	"\n" +
	"AllowedIps\x12\x10\n" +
	"\x03ips\x18\x01 \x03(\tR\x03ipsB\xb0\x01\n" +
	"\x14com.api.v1alpha1.orgB\tUserProtoP\x01Z+github.com/tcncloud/api-go/api/v1alpha1/org\xa2\x02\x03AVO\xaa\x02\x10Api.V1alpha1.Org\xca\x02\x10Api\\V1alpha1\\Org\xe2\x02\x1cApi\\V1alpha1\\Org\\GPBMetadata\xea\x02\x12Api::V1alpha1::Orgb\x06proto3"
