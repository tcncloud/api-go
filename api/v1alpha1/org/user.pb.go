...
type GetUserSessionDataResponse struct {
	...
	OrgAllowed_2Fa bool `protobuf:"varint,6,opt,name=org_allowed_2fa,json=orgAllowed2fa,proto3" json:"org_allowed_2fa,omitempty"`
}
...
func (x *GetUserSessionDataResponse) GetOrgAllowed_2Fa() bool {
	if x != nil {
		return x.OrgAllowed_2Fa
	}
	return false
}
...
var file_api_v1alpha1_org_user_proto_rawDesc = []byte{
	...
	0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x64, 0x5f, 0x32, 0x66, 0x61, 0x18, 0x06, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x0d, 0x6f, 0x72, 0x67, 0x41, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x64, 0x32, 0x66, 0x61, 0x1a,
...
var file_api_v1alpha1_org_user_proto_depIdxs = []int32{
	...
	87, // 65: api.v1alpha1.org.GetUserSessionDataResponse.User.mfa_timestamp:type_name -> google.protobuf.Timestamp
	78, // 66: api.v1alpha1.org.GetUserSessionDataResponse.User.RegionSidMapEntry.value:type_name -> api.v1alpha1.org.GetUserSessionDataResponse.User.RegionSids
