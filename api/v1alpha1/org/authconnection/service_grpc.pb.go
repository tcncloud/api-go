...
func (c *authConnectionServiceClient) CreateAuthConnection(ctx context.Context, in *CreateAuthConnectionRequest, opts ...grpc.CallOption) (*CreateAuthConnectionResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthConnectionService_CreateAuthConnection_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authConnectionServiceClient) ListAuthConnectionIds(ctx context.Context, in *ListAuthConnectionIdsRequest, opts ...grpc.CallOption) (*ListAuthConnectionIdsResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthConnectionService_ListAuthConnectionIds_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authConnectionServiceClient) GetAuthConnectionSettings(ctx context.Context, in *GetAuthConnectionSettingsRequest, opts ...grpc.CallOption) (*GetAuthConnectionSettingsResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthConnectionService_GetAuthConnectionSettings_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authConnectionServiceClient) GetAuthConnection(ctx context.Context, in *GetAuthConnectionRequest, opts ...grpc.CallOption) (*GetAuthConnectionResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthConnectionService_GetAuthConnection_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authConnectionServiceClient) DeleteAuthConnection(ctx context.Context, in *DeleteAuthConnectionRequest, opts ...grpc.CallOption) (*DeleteAuthConnectionResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthConnectionService_DeleteAuthConnection_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authConnectionServiceClient) UpdateAuthConnectionSecret(ctx context.Context, in *UpdateAuthConnectionSecretRequest, opts ...grpc.CallOption) (*UpdateAuthConnectionSecretResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthConnectionService_UpdateAuthConnectionSecret_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authConnectionServiceClient) UpdateAuthConnectionGroups(ctx context.Context, in *UpdateAuthConnectionGroupsRequest, opts ...grpc.CallOption) (*UpdateAuthConnectionGroupsResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthConnectionService_UpdateAuthConnectionGroups_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedAuthConnectionServiceServer must be embedded to have
...
func (UnimplementedAuthConnectionServiceServer) testEmbeddedByValue()                               {}
...
func RegisterAuthConnectionServiceServer(s grpc.ServiceRegistrar, srv AuthConnectionServiceServer) {
	// If the following call pancis, it indicates UnimplementedAuthConnectionServiceServer was
