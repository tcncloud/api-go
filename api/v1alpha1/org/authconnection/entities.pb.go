...
func file_api_v1alpha1_org_authconnection_entities_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_v1alpha1_org_authconnection_entities_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListAuthConnectionIdsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_v1alpha1_org_authconnection_entities_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListAuthConnectionIdsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_v1alpha1_org_authconnection_entities_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
