...
var file_api_v1alpha1_org_labels_service_proto_rawDesc = []byte{
	...
	0xc6, 0x0a, 0x0a, 0x0d, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x6e, 0x74, 0x69, 0x74, 0x79, 0x6d, 0x61, 0x70, 0x42, 0xdf, 0x01, 0x0a, 0x1b, 0x63, 0x6f, 0x6d,
	0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x6f, 0x72,
	0x67, 0x2e, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x42, 0x0c, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x31, 0x2f, 0x6f, 0x72, 0x67, 0x2f, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0xa2, 0x02, 0x04, 0x41,
	0x56, 0x4f, 0x4c, 0xaa, 0x02, 0x17, 0x41, 0x70, 0x69, 0x2e, 0x56, 0x31, 0x61, 0x6c, 0x70, 0x68,
	0x61, 0x31, 0x2e, 0x4f, 0x72, 0x67, 0x2e, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0xca, 0x02, 0x17,
	0x41, 0x70, 0x69, 0x5c, 0x56, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x5c, 0x4f, 0x72, 0x67,
	0x5c, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0xe2, 0x02, 0x23, 0x41, 0x70, 0x69, 0x5c, 0x56, 0x31,
	...
	0x72, 0x67, 0x3a, 0x3a, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_api_v1alpha1_org_labels_service_proto_goTypes = []interface{}{
	...
	(*CreateLabelResponse)(nil),         // 8: api.v1alpha1.org.labels.CreateLabelResponse
	(*GetLabelResponse)(nil),            // 9: api.v1alpha1.org.labels.GetLabelResponse
	(*UpdateLabelResponse)(nil),         // 10: api.v1alpha1.org.labels.UpdateLabelResponse
	(*ListLabelsResponse)(nil),          // 11: api.v1alpha1.org.labels.ListLabelsResponse
	(*DeleteLabelResponse)(nil),         // 12: api.v1alpha1.org.labels.DeleteLabelResponse
	(*AttachLabelResponse)(nil),         // 13: api.v1alpha1.org.labels.AttachLabelResponse
	(*DetachLabelResponse)(nil),         // 14: api.v1alpha1.org.labels.DetachLabelResponse
...
var file_api_v1alpha1_org_labels_service_proto_depIdxs = []int32{
	...
	8,  // 8: api.v1alpha1.org.labels.LabelsService.CreateLabel:output_type -> api.v1alpha1.org.labels.CreateLabelResponse
	9,  // 9: api.v1alpha1.org.labels.LabelsService.GetLabel:output_type -> api.v1alpha1.org.labels.GetLabelResponse
	10, // 10: api.v1alpha1.org.labels.LabelsService.UpdateLabel:output_type -> api.v1alpha1.org.labels.UpdateLabelResponse
	11, // 11: api.v1alpha1.org.labels.LabelsService.ListLabels:output_type -> api.v1alpha1.org.labels.ListLabelsResponse
	12, // 12: api.v1alpha1.org.labels.LabelsService.DeleteLabel:output_type -> api.v1alpha1.org.labels.DeleteLabelResponse
	13, // 13: api.v1alpha1.org.labels.LabelsService.AttachLabel:output_type -> api.v1alpha1.org.labels.AttachLabelResponse
	14, // 14: api.v1alpha1.org.labels.LabelsService.DetachLabel:output_type -> api.v1alpha1.org.labels.DetachLabelResponse
	15, // 15: api.v1alpha1.org.labels.LabelsService.GetLabeledEntityMap:output_type -> api.v1alpha1.org.labels.GetLabeledEntityMapResponse
