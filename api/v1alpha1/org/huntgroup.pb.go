...
const file_api_v1alpha1_org_huntgroup_proto_rawDesc = "" +
	"\n" +
	" api/v1alpha1/org/huntgroup.proto\x12\x10api.v1alpha1.org\x1a\x1capi/commons/broadcasts.proto\x1a\x15api/commons/org.proto\x1a\x1fapi/commons/org/huntgroup.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"~\n" +
	"\x1bGetHuntGroupSettingsRequest\x12$\n" +
	"\x0ehunt_group_sid\x18\x01 \x01(\x03R\fhuntGroupSid\x129\n" +
	"\n" +
	"field_mask\x18d \x01(\v2\x1a.google.protobuf.FieldMaskR\tfieldMask\"\x88\x05\n" +
	...
	"\x17number_history_settings\x18\a \x01(\v2&.api.commons.org.NumberHistorySettingsR\x15numberHistorySettings\"\xeb\x05\n" +
	"\x1eUpdateHuntGroupSettingsRequest\x12$\n" +
	"\x0ehunt_group_sid\x18\x01 \x01(\x03R\fhuntGroupSid\x12K\n" +
	"\x10general_settings\x18\x02 \x01(\v2 .api.commons.org.GeneralSettingsR\x0fgeneralSettings\x12]\n" +
	"\x16communication_settings\x18\x03 \x01(\v2&.api.commons.org.CommunicationSettingsR\x15communicationSettings\x12N\n" +
	"\x11callback_settings\x18\x04 \x01(\v2!.api.commons.org.CallbackSettingsR\x10callbackSettings\x12X\n" +
	"\x15preview_dial_settings\x18\x05 \x01(\v2$.api.commons.org.PreviewDialSettingsR\x13previewDialSettings\x12U\n" +
	"\x14manual_dial_settings\x18\x06 \x01(\v2#.api.commons.org.ManualDialSettingsR\x12manualDialSettings\x12[\n" +
	"\x16transfer_call_settings\x18\a \x01(\v2%.api.commons.org.TransferCallSettingsR\x14transferCallSettings\x12^\n" +
	"\x17number_history_settings\x18\b \x01(\v2&.api.commons.org.NumberHistorySettingsR\x15numberHistorySettings\x129\n" +
	"\n" +
	"field_mask\x18d \x01(\v2\x1a.google.protobuf.FieldMaskR\tfieldMask\"!\n" +
	"\x1fUpdateHuntGroupSettingsResponse\"\x82\x01\n" +
	"\x16CreateHuntGroupRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x122\n" +
	"\x04type\x18\x03 \x01(\x0e2\x1e.api.commons.org.HuntGroupTypeR\x04type\"?\n" +
	"\x17CreateHuntGroupResponse\x12$\n" +
	"\x0ehunt_group_sid\x18\x01 \x01(\x03R\fhuntGroupSid\"\xb6\x01\n" +
	"$UpdateHuntGroupGeneralDetailsRequest\x12$\n" +
	"\x0ehunt_group_sid\x18\x01 \x01(\x03R\fhuntGroupSid\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x122\n" +
	"\x04type\x18\x04 \x01(\x0e2\x1e.api.commons.org.HuntGroupTypeR\x04type\"'\n" +
	"%UpdateHuntGroupGeneralDetailsResponse\">\n" +
	"\x16DeleteHuntGroupRequest\x12$\n" +
	"\x0ehunt_group_sid\x18\x01 \x01(\x03R\fhuntGroupSid\"\x19\n" +
	"\x17DeleteHuntGroupResponse\"B\n" +
	"\x1aGetHuntGroupDetailsRequest\x12$\n" +
	"\x0ehunt_group_sid\x18\x01 \x01(\x03R\fhuntGroupSid\"n\n" +
	"\x1bGetHuntGroupDetailsResponse\x12O\n" +
	"\x12hunt_group_details\x18\x01 \x01(\v2!.api.commons.org.HuntGroupDetailsR\x10huntGroupDetails\"\x1c\n" +
	"\x1aListCallerIdBucketsRequest\"u\n" +
	"\x1bListCallerIdBucketsResponse\x12V\n" +
	"\x15caller_id_bucket_data\x18\x01 \x03(\v2#.api.commons.org.CallerIdBucketDataR\x12callerIdBucketData\"R\n" +
	"\x19GetDataDipTemplateRequest\x125\n" +
	"\x17xml_client_property_sid\x18\x01 \x01(\x03R\x14xmlClientPropertySid\"X\n" +
	"\x1aGetDataDipTemplateResponse\x12:\n" +
	"\btemplate\x18\x01 \x01(\v2\x1e.api.commons.org.DataDipConfigR\btemplate\"]\n" +
	"\x1bListDataDipTemplatesRequest\x12>\n" +
	"\x06filter\x18\x01 \x01(\x0e2&.api.commons.DataDipTemplateFilterTypeR\x06filter\"\\\n" +
	"\x1cListDataDipTemplatesResponse\x12<\n" +
	"\ttemplates\x18\x01 \x03(\v2\x1e.api.commons.org.DataDipConfigR\ttemplates\"Z\n" +
	"\x1cCreateDataDipTemplateRequest\x12:\n" +
	"\btemplate\x18\x01 \x01(\v2\x1e.api.commons.org.DataDipConfigR\btemplate\"V\n" +
	"\x1dCreateDataDipTemplateResponse\x125\n" +
	"\x17xml_client_property_sid\x18\x01 \x01(\x03R\x14xmlClientPropertySid\"q\n" +
	"\x1cUpdateDataDipTemplateRequest\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x12:\n" +
	"\btemplate\x18\x02 \x01(\v2\x1e.api.commons.org.DataDipConfigR\btemplate\"\x1f\n" +
	"\x1dUpdateDataDipTemplateResponse\"l\n" +
	"\x1cDeleteDataDipTemplateRequest\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x125\n" +
	"\x17xml_client_property_sid\x18\x02 \x01(\x03R\x14xmlClientPropertySid\"\x1f\n" +
	"\x1dDeleteDataDipTemplateResponse\"\x8b\x01\n" +
	"\x1aCopyDataDipTemplateRequest\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x125\n" +
	"\x17xml_client_property_sid\x18\x02 \x01(\x03R\x14xmlClientPropertySid\x12\x1f\n" +
	"\vconfig_name\x18\x03 \x01(\tR\n" +
	"configName\"T\n" +
	"\x1bCopyDataDipTemplateResponse\x125\n" +
	...
	"\vconfig_name\x18\x03 \x01(\tR\n" +
	"configName\x12,\n" +
	"\x12destination_org_id\x18\x04 \x01(\tR\x10destinationOrgId\"+\n" +
	...
	"\ttemplates\x18\x01 \x03(\v2B.api.v1alpha1.org.ListBroadcastTemplateGeneralDetailsResponse.DataR\ttemplates\x1a\xcc\x01\n" +
	"\x04Data\x12!\n" +
	"\ftemplate_sid\x18\x01 \x01(\x03R\vtemplateSid\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12A\n" +
	"\x0ebroadcast_type\x18\x03 \x01(\x0e2\x1a.api.commons.BroadcastTypeR\rbroadcastType\x12J\n" +
	"\x13last_scheduled_date\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\x11lastScheduledDate\"#\n" +
	"!ListAgentResponseAutoRulesRequest\"k\n" +
	"\"ListAgentResponseAutoRulesResponse\x12E\n" +
	"\brulesets\x18\x01 \x03(\v2).api.commons.org.AgentResponseAutoRuleSetR\brulesets\"j\n" +
	"#CreateAgentResponseAutoRulesRequest\x12C\n" +
	"\aruleset\x18\x01 \x01(\v2).api.commons.org.AgentResponseAutoRuleSetR\aruleset\"&\n" +
	"$CreateAgentResponseAutoRulesResponse\"\x8a\x01\n" +
	"#UpdateAgentResponseAutoRulesRequest\x12\x1e\n" +
	"\n" +
	"rulesetSid\x18\x01 \x01(\x03R\n" +
	"rulesetSid\x12C\n" +
	"\aruleset\x18\x02 \x01(\v2).api.commons.org.AgentResponseAutoRuleSetR\aruleset\"&\n" +
	...
	"-GetHuntGroupClientInfoDisplayTemplateResponse\x12F\n" +
	"\btemplate\x18\x01 \x01(\v2*.api.commons.org.ClientInfoDisplayTemplateR\btemplate\"\x9f\x01\n" +
	"/CreateHuntGroupClientInfoDisplayTemplateRequest\x12$\n" +
	"\x0ehunt_group_sid\x18\x01 \x01(\x03R\fhuntGroupSid\x12F\n" +
	"\btemplate\x18\x02 \x01(\v2*.api.commons.org.ClientInfoDisplayTemplateR\btemplate\"U\n" +
	"0CreateHuntGroupClientInfoDisplayTemplateResponse\x12!\n" +
	"\ftemplate_sid\x18\x01 \x01(\x03R\vtemplateSid\"\x9f\x01\n" +
	"/UpdateHuntGroupClientInfoDisplayTemplateRequest\x12$\n" +
	"\x0ehunt_group_sid\x18\x01 \x01(\x03R\fhuntGroupSid\x12F\n" +
	"\btemplate\x18\x02 \x01(\v2*.api.commons.org.ClientInfoDisplayTemplateR\btemplate\"2\n" +
	...
	"\ftemplate_sid\x18\x02 \x01(\x03R\vtemplateSid\"2\n" +
	"0DeleteHuntGroupClientInfoDisplayTemplateResponse\"\xa2\x01\n" +
	"-CopyHuntGroupClientInfoDisplayTemplateRequest\x12)\n" +
	"\x11to_hunt_group_sid\x18\x01 \x01(\x03R\x0etoHuntGroupSid\x12F\n" +
	"\btemplate\x18\x02 \x01(\v2*.api.commons.org.ClientInfoDisplayTemplateR\btemplate\"0\n" +
	".CopyHuntGroupClientInfoDisplayTemplateResponse\"x\n" +
	".CreateCampaignClientInfoDisplayTemplateRequest\x12F\n" +
	"\btemplate\x18\x01 \x01(\v2*.api.commons.org.ClientInfoDisplayTemplateR\btemplate\"T\n" +
	"/CreateCampaignClientInfoDisplayTemplateResponse\x12!\n" +
	"\ftemplate_sid\x18\x01 \x01(\x03R\vtemplateSid\"\x94\x02\n" +
	"/ListHuntGroupsWithClientInfoTemplateDataRequest\x12`\n" +
	"\x06filter\x18\x01 \x01(\x0e2H.api.v1alpha1.org.ListHuntGroupsWithClientInfoTemplateDataRequest.FilterR\x06filter\"\x7f\n" +
	"\x06Filter\x12\x16\n" +
	"\x12FILTER_UNSPECIFIED\x10\x00\x12\x0e\n" +
	"\n" +
	...
	"\x1ehunt_groups_with_template_data\x18\x01 \x03(\v24.api.commons.org.HuntGroupWithClientInfoTemplateDataR\x1ahuntGroupsWithTemplateData\"D\n" +
	"\x1cListHuntGroupWebLinksRequest\x12$\n" +
	"\x0ehunt_group_sid\x18\x01 \x01(\x03R\fhuntGroupSid\"V\n" +
	"\x1dListHuntGroupWebLinksResponse\x125\n" +
	"\tweb_links\x18\x01 \x03(\v2\x18.api.commons.org.WebLinkR\bwebLinks\"\xac\x01\n" +
	"\x1bCopyHuntGroupWebLinkRequest\x12-\n" +
	"\x13from_hunt_group_sid\x18\x01 \x01(\x03R\x10fromHuntGroupSid\x12)\n" +
	"\x11to_hunt_group_sid\x18\x02 \x01(\x03R\x0etoHuntGroupSid\x123\n" +
	"\bweb_link\x18\x03 \x01(\v2\x18.api.commons.org.WebLinkR\awebLink\"\x1e\n" +
	"\x1cCopyHuntGroupWebLinkResponse\"}\n" +
	"\x1eUpdateHuntGroupWebLinksRequest\x12$\n" +
	"\x0ehunt_group_sid\x18\x01 \x01(\x03R\fhuntGroupSid\x125\n" +
	"\tweb_links\x18\x02 \x03(\v2\x18.api.commons.org.WebLinkR\bwebLinks\"!\n" +
	"\x1fUpdateHuntGroupWebLinksResponse\"c\n" +
	"$ListHuntGroupIntegrationLinksRequest\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x12$\n" +
	"\x0ehunt_group_sid\x18\x02 \x01(\x03R\fhuntGroupSid\"_\n" +
	"%ListHuntGroupIntegrationLinksResponse\x126\n" +
	"\x05links\x18\x01 \x03(\v2 .api.commons.org.IntegrationLinkR\x05links\"\x86\x01\n" +
	"#CopyHuntGroupIntegrationLinkRequest\x12)\n" +
	"\x11to_hunt_group_sid\x18\x01 \x01(\x03R\x0etoHuntGroupSid\x124\n" +
	"\x04link\x18\x02 \x01(\v2 .api.commons.org.IntegrationLinkR\x04link\"&\n" +
	"$CopyHuntGroupIntegrationLinkResponse\"\x86\x01\n" +
	"&UpdateHuntGroupIntegrationLinksRequest\x126\n" +
	"\x05links\x18\x01 \x03(\v2 .api.commons.org.IntegrationLinkR\x05links\x12$\n" +
	"\x0ehunt_group_sid\x18\x02 \x01(\x03R\fhuntGroupSid\")\n" +
	"'UpdateHuntGroupIntegrationLinksResponse\"D\n" +
	"\x18ListAgentTriggersRequest\x12$\n" +
	"\x0ehunt_group_sid\x18\x01 \x01(\x03R\fhuntGroupSid:\x02\x18\x01\"e\n" +
	"\x19ListAgentTriggersResponse\x12D\n" +
	"\x0eagent_triggers\x18\x01 \x03(\v2\x1d.api.commons.org.AgentTriggerR\ragentTriggers:\x02\x18\x01\"\xbb\x01\n" +
	"\x17CopyAgentTriggerRequest\x12-\n" +
	"\x13from_hunt_group_sid\x18\x01 \x01(\x03R\x10fromHuntGroupSid\x12)\n" +
	"\x11to_hunt_group_sid\x18\x02 \x01(\x03R\x0etoHuntGroupSid\x12B\n" +
	"\ragent_trigger\x18\x03 \x01(\v2\x1d.api.commons.org.AgentTriggerR\fagentTrigger:\x02\x18\x01\"\x1e\n" +
	"\x18CopyAgentTriggerResponse:\x02\x18\x01\"\x8c\x01\n" +
	"\x1aUpdateAgentTriggersRequest\x12$\n" +
	"\x0ehunt_group_sid\x18\x01 \x01(\x03R\fhuntGroupSid\x12D\n" +
	"\x0eagent_triggers\x18\x02 \x03(\v2\x1d.api.commons.org.AgentTriggerR\ragentTriggers:\x02\x18\x01\"!\n" +
	"\x1bUpdateAgentTriggersResponse:\x02\x18\x01\"\x1d\n" +
	"\x1bListHuntGroupScriptsRequest\"Z\n" +
	"\x1cListHuntGroupScriptsResponse\x12:\n" +
	"\ascripts\x18\x01 \x03(\v2 .api.commons.org.HuntGroupScriptR\ascripts\"d\n" +
	"\x19GetHuntGroupScriptRequest\x12(\n" +
	"\x0ehunt_group_sid\x18\x01 \x01(\x03B\x02\x18\x01R\fhuntGroupSid\x12\x1d\n" +
	"\n" +
	"script_sid\x18\x02 \x01(\x03R\tscriptSid\"\xe7\x03\n" +
	"\x1aGetHuntGroupScriptResponse\x12P\n" +
	"\x11hunt_group_script\x18\x01 \x01(\v2 .api.commons.org.HuntGroupScriptB\x02\x18\x01R\x0fhuntGroupScript\x12j\n" +
	"\x0escript_details\x18\x02 \x01(\v2C.api.v1alpha1.org.GetHuntGroupScriptResponse.HuntGroupScriptDetailsR\rscriptDetails\x1a\x8a\x02\n" +
	"\x16HuntGroupScriptDetails\x128\n" +
	...
	"\x1cCreateHuntGroupScriptRequest\x12(\n" +
	"\x0ehunt_group_sid\x18\x01 \x01(\x03B\x02\x18\x01R\fhuntGroupSid\x12L\n" +
	"\x11hunt_group_script\x18\x02 \x01(\v2 .api.commons.org.HuntGroupScriptR\x0fhuntGroupScript\"\x1f\n" +
	"\x1dCreateHuntGroupScriptResponse\"\xb5\x01\n" +
	"\x1cUpdateHuntGroupScriptRequest\x12(\n" +
	"\x0ehunt_group_sid\x18\x01 \x01(\x03B\x02\x18\x01R\fhuntGroupSid\x12L\n" +
	"\x11hunt_group_script\x18\x02 \x01(\v2 .api.commons.org.HuntGroupScriptR\x0fhuntGroupScript\x12\x1d\n" +
	"\n" +
	"script_sid\x18\x03 \x01(\x03R\tscriptSid\"\x1f\n" +
	"\x1dUpdateHuntGroupScriptResponse\"g\n" +
	"\x1cDeleteHuntGroupScriptRequest\x12(\n" +
	"\x0ehunt_group_sid\x18\x01 \x01(\x03B\x02\x18\x01R\fhuntGroupSid\x12\x1d\n" +
	"\n" +
	"script_sid\x18\x02 \x01(\x03R\tscriptSid\"\x1f\n" +
	"\x1dDeleteHuntGroupScriptResponse\"h\n" +
	"\x1fAssignScriptToHuntGroupsRequest\x12\x1d\n" +
	"\n" +
	...
	"\x1eListResponseEvaluatorsResponse\x12B\n" +
	"\n" +
	"evaluators\x18\x01 \x03(\v2\".api.commons.org.ResponseEvaluatorR\n" +
	"evaluators\"@\n" +
	"\x1bGetResponseEvaluatorRequest\x12!\n" +
	"\fevaluator_id\x18\x01 \x01(\tR\vevaluatorId\"`\n" +
	"\x1cGetResponseEvaluatorResponse\x12@\n" +
	"\tevaluator\x18\x01 \x01(\v2\".api.commons.org.ResponseEvaluatorR\tevaluator\"b\n" +
	"\x1eCreateResponseEvaluatorRequest\x12@\n" +
	"\tevaluator\x18\x01 \x01(\v2\".api.commons.org.ResponseEvaluatorR\tevaluator\"c\n" +
	"\x1fCreateResponseEvaluatorResponse\x12@\n" +
	"\tevaluator\x18\x01 \x01(\v2\".api.commons.org.ResponseEvaluatorR\tevaluator\"b\n" +
	"\x1eUpdateResponseEvaluatorRequest\x12@\n" +
	"\tevaluator\x18\x01 \x01(\v2\".api.commons.org.ResponseEvaluatorR\tevaluator\"c\n" +
	"\x1fUpdateResponseEvaluatorResponse\x12@\n" +
	"\tevaluator\x18\x01 \x01(\v2\".api.commons.org.ResponseEvaluatorR\tevaluator\"C\n" +
	"\x1eDeleteResponseEvaluatorRequest\x12!\n" +
	"\fevaluator_id\x18\x01 \x01(\tR\vevaluatorId\"!\n" +
	"\x1fDeleteResponseEvaluatorResponseB\xb5\x01\n" +
	"\x14com.api.v1alpha1.orgB\x0eHuntgroupProtoP\x01Z+github.com/tcncloud/api-go/api/v1alpha1/org\xa2\x02\x03AVO\xaa\x02\x10Api.V1alpha1.Org\xca\x02\x10Api\\V1alpha1\\Org\xe2\x02\x1cApi\\V1alpha1\\Org\\GPBMetadata\xea\x02\x12Api::V1alpha1::Orgb\x06proto3"
