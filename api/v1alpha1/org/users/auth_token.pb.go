...
const file_api_v1alpha1_org_users_auth_token_proto_rawDesc = "" +
	"\n" +
	"'api/v1alpha1/org/users/auth_token.proto\x12\x16api.v1alpha1.org.users\x1a api/commons/org/auth_token.proto\"\x18\n" +
	...
	"\x05token\x18\x01 \x01(\tR\x05token\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\"!\n" +
	"\x1fDeleteAuthTokenByUserIdResponseB\xdb\x01\n" +
	"\x1acom.api.v1alpha1.org.usersB\x0eAuthTokenProtoP\x01Z1github.com/tcncloud/api-go/api/v1alpha1/org/users\xa2\x02\x04AVOU\xaa\x02\x16Api.V1alpha1.Org.Users\xca\x02\x16Api\\V1alpha1\\Org\\Users\xe2\x02\"Api\\V1alpha1\\Org\\Users\\GPBMetadata\xea\x02\x19Api::V1alpha1::Org::Usersb\x06proto3"

var (
	file_api_v1alpha1_org_users_auth_token_proto_rawDescOnce sync.Once
	file_api_v1alpha1_org_users_auth_token_proto_rawDescData []byte
)
...
func file_api_v1alpha1_org_users_auth_token_proto_rawDescGZIP() []byte {
	file_api_v1alpha1_org_users_auth_token_proto_rawDescOnce.Do(func() {
		file_api_v1alpha1_org_users_auth_token_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_v1alpha1_org_users_auth_token_proto_rawDesc), len(file_api_v1alpha1_org_users_auth_token_proto_rawDesc)))
	})
...
func file_api_v1alpha1_org_users_auth_token_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_v1alpha1_org_users_auth_token_proto_rawDesc), len(file_api_v1alpha1_org_users_auth_token_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   16,
			NumExtensions: 0,
			NumServices:   0,
