...
const file_api_v1alpha1_org_labels_proto_rawDesc = "" +
	"\n" +
	"\x1dapi/v1alpha1/org/labels.proto\x12\x10api.v1alpha1.org\x1a\x1capi/commons/auth/perms.proto\x1a\x18api/commons/labels.proto\"\x94\x01\n" +
	"\x05Label\x12\x12\n" +
	...
	"\adeleted\x18\t \x01(\bR\adeletedJ\x04\b\x04\x10\x05J\x04\b\x05\x10\x06\"C\n" +
	"\x12CreateLabelRequest\x12-\n" +
	"\x05label\x18\x01 \x01(\v2\x17.api.v1alpha1.org.LabelR\x05label\"0\n" +
	"\x13CreateLabelResponse\x12\x19\n" +
	"\blabel_id\x18\x01 \x01(\tR\alabelId\"5\n" +
	"\x12DeleteLabelRequest\x12\x19\n" +
	"\blabel_id\x18\x02 \x01(\tR\alabelIdJ\x04\b\x01\x10\x02\"\x15\n" +
	"\x13DeleteLabelResponse\"\x19\n" +
	"\x11ListLabelsRequestJ\x04\b\x02\x10\x03\"E\n" +
	"\x12ListLabelsResponse\x12/\n" +
	"\x06labels\x18\x01 \x03(\v2\x17.api.v1alpha1.org.LabelR\x06labels\"2\n" +
	"\x0fGetLabelRequest\x12\x19\n" +
	"\blabel_id\x18\x02 \x01(\tR\alabelIdJ\x04\b\x01\x10\x02\"A\n" +
	"\x10GetLabelResponse\x12-\n" +
	"\x05label\x18\x01 \x01(\v2\x17.api.v1alpha1.org.LabelR\x05label\"C\n" +
	"\x12UpdateLabelRequest\x12-\n" +
	"\x05label\x18\x01 \x01(\v2\x17.api.v1alpha1.org.LabelR\x05label\"\x15\n" +
	...
	"\x05label\x18\x05 \x01(\v2\x17.api.v1alpha1.org.LabelR\x05labelJ\x04\b\x04\x10\x05\"_\n" +
	"\x12AssignLabelRequest\x12C\n" +
	"\vassignments\x18\x02 \x03(\v2!.api.v1alpha1.org.LabelAssignmentR\vassignmentsJ\x04\b\x01\x10\x02\"\x15\n" +
	"\x13AssignLabelResponse\"a\n" +
	"\x14UnassignLabelRequest\x12C\n" +
	"\vassignments\x18\x02 \x03(\v2!.api.v1alpha1.org.LabelAssignmentR\vassignmentsJ\x04\b\x01\x10\x02\"\x17\n" +
	"\x15UnassignLabelResponse\"7\n" +
	"\x1aGetAssignmentCountsRequest\x12\x19\n" +
	"\blabel_id\x18\x01 \x01(\tR\alabelId\"\xab\x01\n" +
	"\x1bGetAssignmentCountsResponse\x12Q\n" +
	"\x06counts\x18\x01 \x03(\v29.api.v1alpha1.org.GetAssignmentCountsResponse.CountsEntryR\x06counts\x1a9\n" +
	...
	"\x06labels\x18\x01 \x03(\v2\x17.api.v1alpha1.org.LabelR\x06labelsB\xb2\x01\n" +
	"\x14com.api.v1alpha1.orgB\vLabelsProtoP\x01Z+github.com/tcncloud/api-go/api/v1alpha1/org\xa2\x02\x03AVO\xaa\x02\x10Api.V1alpha1.Org\xca\x02\x10Api\\V1alpha1\\Org\xe2\x02\x1cApi\\V1alpha1\\Org\\GPBMetadata\xea\x02\x12Api::V1alpha1::Orgb\x06proto3"
