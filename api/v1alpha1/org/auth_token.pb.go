...
const file_api_v1alpha1_org_auth_token_proto_rawDesc = "" +
	"\n" +
	"!api/v1alpha1/org/auth_token.proto\x12\x10api.v1alpha1.org\x1a api/commons/org/auth_token.proto\"\x18\n" +
	"\x16CreateAuthTokenRequest\"T\n" +
	"\x17CreateAuthTokenResponse\x129\n" +
	"\n" +
	"auth_token\x18\x01 \x01(\v2\x1a.api.commons.org.AuthTokenR\tauthToken\"9\n" +
	"\x1eCreateAuthTokenByUserIdRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\"\\\n" +
	"\x1fCreateAuthTokenByUserIdResponse\x129\n" +
	"\n" +
	"auth_token\x18\x01 \x01(\v2\x1a.api.commons.org.AuthTokenR\tauthToken\"\x17\n" +
	"\x15ListAuthTokensRequest\"U\n" +
	"\x16ListAuthTokensResponse\x12;\n" +
	"\vauth_tokens\x18\x01 \x03(\v2\x1a.api.commons.org.AuthTokenR\n" +
	"authTokens\"8\n" +
	...
	"\x16DeleteAuthTokenRequest\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\"\x19\n" +
	"\x17DeleteAuthTokenResponse\"O\n" +
	"\x1eDeleteAuthTokenByUserIdRequest\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\"!\n" +
	"\x1fDeleteAuthTokenByUserIdResponseB\xb5\x01\n" +
	"\x14com.api.v1alpha1.orgB\x0eAuthTokenProtoP\x01Z+github.com/tcncloud/api-go/api/v1alpha1/org\xa2\x02\x03AVO\xaa\x02\x10Api.V1alpha1.Org\xca\x02\x10Api\\V1alpha1\\Org\xe2\x02\x1cApi\\V1alpha1\\Org\\GPBMetadata\xea\x02\x12Api::V1alpha1::Orgb\x06proto3"
