...
const file_api_v1alpha1_org_businesshours_entities_proto_rawDesc = "" +
	"\n" +
	"-api/v1alpha1/org/businesshours/entities.proto\x12\x1eapi.v1alpha1.org.businesshours\x1a\x15api/commons/org.proto\x1a!api/commons/org/preferences.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x1a\n" +
	"\x18ListBusinessHoursRequest\"b\n" +
	"\x19ListBusinessHoursResponse\x12E\n" +
	"\x0ebusiness_hours\x18\x01 \x03(\v2\x1e.api.commons.org.BusinessHoursR\rbusinessHours\"E\n" +
	"\x17GetBusinessHoursRequest\x12*\n" +
	"\x11business_hours_id\x18\x01 \x01(\tR\x0fbusinessHoursId\"a\n" +
	"\x18GetBusinessHoursResponse\x12E\n" +
	"\x0ebusiness_hours\x18\x01 \x01(\v2\x1e.api.commons.org.BusinessHoursR\rbusinessHours\"\xe1\x01\n" +
	...
	"\btimezone\x18\x04 \x01(\x0e2\x15.api.commons.TimeZoneR\btimezone\"F\n" +
	"\x18SetBusinessHoursResponse\x12*\n" +
	"\x11business_hours_id\x18\x01 \x01(\tR\x0fbusinessHoursId\"\x90\x01\n" +
	"!AddIntervalToBusinessHoursRequest\x12*\n" +
	"\x11business_hours_id\x18\x01 \x01(\tR\x0fbusinessHoursId\x12?\n" +
	"\fday_interval\x18\x02 \x01(\v2\x1c.api.commons.org.DayIntervalR\vdayInterval\"$\n" +
	...
	"\x11business_hours_id\x18\x01 \x01(\tR\x0fbusinessHoursId\"\x1d\n" +
	"\x1bDeleteBusinessHoursResponse\"J\n" +
	"\x1cEvaluateBusinessHoursRequest\x12*\n" +
	"\x11business_hours_id\x18\x01 \x01(\tR\x0fbusinessHoursId\"\x8b\x01\n" +
	"\x1dEvaluateBusinessHoursResponse\x12!\n" +
	"\fwithin_range\x18\x01 \x01(\bR\vwithinRange\x12G\n" +
	"\x11result_expiration\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\x10resultExpirationB\x8a\x02\n" +
	"\"com.api.v1alpha1.org.businesshoursB\rEntitiesProtoP\x01Z9github.com/tcncloud/api-go/api/v1alpha1/org/businesshours\xa2\x02\x04AVOB\xaa\x02\x1eApi.V1alpha1.Org.Businesshours\xca\x02\x1eApi\\V1alpha1\\Org\\Businesshours\xe2\x02*Api\\V1alpha1\\Org\\Businesshours\\GPBMetadata\xea\x02!Api::V1alpha1::Org::Businesshoursb\x06proto3"
