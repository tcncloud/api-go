...
func file_api_v1alpha1_agenttraining_learning_opportunity_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_v1alpha1_agenttraining_learning_opportunity_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_agenttraining_learning_opportunity_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
