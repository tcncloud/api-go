...
// UnimplementedAgentTrainingSupportServiceServer must be embedded to have
...
func (UnimplementedAgentTrainingSupportServiceServer) testEmbeddedByValue() {}
...
func RegisterAgentTrainingSupportServiceServer(s grpc.ServiceRegistrar, srv AgentTrainingSupportServiceServer) {
	// If the following call pancis, it indicates UnimplementedAgentTrainingSupportServiceServer was
