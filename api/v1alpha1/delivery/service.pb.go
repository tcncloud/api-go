...
func file_api_v1alpha1_delivery_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_v1alpha1_delivery_service_proto_msgTypes[89].Exporter = func(v interface{}, i int) interface{} {
	...
	file_api_v1alpha1_delivery_service_proto_msgTypes[87].OneofWrappers = []interface{}{
