...
const (
	...
	// WFMListAdherenceAgentStateViolationsProcedure is the fully-qualified name of the WFM's
	// ListAdherenceAgentStateViolations RPC.
	WFMListAdherenceAgentStateViolationsProcedure = "/api.v1alpha1.wfm.WFM/ListAdherenceAgentStateViolations"
	// WFMResolveAdherenceAgentStateViolationProcedure is the fully-qualified name of the WFM's
	// ResolveAdherenceAgentStateViolation RPC.
	WFMResolveAdherenceAgentStateViolationProcedure = "/api.v1alpha1.wfm.WFM/ResolveAdherenceAgentStateViolation"
...
type WFMClient interface {
	...
	ListAdherenceAgentStateViolations(context.Context, *connect_go.Request[wfm.ListAdherenceAgentStateViolationsRequest]) (*connect_go.Response[wfm.ListAdherenceAgentStateViolationsResponse], error)
	...
	ResolveAdherenceAgentStateViolation(context.Context, *connect_go.Request[wfm.ResolveAdherenceAgentStateViolationRequest]) (*connect_go.Response[wfm.ResolveAdherenceAgentStateViolationResponse], error)
...
func NewWFMClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) WFMClient {
	...
	return &wFMClient{
		...
		createSchedulingActivityPauseCodes: connect_go.NewClient[wfm.CreateSchedulingActivityPauseCodesRequest, wfm.CreateSchedulingActivityPauseCodesResponse](
			httpClient,
			baseURL+WFMCreateSchedulingActivityPauseCodesProcedure,
			opts...,
		),
		deleteSchedulingActivityPauseCodes: connect_go.NewClient[wfm.DeleteSchedulingActivityPauseCodesRequest, wfm.DeleteSchedulingActivityPauseCodesResponse](
			httpClient,
			baseURL+WFMDeleteSchedulingActivityPauseCodesProcedure,
			opts...,
		),
		...
		copyWFMAgentMemberships: connect_go.NewClient[wfm.CopyWFMAgentMembershipsRequest, wfm.CopyWFMAgentMembershipsResponse](
			httpClient,
			baseURL+WFMCopyWFMAgentMembershipsProcedure,
			opts...,
		),
		...
		updateShiftInstanceWithSegments: connect_go.NewClient[wfm.UpdateShiftInstanceWithSegmentsRequest, wfm.UpdateShiftInstanceWithSegmentsResponse](
			httpClient,
			baseURL+WFMUpdateShiftInstanceWithSegmentsProcedure,
			opts...,
		),
		...
		createTourPattern: connect_go.NewClient[wfm.CreateTourPatternReq, wfm.CreateTourPatternRes](
			httpClient,
		...
		getTourPattern: connect_go.NewClient[wfm.GetTourPatternReq, wfm.GetTourPatternRes](
			httpClient,
		...
		listTourWeekPatterns: connect_go.NewClient[wfm.ListTourWeekPatternsReq, wfm.ListTourWeekPatternsRes](
			httpClient,
		...
		createTourAgentCollectionWFMAgents: connect_go.NewClient[wfm.CreateTourAgentCollectionWFMAgentsReq, wfm.CreateTourAgentCollectionWFMAgentsRes](
			httpClient,
			baseURL+WFMCreateTourAgentCollectionWFMAgentsProcedure,
			opts...,
		),
		...
		generateTourWeekPatterns: connect_go.NewClient[wfm.GenerateTourWeekPatternsReq, wfm.GenerateTourWeekPatternsRes](
			httpClient,
		...
		replaceAgentOnScheduleV1: connect_go.NewClient[wfm.ReplaceAgentOnScheduleReq, wfm.ReplaceAgentOnScheduleRes](
			httpClient,
			baseURL+WFMReplaceAgentOnScheduleV1Procedure,
			opts...,
		),
		...
		createPublishedShift: connect_go.NewClient[wfm.CreatePublishedShiftRequest, wfm.CreatePublishedShiftResponse](
			httpClient,
			baseURL+WFMCreatePublishedShiftProcedure,
			opts...,
		),
		createPublishedShiftWithSegments: connect_go.NewClient[wfm.CreatePublishedShiftWithSegmentsRequest, wfm.CreatePublishedShiftWithSegmentsResponse](
			httpClient,
			baseURL+WFMCreatePublishedShiftWithSegmentsProcedure,
			opts...,
		),
		updatePublishedShift: connect_go.NewClient[wfm.UpdatePublishedShiftRequest, wfm.UpdatePublishedShiftResponse](
			httpClient,
			baseURL+WFMUpdatePublishedShiftProcedure,
			opts...,
		),
		updatePublishedShiftWithSegments: connect_go.NewClient[wfm.UpdatePublishedShiftWithSegmentsRequest, wfm.UpdatePublishedShiftWithSegmentsResponse](
			httpClient,
			baseURL+WFMUpdatePublishedShiftWithSegmentsProcedure,
			opts...,
		),
		splitPublishedShift: connect_go.NewClient[wfm.SplitPublishedShiftRequest, wfm.SplitPublishedShiftResponse](
			httpClient,
			baseURL+WFMSplitPublishedShiftProcedure,
			opts...,
		),
		swapPublishedShifts: connect_go.NewClient[wfm.SwapPublishedShiftsRequest, wfm.SwapPublishedShiftsResponse](
			httpClient,
			baseURL+WFMSwapPublishedShiftsProcedure,
			opts...,
		),
		deletePublishedShifts: connect_go.NewClient[wfm.DeletePublishedShiftsRequest, wfm.DeletePublishedShiftsResponse](
			httpClient,
			baseURL+WFMDeletePublishedShiftsProcedure,
			opts...,
		),
		replaceAgentOnPublishedSchedule: connect_go.NewClient[wfm.ReplaceAgentOnPublishedScheduleRequest, wfm.ReplaceAgentOnPublishedScheduleResponse](
			httpClient,
			baseURL+WFMReplaceAgentOnPublishedScheduleProcedure,
			opts...,
		),
		removeAgentFromPublishedSchedule: connect_go.NewClient[wfm.RemoveAgentFromPublishedScheduleRequest, wfm.RemoveAgentFromPublishedScheduleResponse](
			httpClient,
			baseURL+WFMRemoveAgentFromPublishedScheduleProcedure,
			opts...,
		),
		copyShiftsToPublishedSchedule: connect_go.NewClient[wfm.CopyShiftsToPublishedScheduleRequest, wfm.CopyShiftsToPublishedScheduleResponse](
			httpClient,
			baseURL+WFMCopyShiftsToPublishedScheduleProcedure,
			opts...,
		),
		createAgentLeavePetition: connect_go.NewClient[wfm.CreateAgentLeavePetitionRequest, wfm.CreateAgentLeavePetitionResponse](
			httpClient,
			baseURL+WFMCreateAgentLeavePetitionProcedure,
			opts...,
		),
		listAgentLeavePetitions: connect_go.NewClient[wfm.ListAgentLeavePetitionsRequest, wfm.ListAgentLeavePetitionsResponse](
			httpClient,
		...
		resolveAgentLeavePetition: connect_go.NewClient[wfm.ResolveAgentLeavePetitionRequest, wfm.ResolveAgentLeavePetitionResponse](
			httpClient,
			baseURL+WFMResolveAgentLeavePetitionProcedure,
			opts...,
		),
		cancelAgentLeavePetition: connect_go.NewClient[wfm.CancelAgentLeavePetitionRequest, wfm.CancelAgentLeavePetitionResponse](
			httpClient,
			baseURL+WFMCancelAgentLeavePetitionProcedure,
			opts...,
		),
		...
		listAdherenceAgentStateViolations: connect_go.NewClient[wfm.ListAdherenceAgentStateViolationsRequest, wfm.ListAdherenceAgentStateViolationsResponse](
			httpClient,
			baseURL+WFMListAdherenceAgentStateViolationsProcedure,
			opts...,
		),
		resolveAdherenceAgentStateViolation: connect_go.NewClient[wfm.ResolveAdherenceAgentStateViolationRequest, wfm.ResolveAdherenceAgentStateViolationResponse](
			httpClient,
			baseURL+WFMResolveAdherenceAgentStateViolationProcedure,
			opts...,
		),
		...
		createRgbaColor: connect_go.NewClient[wfm.CreateRgbaColorRequest, wfm.CreateRgbaColorResponse](
			httpClient,
			baseURL+WFMCreateRgbaColorProcedure,
			opts...,
		),
		listRgbaColors: connect_go.NewClient[wfm.ListRgbaColorsRequest, wfm.ListRgbaColorsResponse](
			httpClient,
			baseURL+WFMListRgbaColorsProcedure,
			opts...,
		),
		updateRgbaColor: connect_go.NewClient[wfm.UpdateRgbaColorRequest, wfm.UpdateRgbaColorResponse](
			httpClient,
			baseURL+WFMUpdateRgbaColorProcedure,
			opts...,
		),
		deleteRgbaColor: connect_go.NewClient[wfm.DeleteRgbaColorRequest, wfm.DeleteRgbaColorResponse](
			httpClient,
			baseURL+WFMDeleteRgbaColorProcedure,
			opts...,
		),
		createAdherenceRuleNotificationConfig: connect_go.NewClient[wfm.CreateAdherenceRuleNotificationConfigRequest, wfm.CreateAdherenceRuleNotificationConfigResponse](
			httpClient,
			baseURL+WFMCreateAdherenceRuleNotificationConfigProcedure,
			opts...,
		),
		updateAdherenceRuleNotificationConfig: connect_go.NewClient[wfm.UpdateAdherenceRuleNotificationConfigRequest, wfm.UpdateAdherenceRuleNotificationConfigResponse](
			httpClient,
			baseURL+WFMUpdateAdherenceRuleNotificationConfigProcedure,
			opts...,
		),
		createAdherenceRuleNotificationConfigEntry: connect_go.NewClient[wfm.CreateAdherenceRuleNotificationConfigEntryRequest, wfm.CreateAdherenceRuleNotificationConfigEntryResponse](
			httpClient,
			baseURL+WFMCreateAdherenceRuleNotificationConfigEntryProcedure,
			opts...,
		),
		updateAdherenceRuleNotificationConfigEntry: connect_go.NewClient[wfm.UpdateAdherenceRuleNotificationConfigEntryRequest, wfm.UpdateAdherenceRuleNotificationConfigEntryResponse](
			httpClient,
			baseURL+WFMUpdateAdherenceRuleNotificationConfigEntryProcedure,
			opts...,
		),
		...
		createAdherenceDepartmentalRule: connect_go.NewClient[wfm.CreateAdherenceDepartmentalRuleRequest, wfm.CreateAdherenceDepartmentalRuleResponse](
			httpClient,
			baseURL+WFMCreateAdherenceDepartmentalRuleProcedure,
			opts...,
		),
		updateAdherenceDepartmentalRule: connect_go.NewClient[wfm.UpdateAdherenceDepartmentalRuleRequest, wfm.UpdateAdherenceDepartmentalRuleResponse](
			httpClient,
			baseURL+WFMUpdateAdherenceDepartmentalRuleProcedure,
			opts...,
		),
		...
		updateAdherenceDepartmentalRuleClause: connect_go.NewClient[wfm.UpdateAdherenceDepartmentalRuleClauseRequest, wfm.UpdateAdherenceDepartmentalRuleClauseResponse](
			httpClient,
			baseURL+WFMUpdateAdherenceDepartmentalRuleClauseProcedure,
			opts...,
		),
		...
		listAdherenceDepartmentalRules: connect_go.NewClient[wfm.ListAdherenceDepartmentalRulesRequest, wfm.ListAdherenceDepartmentalRulesResponse](
			httpClient,
			baseURL+WFMListAdherenceDepartmentalRulesProcedure,
			opts...,
		),
		createAdherenceAgentRule: connect_go.NewClient[wfm.CreateAdherenceAgentRuleRequest, wfm.CreateAdherenceAgentRuleResponse](
			httpClient,
			baseURL+WFMCreateAdherenceAgentRuleProcedure,
			opts...,
		),
		updateAdherenceAgentRule: connect_go.NewClient[wfm.UpdateAdherenceAgentRuleRequest, wfm.UpdateAdherenceAgentRuleResponse](
			httpClient,
			baseURL+WFMUpdateAdherenceAgentRuleProcedure,
			opts...,
		),
		createAdherenceAgentRuleClause: connect_go.NewClient[wfm.CreateAdherenceAgentRuleClauseRequest, wfm.CreateAdherenceAgentRuleClauseResponse](
			httpClient,
			baseURL+WFMCreateAdherenceAgentRuleClauseProcedure,
			opts...,
		),
		updateAdherenceAgentRuleClause: connect_go.NewClient[wfm.UpdateAdherenceAgentRuleClauseRequest, wfm.UpdateAdherenceAgentRuleClauseResponse](
			httpClient,
			baseURL+WFMUpdateAdherenceAgentRuleClauseProcedure,
			opts...,
		),
		...
		agentGetSchedule: connect_go.NewClient[wfm.AgentGetScheduleRequest, wfm.AgentGetScheduleResponse](
			httpClient,
			baseURL+WFMAgentGetScheduleProcedure,
			opts...,
		),
		agentListLeavePetitions: connect_go.NewClient[wfm.AgentListLeavePetitionsRequest, wfm.AgentListLeavePetitionsResponse](
			httpClient,
			baseURL+WFMAgentListLeavePetitionsProcedure,
			opts...,
		),
		agentCreateLeavePetition: connect_go.NewClient[wfm.AgentCreateLeavePetitionRequest, wfm.AgentCreateLeavePetitionResponse](
			httpClient,
			baseURL+WFMAgentCreateLeavePetitionProcedure,
			opts...,
		),
...
type wFMClient struct {
	...
	createSchedulingActivityPauseCodes               *connect_go.Client[wfm.CreateSchedulingActivityPauseCodesRequest, wfm.CreateSchedulingActivityPauseCodesResponse]
	deleteSchedulingActivityPauseCodes               *connect_go.Client[wfm.DeleteSchedulingActivityPauseCodesRequest, wfm.DeleteSchedulingActivityPauseCodesResponse]
	...
	createPublishedShift                             *connect_go.Client[wfm.CreatePublishedShiftRequest, wfm.CreatePublishedShiftResponse]
	createPublishedShiftWithSegments                 *connect_go.Client[wfm.CreatePublishedShiftWithSegmentsRequest, wfm.CreatePublishedShiftWithSegmentsResponse]
	updatePublishedShift                             *connect_go.Client[wfm.UpdatePublishedShiftRequest, wfm.UpdatePublishedShiftResponse]
	updatePublishedShiftWithSegments                 *connect_go.Client[wfm.UpdatePublishedShiftWithSegmentsRequest, wfm.UpdatePublishedShiftWithSegmentsResponse]
	splitPublishedShift                              *connect_go.Client[wfm.SplitPublishedShiftRequest, wfm.SplitPublishedShiftResponse]
	swapPublishedShifts                              *connect_go.Client[wfm.SwapPublishedShiftsRequest, wfm.SwapPublishedShiftsResponse]
	deletePublishedShifts                            *connect_go.Client[wfm.DeletePublishedShiftsRequest, wfm.DeletePublishedShiftsResponse]
	replaceAgentOnPublishedSchedule                  *connect_go.Client[wfm.ReplaceAgentOnPublishedScheduleRequest, wfm.ReplaceAgentOnPublishedScheduleResponse]
	removeAgentFromPublishedSchedule                 *connect_go.Client[wfm.RemoveAgentFromPublishedScheduleRequest, wfm.RemoveAgentFromPublishedScheduleResponse]
	copyShiftsToPublishedSchedule                    *connect_go.Client[wfm.CopyShiftsToPublishedScheduleRequest, wfm.CopyShiftsToPublishedScheduleResponse]
	...
	listAdherenceAgentStateViolations                *connect_go.Client[wfm.ListAdherenceAgentStateViolationsRequest, wfm.ListAdherenceAgentStateViolationsResponse]
	resolveAdherenceAgentStateViolation              *connect_go.Client[wfm.ResolveAdherenceAgentStateViolationRequest, wfm.ResolveAdherenceAgentStateViolationResponse]
	...
	updateAdherenceRuleNotificationConfig            *connect_go.Client[wfm.UpdateAdherenceRuleNotificationConfigRequest, wfm.UpdateAdherenceRuleNotificationConfigResponse]
	...
	updateAdherenceRuleNotificationConfigEntry       *connect_go.Client[wfm.UpdateAdherenceRuleNotificationConfigEntryRequest, wfm.UpdateAdherenceRuleNotificationConfigEntryResponse]
	...
	updateAdherenceDepartmentalRule                  *connect_go.Client[wfm.UpdateAdherenceDepartmentalRuleRequest, wfm.UpdateAdherenceDepartmentalRuleResponse]
	...
	updateAdherenceDepartmentalRuleClause            *connect_go.Client[wfm.UpdateAdherenceDepartmentalRuleClauseRequest, wfm.UpdateAdherenceDepartmentalRuleClauseResponse]
	...
	updateAdherenceAgentRule                         *connect_go.Client[wfm.UpdateAdherenceAgentRuleRequest, wfm.UpdateAdherenceAgentRuleResponse]
	...
	updateAdherenceAgentRuleClause                   *connect_go.Client[wfm.UpdateAdherenceAgentRuleClauseRequest, wfm.UpdateAdherenceAgentRuleClauseResponse]
	...
	agentGetSchedule                                 *connect_go.Client[wfm.AgentGetScheduleRequest, wfm.AgentGetScheduleResponse]
...
// CreateSchedulingActivityPauseCodes calls api.v1alpha1.wfm.WFM.CreateSchedulingActivityPauseCodes.
func (c *wFMClient) CreateSchedulingActivityPauseCodes(ctx context.Context, req *connect_go.Request[wfm.CreateSchedulingActivityPauseCodesRequest]) (*connect_go.Response[wfm.CreateSchedulingActivityPauseCodesResponse], error) {
	return c.createSchedulingActivityPauseCodes.CallUnary(ctx, req)
}

// DeleteSchedulingActivityPauseCodes calls api.v1alpha1.wfm.WFM.DeleteSchedulingActivityPauseCodes.
func (c *wFMClient) DeleteSchedulingActivityPauseCodes(ctx context.Context, req *connect_go.Request[wfm.DeleteSchedulingActivityPauseCodesRequest]) (*connect_go.Response[wfm.DeleteSchedulingActivityPauseCodesResponse], error) {
	return c.deleteSchedulingActivityPauseCodes.CallUnary(ctx, req)
}
...
// CopyWFMAgentMemberships calls api.v1alpha1.wfm.WFM.CopyWFMAgentMemberships.
func (c *wFMClient) CopyWFMAgentMemberships(ctx context.Context, req *connect_go.Request[wfm.CopyWFMAgentMembershipsRequest]) (*connect_go.Response[wfm.CopyWFMAgentMembershipsResponse], error) {
	return c.copyWFMAgentMemberships.CallUnary(ctx, req)
}
...
// UpdateShiftInstanceWithSegments calls api.v1alpha1.wfm.WFM.UpdateShiftInstanceWithSegments.
func (c *wFMClient) UpdateShiftInstanceWithSegments(ctx context.Context, req *connect_go.Request[wfm.UpdateShiftInstanceWithSegmentsRequest]) (*connect_go.Response[wfm.UpdateShiftInstanceWithSegmentsResponse], error) {
	return c.updateShiftInstanceWithSegments.CallUnary(ctx, req)
}
...
func (c *wFMClient) UpsertTourPatternWithMembers(ctx context.Context, req *connect_go.Request[wfm.UpsertTourPatternWithMembersReq]) (*connect_go.Response[wfm.UpsertTourPatternWithMembersRes], error) {
	return c.upsertTourPatternWithMembers.CallUnary(ctx, req)
}
...
// ListTourWeekPatterns calls api.v1alpha1.wfm.WFM.ListTourWeekPatterns.
func (c *wFMClient) ListTourWeekPatterns(ctx context.Context, req *connect_go.Request[wfm.ListTourWeekPatternsReq]) (*connect_go.Response[wfm.ListTourWeekPatternsRes], error) {
...
func (c *wFMClient) ListTourShiftInstanceConfigs(ctx context.Context, req *connect_go.Request[wfm.ListTourShiftInstanceConfigsReq]) (*connect_go.Response[wfm.ListTourShiftInstanceConfigsRes], error) {
...
func (c *wFMClient) ListTourShiftSegmentConfigs(ctx context.Context, req *connect_go.Request[wfm.ListTourShiftSegmentConfigsReq]) (*connect_go.Response[wfm.ListTourShiftSegmentConfigsRes], error) {
...
func (c *wFMClient) CreateTourAgentCollectionWFMAgents(ctx context.Context, req *connect_go.Request[wfm.CreateTourAgentCollectionWFMAgentsReq]) (*connect_go.Response[wfm.CreateTourAgentCollectionWFMAgentsRes], error) {
	return c.createTourAgentCollectionWFMAgents.CallUnary(ctx, req)
}
...
// ReplaceAgentOnScheduleV1 calls api.v1alpha1.wfm.WFM.ReplaceAgentOnScheduleV1.
func (c *wFMClient) ReplaceAgentOnScheduleV1(ctx context.Context, req *connect_go.Request[wfm.ReplaceAgentOnScheduleReq]) (*connect_go.Response[wfm.ReplaceAgentOnScheduleRes], error) {
	return c.replaceAgentOnScheduleV1.CallUnary(ctx, req)
}
...
// CreatePublishedShift calls api.v1alpha1.wfm.WFM.CreatePublishedShift.
func (c *wFMClient) CreatePublishedShift(ctx context.Context, req *connect_go.Request[wfm.CreatePublishedShiftRequest]) (*connect_go.Response[wfm.CreatePublishedShiftResponse], error) {
	return c.createPublishedShift.CallUnary(ctx, req)
}

// CreatePublishedShiftWithSegments calls api.v1alpha1.wfm.WFM.CreatePublishedShiftWithSegments.
func (c *wFMClient) CreatePublishedShiftWithSegments(ctx context.Context, req *connect_go.Request[wfm.CreatePublishedShiftWithSegmentsRequest]) (*connect_go.Response[wfm.CreatePublishedShiftWithSegmentsResponse], error) {
	return c.createPublishedShiftWithSegments.CallUnary(ctx, req)
}

// UpdatePublishedShift calls api.v1alpha1.wfm.WFM.UpdatePublishedShift.
func (c *wFMClient) UpdatePublishedShift(ctx context.Context, req *connect_go.Request[wfm.UpdatePublishedShiftRequest]) (*connect_go.Response[wfm.UpdatePublishedShiftResponse], error) {
	return c.updatePublishedShift.CallUnary(ctx, req)
}

// UpdatePublishedShiftWithSegments calls api.v1alpha1.wfm.WFM.UpdatePublishedShiftWithSegments.
func (c *wFMClient) UpdatePublishedShiftWithSegments(ctx context.Context, req *connect_go.Request[wfm.UpdatePublishedShiftWithSegmentsRequest]) (*connect_go.Response[wfm.UpdatePublishedShiftWithSegmentsResponse], error) {
	return c.updatePublishedShiftWithSegments.CallUnary(ctx, req)
}

// SplitPublishedShift calls api.v1alpha1.wfm.WFM.SplitPublishedShift.
func (c *wFMClient) SplitPublishedShift(ctx context.Context, req *connect_go.Request[wfm.SplitPublishedShiftRequest]) (*connect_go.Response[wfm.SplitPublishedShiftResponse], error) {
	return c.splitPublishedShift.CallUnary(ctx, req)
}

// SwapPublishedShifts calls api.v1alpha1.wfm.WFM.SwapPublishedShifts.
func (c *wFMClient) SwapPublishedShifts(ctx context.Context, req *connect_go.Request[wfm.SwapPublishedShiftsRequest]) (*connect_go.Response[wfm.SwapPublishedShiftsResponse], error) {
	return c.swapPublishedShifts.CallUnary(ctx, req)
}

// DeletePublishedShifts calls api.v1alpha1.wfm.WFM.DeletePublishedShifts.
func (c *wFMClient) DeletePublishedShifts(ctx context.Context, req *connect_go.Request[wfm.DeletePublishedShiftsRequest]) (*connect_go.Response[wfm.DeletePublishedShiftsResponse], error) {
	return c.deletePublishedShifts.CallUnary(ctx, req)
}

// ReplaceAgentOnPublishedSchedule calls api.v1alpha1.wfm.WFM.ReplaceAgentOnPublishedSchedule.
func (c *wFMClient) ReplaceAgentOnPublishedSchedule(ctx context.Context, req *connect_go.Request[wfm.ReplaceAgentOnPublishedScheduleRequest]) (*connect_go.Response[wfm.ReplaceAgentOnPublishedScheduleResponse], error) {
	return c.replaceAgentOnPublishedSchedule.CallUnary(ctx, req)
}

// RemoveAgentFromPublishedSchedule calls api.v1alpha1.wfm.WFM.RemoveAgentFromPublishedSchedule.
func (c *wFMClient) RemoveAgentFromPublishedSchedule(ctx context.Context, req *connect_go.Request[wfm.RemoveAgentFromPublishedScheduleRequest]) (*connect_go.Response[wfm.RemoveAgentFromPublishedScheduleResponse], error) {
	return c.removeAgentFromPublishedSchedule.CallUnary(ctx, req)
}

// CopyShiftsToPublishedSchedule calls api.v1alpha1.wfm.WFM.CopyShiftsToPublishedSchedule.
func (c *wFMClient) CopyShiftsToPublishedSchedule(ctx context.Context, req *connect_go.Request[wfm.CopyShiftsToPublishedScheduleRequest]) (*connect_go.Response[wfm.CopyShiftsToPublishedScheduleResponse], error) {
	return c.copyShiftsToPublishedSchedule.CallUnary(ctx, req)
}

// CreateAgentLeavePetition calls api.v1alpha1.wfm.WFM.CreateAgentLeavePetition.
func (c *wFMClient) CreateAgentLeavePetition(ctx context.Context, req *connect_go.Request[wfm.CreateAgentLeavePetitionRequest]) (*connect_go.Response[wfm.CreateAgentLeavePetitionResponse], error) {
	return c.createAgentLeavePetition.CallUnary(ctx, req)
}
...
// ResolveAgentLeavePetition calls api.v1alpha1.wfm.WFM.ResolveAgentLeavePetition.
func (c *wFMClient) ResolveAgentLeavePetition(ctx context.Context, req *connect_go.Request[wfm.ResolveAgentLeavePetitionRequest]) (*connect_go.Response[wfm.ResolveAgentLeavePetitionResponse], error) {
	return c.resolveAgentLeavePetition.CallUnary(ctx, req)
}

// CancelAgentLeavePetition calls api.v1alpha1.wfm.WFM.CancelAgentLeavePetition.
func (c *wFMClient) CancelAgentLeavePetition(ctx context.Context, req *connect_go.Request[wfm.CancelAgentLeavePetitionRequest]) (*connect_go.Response[wfm.CancelAgentLeavePetitionResponse], error) {
	return c.cancelAgentLeavePetition.CallUnary(ctx, req)
}
...
// ListAdherenceAgentStateViolations calls api.v1alpha1.wfm.WFM.ListAdherenceAgentStateViolations.
func (c *wFMClient) ListAdherenceAgentStateViolations(ctx context.Context, req *connect_go.Request[wfm.ListAdherenceAgentStateViolationsRequest]) (*connect_go.Response[wfm.ListAdherenceAgentStateViolationsResponse], error) {
	return c.listAdherenceAgentStateViolations.CallUnary(ctx, req)
}

// ResolveAdherenceAgentStateViolation calls
// api.v1alpha1.wfm.WFM.ResolveAdherenceAgentStateViolation.
func (c *wFMClient) ResolveAdherenceAgentStateViolation(ctx context.Context, req *connect_go.Request[wfm.ResolveAdherenceAgentStateViolationRequest]) (*connect_go.Response[wfm.ResolveAdherenceAgentStateViolationResponse], error) {
	return c.resolveAdherenceAgentStateViolation.CallUnary(ctx, req)
}
...
func (c *wFMClient) CreateRgbaColor(ctx context.Context, req *connect_go.Request[wfm.CreateRgbaColorRequest]) (*connect_go.Response[wfm.CreateRgbaColorResponse], error) {
	return c.createRgbaColor.CallUnary(ctx, req)
}

// ListRgbaColors calls api.v1alpha1.wfm.WFM.ListRgbaColors.
func (c *wFMClient) ListRgbaColors(ctx context.Context, req *connect_go.Request[wfm.ListRgbaColorsRequest]) (*connect_go.Response[wfm.ListRgbaColorsResponse], error) {
	return c.listRgbaColors.CallUnary(ctx, req)
}

// UpdateRgbaColor calls api.v1alpha1.wfm.WFM.UpdateRgbaColor.
func (c *wFMClient) UpdateRgbaColor(ctx context.Context, req *connect_go.Request[wfm.UpdateRgbaColorRequest]) (*connect_go.Response[wfm.UpdateRgbaColorResponse], error) {
	return c.updateRgbaColor.CallUnary(ctx, req)
}

// DeleteRgbaColor calls api.v1alpha1.wfm.WFM.DeleteRgbaColor.
func (c *wFMClient) DeleteRgbaColor(ctx context.Context, req *connect_go.Request[wfm.DeleteRgbaColorRequest]) (*connect_go.Response[wfm.DeleteRgbaColorResponse], error) {
	return c.deleteRgbaColor.CallUnary(ctx, req)
}

// CreateAdherenceRuleNotificationConfig calls
// api.v1alpha1.wfm.WFM.CreateAdherenceRuleNotificationConfig.
func (c *wFMClient) CreateAdherenceRuleNotificationConfig(ctx context.Context, req *connect_go.Request[wfm.CreateAdherenceRuleNotificationConfigRequest]) (*connect_go.Response[wfm.CreateAdherenceRuleNotificationConfigResponse], error) {
	return c.createAdherenceRuleNotificationConfig.CallUnary(ctx, req)
}

// UpdateAdherenceRuleNotificationConfig calls
// api.v1alpha1.wfm.WFM.UpdateAdherenceRuleNotificationConfig.
func (c *wFMClient) UpdateAdherenceRuleNotificationConfig(ctx context.Context, req *connect_go.Request[wfm.UpdateAdherenceRuleNotificationConfigRequest]) (*connect_go.Response[wfm.UpdateAdherenceRuleNotificationConfigResponse], error) {
	return c.updateAdherenceRuleNotificationConfig.CallUnary(ctx, req)
}

// CreateAdherenceRuleNotificationConfigEntry calls
// api.v1alpha1.wfm.WFM.CreateAdherenceRuleNotificationConfigEntry.
func (c *wFMClient) CreateAdherenceRuleNotificationConfigEntry(ctx context.Context, req *connect_go.Request[wfm.CreateAdherenceRuleNotificationConfigEntryRequest]) (*connect_go.Response[wfm.CreateAdherenceRuleNotificationConfigEntryResponse], error) {
	return c.createAdherenceRuleNotificationConfigEntry.CallUnary(ctx, req)
}

// UpdateAdherenceRuleNotificationConfigEntry calls
// api.v1alpha1.wfm.WFM.UpdateAdherenceRuleNotificationConfigEntry.
func (c *wFMClient) UpdateAdherenceRuleNotificationConfigEntry(ctx context.Context, req *connect_go.Request[wfm.UpdateAdherenceRuleNotificationConfigEntryRequest]) (*connect_go.Response[wfm.UpdateAdherenceRuleNotificationConfigEntryResponse], error) {
	return c.updateAdherenceRuleNotificationConfigEntry.CallUnary(ctx, req)
}
...
func (c *wFMClient) ListAdherenceRuleNotificationConfigs(ctx context.Context, req *connect_go.Request[wfm.ListAdherenceRuleNotificationConfigsRequest]) (*connect_go.Response[wfm.ListAdherenceRuleNotificationConfigsResponse], error) {
	return c.listAdherenceRuleNotificationConfigs.CallUnary(ctx, req)
}

// CreateAdherenceDepartmentalRule calls api.v1alpha1.wfm.WFM.CreateAdherenceDepartmentalRule.
func (c *wFMClient) CreateAdherenceDepartmentalRule(ctx context.Context, req *connect_go.Request[wfm.CreateAdherenceDepartmentalRuleRequest]) (*connect_go.Response[wfm.CreateAdherenceDepartmentalRuleResponse], error) {
	return c.createAdherenceDepartmentalRule.CallUnary(ctx, req)
}

// UpdateAdherenceDepartmentalRule calls api.v1alpha1.wfm.WFM.UpdateAdherenceDepartmentalRule.
func (c *wFMClient) UpdateAdherenceDepartmentalRule(ctx context.Context, req *connect_go.Request[wfm.UpdateAdherenceDepartmentalRuleRequest]) (*connect_go.Response[wfm.UpdateAdherenceDepartmentalRuleResponse], error) {
	return c.updateAdherenceDepartmentalRule.CallUnary(ctx, req)
}

// CreateAdherenceDepartmentalRuleClause calls
...
// UpdateAdherenceDepartmentalRuleClause calls
// api.v1alpha1.wfm.WFM.UpdateAdherenceDepartmentalRuleClause.
func (c *wFMClient) UpdateAdherenceDepartmentalRuleClause(ctx context.Context, req *connect_go.Request[wfm.UpdateAdherenceDepartmentalRuleClauseRequest]) (*connect_go.Response[wfm.UpdateAdherenceDepartmentalRuleClauseResponse], error) {
	return c.updateAdherenceDepartmentalRuleClause.CallUnary(ctx, req)
}
...
func (c *wFMClient) ListAdherenceDepartmentalRules(ctx context.Context, req *connect_go.Request[wfm.ListAdherenceDepartmentalRulesRequest]) (*connect_go.Response[wfm.ListAdherenceDepartmentalRulesResponse], error) {
	return c.listAdherenceDepartmentalRules.CallUnary(ctx, req)
}

// CreateAdherenceAgentRule calls api.v1alpha1.wfm.WFM.CreateAdherenceAgentRule.
func (c *wFMClient) CreateAdherenceAgentRule(ctx context.Context, req *connect_go.Request[wfm.CreateAdherenceAgentRuleRequest]) (*connect_go.Response[wfm.CreateAdherenceAgentRuleResponse], error) {
	return c.createAdherenceAgentRule.CallUnary(ctx, req)
}

// UpdateAdherenceAgentRule calls api.v1alpha1.wfm.WFM.UpdateAdherenceAgentRule.
func (c *wFMClient) UpdateAdherenceAgentRule(ctx context.Context, req *connect_go.Request[wfm.UpdateAdherenceAgentRuleRequest]) (*connect_go.Response[wfm.UpdateAdherenceAgentRuleResponse], error) {
	return c.updateAdherenceAgentRule.CallUnary(ctx, req)
}

// CreateAdherenceAgentRuleClause calls api.v1alpha1.wfm.WFM.CreateAdherenceAgentRuleClause.
func (c *wFMClient) CreateAdherenceAgentRuleClause(ctx context.Context, req *connect_go.Request[wfm.CreateAdherenceAgentRuleClauseRequest]) (*connect_go.Response[wfm.CreateAdherenceAgentRuleClauseResponse], error) {
	return c.createAdherenceAgentRuleClause.CallUnary(ctx, req)
}

// UpdateAdherenceAgentRuleClause calls api.v1alpha1.wfm.WFM.UpdateAdherenceAgentRuleClause.
func (c *wFMClient) UpdateAdherenceAgentRuleClause(ctx context.Context, req *connect_go.Request[wfm.UpdateAdherenceAgentRuleClauseRequest]) (*connect_go.Response[wfm.UpdateAdherenceAgentRuleClauseResponse], error) {
	return c.updateAdherenceAgentRuleClause.CallUnary(ctx, req)
}
...
// AgentGetSchedule calls api.v1alpha1.wfm.WFM.AgentGetSchedule.
func (c *wFMClient) AgentGetSchedule(ctx context.Context, req *connect_go.Request[wfm.AgentGetScheduleRequest]) (*connect_go.Response[wfm.AgentGetScheduleResponse], error) {
	return c.agentGetSchedule.CallUnary(ctx, req)
}

// AgentListLeavePetitions calls api.v1alpha1.wfm.WFM.AgentListLeavePetitions.
func (c *wFMClient) AgentListLeavePetitions(ctx context.Context, req *connect_go.Request[wfm.AgentListLeavePetitionsRequest]) (*connect_go.Response[wfm.AgentListLeavePetitionsResponse], error) {
	return c.agentListLeavePetitions.CallUnary(ctx, req)
}

// AgentCreateLeavePetition calls api.v1alpha1.wfm.WFM.AgentCreateLeavePetition.
func (c *wFMClient) AgentCreateLeavePetition(ctx context.Context, req *connect_go.Request[wfm.AgentCreateLeavePetitionRequest]) (*connect_go.Response[wfm.AgentCreateLeavePetitionResponse], error) {
	return c.agentCreateLeavePetition.CallUnary(ctx, req)
}
...
func NewWFMHandler(svc WFMHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	wFMCreateSchedulingActivityPauseCodesHandler := connect_go.NewUnaryHandler(
		WFMCreateSchedulingActivityPauseCodesProcedure,
		svc.CreateSchedulingActivityPauseCodes,
		opts...,
	)
	wFMDeleteSchedulingActivityPauseCodesHandler := connect_go.NewUnaryHandler(
		WFMDeleteSchedulingActivityPauseCodesProcedure,
		svc.DeleteSchedulingActivityPauseCodes,
		opts...,
	)
	...
	wFMCopyWFMAgentMembershipsHandler := connect_go.NewUnaryHandler(
		WFMCopyWFMAgentMembershipsProcedure,
		svc.CopyWFMAgentMemberships,
		opts...,
	)
	...
	wFMUpdateShiftInstanceWithSegmentsHandler := connect_go.NewUnaryHandler(
		WFMUpdateShiftInstanceWithSegmentsProcedure,
		svc.UpdateShiftInstanceWithSegments,
		opts...,
	)
	...
	wFMCreateTourPatternHandler := connect_go.NewUnaryHandler(
		WFMCreateTourPatternProcedure,
	...
	wFMGetTourPatternHandler := connect_go.NewUnaryHandler(
		WFMGetTourPatternProcedure,
		svc.GetTourPattern,
		opts...,
	)
	...
	wFMListTourWeekPatternsHandler := connect_go.NewUnaryHandler(
		WFMListTourWeekPatternsProcedure,
	...
	wFMListTourShiftInstanceConfigsHandler := connect_go.NewUnaryHandler(
		WFMListTourShiftInstanceConfigsProcedure,
	...
	wFMListTourShiftSegmentConfigsHandler := connect_go.NewUnaryHandler(
		WFMListTourShiftSegmentConfigsProcedure,
	...
	wFMCreateTourAgentCollectionWFMAgentsHandler := connect_go.NewUnaryHandler(
		WFMCreateTourAgentCollectionWFMAgentsProcedure,
		svc.CreateTourAgentCollectionWFMAgents,
		opts...,
	)
	...
	wFMGenerateTourWeekPatternsHandler := connect_go.NewUnaryHandler(
		WFMGenerateTourWeekPatternsProcedure,
	...
	wFMReplaceAgentOnScheduleV1Handler := connect_go.NewUnaryHandler(
		WFMReplaceAgentOnScheduleV1Procedure,
		svc.ReplaceAgentOnScheduleV1,
		opts...,
	)
	...
	wFMCreatePublishedShiftHandler := connect_go.NewUnaryHandler(
		WFMCreatePublishedShiftProcedure,
		svc.CreatePublishedShift,
		opts...,
	)
	wFMCreatePublishedShiftWithSegmentsHandler := connect_go.NewUnaryHandler(
		WFMCreatePublishedShiftWithSegmentsProcedure,
		svc.CreatePublishedShiftWithSegments,
		opts...,
	)
	wFMUpdatePublishedShiftHandler := connect_go.NewUnaryHandler(
		WFMUpdatePublishedShiftProcedure,
		svc.UpdatePublishedShift,
		opts...,
	)
	wFMUpdatePublishedShiftWithSegmentsHandler := connect_go.NewUnaryHandler(
		WFMUpdatePublishedShiftWithSegmentsProcedure,
		svc.UpdatePublishedShiftWithSegments,
		opts...,
	)
	wFMSplitPublishedShiftHandler := connect_go.NewUnaryHandler(
		WFMSplitPublishedShiftProcedure,
		svc.SplitPublishedShift,
		opts...,
	)
	wFMSwapPublishedShiftsHandler := connect_go.NewUnaryHandler(
		WFMSwapPublishedShiftsProcedure,
		svc.SwapPublishedShifts,
		opts...,
	)
	wFMDeletePublishedShiftsHandler := connect_go.NewUnaryHandler(
		WFMDeletePublishedShiftsProcedure,
		svc.DeletePublishedShifts,
		opts...,
	)
	wFMReplaceAgentOnPublishedScheduleHandler := connect_go.NewUnaryHandler(
		WFMReplaceAgentOnPublishedScheduleProcedure,
		svc.ReplaceAgentOnPublishedSchedule,
		opts...,
	)
	wFMRemoveAgentFromPublishedScheduleHandler := connect_go.NewUnaryHandler(
		WFMRemoveAgentFromPublishedScheduleProcedure,
		svc.RemoveAgentFromPublishedSchedule,
		opts...,
	)
	wFMCopyShiftsToPublishedScheduleHandler := connect_go.NewUnaryHandler(
		WFMCopyShiftsToPublishedScheduleProcedure,
		svc.CopyShiftsToPublishedSchedule,
		opts...,
	)
	wFMCreateAgentLeavePetitionHandler := connect_go.NewUnaryHandler(
		WFMCreateAgentLeavePetitionProcedure,
		svc.CreateAgentLeavePetition,
		opts...,
	)
	wFMListAgentLeavePetitionsHandler := connect_go.NewUnaryHandler(
		WFMListAgentLeavePetitionsProcedure,
	...
	wFMResolveAgentLeavePetitionHandler := connect_go.NewUnaryHandler(
		WFMResolveAgentLeavePetitionProcedure,
		svc.ResolveAgentLeavePetition,
		opts...,
	)
	wFMCancelAgentLeavePetitionHandler := connect_go.NewUnaryHandler(
		WFMCancelAgentLeavePetitionProcedure,
		svc.CancelAgentLeavePetition,
		opts...,
	)
	...
	wFMListAdherenceAgentStateViolationsHandler := connect_go.NewUnaryHandler(
		WFMListAdherenceAgentStateViolationsProcedure,
		svc.ListAdherenceAgentStateViolations,
		opts...,
	)
	wFMResolveAdherenceAgentStateViolationHandler := connect_go.NewUnaryHandler(
		WFMResolveAdherenceAgentStateViolationProcedure,
		svc.ResolveAdherenceAgentStateViolation,
		opts...,
	)
	...
	wFMCreateRgbaColorHandler := connect_go.NewUnaryHandler(
		WFMCreateRgbaColorProcedure,
		svc.CreateRgbaColor,
		opts...,
	)
	wFMListRgbaColorsHandler := connect_go.NewUnaryHandler(
		WFMListRgbaColorsProcedure,
		svc.ListRgbaColors,
		opts...,
	)
	wFMUpdateRgbaColorHandler := connect_go.NewUnaryHandler(
		WFMUpdateRgbaColorProcedure,
		svc.UpdateRgbaColor,
		opts...,
	)
	wFMDeleteRgbaColorHandler := connect_go.NewUnaryHandler(
		WFMDeleteRgbaColorProcedure,
		svc.DeleteRgbaColor,
		opts...,
	)
	wFMCreateAdherenceRuleNotificationConfigHandler := connect_go.NewUnaryHandler(
		WFMCreateAdherenceRuleNotificationConfigProcedure,
		svc.CreateAdherenceRuleNotificationConfig,
		opts...,
	)
	wFMUpdateAdherenceRuleNotificationConfigHandler := connect_go.NewUnaryHandler(
		WFMUpdateAdherenceRuleNotificationConfigProcedure,
		svc.UpdateAdherenceRuleNotificationConfig,
		opts...,
	)
	wFMCreateAdherenceRuleNotificationConfigEntryHandler := connect_go.NewUnaryHandler(
		WFMCreateAdherenceRuleNotificationConfigEntryProcedure,
		svc.CreateAdherenceRuleNotificationConfigEntry,
		opts...,
	)
	wFMUpdateAdherenceRuleNotificationConfigEntryHandler := connect_go.NewUnaryHandler(
		WFMUpdateAdherenceRuleNotificationConfigEntryProcedure,
		svc.UpdateAdherenceRuleNotificationConfigEntry,
		opts...,
	)
	...
	wFMCreateAdherenceDepartmentalRuleHandler := connect_go.NewUnaryHandler(
		WFMCreateAdherenceDepartmentalRuleProcedure,
		svc.CreateAdherenceDepartmentalRule,
		opts...,
	)
	wFMUpdateAdherenceDepartmentalRuleHandler := connect_go.NewUnaryHandler(
		WFMUpdateAdherenceDepartmentalRuleProcedure,
		svc.UpdateAdherenceDepartmentalRule,
		opts...,
	)
	...
	wFMUpdateAdherenceDepartmentalRuleClauseHandler := connect_go.NewUnaryHandler(
		WFMUpdateAdherenceDepartmentalRuleClauseProcedure,
		svc.UpdateAdherenceDepartmentalRuleClause,
		opts...,
	)
	...
	wFMListAdherenceDepartmentalRulesHandler := connect_go.NewUnaryHandler(
		WFMListAdherenceDepartmentalRulesProcedure,
		svc.ListAdherenceDepartmentalRules,
		opts...,
	)
	wFMCreateAdherenceAgentRuleHandler := connect_go.NewUnaryHandler(
		WFMCreateAdherenceAgentRuleProcedure,
		svc.CreateAdherenceAgentRule,
		opts...,
	)
	wFMUpdateAdherenceAgentRuleHandler := connect_go.NewUnaryHandler(
		WFMUpdateAdherenceAgentRuleProcedure,
		svc.UpdateAdherenceAgentRule,
		opts...,
	)
	wFMCreateAdherenceAgentRuleClauseHandler := connect_go.NewUnaryHandler(
		WFMCreateAdherenceAgentRuleClauseProcedure,
		svc.CreateAdherenceAgentRuleClause,
		opts...,
	)
	wFMUpdateAdherenceAgentRuleClauseHandler := connect_go.NewUnaryHandler(
		WFMUpdateAdherenceAgentRuleClauseProcedure,
		svc.UpdateAdherenceAgentRuleClause,
		opts...,
	)
	...
	wFMAgentGetScheduleHandler := connect_go.NewUnaryHandler(
		WFMAgentGetScheduleProcedure,
		svc.AgentGetSchedule,
		opts...,
	)
	wFMAgentListLeavePetitionsHandler := connect_go.NewUnaryHandler(
		WFMAgentListLeavePetitionsProcedure,
		svc.AgentListLeavePetitions,
		opts...,
	)
	wFMAgentCreateLeavePetitionHandler := connect_go.NewUnaryHandler(
		WFMAgentCreateLeavePetitionProcedure,
		svc.AgentCreateLeavePetition,
		opts...,
	)
	...
	return "/api.v1alpha1.wfm.WFM/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case WFMCreateSchedulingActivityPauseCodesProcedure:
			wFMCreateSchedulingActivityPauseCodesHandler.ServeHTTP(w, r)
		case WFMDeleteSchedulingActivityPauseCodesProcedure:
			wFMDeleteSchedulingActivityPauseCodesHandler.ServeHTTP(w, r)
		...
		case WFMCopyWFMAgentMembershipsProcedure:
			wFMCopyWFMAgentMembershipsHandler.ServeHTTP(w, r)
		...
		case WFMUpdateShiftInstanceWithSegmentsProcedure:
			wFMUpdateShiftInstanceWithSegmentsHandler.ServeHTTP(w, r)
		...
		case WFMReplaceAgentOnScheduleV1Procedure:
		...
		case WFMCreatePublishedShiftProcedure:
			wFMCreatePublishedShiftHandler.ServeHTTP(w, r)
		case WFMCreatePublishedShiftWithSegmentsProcedure:
			wFMCreatePublishedShiftWithSegmentsHandler.ServeHTTP(w, r)
		case WFMUpdatePublishedShiftProcedure:
			wFMUpdatePublishedShiftHandler.ServeHTTP(w, r)
		case WFMUpdatePublishedShiftWithSegmentsProcedure:
			wFMUpdatePublishedShiftWithSegmentsHandler.ServeHTTP(w, r)
		case WFMSplitPublishedShiftProcedure:
			wFMSplitPublishedShiftHandler.ServeHTTP(w, r)
		case WFMSwapPublishedShiftsProcedure:
			wFMSwapPublishedShiftsHandler.ServeHTTP(w, r)
		case WFMDeletePublishedShiftsProcedure:
			wFMDeletePublishedShiftsHandler.ServeHTTP(w, r)
		case WFMReplaceAgentOnPublishedScheduleProcedure:
			wFMReplaceAgentOnPublishedScheduleHandler.ServeHTTP(w, r)
		case WFMRemoveAgentFromPublishedScheduleProcedure:
			wFMRemoveAgentFromPublishedScheduleHandler.ServeHTTP(w, r)
		case WFMCopyShiftsToPublishedScheduleProcedure:
			wFMCopyShiftsToPublishedScheduleHandler.ServeHTTP(w, r)
		case WFMCreateAgentLeavePetitionProcedure:
		...
		case WFMResolveAgentLeavePetitionProcedure:
			wFMResolveAgentLeavePetitionHandler.ServeHTTP(w, r)
		case WFMCancelAgentLeavePetitionProcedure:
		...
		case WFMListAdherenceAgentStateViolationsProcedure:
			wFMListAdherenceAgentStateViolationsHandler.ServeHTTP(w, r)
		case WFMResolveAdherenceAgentStateViolationProcedure:
			wFMResolveAdherenceAgentStateViolationHandler.ServeHTTP(w, r)
		...
		case WFMListRgbaColorsProcedure:
			wFMListRgbaColorsHandler.ServeHTTP(w, r)
		case WFMUpdateRgbaColorProcedure:
			wFMUpdateRgbaColorHandler.ServeHTTP(w, r)
		case WFMDeleteRgbaColorProcedure:
			wFMDeleteRgbaColorHandler.ServeHTTP(w, r)
		case WFMCreateAdherenceRuleNotificationConfigProcedure:
			wFMCreateAdherenceRuleNotificationConfigHandler.ServeHTTP(w, r)
		case WFMUpdateAdherenceRuleNotificationConfigProcedure:
			wFMUpdateAdherenceRuleNotificationConfigHandler.ServeHTTP(w, r)
		...
		case WFMUpdateAdherenceRuleNotificationConfigEntryProcedure:
			wFMUpdateAdherenceRuleNotificationConfigEntryHandler.ServeHTTP(w, r)
		...
		case WFMUpdateAdherenceDepartmentalRuleProcedure:
			wFMUpdateAdherenceDepartmentalRuleHandler.ServeHTTP(w, r)
		case WFMCreateAdherenceDepartmentalRuleClauseProcedure:
			wFMCreateAdherenceDepartmentalRuleClauseHandler.ServeHTTP(w, r)
		case WFMUpdateAdherenceDepartmentalRuleClauseProcedure:
			wFMUpdateAdherenceDepartmentalRuleClauseHandler.ServeHTTP(w, r)
		...
		case WFMCreateAdherenceAgentRuleProcedure:
			wFMCreateAdherenceAgentRuleHandler.ServeHTTP(w, r)
		case WFMUpdateAdherenceAgentRuleProcedure:
			wFMUpdateAdherenceAgentRuleHandler.ServeHTTP(w, r)
		case WFMCreateAdherenceAgentRuleClauseProcedure:
			wFMCreateAdherenceAgentRuleClauseHandler.ServeHTTP(w, r)
		case WFMUpdateAdherenceAgentRuleClauseProcedure:
			wFMUpdateAdherenceAgentRuleClauseHandler.ServeHTTP(w, r)
		...
		case WFMAgentGetScheduleProcedure:
			wFMAgentGetScheduleHandler.ServeHTTP(w, r)
		case WFMAgentListLeavePetitionsProcedure:
			wFMAgentListLeavePetitionsHandler.ServeHTTP(w, r)
		case WFMAgentCreateLeavePetitionProcedure:
...
func (UnimplementedWFMHandler) CreateSchedulingActivityPauseCodes(context.Context, *connect_go.Request[wfm.CreateSchedulingActivityPauseCodesRequest]) (*connect_go.Response[wfm.CreateSchedulingActivityPauseCodesResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.CreateSchedulingActivityPauseCodes is not implemented"))
}

func (UnimplementedWFMHandler) DeleteSchedulingActivityPauseCodes(context.Context, *connect_go.Request[wfm.DeleteSchedulingActivityPauseCodesRequest]) (*connect_go.Response[wfm.DeleteSchedulingActivityPauseCodesResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.DeleteSchedulingActivityPauseCodes is not implemented"))
}
...
func (UnimplementedWFMHandler) CopyWFMAgentMemberships(context.Context, *connect_go.Request[wfm.CopyWFMAgentMembershipsRequest]) (*connect_go.Response[wfm.CopyWFMAgentMembershipsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.CopyWFMAgentMemberships is not implemented"))
}
...
func (UnimplementedWFMHandler) UpdateShiftInstanceWithSegments(context.Context, *connect_go.Request[wfm.UpdateShiftInstanceWithSegmentsRequest]) (*connect_go.Response[wfm.UpdateShiftInstanceWithSegmentsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.UpdateShiftInstanceWithSegments is not implemented"))
}
...
func (UnimplementedWFMHandler) UpsertTourPatternWithMembers(context.Context, *connect_go.Request[wfm.UpsertTourPatternWithMembersReq]) (*connect_go.Response[wfm.UpsertTourPatternWithMembersRes], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.UpsertTourPatternWithMembers is not implemented"))
}
...
func (UnimplementedWFMHandler) ListTourWeekPatterns(context.Context, *connect_go.Request[wfm.ListTourWeekPatternsReq]) (*connect_go.Response[wfm.ListTourWeekPatternsRes], error) {
...
func (UnimplementedWFMHandler) CreateTourAgentCollectionWFMAgents(context.Context, *connect_go.Request[wfm.CreateTourAgentCollectionWFMAgentsReq]) (*connect_go.Response[wfm.CreateTourAgentCollectionWFMAgentsRes], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.CreateTourAgentCollectionWFMAgents is not implemented"))
}
...
func (UnimplementedWFMHandler) ReplaceAgentOnScheduleV1(context.Context, *connect_go.Request[wfm.ReplaceAgentOnScheduleReq]) (*connect_go.Response[wfm.ReplaceAgentOnScheduleRes], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.ReplaceAgentOnScheduleV1 is not implemented"))
}
...
func (UnimplementedWFMHandler) CreatePublishedShift(context.Context, *connect_go.Request[wfm.CreatePublishedShiftRequest]) (*connect_go.Response[wfm.CreatePublishedShiftResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.CreatePublishedShift is not implemented"))
}

func (UnimplementedWFMHandler) CreatePublishedShiftWithSegments(context.Context, *connect_go.Request[wfm.CreatePublishedShiftWithSegmentsRequest]) (*connect_go.Response[wfm.CreatePublishedShiftWithSegmentsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.CreatePublishedShiftWithSegments is not implemented"))
}

func (UnimplementedWFMHandler) UpdatePublishedShift(context.Context, *connect_go.Request[wfm.UpdatePublishedShiftRequest]) (*connect_go.Response[wfm.UpdatePublishedShiftResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.UpdatePublishedShift is not implemented"))
}

func (UnimplementedWFMHandler) UpdatePublishedShiftWithSegments(context.Context, *connect_go.Request[wfm.UpdatePublishedShiftWithSegmentsRequest]) (*connect_go.Response[wfm.UpdatePublishedShiftWithSegmentsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.UpdatePublishedShiftWithSegments is not implemented"))
}

func (UnimplementedWFMHandler) SplitPublishedShift(context.Context, *connect_go.Request[wfm.SplitPublishedShiftRequest]) (*connect_go.Response[wfm.SplitPublishedShiftResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.SplitPublishedShift is not implemented"))
}

func (UnimplementedWFMHandler) SwapPublishedShifts(context.Context, *connect_go.Request[wfm.SwapPublishedShiftsRequest]) (*connect_go.Response[wfm.SwapPublishedShiftsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.SwapPublishedShifts is not implemented"))
}

func (UnimplementedWFMHandler) DeletePublishedShifts(context.Context, *connect_go.Request[wfm.DeletePublishedShiftsRequest]) (*connect_go.Response[wfm.DeletePublishedShiftsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.DeletePublishedShifts is not implemented"))
}

func (UnimplementedWFMHandler) ReplaceAgentOnPublishedSchedule(context.Context, *connect_go.Request[wfm.ReplaceAgentOnPublishedScheduleRequest]) (*connect_go.Response[wfm.ReplaceAgentOnPublishedScheduleResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.ReplaceAgentOnPublishedSchedule is not implemented"))
}

func (UnimplementedWFMHandler) RemoveAgentFromPublishedSchedule(context.Context, *connect_go.Request[wfm.RemoveAgentFromPublishedScheduleRequest]) (*connect_go.Response[wfm.RemoveAgentFromPublishedScheduleResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.RemoveAgentFromPublishedSchedule is not implemented"))
}

func (UnimplementedWFMHandler) CopyShiftsToPublishedSchedule(context.Context, *connect_go.Request[wfm.CopyShiftsToPublishedScheduleRequest]) (*connect_go.Response[wfm.CopyShiftsToPublishedScheduleResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.CopyShiftsToPublishedSchedule is not implemented"))
}

func (UnimplementedWFMHandler) CreateAgentLeavePetition(context.Context, *connect_go.Request[wfm.CreateAgentLeavePetitionRequest]) (*connect_go.Response[wfm.CreateAgentLeavePetitionResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.CreateAgentLeavePetition is not implemented"))
}
...
func (UnimplementedWFMHandler) ResolveAgentLeavePetition(context.Context, *connect_go.Request[wfm.ResolveAgentLeavePetitionRequest]) (*connect_go.Response[wfm.ResolveAgentLeavePetitionResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.ResolveAgentLeavePetition is not implemented"))
}

func (UnimplementedWFMHandler) CancelAgentLeavePetition(context.Context, *connect_go.Request[wfm.CancelAgentLeavePetitionRequest]) (*connect_go.Response[wfm.CancelAgentLeavePetitionResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.CancelAgentLeavePetition is not implemented"))
}
...
func (UnimplementedWFMHandler) ListAdherenceAgentStateViolations(context.Context, *connect_go.Request[wfm.ListAdherenceAgentStateViolationsRequest]) (*connect_go.Response[wfm.ListAdherenceAgentStateViolationsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.ListAdherenceAgentStateViolations is not implemented"))
}

func (UnimplementedWFMHandler) ResolveAdherenceAgentStateViolation(context.Context, *connect_go.Request[wfm.ResolveAdherenceAgentStateViolationRequest]) (*connect_go.Response[wfm.ResolveAdherenceAgentStateViolationResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.ResolveAdherenceAgentStateViolation is not implemented"))
}
...
func (UnimplementedWFMHandler) CreateRgbaColor(context.Context, *connect_go.Request[wfm.CreateRgbaColorRequest]) (*connect_go.Response[wfm.CreateRgbaColorResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.CreateRgbaColor is not implemented"))
}

func (UnimplementedWFMHandler) ListRgbaColors(context.Context, *connect_go.Request[wfm.ListRgbaColorsRequest]) (*connect_go.Response[wfm.ListRgbaColorsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.ListRgbaColors is not implemented"))
}

func (UnimplementedWFMHandler) UpdateRgbaColor(context.Context, *connect_go.Request[wfm.UpdateRgbaColorRequest]) (*connect_go.Response[wfm.UpdateRgbaColorResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.UpdateRgbaColor is not implemented"))
}

func (UnimplementedWFMHandler) DeleteRgbaColor(context.Context, *connect_go.Request[wfm.DeleteRgbaColorRequest]) (*connect_go.Response[wfm.DeleteRgbaColorResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.DeleteRgbaColor is not implemented"))
}

func (UnimplementedWFMHandler) CreateAdherenceRuleNotificationConfig(context.Context, *connect_go.Request[wfm.CreateAdherenceRuleNotificationConfigRequest]) (*connect_go.Response[wfm.CreateAdherenceRuleNotificationConfigResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.CreateAdherenceRuleNotificationConfig is not implemented"))
}

func (UnimplementedWFMHandler) UpdateAdherenceRuleNotificationConfig(context.Context, *connect_go.Request[wfm.UpdateAdherenceRuleNotificationConfigRequest]) (*connect_go.Response[wfm.UpdateAdherenceRuleNotificationConfigResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.UpdateAdherenceRuleNotificationConfig is not implemented"))
}

func (UnimplementedWFMHandler) CreateAdherenceRuleNotificationConfigEntry(context.Context, *connect_go.Request[wfm.CreateAdherenceRuleNotificationConfigEntryRequest]) (*connect_go.Response[wfm.CreateAdherenceRuleNotificationConfigEntryResponse], error) {
...
func (UnimplementedWFMHandler) UpdateAdherenceRuleNotificationConfigEntry(context.Context, *connect_go.Request[wfm.UpdateAdherenceRuleNotificationConfigEntryRequest]) (*connect_go.Response[wfm.UpdateAdherenceRuleNotificationConfigEntryResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.UpdateAdherenceRuleNotificationConfigEntry is not implemented"))
}
...
func (UnimplementedWFMHandler) CreateAdherenceDepartmentalRule(context.Context, *connect_go.Request[wfm.CreateAdherenceDepartmentalRuleRequest]) (*connect_go.Response[wfm.CreateAdherenceDepartmentalRuleResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.CreateAdherenceDepartmentalRule is not implemented"))
}

func (UnimplementedWFMHandler) UpdateAdherenceDepartmentalRule(context.Context, *connect_go.Request[wfm.UpdateAdherenceDepartmentalRuleRequest]) (*connect_go.Response[wfm.UpdateAdherenceDepartmentalRuleResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.UpdateAdherenceDepartmentalRule is not implemented"))
}
...
func (UnimplementedWFMHandler) UpdateAdherenceDepartmentalRuleClause(context.Context, *connect_go.Request[wfm.UpdateAdherenceDepartmentalRuleClauseRequest]) (*connect_go.Response[wfm.UpdateAdherenceDepartmentalRuleClauseResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.UpdateAdherenceDepartmentalRuleClause is not implemented"))
}
...
func (UnimplementedWFMHandler) ListAdherenceDepartmentalRules(context.Context, *connect_go.Request[wfm.ListAdherenceDepartmentalRulesRequest]) (*connect_go.Response[wfm.ListAdherenceDepartmentalRulesResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.ListAdherenceDepartmentalRules is not implemented"))
}

func (UnimplementedWFMHandler) CreateAdherenceAgentRule(context.Context, *connect_go.Request[wfm.CreateAdherenceAgentRuleRequest]) (*connect_go.Response[wfm.CreateAdherenceAgentRuleResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.CreateAdherenceAgentRule is not implemented"))
}

func (UnimplementedWFMHandler) UpdateAdherenceAgentRule(context.Context, *connect_go.Request[wfm.UpdateAdherenceAgentRuleRequest]) (*connect_go.Response[wfm.UpdateAdherenceAgentRuleResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.UpdateAdherenceAgentRule is not implemented"))
}

func (UnimplementedWFMHandler) CreateAdherenceAgentRuleClause(context.Context, *connect_go.Request[wfm.CreateAdherenceAgentRuleClauseRequest]) (*connect_go.Response[wfm.CreateAdherenceAgentRuleClauseResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.CreateAdherenceAgentRuleClause is not implemented"))
}

func (UnimplementedWFMHandler) UpdateAdherenceAgentRuleClause(context.Context, *connect_go.Request[wfm.UpdateAdherenceAgentRuleClauseRequest]) (*connect_go.Response[wfm.UpdateAdherenceAgentRuleClauseResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.UpdateAdherenceAgentRuleClause is not implemented"))
}
...
func (UnimplementedWFMHandler) AgentGetSchedule(context.Context, *connect_go.Request[wfm.AgentGetScheduleRequest]) (*connect_go.Response[wfm.AgentGetScheduleResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.AgentGetSchedule is not implemented"))
}

func (UnimplementedWFMHandler) AgentListLeavePetitions(context.Context, *connect_go.Request[wfm.AgentListLeavePetitionsRequest]) (*connect_go.Response[wfm.AgentListLeavePetitionsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.AgentListLeavePetitions is not implemented"))
}

func (UnimplementedWFMHandler) AgentCreateLeavePetition(context.Context, *connect_go.Request[wfm.AgentCreateLeavePetitionRequest]) (*connect_go.Response[wfm.AgentCreateLeavePetitionResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.wfm.WFM.AgentCreateLeavePetition is not implemented"))
}
