...
func (x *GetInvoiceRes) GetInvoice() *billing.Invoice {
	if x, ok := x.GetFormat().(*GetInvoiceRes_Invoice); ok {
		return x.Invoice
	}
	return nil
}
...
type GetInvoiceRes_Invoice struct {
...
func (x *ExportGeneratedInvoicesReq) Reset() {
	*x = ExportGeneratedInvoicesReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *ExportGeneratedInvoicesReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExportGeneratedInvoicesReq) ProtoMessage() {}

func (x *ExportGeneratedInvoicesReq) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1alpha1_billing_entities_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExportGeneratedInvoicesReq.ProtoReflect.Descriptor instead.
func (*ExportGeneratedInvoicesReq) Descriptor() ([]byte, []int) {
	return file_api_v1alpha1_billing_entities_proto_rawDescGZIP(), []int{6}
}

func (x *ExportGeneratedInvoicesReq) GetInvoiceDate() *timestamppb.Timestamp {
	if x != nil {
		return x.InvoiceDate
	}
	return nil
...
func (x *ExportGeneratedInvoicesReq) GetOrgId() string {
	if x != nil {
		return x.OrgId
	}
	return ""
...
type ExportGeneratedInvoicesRes struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// Types that are assignable to Format:
	//
	//	*ExportGeneratedInvoicesRes_Invoice
	//	*ExportGeneratedInvoicesRes_Csv
	Format isExportGeneratedInvoicesRes_Format `protobuf_oneof:"format"`
}

func (x *ExportGeneratedInvoicesRes) Reset() {
	*x = ExportGeneratedInvoicesRes{}
	if protoimpl.UnsafeEnabled {
...
func (x *ExportGeneratedInvoicesRes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExportGeneratedInvoicesRes) ProtoMessage() {}

func (x *ExportGeneratedInvoicesRes) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1alpha1_billing_entities_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExportGeneratedInvoicesRes.ProtoReflect.Descriptor instead.
func (*ExportGeneratedInvoicesRes) Descriptor() ([]byte, []int) {
	return file_api_v1alpha1_billing_entities_proto_rawDescGZIP(), []int{7}
}

func (m *ExportGeneratedInvoicesRes) GetFormat() isExportGeneratedInvoicesRes_Format {
	if m != nil {
		return m.Format
	}
	return nil
...
func (x *ExportGeneratedInvoicesRes) GetInvoice() *billing.Invoice {
	if x, ok := x.GetFormat().(*ExportGeneratedInvoicesRes_Invoice); ok {
		return x.Invoice
	}
	return nil
}

func (x *ExportGeneratedInvoicesRes) GetCsv() string {
	if x, ok := x.GetFormat().(*ExportGeneratedInvoicesRes_Csv); ok {
		return x.Csv
	}
	return ""
}

type isExportGeneratedInvoicesRes_Format interface {
	isExportGeneratedInvoicesRes_Format()
}

type ExportGeneratedInvoicesRes_Invoice struct {
	Invoice *billing.Invoice `protobuf:"bytes,1,opt,name=invoice,proto3,oneof"`
}

type ExportGeneratedInvoicesRes_Csv struct {
	Csv string `protobuf:"bytes,2,opt,name=csv,proto3,oneof"`
}

func (*ExportGeneratedInvoicesRes_Invoice) isExportGeneratedInvoicesRes_Format() {}

func (*ExportGeneratedInvoicesRes_Csv) isExportGeneratedInvoicesRes_Format() {}
...
var file_api_v1alpha1_billing_entities_proto_rawDesc = []byte{
	...
	0x61, 0x6e, 0x22, 0x65, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x49, 0x6e, 0x76, 0x6f, 0x69, 0x63, 0x65,
	0x52, 0x65, 0x71, 0x12, 0x3d, 0x0a, 0x0c, 0x69, 0x6e, 0x76, 0x6f, 0x69, 0x63, 0x65, 0x5f, 0x64,
	...
	0x74, 0x65, 0x12, 0x15, 0x0a, 0x06, 0x6f, 0x72, 0x67, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x05, 0x6f, 0x72, 0x67, 0x49, 0x64, 0x22, 0x67, 0x0a, 0x0d, 0x47, 0x65, 0x74,
	0x49, 0x6e, 0x76, 0x6f, 0x69, 0x63, 0x65, 0x52, 0x65, 0x73, 0x12, 0x38, 0x0a, 0x07, 0x69, 0x6e,
	0x76, 0x6f, 0x69, 0x63, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x61, 0x70,
	...
	0x6f, 0x69, 0x63, 0x65, 0x12, 0x12, 0x0a, 0x03, 0x63, 0x73, 0x76, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x09, 0x48, 0x00, 0x52, 0x03, 0x63, 0x73, 0x76, 0x42, 0x08, 0x0a, 0x06, 0x66, 0x6f, 0x72, 0x6d,
	0x61, 0x74, 0x22, 0x72, 0x0a, 0x1a, 0x45, 0x78, 0x70, 0x6f, 0x72, 0x74, 0x47, 0x65, 0x6e, 0x65,
	0x72, 0x61, 0x74, 0x65, 0x64, 0x49, 0x6e, 0x76, 0x6f, 0x69, 0x63, 0x65, 0x73, 0x52, 0x65, 0x71,
	...
	0x05, 0x6f, 0x72, 0x67, 0x49, 0x64, 0x22, 0x74, 0x0a, 0x1a, 0x45, 0x78, 0x70, 0x6f, 0x72, 0x74,
	0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x64, 0x49, 0x6e, 0x76, 0x6f, 0x69, 0x63, 0x65,
	0x73, 0x52, 0x65, 0x73, 0x12, 0x38, 0x0a, 0x07, 0x69, 0x6e, 0x76, 0x6f, 0x69, 0x63, 0x65, 0x18,
	...
	,
	...
	,
...
var file_api_v1alpha1_billing_entities_proto_goTypes = []interface{}{
	...
	(*ExportGeneratedInvoicesReq)(nil), // 7: api.v1alpha1.billing.ExportGeneratedInvoicesReq
	(*ExportGeneratedInvoicesRes)(nil), // 8: api.v1alpha1.billing.ExportGeneratedInvoicesRes
...
var file_api_v1alpha1_billing_entities_proto_depIdxs = []int32{
	...
	12, // 4: api.v1alpha1.billing.GetInvoiceRes.invoice:type_name -> api.commons.billing.Invoice
	11, // 5: api.v1alpha1.billing.ExportGeneratedInvoicesReq.invoice_date:type_name -> google.protobuf.Timestamp
	12, // 6: api.v1alpha1.billing.ExportGeneratedInvoicesRes.invoice:type_name -> api.commons.billing.Invoice
...
func file_api_v1alpha1_billing_entities_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_v1alpha1_billing_entities_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ExportGeneratedInvoicesReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_v1alpha1_billing_entities_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ExportGeneratedInvoicesRes); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_api_v1alpha1_billing_entities_proto_msgTypes[5].OneofWrappers = []interface{}{
		(*GetInvoiceRes_Invoice)(nil),
		(*GetInvoiceRes_Csv)(nil),
	}
	file_api_v1alpha1_billing_entities_proto_msgTypes[7].OneofWrappers = []interface{}{
		(*ExportGeneratedInvoicesRes_Invoice)(nil),
		(*ExportGeneratedInvoicesRes_Csv)(nil),
	}
	type x struct{}
