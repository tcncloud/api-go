...
type GetInvoiceReq struct {
	...
	//
	//	*GetInvoiceReq_Invoice
	//	*GetInvoiceReq_Csv
	Format isGetInvoiceReq_Format `protobuf_oneof:"format"`
}
...
func (m *GetInvoiceReq) GetFormat() isGetInvoiceReq_Format {
	if m != nil {
		return m.Format
	}
	return nil
...
func (x *GetInvoiceReq) GetInvoice() *billing.Invoice {
	if x, ok := x.GetFormat().(*GetInvoiceReq_Invoice); ok {
		return x.Invoice
	}
	return nil
}

func (x *GetInvoiceReq) GetCsv() string {
	if x, ok := x.GetFormat().(*GetInvoiceReq_Csv); ok {
		return x.Csv
	}
	return ""
}

type isGetInvoiceReq_Format interface {
	isGetInvoiceReq_Format()
}

type GetInvoiceReq_Invoice struct {
	Invoice *billing.Invoice `protobuf:"bytes,3,opt,name=invoice,proto3,oneof"`
}

type GetInvoiceReq_Csv struct {
	Csv string `protobuf:"bytes,4,opt,name=csv,proto3,oneof"`
}

func (*GetInvoiceReq_Invoice) isGetInvoiceReq_Format() {}

func (*GetInvoiceReq_Csv) isGetInvoiceReq_Format() {}
...
func (x *GetInvoiceRes) GetInvoiceFormat() *billing.Invoice {
	if x, ok := x.GetFormat().(*GetInvoiceRes_InvoiceFormat); ok {
		return x.InvoiceFormat
	}
	return nil
}

func (x *GetInvoiceRes) GetCsv() string {
	if x, ok := x.GetFormat().(*GetInvoiceRes_Csv); ok {
		return x.Csv
	}
	return ""
}
...
type GetInvoiceRes_InvoiceFormat struct {
	InvoiceFormat *billing.Invoice `protobuf:"bytes,2,opt,name=invoice_format,json=invoiceFormat,proto3,oneof"`
}

type GetInvoiceRes_Csv struct {
	Csv string `protobuf:"bytes,3,opt,name=csv,proto3,oneof"`
}

func (*GetInvoiceRes_InvoiceFormat) isGetInvoiceRes_Format() {}

func (*GetInvoiceRes_Csv) isGetInvoiceRes_Format() {}
...
type ExportGeneratedInvoiceRes struct {
	...
	// Types that are assignable to Format:
	//
	//	*ExportGeneratedInvoiceRes_Invoice
	//	*ExportGeneratedInvoiceRes_Csv
...
func (x *ExportGeneratedInvoiceRes) GetInvoice() *billing.Invoice {
	if x, ok := x.GetFormat().(*ExportGeneratedInvoiceRes_Invoice); ok {
		return x.Invoice
	}
	return nil
}

func (x *ExportGeneratedInvoiceRes) GetCsv() string {
	if x, ok := x.GetFormat().(*ExportGeneratedInvoiceRes_Csv); ok {
		return x.Csv
	}
	return ""
}
...
type ExportGeneratedInvoiceRes_Invoice struct {
	Invoice *billing.Invoice `protobuf:"bytes,1,opt,name=invoice,proto3,oneof"`
}

type ExportGeneratedInvoiceRes_Csv struct {
	Csv string `protobuf:"bytes,2,opt,name=csv,proto3,oneof"`
}

func (*ExportGeneratedInvoiceRes_Invoice) isExportGeneratedInvoiceRes_Format() {}

func (*ExportGeneratedInvoiceRes_Csv) isExportGeneratedInvoiceRes_Format() {}
...
var file_api_v1alpha1_billing_entities_proto_rawDesc = []byte{
	...
	0x61, 0x6e, 0x22, 0xbd, 0x01, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x49, 0x6e, 0x76, 0x6f, 0x69, 0x63,
	...
	,
	...
	,
	...
	,
	...
	0x68, 0x61, 0x31, 0x2f, 0x62, 0x69, 0x6c, 0x6c, 0x69, 0x6e, 0x67, 0xa2, 0x02, 0x03, 0x41, 0x56,
	0x42, 0xaa, 0x02, 0x14, 0x41, 0x70, 0x69, 0x2e, 0x56, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31,
	0x2e, 0x42, 0x69, 0x6c, 0x6c, 0x69, 0x6e, 0x67, 0xca, 0x02, 0x14, 0x41, 0x70, 0x69, 0x5c, 0x56,
	0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x5c, 0x42, 0x69, 0x6c, 0x6c, 0x69, 0x6e, 0x67, 0xe2,
	0x02, 0x20, 0x41, 0x70, 0x69, 0x5c, 0x56, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x5c, 0x42,
	...
	0x61, 0x31, 0x3a, 0x3a, 0x42, 0x69, 0x6c, 0x6c, 0x69, 0x6e, 0x67, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_api_v1alpha1_billing_entities_proto_goTypes = []interface{}{
	...
	(*billing.Invoice)(nil),           // 12: api.commons.billing.Invoice
}
var file_api_v1alpha1_billing_entities_proto_depIdxs = []int32{
	...
	12, // 4: api.v1alpha1.billing.GetInvoiceReq.invoice:type_name -> api.commons.billing.Invoice
	12, // 5: api.v1alpha1.billing.GetInvoiceRes.invoice:type_name -> api.commons.billing.Invoice
	12, // 6: api.v1alpha1.billing.GetInvoiceRes.invoice_format:type_name -> api.commons.billing.Invoice
	11, // 7: api.v1alpha1.billing.ExportGeneratedInvoiceReq.invoice_date:type_name -> google.protobuf.Timestamp
	12, // 8: api.v1alpha1.billing.ExportGeneratedInvoiceRes.invoice:type_name -> api.commons.billing.Invoice
...
func file_api_v1alpha1_billing_entities_proto_init() {
	...
	file_api_v1alpha1_billing_entities_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*GetInvoiceReq_Invoice)(nil),
		(*GetInvoiceReq_Csv)(nil),
	}
	file_api_v1alpha1_billing_entities_proto_msgTypes[5].OneofWrappers = []interface{}{
		(*GetInvoiceRes_InvoiceFormat)(nil),
		(*GetInvoiceRes_Csv)(nil),
	}
	file_api_v1alpha1_billing_entities_proto_msgTypes[7].OneofWrappers = []interface{}{
		(*ExportGeneratedInvoiceRes_Invoice)(nil),
		(*ExportGeneratedInvoiceRes_Csv)(nil),
	}
	type x struct{}
