...
// UnimplementedFtsApiServer must be embedded to have
...
func (UnimplementedFtsApiServer) testEmbeddedByValue()                {}
...
func RegisterFtsApiServer(s grpc.ServiceRegistrar, srv FtsApiServer) {
	// If the following call pancis, it indicates UnimplementedFtsApiServer was
