...
func file_api_v1alpha1_exile_station_finvi_v1_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_v1alpha1_exile_station_finvi_v1_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*PopAccountReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_v1alpha1_exile_station_finvi_v1_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*PopAccountRes); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
