...
// UnimplementedVmdsServiceServer must be embedded to have
...
func (UnimplementedVmdsServiceServer) testEmbeddedByValue()                     {}
...
func RegisterVmdsServiceServer(s grpc.ServiceRegistrar, srv VmdsServiceServer) {
	// If the following call pancis, it indicates UnimplementedVmdsServiceServer was
