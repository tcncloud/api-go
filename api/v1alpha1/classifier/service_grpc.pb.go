...
func (c *classifierFileTemplatesClient) UpdateFileTemplate(ctx context.Context, in *UpdateFileTemplateRequest, opts ...grpc.CallOption) (*UpdateFileTemplateResponse, error) {
	...
	err := c.cc.Invoke(ctx, ClassifierFileTemplates_UpdateFileTemplate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *classifierFileTemplatesClient) DeleteFileTemplate(ctx context.Context, in *DeleteFileTemplateRequest, opts ...grpc.CallOption) (*DeleteFileTemplateResponse, error) {
	...
	err := c.cc.Invoke(ctx, ClassifierFileTemplates_DeleteFileTemplate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *classifierFileTemplatesClient) ListFileTemplates(ctx context.Context, in *ListFileTemplatesRequest, opts ...grpc.CallOption) (*ListFileTemplatesResponse, error) {
	...
	err := c.cc.Invoke(ctx, ClassifierFileTemplates_ListFileTemplates_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *classifierFileTemplatesClient) GetFileTemplate(ctx context.Context, in *GetFileTemplateRequest, opts ...grpc.CallOption) (*GetFileTemplateResponse, error) {
	...
	err := c.cc.Invoke(ctx, ClassifierFileTemplates_GetFileTemplate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedClassifierFileTemplatesServer must be embedded to have
...
func (UnimplementedClassifierFileTemplatesServer) testEmbeddedByValue() {}
...
func RegisterClassifierFileTemplatesServer(s grpc.ServiceRegistrar, srv ClassifierFileTemplatesServer) {
	// If the following call pancis, it indicates UnimplementedClassifierFileTemplatesServer was
