...
const (
	NewsroomAPI_Ping_FullMethodName = "/api.v1alpha1.newsroom.NewsroomAPI/Ping"
)
...
func (c *newsroomAPIClient) Ping(ctx context.Context, in *PingReq, opts ...grpc.CallOption) (*PingRes, error) {
	out := new(PingRes)
	err := c.cc.Invoke(ctx, NewsroomAPI_Ping_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedNewsroomAPIServer) Ping(context.Context, *PingReq) (*PingRes, error) {
...
func _NewsroomAPI_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PingReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NewsroomAPIServer).Ping(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NewsroomAPI_Ping_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NewsroomAPIServer).Ping(ctx, req.(*PingReq))
	}
...
var NewsroomAPI_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Ping",
			Handler:    _NewsroomAPI_Ping_Handler,
		},
	},
