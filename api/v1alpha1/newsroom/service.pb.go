...
var file_api_v1alpha1_newsroom_service_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x8f, 0x0d, 0x0a, 0x0b, 0x4e, 0x65,
	...
	0x6e, 0x65, 0x77, 0x73, 0x66, 0x6f, 0x72, 0x75, 0x73, 0x65, 0x72, 0x42, 0xd1, 0x01, 0x0a, 0x19,
	0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31,
	0x2e, 0x6e, 0x65, 0x77, 0x73, 0x72, 0x6f, 0x6f, 0x6d, 0x42, 0x0c, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	,
...
var file_api_v1alpha1_newsroom_service_proto_goTypes = []interface{}{
	...
	(*CreateNewsArticleResponse)(nil),       // 9: api.v1alpha1.newsroom.CreateNewsArticleResponse
	(*ListNewsArticlesResponse)(nil),        // 10: api.v1alpha1.newsroom.ListNewsArticlesResponse
	(*GetNewsArticleByIdResponse)(nil),      // 11: api.v1alpha1.newsroom.GetNewsArticleByIdResponse
	(*UpdateNewsArticleResponse)(nil),       // 12: api.v1alpha1.newsroom.UpdateNewsArticleResponse
	(*CreatePublishedArticleResponse)(nil),  // 13: api.v1alpha1.newsroom.CreatePublishedArticleResponse
	...
	(*UserActivityResponse)(nil),            // 16: api.v1alpha1.newsroom.UserActivityResponse
	(*GetNewsForUserResponse)(nil),          // 17: api.v1alpha1.newsroom.GetNewsForUserResponse
}
var file_api_v1alpha1_newsroom_service_proto_depIdxs = []int32{
	...
	9,  // 9: api.v1alpha1.newsroom.NewsroomAPI.CreateNewsArticle:output_type -> api.v1alpha1.newsroom.CreateNewsArticleResponse
	10, // 10: api.v1alpha1.newsroom.NewsroomAPI.ListNewsArticles:output_type -> api.v1alpha1.newsroom.ListNewsArticlesResponse
	11, // 11: api.v1alpha1.newsroom.NewsroomAPI.GetNewsArticleById:output_type -> api.v1alpha1.newsroom.GetNewsArticleByIdResponse
	12, // 12: api.v1alpha1.newsroom.NewsroomAPI.UpdateNewsArticle:output_type -> api.v1alpha1.newsroom.UpdateNewsArticleResponse
	13, // 13: api.v1alpha1.newsroom.NewsroomAPI.CreatePublishedArticle:output_type -> api.v1alpha1.newsroom.CreatePublishedArticleResponse
	14, // 14: api.v1alpha1.newsroom.NewsroomAPI.ListPublishedArticles:output_type -> api.v1alpha1.newsroom.ListPublishedArticlesResponse
	15, // 15: api.v1alpha1.newsroom.NewsroomAPI.GetPublishedArticleById:output_type -> api.v1alpha1.newsroom.GetPublishedArticleByIdResponse
	16, // 16: api.v1alpha1.newsroom.NewsroomAPI.UserActivity:output_type -> api.v1alpha1.newsroom.UserActivityResponse
	17, // 17: api.v1alpha1.newsroom.NewsroomAPI.GetNewsForUser:output_type -> api.v1alpha1.newsroom.GetNewsForUserResponse
