...
var file_api_v1alpha1_newsroom_service_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xe7, 0x05, 0x0a, 0x0b, 0x4e, 0x65,
	...
	0x63, 0x6c, 0x65, 0x42, 0xd1, 0x01, 0x0a, 0x19, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x6e, 0x65, 0x77, 0x73, 0x72, 0x6f, 0x6f,
	0x6d, 0x42, 0x0c, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50,
...
var file_api_v1alpha1_newsroom_service_proto_goTypes = []interface{}{
	...
	(*CreateNewsArticleResponse)(nil),  // 4: api.v1alpha1.newsroom.CreateNewsArticleResponse
	(*ListNewsArticlesResponse)(nil),   // 5: api.v1alpha1.newsroom.ListNewsArticlesResponse
	(*GetNewsArticleByIdResponse)(nil), // 6: api.v1alpha1.newsroom.GetNewsArticleByIdResponse
...
var file_api_v1alpha1_newsroom_service_proto_depIdxs = []int32{
	...
	4, // 4: api.v1alpha1.newsroom.NewsroomAPI.CreateNewsArticle:output_type -> api.v1alpha1.newsroom.CreateNewsArticleResponse
	5, // 5: api.v1alpha1.newsroom.NewsroomAPI.ListNewsArticles:output_type -> api.v1alpha1.newsroom.ListNewsArticlesResponse
	6, // 6: api.v1alpha1.newsroom.NewsroomAPI.GetNewsArticleById:output_type -> api.v1alpha1.newsroom.GetNewsArticleByIdResponse
	7, // 7: api.v1alpha1.newsroom.NewsroomAPI.UpdateNewsArticle:output_type -> api.v1alpha1.newsroom.UpdateNewsArticleResponse
