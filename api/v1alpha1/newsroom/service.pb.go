...
var file_api_v1alpha1_newsroom_service_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xc5, 0x0a, 0x0a, 0x0b, 0x4e, 0x65,
...
var file_api_v1alpha1_newsroom_service_proto_goTypes = []interface{}{
	...
	(*CreateNewsArticleResponse)(nil),       // 7: api.v1alpha1.newsroom.CreateNewsArticleResponse
	(*ListNewsArticlesResponse)(nil),        // 8: api.v1alpha1.newsroom.ListNewsArticlesResponse
	(*GetNewsArticleByIdResponse)(nil),      // 9: api.v1alpha1.newsroom.GetNewsArticleByIdResponse
	(*UpdateNewsArticleResponse)(nil),       // 10: api.v1alpha1.newsroom.UpdateNewsArticleResponse
	(*CreatePublishedArticleResponse)(nil),  // 11: api.v1alpha1.newsroom.CreatePublishedArticleResponse
	(*ListPublishedArticlesResponse)(nil),   // 12: api.v1alpha1.newsroom.ListPublishedArticlesResponse
	(*GetPublishedArticleByIdResponse)(nil), // 13: api.v1alpha1.newsroom.GetPublishedArticleByIdResponse
}
var file_api_v1alpha1_newsroom_service_proto_depIdxs = []int32{
	...
	7,  // 7: api.v1alpha1.newsroom.NewsroomAPI.CreateNewsArticle:output_type -> api.v1alpha1.newsroom.CreateNewsArticleResponse
	8,  // 8: api.v1alpha1.newsroom.NewsroomAPI.ListNewsArticles:output_type -> api.v1alpha1.newsroom.ListNewsArticlesResponse
	9,  // 9: api.v1alpha1.newsroom.NewsroomAPI.GetNewsArticleById:output_type -> api.v1alpha1.newsroom.GetNewsArticleByIdResponse
	10, // 10: api.v1alpha1.newsroom.NewsroomAPI.UpdateNewsArticle:output_type -> api.v1alpha1.newsroom.UpdateNewsArticleResponse
	11, // 11: api.v1alpha1.newsroom.NewsroomAPI.CreatePublishedArticle:output_type -> api.v1alpha1.newsroom.CreatePublishedArticleResponse
	12, // 12: api.v1alpha1.newsroom.NewsroomAPI.ListPublishedArticles:output_type -> api.v1alpha1.newsroom.ListPublishedArticlesResponse
	13, // 13: api.v1alpha1.newsroom.NewsroomAPI.GetPublishedArticleById:output_type -> api.v1alpha1.newsroom.GetPublishedArticleByIdResponse
