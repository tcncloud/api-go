...
var file_api_v1alpha1_newsroom_service_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xcb, 0x0e, 0x0a, 0x0b, 0x4e, 0x65,
	...
	,
...
var file_api_v1alpha1_newsroom_service_proto_goTypes = []interface{}{
	...
	(*StoreNewsroomImageRequest)(nil),       // 9: api.v1alpha1.newsroom.StoreNewsroomImageRequest
	(*CreateNewsArticleResponse)(nil),       // 10: api.v1alpha1.newsroom.CreateNewsArticleResponse
	(*ListNewsArticlesResponse)(nil),        // 11: api.v1alpha1.newsroom.ListNewsArticlesResponse
	(*GetNewsArticleByIdResponse)(nil),      // 12: api.v1alpha1.newsroom.GetNewsArticleByIdResponse
	(*UpdateNewsArticleResponse)(nil),       // 13: api.v1alpha1.newsroom.UpdateNewsArticleResponse
	(*CreatePublishedArticleResponse)(nil),  // 14: api.v1alpha1.newsroom.CreatePublishedArticleResponse
	(*ListPublishedArticlesResponse)(nil),   // 15: api.v1alpha1.newsroom.ListPublishedArticlesResponse
	(*GetPublishedArticleByIdResponse)(nil), // 16: api.v1alpha1.newsroom.GetPublishedArticleByIdResponse
	(*UserActivityResponse)(nil),            // 17: api.v1alpha1.newsroom.UserActivityResponse
	(*GetNewsForUserResponse)(nil),          // 18: api.v1alpha1.newsroom.GetNewsForUserResponse
	(*StoreNewsroomImageResponse)(nil),      // 19: api.v1alpha1.newsroom.StoreNewsroomImageResponse
}
var file_api_v1alpha1_newsroom_service_proto_depIdxs = []int32{
	...
	9,  // 9: api.v1alpha1.newsroom.NewsroomAPI.StoreNewsroomImage:input_type -> api.v1alpha1.newsroom.StoreNewsroomImageRequest
	10, // 10: api.v1alpha1.newsroom.NewsroomAPI.CreateNewsArticle:output_type -> api.v1alpha1.newsroom.CreateNewsArticleResponse
	11, // 11: api.v1alpha1.newsroom.NewsroomAPI.ListNewsArticles:output_type -> api.v1alpha1.newsroom.ListNewsArticlesResponse
	12, // 12: api.v1alpha1.newsroom.NewsroomAPI.GetNewsArticleById:output_type -> api.v1alpha1.newsroom.GetNewsArticleByIdResponse
	13, // 13: api.v1alpha1.newsroom.NewsroomAPI.UpdateNewsArticle:output_type -> api.v1alpha1.newsroom.UpdateNewsArticleResponse
	14, // 14: api.v1alpha1.newsroom.NewsroomAPI.CreatePublishedArticle:output_type -> api.v1alpha1.newsroom.CreatePublishedArticleResponse
	15, // 15: api.v1alpha1.newsroom.NewsroomAPI.ListPublishedArticles:output_type -> api.v1alpha1.newsroom.ListPublishedArticlesResponse
	16, // 16: api.v1alpha1.newsroom.NewsroomAPI.GetPublishedArticleById:output_type -> api.v1alpha1.newsroom.GetPublishedArticleByIdResponse
	17, // 17: api.v1alpha1.newsroom.NewsroomAPI.UserActivity:output_type -> api.v1alpha1.newsroom.UserActivityResponse
	18, // 18: api.v1alpha1.newsroom.NewsroomAPI.GetNewsForUser:output_type -> api.v1alpha1.newsroom.GetNewsForUserResponse
	19, // 19: api.v1alpha1.newsroom.NewsroomAPI.StoreNewsroomImage:output_type -> api.v1alpha1.newsroom.StoreNewsroomImageResponse
