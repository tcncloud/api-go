...
type ListTicketTemplateResponse struct {
	...
	EnabledTemplates *commons.ListTemplate `protobuf:"bytes,1,opt,name=enabled_templates,json=enabledTemplates,proto3" json:"enabled_templates,omitempty"`
}
...
var file_api_v1alpha1_tickets_ticket_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x65, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x61, 0x70, 0x69,
