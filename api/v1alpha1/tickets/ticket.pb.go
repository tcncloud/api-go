...
var file_api_v1alpha1_tickets_ticket_proto_rawDesc = []byte{
	...
	0x41, 0x73, 0x73, 0x69, 0x67, 0x6e, 0x65, 0x65, 0x22, 0x3e, 0x0a, 0x0f, 0x43, 0x72, 0x65, 0x61,
...
var file_api_v1alpha1_tickets_ticket_proto_goTypes = []interface{}{
	...
	(*commons.Duration)(nil),                  // 58: api.commons.Duration
	(*commons.TicketSla)(nil),                 // 59: api.commons.TicketSla
	(*commons.SlaConditions)(nil),             // 60: api.commons.SlaConditions
	(*commons.ConfirmReplyComment)(nil),       // 61: api.commons.ConfirmReplyComment
	(commons.TicketStatus)(0),                 // 62: api.commons.TicketStatus
}
var file_api_v1alpha1_tickets_ticket_proto_depIdxs = []int32{
	...
	58, // 15: api.v1alpha1.tickets.CreateSlaReq.duration:type_name -> api.commons.Duration
	59, // 16: api.v1alpha1.tickets.CreateSlaRes.sla:type_name -> api.commons.TicketSla
	59, // 17: api.v1alpha1.tickets.ListSlaRes.ticketsSla:type_name -> api.commons.TicketSla
	59, // 18: api.v1alpha1.tickets.UpdateSlaRes.ticketsSla:type_name -> api.commons.TicketSla
	60, // 19: api.v1alpha1.tickets.ListSlaConditionRes.slaCondition:type_name -> api.commons.SlaConditions
	61, // 20: api.v1alpha1.tickets.ReplyCommentRes.is_created:type_name -> api.commons.ConfirmReplyComment
	36, // 21: api.v1alpha1.tickets.ListSkillsResponse.skills:type_name -> api.v1alpha1.tickets.Skill
	39, // 22: api.v1alpha1.tickets.ListUsersResponse.users:type_name -> api.v1alpha1.tickets.User
	52, // 23: api.v1alpha1.tickets.CreateTicketActionRequest.ticket_action:type_name -> api.commons.TicketAction
	52, // 24: api.v1alpha1.tickets.CreateTicketActionResponse.ticket_action:type_name -> api.commons.TicketAction
	62, // 25: api.v1alpha1.tickets.ChangeTicketStatusRequest.ticket_status:type_name -> api.commons.TicketStatus
