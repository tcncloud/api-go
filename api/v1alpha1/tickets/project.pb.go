...
var file_api_v1alpha1_tickets_project_proto_rawDesc = []byte{
	...
	0x74, 0x52, 0x06, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x42, 0x5a, 0x0a, 0x23, 0x63, 0x6f, 0x6d,
	...
	0x6c, 0x70, 0x68, 0x61, 0x31, 0x2f, 0x74, 0x69, 0x63, 0x6b, 0x65, 0x74, 0x73, 0x3b, 0x74, 0x69,
...
func file_api_v1alpha1_tickets_project_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_v1alpha1_tickets_project_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_tickets_project_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_tickets_project_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_tickets_project_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_tickets_project_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_tickets_project_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
