...
import (
	...
	sentinel "github.com/tcncloud/api-go/api/v1alpha1/sentinel"
	http "net/http"
	strings "strings"
)
...
func NewSentinelHandler(svc SentinelHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/api.v1alpha1.sentinel.Sentinel/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
