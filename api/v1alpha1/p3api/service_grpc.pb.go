...
func (c *p3ApiClient) GetExtendedCallHistories(ctx context.Context, in *v0alpha.ListExtendedCallHistoryReq, opts ...grpc.CallOption) (P3Api_GetExtendedCallHistoriesClient, error) {
	stream, err := c.cc.NewStream(ctx, &P3Api_ServiceDesc.Streams[0], P3Api_GetExtendedCallHistories_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &p3ApiGetExtendedCallHistoriesClient{stream}
...
func (c *p3ApiClient) GetActivityLogHistories(ctx context.Context, in *v0alpha.GetActivityLogHistoryReq, opts ...grpc.CallOption) (P3Api_GetActivityLogHistoriesClient, error) {
	stream, err := c.cc.NewStream(ctx, &P3Api_ServiceDesc.Streams[1], P3Api_GetActivityLogHistories_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &p3ApiGetActivityLogHistoriesClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func _P3Api_GetExtendedCallHistories_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(P3ApiServer).GetExtendedCallHistories(m, &p3ApiGetExtendedCallHistoriesServer{stream})
}
...
func _P3Api_GetActivityLogHistories_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(P3ApiServer).GetActivityLogHistories(m, &p3ApiGetActivityLogHistoriesServer{stream})
}
