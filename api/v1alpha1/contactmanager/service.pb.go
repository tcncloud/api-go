...
var file_api_v1alpha1_contactmanager_service_proto_rawDesc = []byte{
	...
	0x6f, 0x32, 0x96, 0x0a, 0x0a, 0x0e, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x63, 0x74, 0x4d, 0x61, 0x6e,
	...
	0x6e, 0x74, 0x61, 0x63, 0x74, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x42, 0xf5, 0x01, 0x0a, 0x1f, 0x63,
	0x6f, 0x6d, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e,
	0x63, 0x6f, 0x6e, 0x74, 0x61, 0x63, 0x74, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x42, 0x0c,
...
var file_api_v1alpha1_contactmanager_service_proto_goTypes = []interface{}{
	...
	(*GetContactListResponse)(nil),        // 6: api.v1alpha1.contactmanager.GetContactListResponse
	(*ListContactEntryListResponse)(nil),  // 7: api.v1alpha1.contactmanager.ListContactEntryListResponse
	(*GetEncContactEntryResponse)(nil),    // 8: api.v1alpha1.contactmanager.GetEncContactEntryResponse
	(*GetKYCEncContactEntryResponse)(nil), // 9: api.v1alpha1.contactmanager.GetKYCEncContactEntryResponse
	(*GetKYCKeysResponse)(nil),            // 10: api.v1alpha1.contactmanager.GetKYCKeysResponse
	(*AddContactEntryResponse)(nil),       // 11: api.v1alpha1.contactmanager.AddContactEntryResponse
}
var file_api_v1alpha1_contactmanager_service_proto_depIdxs = []int32{
	...
	6,  // 6: api.v1alpha1.contactmanager.ContactManager.GetContactList:output_type -> api.v1alpha1.contactmanager.GetContactListResponse
	7,  // 7: api.v1alpha1.contactmanager.ContactManager.ListContactEntryList:output_type -> api.v1alpha1.contactmanager.ListContactEntryListResponse
	8,  // 8: api.v1alpha1.contactmanager.ContactManager.GetEncContactEntry:output_type -> api.v1alpha1.contactmanager.GetEncContactEntryResponse
	9,  // 9: api.v1alpha1.contactmanager.ContactManager.GetKYCEncContactEntry:output_type -> api.v1alpha1.contactmanager.GetKYCEncContactEntryResponse
	10, // 10: api.v1alpha1.contactmanager.ContactManager.GetKYCKeys:output_type -> api.v1alpha1.contactmanager.GetKYCKeysResponse
	11, // 11: api.v1alpha1.contactmanager.ContactManager.AddContactEntry:output_type -> api.v1alpha1.contactmanager.AddContactEntryResponse
