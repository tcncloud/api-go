...
var file_api_v1alpha1_contactmanager_service_proto_rawDesc = []byte{
	...
	0x6f, 0x32, 0xd5, 0x0d, 0x0a, 0x0e, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x63, 0x74, 0x4d, 0x61, 0x6e,
	...
	0x73, 0x62, 0x79, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x42, 0xf5, 0x01, 0x0a, 0x1f, 0x63, 0x6f,
...
var file_api_v1alpha1_contactmanager_service_proto_goTypes = []any{
	...
	(*GetContactListResponse)(nil),        // 8: api.v1alpha1.contactmanager.GetContactListResponse
	(*ListContactEntryListResponse)(nil),  // 9: api.v1alpha1.contactmanager.ListContactEntryListResponse
	(*GetEncContactEntryResponse)(nil),    // 10: api.v1alpha1.contactmanager.GetEncContactEntryResponse
	(*GetKYCEncContactEntryResponse)(nil), // 11: api.v1alpha1.contactmanager.GetKYCEncContactEntryResponse
	(*GetKYCKeysResponse)(nil),            // 12: api.v1alpha1.contactmanager.GetKYCKeysResponse
	(*AddContactEntryResponse)(nil),       // 13: api.v1alpha1.contactmanager.AddContactEntryResponse
	(*EditContactEntryResponse)(nil),      // 14: api.v1alpha1.contactmanager.EditContactEntryResponse
	(*ListContactsByEntityResponse)(nil),  // 15: api.v1alpha1.contactmanager.ListContactsByEntityResponse
}
var file_api_v1alpha1_contactmanager_service_proto_depIdxs = []int32{
	...
	8,  // 8: api.v1alpha1.contactmanager.ContactManager.GetContactList:output_type -> api.v1alpha1.contactmanager.GetContactListResponse
	9,  // 9: api.v1alpha1.contactmanager.ContactManager.ListContactEntryList:output_type -> api.v1alpha1.contactmanager.ListContactEntryListResponse
	10, // 10: api.v1alpha1.contactmanager.ContactManager.GetEncContactEntry:output_type -> api.v1alpha1.contactmanager.GetEncContactEntryResponse
	11, // 11: api.v1alpha1.contactmanager.ContactManager.GetKYCEncContactEntry:output_type -> api.v1alpha1.contactmanager.GetKYCEncContactEntryResponse
	12, // 12: api.v1alpha1.contactmanager.ContactManager.GetKYCKeys:output_type -> api.v1alpha1.contactmanager.GetKYCKeysResponse
	13, // 13: api.v1alpha1.contactmanager.ContactManager.AddContactEntry:output_type -> api.v1alpha1.contactmanager.AddContactEntryResponse
	14, // 14: api.v1alpha1.contactmanager.ContactManager.EditContactEntry:output_type -> api.v1alpha1.contactmanager.EditContactEntryResponse
	15, // 15: api.v1alpha1.contactmanager.ContactManager.ListContactsByEntity:output_type -> api.v1alpha1.contactmanager.ListContactsByEntityResponse
