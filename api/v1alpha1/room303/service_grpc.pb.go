...
const (
	...
	Room303API_EditRoomConfig_FullMethodName        = "/api.v1alpha1.room303.Room303API/EditRoomConfig"
)
...
type Room303APIClient interface {
	...
	EditRoomConfig(ctx context.Context, in *EditRoomConfigRequest, opts ...grpc.CallOption) (*commons.Room, error)
}
...
func (c *room303APIClient) EditRoomConfig(ctx context.Context, in *EditRoomConfigRequest, opts ...grpc.CallOption) (*commons.Room, error) {
	out := new(commons.Room)
	err := c.cc.Invoke(ctx, Room303API_EditRoomConfig_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type Room303APIServer interface {
	...
	// allow room configurations to be edited
	EditRoomConfig(context.Context, *EditRoomConfigRequest) (*commons.Room, error)
...
func (UnimplementedRoom303APIServer) EditRoomConfig(context.Context, *EditRoomConfigRequest) (*commons.Room, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EditRoomConfig not implemented")
}
...
func _Room303API_EditRoomConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EditRoomConfigRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(Room303APIServer).EditRoomConfig(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Room303API_EditRoomConfig_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(Room303APIServer).EditRoomConfig(ctx, req.(*EditRoomConfigRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Room303API_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Room303API_EditRoomConfig_Handler,
		},
	},
