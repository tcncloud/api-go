...
const (
	...
	// Room303APIEditRoomConfigProcedure is the fully-qualified name of the Room303API's EditRoomConfig
	// RPC.
	Room303APIEditRoomConfigProcedure = "/api.v1alpha1.room303.Room303API/EditRoomConfig"
)
...
type Room303APIClient interface {
	...
	EditRoomConfig(context.Context, *connect_go.Request[room303.EditRoomConfigRequest]) (*connect_go.Response[commons.Room], error)
}
...
func NewRoom303APIClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) Room303APIClient {
	...
	return &room303APIClient{
		...
		editRoomConfig: connect_go.NewClient[room303.EditRoomConfigRequest, commons.Room](
			httpClient,
			baseURL+Room303APIEditRoomConfigProcedure,
			opts...,
		),
	}
}
...
type room303APIClient struct {
	...
	editRoomConfig        *connect_go.Client[room303.EditRoomConfigRequest, commons.Room]
}
...
// EditRoomConfig calls api.v1alpha1.room303.Room303API.EditRoomConfig.
func (c *room303APIClient) EditRoomConfig(ctx context.Context, req *connect_go.Request[room303.EditRoomConfigRequest]) (*connect_go.Response[commons.Room], error) {
	return c.editRoomConfig.CallUnary(ctx, req)
}
...
func NewRoom303APIHandler(svc Room303APIHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	room303APIEditRoomConfigHandler := connect_go.NewUnaryHandler(
		Room303APIEditRoomConfigProcedure,
		svc.EditRoomConfig,
		opts...,
	)
	return "/api.v1alpha1.room303.Room303API/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case Room303APIEditRoomConfigProcedure:
			room303APIEditRoomConfigHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
...
func (UnimplementedRoom303APIHandler) EditRoomConfig(context.Context, *connect_go.Request[room303.EditRoomConfigRequest]) (*connect_go.Response[commons.Room], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.room303.Room303API.EditRoomConfig is not implemented"))
}
