...
func NewRoom303APIClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) Room303APIClient {
	...
	return &room303APIClient{
		...
		updateRoom: connect_go.NewClient[room303.UpdateRoomRequest, commons.Room](
			httpClient,
			baseURL+Room303APIUpdateRoomProcedure,
			opts...,
		),
	}
}
...
type room303APIClient struct {
	...
	updateRoom            *connect_go.Client[room303.UpdateRoomRequest, commons.Room]
}
...
// UpdateRoom calls api.v1alpha1.room303.Room303API.UpdateRoom.
func (c *room303APIClient) UpdateRoom(ctx context.Context, req *connect_go.Request[room303.UpdateRoomRequest]) (*connect_go.Response[commons.Room], error) {
...
func NewRoom303APIHandler(svc Room303APIHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	room303APIUpdateRoomHandler := connect_go.NewUnaryHandler(
		Room303APIUpdateRoomProcedure,
		svc.UpdateRoom,
		opts...,
	)
	return "/api.v1alpha1.room303.Room303API/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case Room303APIUpdateRoomProcedure:
			room303APIUpdateRoomHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
...
func (UnimplementedRoom303APIHandler) UpdateRoom(context.Context, *connect_go.Request[room303.UpdateRoomRequest]) (*connect_go.Response[commons.Room], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1alpha1.room303.Room303API.UpdateRoom is not implemented"))
}
