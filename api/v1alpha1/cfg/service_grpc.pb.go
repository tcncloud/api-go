...
type CfgClient interface {
	...
	GetWebAgentConfig(ctx context.Context, in *GetWebAgentConfigReq, opts ...grpc.CallOption) (*WebAgent, error)
}
...
func (c *cfgClient) GetWebAgentConfig(ctx context.Context, in *GetWebAgentConfigReq, opts ...grpc.CallOption) (*WebAgent, error) {
...
type CfgServer interface {
	// Get the configuration for a given web agent.
	GetWebAgentConfig(context.Context, *GetWebAgentConfigReq) (*WebAgent, error)
	mustEmbedUnimplementedCfgServer()
}

// UnimplementedCfgServer must be embedded to have
...
func (UnimplementedCfgServer) testEmbeddedByValue()             {}
...
func RegisterCfgServer(s grpc.ServiceRegistrar, srv CfgServer) {
	// If the following call pancis, it indicates UnimplementedCfgServer was
...
func _Cfg_GetWebAgentConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CfgServer).GetWebAgentConfig(ctx, req.(*GetWebAgentConfigReq))
	}
...
var Cfg_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.v1alpha1.cfg.Cfg",
	...
	Metadata: "api/v1alpha1/cfg/service.proto",
}
