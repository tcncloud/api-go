...
var file_api_v1alpha1_vanalytics_flag_transcript_filter_proto_rawDesc = []byte{
	...
	0x70, 0x73, 0x68, 0x6f, 0x74, 0x42, 0x63, 0x0a, 0x26, 0x63, 0x6f, 0x6d, 0x2e, 0x74, 0x63, 0x6e,
...
var (
	...
	file_api_v1alpha1_vanalytics_flag_transcript_filter_proto_rawDescData = file_api_v1alpha1_vanalytics_flag_transcript_filter_proto_rawDesc
)
...
func file_api_v1alpha1_vanalytics_flag_transcript_filter_proto_rawDescGZIP() []byte {
	file_api_v1alpha1_vanalytics_flag_transcript_filter_proto_rawDescOnce.Do(func() {
		file_api_v1alpha1_vanalytics_flag_transcript_filter_proto_rawDescData = protoimpl.X.CompressGZIP(file_api_v1alpha1_vanalytics_flag_transcript_filter_proto_rawDescData)
	})
...
var file_api_v1alpha1_vanalytics_flag_transcript_filter_proto_goTypes = []interface{}{
...
func file_api_v1alpha1_vanalytics_flag_transcript_filter_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_v1alpha1_vanalytics_flag_transcript_filter_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_vanalytics_flag_transcript_filter_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_vanalytics_flag_transcript_filter_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_api_v1alpha1_vanalytics_flag_transcript_filter_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_api_v1alpha1_vanalytics_flag_transcript_filter_proto_rawDesc = nil
