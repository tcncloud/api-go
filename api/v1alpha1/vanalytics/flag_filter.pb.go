...
const file_api_v1alpha1_vanalytics_flag_filter_proto_rawDesc = "" +
	"\n" +
	")api/v1alpha1/vanalytics/flag_filter.proto\x12\x17api.v1alpha1.vanalytics\x1a$api/v1alpha1/vanalytics/filter.proto\x1a\"api/v1alpha1/vanalytics/flag.proto\x1a google/protobuf/field_mask.proto\"_\n" +
	"\x17CreateFlagFilterRequest\x12D\n" +
	"\vflag_filter\x18\x01 \x01(\v2#.api.v1alpha1.vanalytics.FlagFilterR\n" +
	"flagFilter\"\xe7\x01\n" +
	...
	"filterMask\x12\x1b\n" +
	"\tflag_sids\x18\x06 \x03(\x03R\bflagSids\"\x89\x01\n" +
	"\x17ListFlagFiltersResponse\x12&\n" +
	"\x0fnext_page_token\x18\x01 \x01(\tR\rnextPageToken\x12F\n" +
	"\fflag_filters\x18\x02 \x03(\v2#.api.v1alpha1.vanalytics.FlagFilterR\vflagFilters\"e\n" +
	"\x17DeleteFlagFilterRequest\x12\x19\n" +
	"\bflag_sid\x18\x01 \x01(\x03R\aflagSid\x12\x1d\n" +
	"\n" +
	"filter_sid\x18\x02 \x01(\x03R\tfilterSid\x12\x10\n" +
	"\x03all\x18\x03 \x01(\bR\x03all\"\x1a\n" +
	"\x18DeleteFlagFilterResponse\"\xda\x01\n" +
	"\n" +
	"FlagFilter\x12&\n" +
	"\x0fflag_filter_sid\x18\x01 \x01(\x03R\rflagFilterSid\x12\x1d\n" +
	"\n" +
	"filter_sid\x18\x02 \x01(\x03R\tfilterSid\x12\x19\n" +
	"\bflag_sid\x18\x03 \x01(\x03R\aflagSid\x121\n" +
	"\x04flag\x18\x05 \x01(\v2\x1d.api.v1alpha1.vanalytics.FlagR\x04flag\x127\n" +
	"\x06filter\x18\x06 \x01(\v2\x1f.api.v1alpha1.vanalytics.FilterR\x06filterB\xe0\x01\n" +
	"\x1bcom.api.v1alpha1.vanalyticsB\x0fFlagFilterProtoP\x01Z2github.com/tcncloud/api-go/api/v1alpha1/vanalytics\xa2\x02\x03AVV\xaa\x02\x17Api.V1alpha1.Vanalytics\xca\x02\x17Api\\V1alpha1\\Vanalytics\xe2\x02#Api\\V1alpha1\\Vanalytics\\GPBMetadata\xea\x02\x19Api::V1alpha1::Vanalyticsb\x06proto3"

var (
	file_api_v1alpha1_vanalytics_flag_filter_proto_rawDescOnce sync.Once
	file_api_v1alpha1_vanalytics_flag_filter_proto_rawDescData []byte
)
...
func file_api_v1alpha1_vanalytics_flag_filter_proto_rawDescGZIP() []byte {
	file_api_v1alpha1_vanalytics_flag_filter_proto_rawDescOnce.Do(func() {
		file_api_v1alpha1_vanalytics_flag_filter_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_v1alpha1_vanalytics_flag_filter_proto_rawDesc), len(file_api_v1alpha1_vanalytics_flag_filter_proto_rawDesc)))
	})
...
func file_api_v1alpha1_vanalytics_flag_filter_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_v1alpha1_vanalytics_flag_filter_proto_rawDesc), len(file_api_v1alpha1_vanalytics_flag_filter_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
