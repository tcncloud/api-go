...
var file_api_v1alpha1_vanalytics_aclpb_aclpb_proto_rawDesc = []byte{
	...
	0x42, 0x6a, 0x0a, 0x2c, 0x63, 0x6f, 0x6d, 0x2e, 0x74, 0x63, 0x6e, 0x2e, 0x6d, 0x61, 0x74, 0x72,
	0x69, 0x78, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e,
	0x76, 0x61, 0x6e, 0x61, 0x6c, 0x79, 0x74, 0x69, 0x63, 0x73, 0x2e, 0x61, 0x63, 0x6c, 0x70, 0x62,
	...
	0x2f, 0x61, 0x63, 0x6c, 0x70, 0x62, 0x3b, 0x61, 0x63, 0x6c, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_api_v1alpha1_vanalytics_aclpb_aclpb_proto_goTypes = []interface{}{
...
func file_api_v1alpha1_vanalytics_aclpb_aclpb_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_v1alpha1_vanalytics_aclpb_aclpb_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_vanalytics_aclpb_aclpb_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Action); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_v1alpha1_vanalytics_aclpb_aclpb_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CallSkillsInitial); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_api_v1alpha1_vanalytics_aclpb_aclpb_proto_msgTypes[1].OneofWrappers = []interface{}{
