...
func file_api_v1alpha1_vanalytics_correction_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_v1alpha1_vanalytics_correction_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_vanalytics_correction_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_vanalytics_correction_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_vanalytics_correction_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_vanalytics_correction_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_vanalytics_correction_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_vanalytics_correction_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
