...
const file_api_v1alpha1_vanalytics_correction_proto_rawDesc = "" +
	"\n" +
	"(api/v1alpha1/vanalytics/correction.proto\x12\x17api.v1alpha1.vanalytics\x1a\x1egoogle/protobuf/duration.proto\x1a google/protobuf/field_mask.proto\"\x9b\x01\n" +
	"\x17UpdateCorrectionRequest\x12C\n" +
	"\n" +
	"correction\x18\x01 \x01(\v2#.api.v1alpha1.vanalytics.CorrectionR\n" +
	"correction\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"_\n" +
	"\x18UpdateCorrectionResponse\x12C\n" +
	"\n" +
	"correction\x18\x01 \x01(\v2#.api.v1alpha1.vanalytics.CorrectionR\n" +
	"correction\"^\n" +
	"\x17CreateCorrectionRequest\x12C\n" +
	"\n" +
	"correction\x18\x01 \x01(\v2#.api.v1alpha1.vanalytics.CorrectionR\n" +
	"correction\"_\n" +
	"\x18CreateCorrectionResponse\x12C\n" +
	"\n" +
	"correction\x18\x01 \x01(\v2#.api.v1alpha1.vanalytics.CorrectionR\n" +
	"correction\"=\n" +
	...
	"\x17ListCorrectionsResponse\x12E\n" +
	"\vcorrections\x18\x01 \x03(\v2#.api.v1alpha1.vanalytics.CorrectionR\vcorrections\"X\n" +
	"\x17DeleteCorrectionRequest\x12%\n" +
	"\x0ecorrection_sid\x18\x01 \x01(\x03R\rcorrectionSid\x12\x16\n" +
	"\x06return\x18\x03 \x01(\bR\x06return\"_\n" +
	"\x18DeleteCorrectionResponse\x12C\n" +
	"\n" +
	"correction\x18\x01 \x01(\v2#.api.v1alpha1.vanalytics.CorrectionR\n" +
	"correction\"\x91\x02\n" +
	"\n" +
	...
	"\achannel\x18\a \x01(\rR\achannelB\xe0\x01\n" +
	"\x1bcom.api.v1alpha1.vanalyticsB\x0fCorrectionProtoP\x01Z2github.com/tcncloud/api-go/api/v1alpha1/vanalytics\xa2\x02\x03AVV\xaa\x02\x17Api.V1alpha1.Vanalytics\xca\x02\x17Api\\V1alpha1\\Vanalytics\xe2\x02#Api\\V1alpha1\\Vanalytics\\GPBMetadata\xea\x02\x19Api::V1alpha1::Vanalyticsb\x06proto3"

var (
	file_api_v1alpha1_vanalytics_correction_proto_rawDescOnce sync.Once
	file_api_v1alpha1_vanalytics_correction_proto_rawDescData []byte
)
...
func file_api_v1alpha1_vanalytics_correction_proto_rawDescGZIP() []byte {
	file_api_v1alpha1_vanalytics_correction_proto_rawDescOnce.Do(func() {
		file_api_v1alpha1_vanalytics_correction_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_v1alpha1_vanalytics_correction_proto_rawDesc), len(file_api_v1alpha1_vanalytics_correction_proto_rawDesc)))
	})
...
func file_api_v1alpha1_vanalytics_correction_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_v1alpha1_vanalytics_correction_proto_rawDesc), len(file_api_v1alpha1_vanalytics_correction_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
