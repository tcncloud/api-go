...
const file_api_v1alpha1_vanalytics_transcript_proto_rawDesc = "" +
	"\n" +
	"(api/v1alpha1/vanalytics/transcript.proto\x12\x17api.v1alpha1.vanalytics\x1a\x15api/commons/acd.proto\x1a\x1capi/commons/vanalytics.proto\x1a)api/v1alpha1/vanalytics/aclpb/aclpb.proto\x1a\"api/v1alpha1/vanalytics/expr.proto\x1a0api/v1alpha1/vanalytics/transcript_summary.proto\x1a\x1egoogle/protobuf/duration.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\\\n" +
	"\x1cBulkDeleteTranscriptsRequest\x12<\n" +
	"\x05query\x18\x01 \x01(\v2&.api.v1alpha1.vanalytics.SearchRequestR\x05query\"5\n" +
	"\x1dBulkDeleteTranscriptsResponse\x12\x14\n" +
	"\x05total\x18\x01 \x01(\rR\x05total\"]\n" +
	"\x1dBulkRestoreTranscriptsRequest\x12<\n" +
	"\x05query\x18\x01 \x01(\v2&.api.v1alpha1.vanalytics.SearchRequestR\x05query\"6\n" +
	"\x1eBulkRestoreTranscriptsResponse\x12\x14\n" +
	"\x05total\x18\x01 \x01(\rR\x05total\"\xc1\x17\n" +
	"\rSearchRequest\x12H\n" +
	"\asilence\x18\x02 \x01(\v2..api.v1alpha1.vanalytics.SearchRequest.SilenceR\asilence\x12@\n" +
	"\ttalk_time\x18\x03 \x01(\v2#.api.v1alpha1.vanalytics.Uint32ExprR\btalkTime\x12B\n" +
	"\x05agent\x18\x04 \x01(\v2,.api.v1alpha1.vanalytics.SearchRequest.AgentR\x05agent\x12\x1b\n" +
	"\tpage_size\x18\x05 \x01(\rR\bpageSize\x121\n" +
	"\x04sort\x18\x06 \x01(\v2\x1d.api.v1alpha1.vanalytics.SortR\x04sort\x12G\n" +
	"\vcreate_time\x18\a \x01(\v2&.api.v1alpha1.vanalytics.TimestampExprR\n" +
	"createTime\x12L\n" +
	"\ttalk_over\x18\b \x01(\v2/.api.v1alpha1.vanalytics.SearchRequest.TalkOverR\btalkOver\x12B\n" +
	"\x05terms\x18\t \x01(\v2,.api.v1alpha1.vanalytics.SearchRequest.TermsR\x05terms\x12\x18\n" +
	"\achannel\x18\n" +
	" \x01(\rR\achannel\x12E\n" +
	"\x06phrase\x18\v \x01(\v2-.api.v1alpha1.vanalytics.SearchRequest.PhraseR\x06phrase\x12C\n" +
	"\x0ftranscript_mask\x18\f \x01(\v2\x1a.google.protobuf.FieldMaskR\x0etranscriptMask\x12%\n" +
	"\x0etranscript_sid\x18\r \x01(\x03R\rtranscriptSid\x12!\n" +
	"\fphone_number\x18\x0e \x01(\tR\vphoneNumber\x12\x1b\n" +
	"\tcaller_id\x18\x0f \x01(\tR\bcallerId\x12'\n" +
	"\x0ftranscript_sids\x18\x10 \x03(\x03R\x0etranscriptSids\x12N\n" +
	"\x0fcall_start_time\x18\x11 \x01(\v2&.api.v1alpha1.vanalytics.TimestampExprR\rcallStartTime\x129\n" +
	"\n" +
	"call_types\x18\x12 \x03(\x0e2\x1a.api.commons.CallType.EnumR\tcallTypes\x12\x1b\n" +
	"\tcall_sids\x18\x13 \x03(\x03R\bcallSids\x12&\n" +
	"\x0fhunt_group_sids\x18\x14 \x03(\x03R\rhuntGroupSids\x12\x1f\n" +
	"\vgroup_names\x18\x15 \x03(\tR\n" +
	"groupNames\x12P\n" +
	"\x0eagent_call_log\x18\x16 \x01(\v2*.api.v1alpha1.vanalytics.AgentCallLogQueryR\fagentCallLog\x12:\n" +
	"\x05where\x18\x17 \x01(\v2$.api.v1alpha1.vanalytics.SearchQueryR\x05where\x12C\n" +
	"\n" +
	"time_frame\x18\x18 \x01(\v2$.api.v1alpha1.vanalytics.Uint32RangeR\ttimeFrame\x1a\xa9\x04\n" +
	"\x06Phrase\x12H\n" +
	"\x05words\x18\x01 \x03(\v22.api.v1alpha1.vanalytics.SearchRequest.Phrase.WordR\x05words\x12\x12\n" +
	"\x04slop\x18\x02 \x01(\rR\x04slop\x12\x19\n" +
	"\bin_order\x18\x03 \x01(\bR\ainOrder\x12U\n" +
	"\thighlight\x18\x04 \x01(\v27.api.v1alpha1.vanalytics.SearchRequest.Phrase.HighlightR\thighlight\x12\x10\n" +
	"\x03not\x18\x05 \x01(\bR\x03not\x12B\n" +
	"\x05agent\x18\x06 \x01(\v2,.api.v1alpha1.vanalytics.SearchRequest.AgentR\x05agent\x12\x18\n" +
	"\achannel\x18\a \x01(\rR\achannel\x12^\n" +
	"\x0fposition_offset\x18\b \x01(\v25.api.v1alpha1.vanalytics.SearchRequest.PositionOffsetR\x0epositionOffset\x1a:\n" +
	"\x04Word\x12\x14\n" +
	"\x05value\x18\x01 \x01(\tR\x05value\x12\x1c\n" +
	"\tfuzziness\x18\x02 \x01(\tR\tfuzziness\x1aC\n" +
	"\tHighlight\x12\x19\n" +
	"\bpre_tags\x18\x01 \x03(\tR\apreTags\x12\x1b\n" +
	"\tpost_tags\x18\x02 \x03(\tR\bpostTags\x1ap\n" +
	"\x0ePositionOffset\x12/\n" +
	"\x05start\x18\x01 \x01(\v2\x19.google.protobuf.DurationR\x05start\x12-\n" +
	"\x04stop\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\x04stop\x1a\xc3\x02\n" +
	"\aSilence\x12J\n" +
	"\x0eduration_total\x18\x01 \x01(\v2#.api.v1alpha1.vanalytics.Uint32ExprR\rdurationTotal\x12F\n" +
	"\fduration_max\x18\x02 \x01(\v2#.api.v1alpha1.vanalytics.Uint32ExprR\vdurationMax\x12N\n" +
	"\x10occurrence_total\x18\x03 \x01(\v2#.api.v1alpha1.vanalytics.Uint32ExprR\x0foccurrenceTotal\x12T\n" +
	"\x13duration_percentage\x18\x04 \x01(\v2#.api.v1alpha1.vanalytics.Uint32ExprR\x12durationPercentage\x1a\xc4\x02\n" +
	"\bTalkOver\x12J\n" +
	"\x0eduration_total\x18\x01 \x01(\v2#.api.v1alpha1.vanalytics.Uint32ExprR\rdurationTotal\x12F\n" +
	"\fduration_max\x18\x02 \x01(\v2#.api.v1alpha1.vanalytics.Uint32ExprR\vdurationMax\x12N\n" +
	"\x10occurrence_total\x18\x03 \x01(\v2#.api.v1alpha1.vanalytics.Uint32ExprR\x0foccurrenceTotal\x12T\n" +
	"\x13duration_percentage\x18\x04 \x01(\v2#.api.v1alpha1.vanalytics.Uint32ExprR\x12durationPercentage\x1a\xfb\x01\n" +
	"\x05Terms\x12\x10\n" +
	"\x03any\x18\x01 \x03(\tR\x03any\x12\x10\n" +
	"\x03all\x18\x02 \x03(\tR\x03all\x12\x10\n" +
	"\x03not\x18\x03 \x01(\bR\x03not\x12B\n" +
	"\x05agent\x18\x04 \x01(\v2,.api.v1alpha1.vanalytics.SearchRequest.AgentR\x05agent\x12\x18\n" +
	"\achannel\x18\x05 \x01(\rR\achannel\x12^\n" +
	"\x0fposition_offset\x18\x06 \x01(\v25.api.v1alpha1.vanalytics.SearchRequest.PositionOffsetR\x0epositionOffset\x1a\x8b\x01\n" +
	"\x05Agent\x12R\n" +
	"\tuser_name\x18\x01 \x01(\v25.api.v1alpha1.vanalytics.SearchRequest.Agent.UserNameR\buserName\x1a.\n" +
	"\bUserName\x12\x10\n" +
	"\x03any\x18\x01 \x03(\tR\x03any\x12\x10\n" +
	"\x03all\x18\x02 \x03(\tR\x03allJ\x04\b\x01\x10\x02\"\xcd(\n" +
	"\vSearchQuery\x12Y\n" +
	"\x0etranscript_sid\x18\x01 \x01(\v22.api.v1alpha1.vanalytics.SearchQuery.TranscriptSidR\rtranscriptSid\x12S\n" +
	"\fflag_summary\x18\x02 \x01(\v20.api.v1alpha1.vanalytics.SearchQuery.FlagSummaryR\vflagSummary\x124\n" +
	"\x02or\x18\x03 \x03(\v2$.api.v1alpha1.vanalytics.SearchQueryR\x02or\x126\n" +
	"\x03and\x18\x04 \x03(\v2$.api.v1alpha1.vanalytics.SearchQueryR\x03and\x12M\n" +
	"\n" +
	"audio_time\x18\x05 \x01(\v2..api.v1alpha1.vanalytics.SearchQuery.AudioTimeR\taudioTime\x12P\n" +
	"\vdelete_time\x18\x06 \x01(\v2/.api.v1alpha1.vanalytics.SearchQuery.DeleteTimeR\n" +
	"deleteTime\x126\n" +
	"\x03not\x18\a \x01(\v2$.api.v1alpha1.vanalytics.SearchQueryR\x03not\x12F\n" +
	"\aresults\x18\b \x01(\v2,.api.v1alpha1.vanalytics.SearchQuery.ResultsR\aresults\x12Y\n" +
	"\x0eagent_response\x18\t \x01(\v22.api.v1alpha1.vanalytics.SearchQuery.AgentResponseR\ragentResponse\x12W\n" +
	"\x0eagent_call_log\x18\n" +
	" \x01(\v21.api.v1alpha1.vanalytics.SearchQuery.AgentCallLogR\fagentCallLog\x12@\n" +
	"\x05phone\x18\v \x01(\v2*.api.v1alpha1.vanalytics.SearchQuery.PhoneR\x05phone\x1a\xf5\x05\n" +
	"\x05Phone\x127\n" +
	"\x02cc\x18\x01 \x01(\v2'.api.v1alpha1.vanalytics.SearchQuery.CcR\x02cc\x12:\n" +
	"\x03ndc\x18\x02 \x01(\v2(.api.v1alpha1.vanalytics.SearchQuery.NdcR\x03ndc\x12C\n" +
	"\x06prefix\x18\x03 \x01(\v2+.api.v1alpha1.vanalytics.SearchQuery.PrefixR\x06prefix\x12=\n" +
	"\x04city\x18\x04 \x01(\v2).api.v1alpha1.vanalytics.SearchQuery.CityR\x04city\x12=\n" +
	"\x04iso2\x18\x05 \x01(\v2).api.v1alpha1.vanalytics.SearchQuery.Iso2R\x04iso2\x12P\n" +
	"\vregion_code\x18\x06 \x01(\v2/.api.v1alpha1.vanalytics.SearchQuery.RegionCodeR\n" +
	"regionCode\x12P\n" +
	"\vregion_name\x18\a \x01(\v2/.api.v1alpha1.vanalytics.SearchQuery.RegionNameR\n" +
	"regionName\x12J\n" +
	"\ttime_zone\x18\b \x01(\v2-.api.v1alpha1.vanalytics.SearchQuery.TimeZoneR\btimeZone\x12=\n" +
	"\x04type\x18\t \x01(\v2).api.v1alpha1.vanalytics.SearchQuery.TypeR\x04type\x12:\n" +
	"\x03utc\x18\n" +
	" \x01(\v2(.api.v1alpha1.vanalytics.SearchQuery.UtcR\x03utc\x12I\n" +
	"\blocation\x18\v \x01(\v2-.api.v1alpha1.vanalytics.SearchQuery.LocationR\blocation\x1a\x14\n" +
	"\x02Cc\x12\x0e\n" +
	...
	"\bLocation\x12l\n" +
	"\x12zip_code_proximity\x18\x01 \x01(\v2>.api.v1alpha1.vanalytics.SearchQuery.Location.ZipCodeProximityR\x10zipCodeProximity\x1al\n" +
	"\x10ZipCodeProximity\x12!\n" +
	"\fcountry_code\x18\x01 \x01(\tR\vcountryCode\x12\x19\n" +
	"\bzip_code\x18\x02 \x01(\tR\azipCode\x12\x1a\n" +
	"\bdistance\x18\x03 \x01(\tR\bdistance\x1a\xc5\x01\n" +
	"\fAgentCallLog\x12f\n" +
	"\x13call_skills_initial\x18\x01 \x01(\v26.api.v1alpha1.vanalytics.SearchQuery.CallSkillsInitialR\x11callSkillsInitial\x12M\n" +
	"\n" +
	"call_ended\x18\x02 \x01(\v2..api.v1alpha1.vanalytics.SearchQuery.CallEndedR\tcallEnded\x1aI\n" +
	"\tCallEnded\x12<\n" +
	"\areasons\x18\x01 \x03(\x0e2\".api.commons.AgentCallLogCallEndedR\areasons\x1a;\n" +
	"\x11CallSkillsInitial\x12\x12\n" +
	"\x04need\x18\x01 \x03(\tR\x04need\x12\x12\n" +
	"\x04want\x18\x02 \x03(\tR\x04want\x1a\xb3\x05\n" +
	"\rAgentResponse\x12H\n" +
	"\x03key\x18\x01 \x01(\v26.api.v1alpha1.vanalytics.SearchQuery.AgentResponse.KeyR\x03key\x12Q\n" +
	"\x06values\x18\x02 \x01(\v29.api.v1alpha1.vanalytics.SearchQuery.AgentResponse.ValuesR\x06values\x12T\n" +
	"\anumbers\x18\x03 \x01(\v2:.api.v1alpha1.vanalytics.SearchQuery.AgentResponse.NumbersR\anumbers\x1aU\n" +
	"\x06Values\x12\x0e\n" +
	...
	"\vstarts_with\x18\x02 \x01(\tR\n" +
	"startsWith\x12\x1a\n" +
	"\bcontains\x18\x03 \x01(\tR\bcontains\x1a\xf5\x05\n" +
	"\aResults\x12N\n" +
	"\achannel\x18\x01 \x01(\v24.api.v1alpha1.vanalytics.SearchQuery.Results.ChannelR\achannel\x12b\n" +
	"\x0fagent_user_name\x18\x02 \x01(\v2:.api.v1alpha1.vanalytics.SearchQuery.Results.AgentUserNameR\ragentUserName\x12Q\n" +
	"\bsegments\x18\x03 \x01(\v25.api.v1alpha1.vanalytics.SearchQuery.Results.SegmentsR\bsegments\x1a\x19\n" +
	"\aChannel\x12\x0e\n" +
	"\x02eq\x18\x01 \x01(\rR\x02eq\x1a3\n" +
	"\rAgentUserName\x12\x10\n" +
	"\x03any\x18\x01 \x03(\tR\x03any\x12\x10\n" +
	"\x03all\x18\x02 \x03(\tR\x03all\x1a\x92\x03\n" +
	"\bSegments\x12N\n" +
	"\x04text\x18\x01 \x01(\v2:.api.v1alpha1.vanalytics.SearchQuery.Results.Segments.TextR\x04text\x1a\xb5\x02\n" +
	"\x04Text\x12Y\n" +
	"\x06phrase\x18\x01 \x01(\v2A.api.v1alpha1.vanalytics.SearchQuery.Results.Segments.Text.PhraseR\x06phrase\x1a\xd1\x01\n" +
	"\x06Phrase\x12\\\n" +
	"\x05words\x18\x01 \x03(\v2F.api.v1alpha1.vanalytics.SearchQuery.Results.Segments.Text.Phrase.WordR\x05words\x12\x12\n" +
	"\x04slop\x18\x02 \x01(\rR\x04slop\x12\x19\n" +
	"\bin_order\x18\x03 \x01(\bR\ainOrder\x1a:\n" +
	"\x04Word\x12\x14\n" +
	"\x05value\x18\x01 \x01(\tR\x05value\x12\x1c\n" +
	"\tfuzziness\x18\x02 \x01(\tR\tfuzziness\x1a@\n" +
	"\n" +
	"DeleteTime\x122\n" +
	"\x06exists\x18\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\x06exists\x1aP\n" +
	"\rTranscriptSid\x12\x10\n" +
	"\x03any\x18\x01 \x03(\x03R\x03any\x12-\n" +
	"\x03gte\x18\x02 \x01(\v2\x1b.google.protobuf.Int64ValueR\x03gte\x1a\xc3\x01\n" +
	"\tAudioTime\x12-\n" +
	...
	"\x02lt\x18\x04 \x01(\v2\x1b.google.protobuf.Int32ValueR\x02lt\x1a\xd1\a\n" +
	"\vFlagSummary\x12\\\n" +
	"\vneed_review\x18\x01 \x01(\v2;.api.v1alpha1.vanalytics.SearchQuery.FlagSummary.NeedReviewR\n" +
	"needReview\x12b\n" +
	"\rreview_status\x18\x02 \x01(\v2=.api.v1alpha1.vanalytics.SearchQuery.FlagSummary.ReviewStatusR\freviewStatus\x12L\n" +
	"\x05flags\x18\x03 \x01(\v26.api.v1alpha1.vanalytics.SearchQuery.FlagSummary.FlagsR\x05flags\x12L\n" +
	"\x05count\x18\x04 \x01(\v26.api.v1alpha1.vanalytics.SearchQuery.FlagSummary.CountR\x05count\x1a\x8d\x01\n" +
	"\n" +
	"NeedReview\x12a\n" +
	"\tflag_sids\x18\x01 \x01(\v2D.api.v1alpha1.vanalytics.SearchQuery.FlagSummary.NeedReview.FlagSidsR\bflagSids\x1a\x1c\n" +
	"\bFlagSids\x12\x10\n" +
	"\x03any\x18\x01 \x03(\x03R\x03any\x1aQ\n" +
	"\fReviewStatus\x12A\n" +
	"\x03any\x18\x01 \x03(\x0e2/.api.v1alpha1.vanalytics.TranscriptReviewStatusR\x03any\x1a\x91\x01\n" +
	"\x05Flags\x12Y\n" +
	"\bflag_sid\x18\x01 \x01(\v2>.api.v1alpha1.vanalytics.SearchQuery.FlagSummary.Flags.FlagSidR\aflagSid\x1a-\n" +
	"\aFlagSid\x12\x10\n" +
	...
	"\x02eq\x18\x05 \x01(\v2\x1b.google.protobuf.Int32ValueR\x02eq\"\xe6\x01\n" +
	"\x0eSearchResponse\x12\x14\n" +
	"\x05total\x18\x01 \x01(\x04R\x05total\x12?\n" +
	"\x04hits\x18\x04 \x03(\v2+.api.v1alpha1.vanalytics.SearchResponse.HitR\x04hits\x121\n" +
	"\x04sort\x18\x05 \x01(\v2\x1d.api.v1alpha1.vanalytics.SortR\x04sort\x1aJ\n" +
	"\x03Hit\x12C\n" +
	"\n" +
	"transcript\x18\x01 \x01(\v2#.api.v1alpha1.vanalytics.TranscriptR\n" +
	"transcript\"t\n" +
	"\x11AgentCallLogQuery\x12_\n" +
	"\x13call_skills_initial\x18\x01 \x01(\v2/.api.v1alpha1.vanalytics.CallSkillsInitialQueryR\x11callSkillsInitial\"\x92\x01\n" +
	"\x16CallSkillsInitialQuery\x12;\n" +
	"\x04need\x18\x01 \x03(\v2'.api.v1alpha1.vanalytics.VanaTermsQueryR\x04need\x12;\n" +
	"\x04want\x18\x02 \x03(\v2'.api.v1alpha1.vanalytics.VanaTermsQueryR\x04want\"N\n" +
	"\x0eVanaTermsQuery\x12\x14\n" +
	"\x05terms\x18\x01 \x03(\tR\x05terms\x12\x14\n" +
	"\x05lacks\x18\x02 \x01(\bR\x05lacks\x12\x10\n" +
	"\x03all\x18\x03 \x01(\bR\x03all\"\x8a\x01\n" +
	"\x04Sort\x12;\n" +
	"\x06fields\x18\x01 \x03(\v2#.api.v1alpha1.vanalytics.Sort.FieldR\x06fields\x12\x14\n" +
	"\x05after\x18\x02 \x03(\tR\x05after\x1a/\n" +
	"\x05Field\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x12\n" +
	"\x04desc\x18\x02 \x01(\bR\x04desc\"!\n" +
	"\x1fListTranscriptGroupNamesRequest\"q\n" +
	" ListTranscriptGroupNamesResponse\x12M\n" +
	"\vgroup_names\x18\x01 \x03(\v2,.api.v1alpha1.vanalytics.TranscriptGroupNameR\n" +
	"groupNames\"+\n" +
	...
	"\aresults\x18\x05 \x03(\v2\x1f.api.v1alpha1.vanalytics.ResultR\aresults\x12:\n" +
	"\asilence\x18\x06 \x01(\v2 .api.v1alpha1.vanalytics.SilenceR\asilence\x12\x1b\n" +
	"\ttalk_time\x18\a \x01(\rR\btalkTime\x12;\n" +
	"\vcreate_time\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"createTime\x12B\n" +
	"\x0fcall_start_time\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampR\rcallStartTime\x12>\n" +
	"\ttalk_over\x18\v \x01(\v2!.api.v1alpha1.vanalytics.TalkOverR\btalkOver\x12\x1b\n" +
	...
	"\vaudio_bytes\x18\x0f \x01(\x03R\n" +
	"audioBytes\x12\x1d\n" +
	"\n" +
	"group_name\x18\x11 \x01(\tR\tgroupName\x12Q\n" +
	"\x0eagent_call_log\x18\x12 \x01(\v2+.api.v1alpha1.vanalytics.aclpb.AgentCallLogR\fagentCallLog\x12G\n" +
	"\fflag_summary\x18\x13 \x01(\v2$.api.v1alpha1.vanalytics.FlagSummaryR\vflagSummary\x12;\n" +
	"\vdelete_time\x18\x14 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"deleteTime\x12#\n" +
	"\rnumber_format\x18\x15 \x01(\tR\fnumberFormat\x12]\n" +
	"\x0eagent_response\x18\x16 \x03(\v26.api.v1alpha1.vanalytics.Transcript.AgentResponseEntryR\ragentResponse\x12D\n" +
	"\asummary\x18\x18 \x01(\v2*.api.v1alpha1.vanalytics.TranscriptSummaryR\asummary\x1ah\n" +
	"\x12AgentResponseEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12<\n" +
	"\x05value\x18\x02 \x01(\v2&.api.v1alpha1.vanalytics.AgentResponseR\x05value:\x028\x01\"\x91\x03\n" +
	"\x06Result\x12\x18\n" +
	"\achannel\x18\x01 \x01(\x05R\achannel\x12<\n" +
	"\bsegments\x18\x02 \x03(\v2 .api.v1alpha1.vanalytics.SegmentR\bsegments\x12(\n" +
	"\x10agent_first_name\x18\x05 \x01(\tR\x0eagentFirstName\x12&\n" +
	"\x0fagent_last_name\x18\x06 \x01(\tR\ragentLastName\x12&\n" +
	"\x0fagent_user_name\x18\a \x01(\tR\ragentUserName\x12\x1d\n" +
	"\n" +
	"begin_time\x18\b \x01(\rR\tbeginTime\x12\x1a\n" +
	"\bduration\x18\t \x01(\rR\bduration\x12\x12\n" +
	"\x04text\x18\n" +
	" \x01(\tR\x04text\x12$\n" +
	"\x0ehunt_group_sid\x18\v \x01(\x03R\fhuntGroupSid\x12@\n" +
	"\tsentiment\x18\f \x01(\v2\".api.v1alpha1.vanalytics.SentimentR\tsentiment\"\xeb\x04\n" +
	"\tSentiment\x12E\n" +
	"\aoverall\x18\x01 \x01(\v2+.api.v1alpha1.vanalytics.Sentiment.EstimateR\aoverall\x12:\n" +
	...
	"\x04last\x18\x04 \x01(\x0e2$.api.commons.TranscriptSentimentToneR\x04last\x12C\n" +
	"\asamples\x18\x05 \x03(\v2).api.v1alpha1.vanalytics.Sentiment.SampleR\asamples\x1a\xbb\x01\n" +
	"\x06Sample\x12G\n" +
	"\bestimate\x18\x01 \x01(\v2+.api.v1alpha1.vanalytics.Sentiment.EstimateR\bestimate\x121\n" +
	...
	"\bnegative\x18\x03 \x01(\x02R\bnegative\"\xad\x01\n" +
	"\aSegment\x12\x1d\n" +
	"\n" +
	...
	"\x05words\x18\x05 \x03(\v2\x1d.api.v1alpha1.vanalytics.WordR\x05words\"\x95\x01\n" +
	"\x04Word\x12\x1d\n" +
	"\n" +
	"begin_time\x18\x01 \x01(\rR\tbeginTime\x12\x1e\n" +
	"\n" +
	...
	"\bredacted\x18\x05 \x01(\bR\bredacted\"\xbf\x03\n" +
	"\aSilence\x12E\n" +
	"\bduration\x18\x01 \x01(\v2).api.v1alpha1.vanalytics.Silence.DurationR\bduration\x12D\n" +
	"\bsegments\x18\x02 \x03(\v2(.api.v1alpha1.vanalytics.Silence.SegmentR\bsegments\x12K\n" +
	"\n" +
	"occurrence\x18\x03 \x01(\v2+.api.v1alpha1.vanalytics.Silence.OccurrenceR\n" +
	"occurrence\x12\x1c\n" +
	...
	"\bduration\x18\x02 \x01(\rR\bduration\x1a\"\n" +
	"\n" +
	"Occurrence\x12\x14\n" +
	"\x05total\x18\x01 \x01(\rR\x05total\"\x96\x06\n" +
	"\bTalkOver\x12L\n" +
	"\n" +
	"occurrence\x18\x01 \x01(\v2,.api.v1alpha1.vanalytics.TalkOver.OccurrenceR\n" +
	"occurrence\x12F\n" +
	"\bduration\x18\x02 \x01(\v2*.api.v1alpha1.vanalytics.TalkOver.DurationR\bduration\x12B\n" +
	"\aresults\x18\x03 \x03(\v2(.api.v1alpha1.vanalytics.TalkOver.ResultR\aresults\x12\x1c\n" +
	"\tthreshold\x18\x04 \x01(\rR\tthreshold\x1aR\n" +
	"\bDuration\x12\x14\n" +
	"\x05total\x18\x01 \x01(\rR\x05total\x12\x10\n" +
	"\x03max\x18\x02 \x01(\rR\x03max\x12\x1e\n" +
	...
	"\x06Result\x12\x18\n" +
	"\achannel\x18\x01 \x01(\x05R\achannel\x12L\n" +
	"\n" +
	"occurrence\x18\x02 \x01(\v2,.api.v1alpha1.vanalytics.TalkOver.OccurrenceR\n" +
	"occurrence\x12F\n" +
	"\bduration\x18\x03 \x01(\v2*.api.v1alpha1.vanalytics.TalkOver.DurationR\bduration\x12E\n" +
	"\bsegments\x18\x04 \x03(\v2).api.v1alpha1.vanalytics.TalkOver.SegmentR\bsegments\x12&\n" +
	"\x0fagent_user_name\x18\x05 \x01(\tR\ragentUserName\x12*\n" +
	"\x11agent_session_sid\x18\x06 \x01(\x03R\x0fagentSessionSid\x1aD\n" +
	"\aSegment\x12\x1d\n" +
	"\n" +
	"begin_time\x18\x01 \x01(\rR\tbeginTime\x12\x1a\n" +
	"\bduration\x18\x02 \x01(\rR\bduration\x1a\"\n" +
	"\n" +
	"Occurrence\x12\x14\n" +
	"\x05total\x18\x01 \x01(\rR\x05total\"\xff\a\n" +
	"\vFlagSummary\x12\x14\n" +
	"\x05count\x18\x01 \x01(\x05R\x05count\x12!\n" +
	"\fpriority_sum\x18\x02 \x01(\x05R\vprioritySum\x12!\n" +
	"\fpriority_max\x18\x03 \x01(\x05R\vpriorityMax\x12P\n" +
	"\vneed_review\x18\x04 \x01(\v2/.api.v1alpha1.vanalytics.FlagSummary.NeedReviewR\n" +
	"needReview\x12?\n" +
	"\x05flags\x18\x05 \x03(\v2).api.v1alpha1.vanalytics.FlagSummary.FlagR\x05flags\x12T\n" +
	"\rreview_status\x18\x06 \x01(\x0e2/.api.v1alpha1.vanalytics.TranscriptReviewStatusR\freviewStatus\x1a\x85\x01\n" +
	"\n" +
	"NeedReview\x12!\n" +
	...
	"\tflag_sids\x18\x04 \x03(\x03R\bflagSids\x1a\xbb\x02\n" +
	"\x04Flag\x12\x19\n" +
	...
	"\afilters\x18\x05 \x03(\v2+.api.v1alpha1.vanalytics.FlagSummary.FilterR\afilters\x12\x1f\n" +
	"\vmust_review\x18\x06 \x01(\bR\n" +
	"mustReview\x12\x1f\n" +
	"\vmust_notify\x18\a \x01(\bR\n" +
	"mustNotify\x12E\n" +
	"\areviews\x18\b \x03(\v2+.api.v1alpha1.vanalytics.FlagSummary.ReviewR\areviews\x1a\x8b\x01\n" +
	"\x06Filter\x12\x19\n" +
	...
	"\x04sort\x18\x03 \x01(\v2\x1d.api.v1alpha1.vanalytics.SortR\x04sort\x12C\n" +
	"\x0ftranscript_mask\x18\x04 \x01(\v2\x1a.google.protobuf.FieldMaskR\x0etranscriptMask\x12S\n" +
	"\fflag_summary\x18\x05 \x01(\v20.api.v1alpha1.vanalytics.SearchQuery.FlagSummaryR\vflagSummary\x12\x16\n" +
	"\x06filter\x18\x06 \x01(\tR\x06filter*\x81\x01\n" +
	"\x16TranscriptReviewStatus\x12!\n" +
	"\x1dTRANSCRIPT_REVIEW_STATUS_TODO\x10\x00\x12!\n" +
	"\x1dTRANSCRIPT_REVIEW_STATUS_DONE\x10\x01\x12!\n" +
	"\x1dTRANSCRIPT_REVIEW_STATUS_NONE\x10\x02B\xe0\x01\n" +
	"\x1bcom.api.v1alpha1.vanalyticsB\x0fTranscriptProtoP\x01Z2github.com/tcncloud/api-go/api/v1alpha1/vanalytics\xa2\x02\x03AVV\xaa\x02\x17Api.V1alpha1.Vanalytics\xca\x02\x17Api\\V1alpha1\\Vanalytics\xe2\x02#Api\\V1alpha1\\Vanalytics\\GPBMetadata\xea\x02\x19Api::V1alpha1::Vanalyticsb\x06proto3"

var (
	file_api_v1alpha1_vanalytics_transcript_proto_rawDescOnce sync.Once
	file_api_v1alpha1_vanalytics_transcript_proto_rawDescData []byte
)
...
func file_api_v1alpha1_vanalytics_transcript_proto_rawDescGZIP() []byte {
	file_api_v1alpha1_vanalytics_transcript_proto_rawDescOnce.Do(func() {
		file_api_v1alpha1_vanalytics_transcript_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_v1alpha1_vanalytics_transcript_proto_rawDesc), len(file_api_v1alpha1_vanalytics_transcript_proto_rawDesc)))
	})
...
func file_api_v1alpha1_vanalytics_transcript_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_v1alpha1_vanalytics_transcript_proto_rawDesc), len(file_api_v1alpha1_vanalytics_transcript_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   88,
			NumExtensions: 0,
			NumServices:   0,
