...
func (x *DeleteQuestionCategoryRequest) GetQuestionCategoryId() int64 {
	if x != nil {
		if x, ok := x.Where.(*DeleteQuestionCategoryRequest_QuestionCategoryId); ok {
			return x.QuestionCategoryId
		}
	}
	return 0
...
func (x *DeleteQuestionCategoryRequest) GetBothIds() *DeleteQuestionCategoryRequest_BothIds {
	if x != nil {
		if x, ok := x.Where.(*DeleteQuestionCategoryRequest_BothIds_); ok {
			return x.BothIds
		}
	}
	return nil
...
const file_api_v1alpha1_scorecards_question_proto_rawDesc = "" +
	"\n" +
	"&api/v1alpha1/scorecards/question.proto\x12\x17api.v1alpha1.scorecards\x1a\x1capi/commons/scorecards.proto\x1a google/protobuf/field_mask.proto\"J\n" +
	"\x15CreateQuestionRequest\x121\n" +
	"\bquestion\x18\x01 \x01(\v2\x15.api.commons.QuestionR\bquestion\"K\n" +
	"\x16CreateQuestionResponse\x121\n" +
	"\bquestion\x18\x01 \x01(\v2\x15.api.commons.QuestionR\bquestion\"X\n" +
	"\x14ListQuestionsRequest\x12\x1d\n" +
	"\n" +
	"author_ids\x18\x02 \x03(\tR\tauthorIds\x12!\n" +
	"\fcategory_ids\x18\x03 \x03(\x03R\vcategoryIds\"L\n" +
	"\x15ListQuestionsResponse\x123\n" +
	"\tquestions\x18\x01 \x03(\v2\x15.api.commons.QuestionR\tquestions\"\x87\x01\n" +
	"\x15UpdateQuestionRequest\x121\n" +
	"\bquestion\x18\x01 \x01(\v2\x15.api.commons.QuestionR\bquestion\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"K\n" +
	"\x16UpdateQuestionResponse\x121\n" +
	"\bquestion\x18\x01 \x01(\v2\x15.api.commons.QuestionR\bquestion\"8\n" +
	"\x15DeleteQuestionRequest\x12\x1f\n" +
	"\vquestion_id\x18\x02 \x01(\x03R\n" +
	"questionId\"K\n" +
	"\x16DeleteQuestionResponse\x121\n" +
	"\bquestion\x18\x01 \x01(\v2\x15.api.commons.QuestionR\bquestion\"Q\n" +
	"\x12GetQuestionRequest\x12\x1f\n" +
	"\vquestion_id\x18\x02 \x01(\x03R\n" +
	"questionId\x12\x1a\n" +
	"\bquestion\x18\x03 \x01(\tR\bquestion\"H\n" +
	"\x13GetQuestionResponse\x121\n" +
	"\bquestion\x18\x01 \x01(\v2\x15.api.commons.QuestionR\bquestion\"a\n" +
	"\x1dCreateQuestionCategoryRequest\x12\x1f\n" +
	"\vquestion_id\x18\x02 \x01(\x03R\n" +
	"questionId\x12\x1f\n" +
	"\vcategory_id\x18\x03 \x01(\x03R\n" +
	"categoryId\"\x94\x01\n" +
	"\x1eCreateQuestionCategoryResponse\x12\x1f\n" +
	"\vquestion_id\x18\x02 \x01(\x03R\n" +
	"questionId\x12\x1f\n" +
	"\vcategory_id\x18\x03 \x01(\x03R\n" +
	"categoryId\x120\n" +
	"\x14question_category_id\x18\x04 \x01(\x03R\x12questionCategoryId\"\x86\x02\n" +
	"\x1dDeleteQuestionCategoryRequest\x122\n" +
	"\x14question_category_id\x18\x02 \x01(\x03H\x00R\x12questionCategoryId\x12[\n" +
	"\bboth_ids\x18\x03 \x01(\v2>.api.v1alpha1.scorecards.DeleteQuestionCategoryRequest.BothIdsH\x00R\abothIds\x1aK\n" +
	"\aBothIds\x12\x1f\n" +
	...
	"categoryIdB\a\n" +
	"\x05where\"\x94\x01\n" +
	"\x1eDeleteQuestionCategoryResponse\x12\x1f\n" +
	"\vquestion_id\x18\x02 \x01(\x03R\n" +
	"questionId\x12\x1f\n" +
	"\vcategory_id\x18\x03 \x01(\x03R\n" +
	"categoryId\x120\n" +
	"\x14question_category_id\x18\x04 \x01(\x03R\x12questionCategoryId\"`\n" +
	"\x1aBulkCreateQuestionsRequest\x12!\n" +
	"\fscorecard_id\x18\x03 \x01(\x03R\vscorecardId\x12\x1f\n" +
	"\vuse_default\x18\x04 \x01(\bR\n" +
	"useDefault\"R\n" +
	"\x1bBulkCreateQuestionsResponse\x123\n" +
	"\tquestions\x18\x01 \x03(\v2\x15.api.commons.QuestionR\tquestionsB\xde\x01\n" +
	"\x1bcom.api.v1alpha1.scorecardsB\rQuestionProtoP\x01Z2github.com/tcncloud/api-go/api/v1alpha1/scorecards\xa2\x02\x03AVS\xaa\x02\x17Api.V1alpha1.Scorecards\xca\x02\x17Api\\V1alpha1\\Scorecards\xe2\x02#Api\\V1alpha1\\Scorecards\\GPBMetadata\xea\x02\x19Api::V1alpha1::Scorecardsb\x06proto3"

var (
	file_api_v1alpha1_scorecards_question_proto_rawDescOnce sync.Once
	file_api_v1alpha1_scorecards_question_proto_rawDescData []byte
)
...
func file_api_v1alpha1_scorecards_question_proto_rawDescGZIP() []byte {
	file_api_v1alpha1_scorecards_question_proto_rawDescOnce.Do(func() {
		file_api_v1alpha1_scorecards_question_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_v1alpha1_scorecards_question_proto_rawDesc), len(file_api_v1alpha1_scorecards_question_proto_rawDesc)))
	})
...
var file_api_v1alpha1_scorecards_question_proto_goTypes = []any{
...
func file_api_v1alpha1_scorecards_question_proto_init() {
	...
	file_api_v1alpha1_scorecards_question_proto_msgTypes[12].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_v1alpha1_scorecards_question_proto_rawDesc), len(file_api_v1alpha1_scorecards_question_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   17,
			NumExtensions: 0,
			NumServices:   0,
