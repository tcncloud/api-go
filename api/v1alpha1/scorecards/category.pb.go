...
const file_api_v1alpha1_scorecards_category_proto_rawDesc = "" +
	"\n" +
	"&api/v1alpha1/scorecards/category.proto\x12\x17api.v1alpha1.scorecards\x1a\x15api/commons/acd.proto\x1a\x1capi/commons/scorecards.proto\x1a\x1egoogle/protobuf/duration.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"J\n" +
	"\x15CreateCategoryRequest\x121\n" +
	"\bcategory\x18\x01 \x01(\v2\x15.api.commons.CategoryR\bcategory\"K\n" +
	"\x16CreateCategoryResponse\x121\n" +
	"\bcategory\x18\x01 \x01(\v2\x15.api.commons.CategoryR\bcategory\"\xad\x02\n" +
	...
	"\n" +
	"call_types\x18\x04 \x03(\x0e2\x1a.api.commons.CallType.EnumB\x02\x18\x01R\tcallTypes\x12`\n" +
	"\rcategory_type\x18\x05 \x01(\x0e2;.api.v1alpha1.scorecards.ListCategoriesRequest.CategoryTypeR\fcategoryType\"-\n" +
	"\fCategoryType\x12\a\n" +
	"\x03ANY\x10\x00\x12\n" +
	"\n" +
	...
	"\n" +
	"categories\x18\x01 \x03(\v2\x15.api.commons.CategoryR\n" +
	"categories\"\x87\x01\n" +
	"\x15UpdateCategoryRequest\x121\n" +
	"\bcategory\x18\x01 \x01(\v2\x15.api.commons.CategoryR\bcategory\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"K\n" +
	"\x16UpdateCategoryResponse\x121\n" +
	"\bcategory\x18\x01 \x01(\v2\x15.api.commons.CategoryR\bcategory\"8\n" +
	"\x15DeleteCategoryRequest\x12\x1f\n" +
	"\vcategory_id\x18\x02 \x01(\x03R\n" +
	"categoryId\"K\n" +
	"\x16DeleteCategoryResponse\x121\n" +
	"\bcategory\x18\x01 \x01(\v2\x15.api.commons.CategoryR\bcategory\"K\n" +
	...
	"\bcategory\x18\x01 \x01(\v2\x15.api.commons.CategoryR\bcategory\"\xdd\x02\n" +
	...
	"\x0eagent_user_ids\x18\a \x03(\tR\fagentUserIds\x12!\n" +
	"\fscorecard_id\x18\n" +
	" \x01(\x03R\vscorecardId\"j\n" +
	"\x1dSampleCallsByCategoryResponse\x12I\n" +
	"\vagent_calls\x18\x01 \x03(\v2(.api.v1alpha1.scorecards.SampleAgentCallR\n" +
	"agentCalls\"\xec\x02\n" +
	"\x0fSampleAgentCall\x12\x19\n" +
	"\bcall_sid\x18\x01 \x01(\x03R\acallSid\x127\n" +
	"\tcall_type\x18\x02 \x01(\x0e2\x1a.api.commons.CallType.EnumR\bcallType\x129\n" +
	"\n" +
	"call_start\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\tcallStart\x12>\n" +
	"\rcall_duration\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fcallDuration\x121\n" +
	"\x06speech\x18\x05 \x01(\v2\x19.google.protobuf.DurationR\x06speech\x123\n" +
	"\asilence\x18\x06 \x01(\v2\x19.google.protobuf.DurationR\asilence\x12\"\n" +
	"\ragent_user_id\x18\a \x01(\tR\vagentUserId\"\x93\x02\n" +
	...
	"\rcategory_type\x18\x04 \x01(\x0e2B.api.v1alpha1.scorecards.ListCategoriesByOrgIdRequest.CategoryTypeR\fcategoryType\"-\n" +
	"\fCategoryType\x12\a\n" +
	"\x03ANY\x10\x00\x12\n" +
	"\n" +
	"\x06SYSTEM\x10\x01\x12\b\n" +
	"\x04USER\x10\x02B\xde\x01\n" +
	"\x1bcom.api.v1alpha1.scorecardsB\rCategoryProtoP\x01Z2github.com/tcncloud/api-go/api/v1alpha1/scorecards\xa2\x02\x03AVS\xaa\x02\x17Api.V1alpha1.Scorecards\xca\x02\x17Api\\V1alpha1\\Scorecards\xe2\x02#Api\\V1alpha1\\Scorecards\\GPBMetadata\xea\x02\x19Api::V1alpha1::Scorecardsb\x06proto3"

var (
	file_api_v1alpha1_scorecards_category_proto_rawDescOnce sync.Once
	file_api_v1alpha1_scorecards_category_proto_rawDescData []byte
)
...
func file_api_v1alpha1_scorecards_category_proto_rawDescGZIP() []byte {
	file_api_v1alpha1_scorecards_category_proto_rawDescOnce.Do(func() {
		file_api_v1alpha1_scorecards_category_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_v1alpha1_scorecards_category_proto_rawDesc), len(file_api_v1alpha1_scorecards_category_proto_rawDesc)))
	})
...
var file_api_v1alpha1_scorecards_category_proto_goTypes = []any{
...
func file_api_v1alpha1_scorecards_category_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_v1alpha1_scorecards_category_proto_rawDesc), len(file_api_v1alpha1_scorecards_category_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   14,
			NumExtensions: 0,
			NumServices:   0,
