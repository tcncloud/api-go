...
var file_api_v1alpha1_scorecards_scorecard_question_proto_rawDesc = []byte{
	...
	0x64, 0x51, 0x75, 0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x63, 0x0a, 0x26, 0x63, 0x6f, 0x6d,
...
var file_api_v1alpha1_scorecards_scorecard_question_proto_goTypes = []interface{}{
...
func file_api_v1alpha1_scorecards_scorecard_question_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_v1alpha1_scorecards_scorecard_question_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_scorecards_scorecard_question_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_scorecards_scorecard_question_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_scorecards_scorecard_question_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_scorecards_scorecard_question_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_scorecards_scorecard_question_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_scorecards_scorecard_question_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_scorecards_scorecard_question_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
