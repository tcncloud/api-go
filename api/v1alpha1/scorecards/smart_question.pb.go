...
func file_api_v1alpha1_scorecards_smart_question_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_v1alpha1_scorecards_smart_question_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*UpdateSmartQuestionRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_v1alpha1_scorecards_smart_question_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*UpdateSmartQuestionResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_v1alpha1_scorecards_smart_question_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*DeleteSmartQuestionRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_v1alpha1_scorecards_smart_question_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*DeleteSmartQuestionResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
