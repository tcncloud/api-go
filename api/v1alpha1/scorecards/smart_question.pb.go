...
const file_api_v1alpha1_scorecards_smart_question_proto_rawDesc = "" +
	"\n" +
	",api/v1alpha1/scorecards/smart_question.proto\x12\x17api.v1alpha1.scorecards\x1a\x1capi/commons/scorecards.proto\x1a google/protobuf/field_mask.proto\"_\n" +
	"\x1aCreateSmartQuestionRequest\x12A\n" +
	"\x0esmart_question\x18\x01 \x01(\v2\x1a.api.commons.SmartQuestionR\rsmartQuestion\"`\n" +
	"\x1bCreateSmartQuestionResponse\x12A\n" +
	"\x0esmart_question\x18\x01 \x01(\v2\x1a.api.commons.SmartQuestionR\rsmartQuestion\"\x9c\x01\n" +
	"\x1aUpdateSmartQuestionRequest\x12A\n" +
	"\x0esmart_question\x18\x01 \x01(\v2\x1a.api.commons.SmartQuestionR\rsmartQuestion\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"`\n" +
	"\x1bUpdateSmartQuestionResponse\x12A\n" +
	"\x0esmart_question\x18\x01 \x01(\v2\x1a.api.commons.SmartQuestionR\rsmartQuestion\"H\n" +
	"\x1aDeleteSmartQuestionRequest\x12*\n" +
	"\x11smart_question_id\x18\x02 \x01(\x03R\x0fsmartQuestionId\"`\n" +
	"\x1bDeleteSmartQuestionResponse\x12A\n" +
	"\x0esmart_question\x18\x01 \x01(\v2\x1a.api.commons.SmartQuestionR\rsmartQuestionB\xe3\x01\n" +
	"\x1bcom.api.v1alpha1.scorecardsB\x12SmartQuestionProtoP\x01Z2github.com/tcncloud/api-go/api/v1alpha1/scorecards\xa2\x02\x03AVS\xaa\x02\x17Api.V1alpha1.Scorecards\xca\x02\x17Api\\V1alpha1\\Scorecards\xe2\x02#Api\\V1alpha1\\Scorecards\\GPBMetadata\xea\x02\x19Api::V1alpha1::Scorecardsb\x06proto3"
