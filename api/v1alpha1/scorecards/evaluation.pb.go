...
var file_api_v1alpha1_scorecards_evaluation_proto_depIdxs = []int32{
	...
	15, // 9: api.v1alpha1.scorecards.ListEvaluationsRequest.return_fields:type_name -> google.protobuf.FieldMask
	14, // 10: api.v1alpha1.scorecards.ListEvaluationsResponse.evaluations:type_name -> api.commons.Evaluation
	14, // 11: api.v1alpha1.scorecards.PreviewEvaluationScoreRequest.evaluation:type_name -> api.commons.Evaluation
	17, // 12: api.v1alpha1.scorecards.PreviewEvaluationScoreRequest.scorecard:type_name -> api.commons.Scorecard
	14, // 13: api.v1alpha1.scorecards.PreviewEvaluationScoreResponse.evaluation:type_name -> api.commons.Evaluation
