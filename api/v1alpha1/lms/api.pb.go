...
type ParseFileTemplateRequest struct {
	...
	// Types that are assignable to RetrieveBy:
	//
...
func (x *ParseFileTemplateRequest) GetNewTemplate() *NewTemplate {
	if x, ok := x.GetRetrieveBy().(*ParseFileTemplateRequest_NewTemplate); ok {
...
func (x *ParseFileTemplateRequest) GetExistingTemplate() *ExistingTemplate {
	if x, ok := x.GetRetrieveBy().(*ParseFileTemplateRequest_ExistingTemplate); ok {
...
var file_api_v1alpha1_lms_api_proto_goTypes = []interface{}{
...
func file_api_v1alpha1_lms_api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_v1alpha1_lms_api_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_lms_api_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_lms_api_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_lms_api_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_lms_api_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_lms_api_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_lms_api_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ParseFileTemplateRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_v1alpha1_lms_api_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ParseFileTemplateResult); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_v1alpha1_lms_api_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1alpha1_lms_api_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
	...
	file_api_v1alpha1_lms_api_proto_msgTypes[6].OneofWrappers = []interface{}{
