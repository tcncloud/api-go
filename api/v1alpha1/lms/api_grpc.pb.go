...
func (c *lMSClient) ListFileTemplates(ctx context.Context, in *ListFileTemplatesRequest, opts ...grpc.CallOption) (*ListFileTemplatesResponse, error) {
	...
	err := c.cc.Invoke(ctx, LMS_ListFileTemplates_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lMSClient) ParseFileTemplate(ctx context.Context, in *ParseFileTemplateRequest, opts ...grpc.CallOption) (*ParseFileTemplateResult, error) {
	...
	err := c.cc.Invoke(ctx, LMS_ParseFileTemplate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedLMSServer must be embedded to have
...
func RegisterLMSServer(s grpc.ServiceRegistrar, srv LMSServer) {
	// If the following call pancis, it indicates UnimplementedLMSServer was
