...
func file_api_commons_org_organization_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_commons_org_organization_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_organization_proto_msgTypes[1].Exporter = func(v any, i int) any {
