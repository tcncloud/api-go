...
var file_api_commons_org_labels_proto_rawDesc = []byte{
	...
	0x6c, 0x61, 0x62, 0x65, 0x6c, 0x42, 0x50, 0x0a, 0x1e, 0x63, 0x6f, 0x6d, 0x2e, 0x74, 0x63, 0x6e,
	0x2e, 0x6d, 0x61, 0x74, 0x72, 0x69, 0x78, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x63, 0x6f, 0x6d, 0x6d,
	0x6f, 0x6e, 0x73, 0x2e, 0x6f, 0x72, 0x67, 0x5a, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	...
	0x6f, 0x72, 0x67, 0x3b, 0x6f, 0x72, 0x67, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_api_commons_org_labels_proto_goTypes = []interface{}{
...
func file_api_commons_org_labels_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_commons_org_labels_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Label); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_commons_org_labels_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
