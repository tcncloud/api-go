...
type User struct {
	...
	MfaInfo *UserMfaInfo `protobuf:"bytes,500,opt,name=mfa_info,json=mfaInfo,proto3" json:"mfa_info,omitempty"`
}
...
func (x *User) GetMfaInfo() *UserMfaInfo {
	if x != nil {
		return x.MfaInfo
	}
	return nil
...
type UserMfaInfo struct {
	...
	MfaLockedOut bool `protobuf:"varint,2,opt,name=mfa_locked_out,json=mfaLockedOut,proto3" json:"mfa_locked_out,omitempty"`
	// Types that are assignable to MfaType:
	//
	//	*UserMfaInfo_None
	//	*UserMfaInfo_Otp
	MfaType isUserMfaInfo_MfaType `protobuf_oneof:"mfa_type"`
}
...
func (x *UserMfaInfo) GetMfaEnabled() bool {
	if x != nil {
		return x.MfaEnabled
	}
	return false
...
func (x *UserMfaInfo) GetMfaLockedOut() bool {
	if x != nil {
		return x.MfaLockedOut
	}
	return false
}

func (m *UserMfaInfo) GetMfaType() isUserMfaInfo_MfaType {
	if m != nil {
		return m.MfaType
	}
	return nil
...
func (x *UserMfaInfo) GetNone() *UserMfaInfo_NoneSelected {
	if x, ok := x.GetMfaType().(*UserMfaInfo_None); ok {
		return x.None
	}
	return nil
}

func (x *UserMfaInfo) GetOtp() *UserMfaInfo_OtpType {
	if x, ok := x.GetMfaType().(*UserMfaInfo_Otp); ok {
		return x.Otp
	}
	return nil
}

type isUserMfaInfo_MfaType interface {
	isUserMfaInfo_MfaType()
}

type UserMfaInfo_None struct {
	None *UserMfaInfo_NoneSelected `protobuf:"bytes,10,opt,name=none,proto3,oneof"`
}

type UserMfaInfo_Otp struct {
	Otp *UserMfaInfo_OtpType `protobuf:"bytes,11,opt,name=otp,proto3,oneof"`
}

func (*UserMfaInfo_None) isUserMfaInfo_MfaType() {}

func (*UserMfaInfo_Otp) isUserMfaInfo_MfaType() {}
...
type UserMfaInfo_NoneSelected struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *UserMfaInfo_NoneSelected) Reset() {
	*x = UserMfaInfo_NoneSelected{}
	if protoimpl.UnsafeEnabled {
...
func (x *UserMfaInfo_NoneSelected) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserMfaInfo_NoneSelected) ProtoMessage() {}

func (x *UserMfaInfo_NoneSelected) ProtoReflect() protoreflect.Message {
	mi := &file_api_commons_org_user_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserMfaInfo_NoneSelected.ProtoReflect.Descriptor instead.
func (*UserMfaInfo_NoneSelected) Descriptor() ([]byte, []int) {
	return file_api_commons_org_user_proto_rawDescGZIP(), []int{1, 0}
}

func (x *UserMfaInfo_NoneSelected) GetTimeout() *timestamppb.Timestamp {
	if x != nil {
		return x.Timeout
	}
	return nil
...
type UserMfaInfo_OtpType struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	//
	//	*UserMfaInfo_OtpType_Email
	DeliveryMethod isUserMfaInfo_OtpType_DeliveryMethod `protobuf_oneof:"delivery_method"`
}

func (x *UserMfaInfo_OtpType) Reset() {
	*x = UserMfaInfo_OtpType{}
	if protoimpl.UnsafeEnabled {
...
func (x *UserMfaInfo_OtpType) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserMfaInfo_OtpType) ProtoMessage() {}

func (x *UserMfaInfo_OtpType) ProtoReflect() protoreflect.Message {
	mi := &file_api_commons_org_user_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserMfaInfo_OtpType.ProtoReflect.Descriptor instead.
func (*UserMfaInfo_OtpType) Descriptor() ([]byte, []int) {
	return file_api_commons_org_user_proto_rawDescGZIP(), []int{1, 1}
}

func (m *UserMfaInfo_OtpType) GetDeliveryMethod() isUserMfaInfo_OtpType_DeliveryMethod {
	if m != nil {
...
func (x *UserMfaInfo_OtpType) GetEmail() *UserMfaInfo_OtpType_EmailDeliveryMethod {
	if x, ok := x.GetDeliveryMethod().(*UserMfaInfo_OtpType_Email); ok {
		return x.Email
	}
	return nil
}

type isUserMfaInfo_OtpType_DeliveryMethod interface {
	isUserMfaInfo_OtpType_DeliveryMethod()
}

type UserMfaInfo_OtpType_Email struct {
	Email *UserMfaInfo_OtpType_EmailDeliveryMethod `protobuf:"bytes,1,opt,name=email,proto3,oneof"`
}

func (*UserMfaInfo_OtpType_Email) isUserMfaInfo_OtpType_DeliveryMethod() {}

type UserMfaInfo_OtpType_EmailDeliveryMethod struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *UserMfaInfo_OtpType_EmailDeliveryMethod) Reset() {
	*x = UserMfaInfo_OtpType_EmailDeliveryMethod{}
	if protoimpl.UnsafeEnabled {
...
func (x *UserMfaInfo_OtpType_EmailDeliveryMethod) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserMfaInfo_OtpType_EmailDeliveryMethod) ProtoMessage() {}

func (x *UserMfaInfo_OtpType_EmailDeliveryMethod) ProtoReflect() protoreflect.Message {
	mi := &file_api_commons_org_user_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserMfaInfo_OtpType_EmailDeliveryMethod.ProtoReflect.Descriptor instead.
func (*UserMfaInfo_OtpType_EmailDeliveryMethod) Descriptor() ([]byte, []int) {
...
var file_api_commons_org_user_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9b, 0x0d, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x17,
	...
	0x38, 0x0a, 0x08, 0x6d, 0x66, 0x61, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0xf4, 0x03, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x73,
	0x2e, 0x6f, 0x72, 0x67, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x4d, 0x66, 0x61, 0x49, 0x6e, 0x66, 0x6f,
	0x52, 0x07, 0x6d, 0x66, 0x61, 0x49, 0x6e, 0x66, 0x6f, 0x1a, 0x61, 0x0a, 0x11, 0x52, 0x65, 0x67,
	...
	,
	...
	0x52, 0x0a, 0x65, 0x78, 0x70, 0x69, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0xaa, 0x01, 0x0a,
...
var file_api_commons_org_user_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_api_commons_org_user_proto_goTypes = []interface{}{
	(*User)(nil),                     // 0: api.commons.org.User
	(*UserMfaInfo)(nil),              // 1: api.commons.org.UserMfaInfo
	...
	(*UserMfaInfo_NoneSelected)(nil), // 6: api.commons.org.UserMfaInfo.NoneSelected
	(*UserMfaInfo_OtpType)(nil),      // 7: api.commons.org.UserMfaInfo.OtpType
	(*UserMfaInfo_OtpType_EmailDeliveryMethod)(nil), // 8: api.commons.org.UserMfaInfo.OtpType.EmailDeliveryMethod
	(*timestamppb.Timestamp)(nil),                   // 9: google.protobuf.Timestamp
	(*wrapperspb.StringValue)(nil),                  // 10: google.protobuf.StringValue
	(*commons.TimeZoneWrapper)(nil),                 // 11: api.commons.TimeZoneWrapper
	(commons.OperatorApplications)(0),               // 12: api.commons.OperatorApplications
}
var file_api_commons_org_user_proto_depIdxs = []int32{
	...
	9,  // 1: api.commons.org.User.created:type_name -> google.protobuf.Timestamp
	9,  // 2: api.commons.org.User.last_updated:type_name -> google.protobuf.Timestamp
	10, // 3: api.commons.org.User.connection_id:type_name -> google.protobuf.StringValue
	11, // 4: api.commons.org.User.time_zone_override:type_name -> api.commons.TimeZoneWrapper
	12, // 5: api.commons.org.User.default_application:type_name -> api.commons.OperatorApplications
	2,  // 6: api.commons.org.User.skills:type_name -> api.commons.org.Skill
	1,  // 7: api.commons.org.User.mfa_info:type_name -> api.commons.org.UserMfaInfo
	6,  // 8: api.commons.org.UserMfaInfo.none:type_name -> api.commons.org.UserMfaInfo.NoneSelected
	7,  // 9: api.commons.org.UserMfaInfo.otp:type_name -> api.commons.org.UserMfaInfo.OtpType
	9,  // 10: api.commons.org.PasswordResetLink.expiration:type_name -> google.protobuf.Timestamp
	5,  // 11: api.commons.org.User.RegionSidMapEntry.value:type_name -> api.commons.org.User.RegionSids
	9,  // 12: api.commons.org.UserMfaInfo.NoneSelected.timeout:type_name -> google.protobuf.Timestamp
	8,  // 13: api.commons.org.UserMfaInfo.OtpType.email:type_name -> api.commons.org.UserMfaInfo.OtpType.EmailDeliveryMethod
...
func file_api_commons_org_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_commons_org_user_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UserMfaInfo_NoneSelected); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_commons_org_user_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UserMfaInfo_OtpType); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_commons_org_user_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UserMfaInfo_OtpType_EmailDeliveryMethod); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
