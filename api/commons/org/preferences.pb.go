...
var file_api_commons_org_preferences_proto_rawDesc = []byte{
	...
	0x72, 0x6d, 0x61, 0x74, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x22, 0xee, 0x04, 0x0a, 0x19, 0x41,
	...
	0x72, 0x69, 0x66, 0x69, 0x65, 0x64, 0x55, 0x73, 0x65, 0x72, 0x73, 0x12, 0x69, 0x0a, 0x12, 0x65,
	0x6d, 0x61, 0x69, 0x6c, 0x5f, 0x6d, 0x66, 0x61, 0x5f, 0x73, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67,
	0x73, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x3b, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x63, 0x6f,
	...
	,
...
var file_api_commons_org_preferences_proto_goTypes = []interface{}{
	...
	(*AuthenticationPreferences_EmailMfaSettings)(nil), // 43: api.commons.org.AuthenticationPreferences.EmailMfaSettings
	...
	(*commons.LocalePreferences)(nil),                  // 53: api.commons.LocalePreferences
	(commons.DefaultDuplicateHandling)(0),              // 54: api.commons.DefaultDuplicateHandling
	(commons.StandardImportFormat)(0),                  // 55: api.commons.StandardImportFormat
	(commons.AgentInfoSortBy)(0),                       // 56: api.commons.AgentInfoSortBy
	(commons.QueueInfoSortBy)(0),                       // 57: api.commons.QueueInfoSortBy
	(commons.AnsweringMachineDetection)(0),             // 58: api.commons.AnsweringMachineDetection
	(commons.DialOrderType)(0),                         // 59: api.commons.DialOrderType
	(commons.BroadcastTemplateOrdering)(0),             // 60: api.commons.BroadcastTemplateOrdering
	(commons.ScheduleByTimeZoneScope)(0),               // 61: api.commons.ScheduleByTimeZoneScope
	(commons.AnaTimeZone)(0),                           // 62: api.commons.AnaTimeZone
	(commons.StandardReportFilter)(0),                  // 63: api.commons.StandardReportFilter
	(commons.RecordingFileType)(0),                     // 64: api.commons.RecordingFileType
}
var file_api_commons_org_preferences_proto_depIdxs = []int32{
	...
	53, // 3: api.commons.org.OrganizationPreferences.locale_preferences:type_name -> api.commons.LocalePreferences
	...
	54, // 6: api.commons.org.ContactPreferences.default_duplicate_handling:type_name -> api.commons.DefaultDuplicateHandling
	55, // 7: api.commons.org.ImportFormat.standard:type_name -> api.commons.StandardImportFormat
	...
	43, // 10: api.commons.org.AuthenticationPreferences.email_mfa_settings:type_name -> api.commons.org.AuthenticationPreferences.EmailMfaSettings
	42, // 11: api.commons.org.AuthenticationPreferences.duo_mfa_settings:type_name -> api.commons.org.AuthenticationPreferences.DuoMfaSettings
	12, // 12: api.commons.org.DashboardPreferences.default_call_types:type_name -> api.commons.org.IncludedCallTypes
	56, // 13: api.commons.org.DashboardPreferences.default_info_sort_by_value:type_name -> api.commons.AgentInfoSortBy
	13, // 14: api.commons.org.DashboardPreferences.default_barge_in_filtering:type_name -> api.commons.org.BargeInFiltering
	44, // 15: api.commons.org.BargeInFiltering.hunt_group:type_name -> api.commons.org.BargeInFiltering.HuntGroup
	45, // 16: api.commons.org.BargeInFiltering.agent_status:type_name -> api.commons.org.BargeInFiltering.AgentStatus
	57, // 17: api.commons.org.DashboardQueuePreferences.default_info_sort_by_value:type_name -> api.commons.QueueInfoSortBy
	16, // 18: api.commons.org.PhonePreferences.default_dial_order:type_name -> api.commons.org.DialOrder
	58, // 19: api.commons.org.PhonePreferences.answering_machine_detection:type_name -> api.commons.AnsweringMachineDetection
	59, // 20: api.commons.org.DialOrder.standard:type_name -> api.commons.DialOrderType
	...
	60, // 25: api.commons.org.BroadcastPreferences.broadcast_template_ordering:type_name -> api.commons.BroadcastTemplateOrdering
	...
	51, // 28: api.commons.org.BroadcastTime.timezone:type_name -> api.commons.TimeZone
	61, // 29: api.commons.org.SchedulePreferences.schedule_by_time_zone_scope:type_name -> api.commons.ScheduleByTimeZoneScope
	46, // 30: api.commons.org.SchedulePreferences.campaign_links:type_name -> api.commons.org.SchedulePreferences.CampaignLinksEntry
	62, // 31: api.commons.org.BusinessPreferences.time_zone:type_name -> api.commons.AnaTimeZone
	0,  // 32: api.commons.org.ScorecardsPreferences.evaluation_interval:type_name -> api.commons.org.Scorecards.EvaluationInterval
	47, // 33: api.commons.org.VoiceAnalyticsPreferences.redact:type_name -> api.commons.org.VoiceAnalytics.Redact
	49, // 34: api.commons.org.VoiceAnalyticsPreferences.notify:type_name -> api.commons.org.VoiceAnalytics.Notify
	49, // 35: api.commons.org.VoiceAnalyticsPreferences.billing_notify:type_name -> api.commons.org.VoiceAnalytics.Notify
	...
	63, // 38: api.commons.org.ReportFilter.standard:type_name -> api.commons.StandardReportFilter
	...
	64, // 41: api.commons.org.RecordingPreferences.export_file_type:type_name -> api.commons.RecordingFileType
	...
	50, // 51: api.commons.org.AdminClientPreferences.allowed_countries:type_name -> api.commons.Country
	41, // 52: api.commons.org.BusinessHours.ranges:type_name -> api.commons.org.Range
	48, // 53: api.commons.org.VoiceAnalytics.Redact.number:type_name -> api.commons.org.VoiceAnalytics.Number
	1,  // 54: api.commons.org.VoiceAnalytics.Number.kind:type_name -> api.commons.org.VoiceAnalytics.Number.Kind
