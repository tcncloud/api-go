...
type AuthenticationPreferences struct {
	...
	EmailMfaSettings *AuthenticationPreferences_EmailMfaSettings `protobuf:"bytes,15,opt,name=email_mfa_settings,json=emailMfaSettings,proto3" json:"email_mfa_settings,omitempty"`
	...
	DuoMfaSettings *AuthenticationPreferences_DuoMfaSettings `protobuf:"bytes,16,opt,name=duo_mfa_settings,json=duoMfaSettings,proto3" json:"duo_mfa_settings,omitempty"`
	// Org enables the ability to set the password reset interval
	AllowForcePasswordResetInterval bool `protobuf:"varint,17,opt,name=allow_force_password_reset_interval,json=allowForcePasswordResetInterval,proto3" json:"allow_force_password_reset_interval,omitempty"`
	// An interval in the form of days for users in the org to reset passwords
	PasswordResetDayInterval int32 `protobuf:"varint,18,opt,name=password_reset_day_interval,json=passwordResetDayInterval,proto3" json:"password_reset_day_interval,omitempty"`
	// Use IP based authorization per user.
	UserAuthorizationViaIp bool `protobuf:"varint,19,opt,name=user_authorization_via_ip,json=userAuthorizationViaIp,proto3" json:"user_authorization_via_ip,omitempty"`
	// Restrict sso users from logging in via username and password.
	ForceSsoProvider bool `protobuf:"varint,20,opt,name=force_sso_provider,json=forceSsoProvider,proto3" json:"force_sso_provider,omitempty"`
	// Whether or not to enable TOTP for 2FA.
	EnableTotp bool `protobuf:"varint,21,opt,name=enable_totp,json=enableTotp,proto3" json:"enable_totp,omitempty"`
}
...
func (x *AuthenticationPreferences) GetAllowForcePasswordResetInterval() bool {
	if x != nil {
		return x.AllowForcePasswordResetInterval
	}
	return false
}
...
func (x *AuthenticationPreferences) GetPasswordResetDayInterval() int32 {
	if x != nil {
		return x.PasswordResetDayInterval
	}
	return 0
}
...
func (x *AuthenticationPreferences) GetUserAuthorizationViaIp() bool {
	if x != nil {
		return x.UserAuthorizationViaIp
	}
	return false
}
...
type BusinessHours struct {
	...
	BusinessHoursId string `protobuf:"bytes,6,opt,name=business_hours_id,json=businessHoursId,proto3" json:"business_hours_id,omitempty"`
	// The name of the BusinessHours object.
	BusinessHoursName string `protobuf:"bytes,7,opt,name=business_hours_name,json=businessHoursName,proto3" json:"business_hours_name,omitempty"`
	// The timezone.
	Timezone commons.TimeZone `protobuf:"varint,8,opt,name=timezone,proto3,enum=api.commons.TimeZone" json:"timezone,omitempty"`
	// A list of time intervals of the BusinessHours object.
	DayIntervals []*DayInterval `protobuf:"bytes,9,rep,name=day_intervals,json=dayIntervals,proto3" json:"day_intervals,omitempty"`
...
type MonthDayDate struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// A name for this date.
	DateName string `protobuf:"bytes,1,opt,name=date_name,json=dateName,proto3" json:"date_name,omitempty"`
	// Month of the year.
	Month commons.Month `protobuf:"varint,2,opt,name=month,proto3,enum=api.commons.Month" json:"month,omitempty"`
	// Day of the month.
...
func (*MonthDayDate) Descriptor() ([]byte, []int) {
	return file_api_commons_org_preferences_proto_rawDescGZIP(), []int{42}
}
...
type CountryHoliday struct {
	...
	//
	// Deprecated: Marked as deprecated in api/commons/org/preferences.proto.
	Country commons.Country `protobuf:"varint,2,opt,name=country,proto3,enum=api.commons.Country" json:"country,omitempty"`
...
func (*CountryHoliday) Descriptor() ([]byte, []int) {
	return file_api_commons_org_preferences_proto_rawDescGZIP(), []int{43}
}
...
type ProgrammedDay struct {
	...
	// A date or holiday
	//
	// Types that are assignable to DayType:
	//
	//	*ProgrammedDay_Day
	//	*ProgrammedDay_Holiday
	DayType isProgrammedDay_DayType `protobuf_oneof:"DayType"`
}
...
func (*ProgrammedDay) Descriptor() ([]byte, []int) {
	return file_api_commons_org_preferences_proto_rawDescGZIP(), []int{44}
}

func (m *ProgrammedDay) GetDayType() isProgrammedDay_DayType {
	if m != nil {
		return m.DayType
	}
	return nil
...
func (x *ProgrammedDay) GetDay() *MonthDayDate {
	if x, ok := x.GetDayType().(*ProgrammedDay_Day); ok {
		return x.Day
	}
	return nil
}
...
func (x *ProgrammedDay) GetHoliday() *CountryHoliday {
	if x, ok := x.GetDayType().(*ProgrammedDay_Holiday); ok {
		return x.Holiday
	}
	return nil
}

type isProgrammedDay_DayType interface {
	isProgrammedDay_DayType()
}

type ProgrammedDay_Day struct {
	// Named date.
	Day *MonthDayDate `protobuf:"bytes,1,opt,name=day,proto3,oneof"`
}

type ProgrammedDay_Holiday struct {
	// Holiday service holiday.
	Holiday *CountryHoliday `protobuf:"bytes,2,opt,name=holiday,proto3,oneof"`
}

func (*ProgrammedDay_Day) isProgrammedDay_DayType() {}

func (*ProgrammedDay_Holiday) isProgrammedDay_DayType() {}

// ProgrammedDates a list of dates or holidays.
type ProgrammedDates struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	OrgId string `protobuf:"bytes,1,opt,name=org_id,json=orgId,proto3" json:"org_id,omitempty"`
	// Unique ID.
	ProgrammedDatesId string `protobuf:"bytes,2,opt,name=programmed_dates_id,json=programmedDatesId,proto3" json:"programmed_dates_id,omitempty"`
	// Name of the list.
	ProgrammedDatesName string `protobuf:"bytes,3,opt,name=programmed_dates_name,json=programmedDatesName,proto3" json:"programmed_dates_name,omitempty"`
	// Description of the list.
	Description string `protobuf:"bytes,4,opt,name=description,proto3" json:"description,omitempty"`
	// The timezone.
	Timezone commons.TimeZone `protobuf:"varint,5,opt,name=timezone,proto3,enum=api.commons.TimeZone" json:"timezone,omitempty"`
	// The list of dates or holidays.
	Days []*ProgrammedDay `protobuf:"bytes,6,rep,name=days,proto3" json:"days,omitempty"`
...
func (*ProgrammedDates) Descriptor() ([]byte, []int) {
	return file_api_commons_org_preferences_proto_rawDescGZIP(), []int{45}
}
...
type ObservedHolidays struct {
	...
	OrgId string `protobuf:"bytes,1,opt,name=org_id,json=orgId,proto3" json:"org_id,omitempty"`
	// Unique ID.
	ObservedHolidaysId string `protobuf:"bytes,2,opt,name=observed_holidays_id,json=observedHolidaysId,proto3" json:"observed_holidays_id,omitempty"`
	// Name of the list.
	ObservedHolidaysName string `protobuf:"bytes,3,opt,name=observed_holidays_name,json=observedHolidaysName,proto3" json:"observed_holidays_name,omitempty"`
	// Description of the list.
	Description string `protobuf:"bytes,4,opt,name=description,proto3" json:"description,omitempty"`
	// The timezone.
	Timezone commons.TimeZone `protobuf:"varint,5,opt,name=timezone,proto3,enum=api.commons.TimeZone" json:"timezone,omitempty"`
	// The list of dates or holidays.
	Days []*ObservedHoliday `protobuf:"bytes,6,rep,name=days,proto3" json:"days,omitempty"`
	// When the list was last updated.
	LastUpdated *timestamppb.Timestamp `protobuf:"bytes,7,opt,name=last_updated,json=lastUpdated,proto3" json:"last_updated,omitempty"`
}
...
func (*ObservedHolidays) Descriptor() ([]byte, []int) {
	return file_api_commons_org_preferences_proto_rawDescGZIP(), []int{46}
}
...
type ObservedHoliday struct {
	...
	//
	//	*ObservedHoliday_Day
	//	*ObservedHoliday_Holiday
	DayType isObservedHoliday_DayType `protobuf_oneof:"DayType"`
}
...
func (*ObservedHoliday) Descriptor() ([]byte, []int) {
	return file_api_commons_org_preferences_proto_rawDescGZIP(), []int{47}
}

func (m *ObservedHoliday) GetDayType() isObservedHoliday_DayType {
	if m != nil {
		return m.DayType
	}
	return nil
...
func (x *ObservedHoliday) GetDay() *MonthDayDate {
	if x, ok := x.GetDayType().(*ObservedHoliday_Day); ok {
		return x.Day
	}
	return nil
}
...
func (x *ObservedHoliday) GetHoliday() *CountryHoliday {
	if x, ok := x.GetDayType().(*ObservedHoliday_Holiday); ok {
		return x.Holiday
	}
	return nil
}

type isObservedHoliday_DayType interface {
	isObservedHoliday_DayType()
}

type ObservedHoliday_Day struct {
	// Named date.
	Day *MonthDayDate `protobuf:"bytes,1,opt,name=day,proto3,oneof"`
}

type ObservedHoliday_Holiday struct {
	// Holiday service holiday.
	Holiday *CountryHoliday `protobuf:"bytes,2,opt,name=holiday,proto3,oneof"`
}

func (*ObservedHoliday_Day) isObservedHoliday_DayType() {}

func (*ObservedHoliday_Holiday) isObservedHoliday_DayType() {}
...
func (x *CertificateInfo) Reset() {
	*x = CertificateInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_commons_org_preferences_proto_msgTypes[48]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CertificateInfo) Descriptor() ([]byte, []int) {
	return file_api_commons_org_preferences_proto_rawDescGZIP(), []int{48}
}
...
// The duo client secret is not included here - it only exists on the update api.
type AuthenticationPreferences_DuoMfaSettings struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	DuoClientId string `protobuf:"bytes,1,opt,name=duo_client_id,json=duoClientId,proto3" json:"duo_client_id,omitempty"`
	DuoApiHost  string `protobuf:"bytes,2,opt,name=duo_api_host,json=duoApiHost,proto3" json:"duo_api_host,omitempty"`
	Enabled     bool   `protobuf:"varint,3,opt,name=enabled,proto3" json:"enabled,omitempty"`
}

func (x *AuthenticationPreferences_DuoMfaSettings) Reset() {
	*x = AuthenticationPreferences_DuoMfaSettings{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_commons_org_preferences_proto_msgTypes[49]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AuthenticationPreferences_DuoMfaSettings) Descriptor() ([]byte, []int) {
	return file_api_commons_org_preferences_proto_rawDescGZIP(), []int{7, 0}
}

func (x *AuthenticationPreferences_DuoMfaSettings) GetDuoClientId() string {
	if x != nil {
		return x.DuoClientId
	}
	return ""
}
...
type AuthenticationPreferences_EmailMfaSettings struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *AuthenticationPreferences_EmailMfaSettings) Reset() {
	*x = AuthenticationPreferences_EmailMfaSettings{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_commons_org_preferences_proto_msgTypes[50]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AuthenticationPreferences_EmailMfaSettings) Descriptor() ([]byte, []int) {
	return file_api_commons_org_preferences_proto_rawDescGZIP(), []int{7, 1}
}
...
func (x *BargeInFiltering_HuntGroup) Reset() {
	*x = BargeInFiltering_HuntGroup{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_commons_org_preferences_proto_msgTypes[51]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *BargeInFiltering_AgentStatus) Reset() {
	*x = BargeInFiltering_AgentStatus{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_commons_org_preferences_proto_msgTypes[52]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *VoiceAnalytics_Redact) Reset() {
	*x = VoiceAnalytics_Redact{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_commons_org_preferences_proto_msgTypes[54]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *VoiceAnalytics_Number) Reset() {
	*x = VoiceAnalytics_Number{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_commons_org_preferences_proto_msgTypes[55]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *VoiceAnalytics_Notify) Reset() {
	*x = VoiceAnalytics_Notify{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_commons_org_preferences_proto_msgTypes[56]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_api_commons_org_preferences_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a,
	0x15, 0x61, 0x70, 0x69, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x73, 0x2f, 0x6c, 0x6d, 0x73,
	...
	,
	...
	,
	...
	0x69, 0x6e, 0x67, 0x52, 0x18, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x44, 0x75, 0x70, 0x6c,
	0x69, 0x63, 0x61, 0x74, 0x65, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x69, 0x6e, 0x67, 0x22, 0x98, 0x01,
	0x0a, 0x0c, 0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x46, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x12, 0x3f,
	0x0a, 0x08, 0x73, 0x74, 0x61, 0x6e, 0x64, 0x61, 0x72, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e,
	...
	,
	...
	0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x5f,
	0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x66, 0x69, 0x65, 0x6c,
	0x64, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x69, 0x73, 0x5f, 0x70, 0x68, 0x6f, 0x6e,
	0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x69, 0x73, 0x50, 0x68, 0x6f, 0x6e, 0x65,
	0x12, 0x32, 0x0a, 0x15, 0x64, 0x69, 0x73, 0x70, 0x6c, 0x61, 0x79, 0x5f, 0x66, 0x6f, 0x72, 0x6d,
	...
	0x72, 0x69, 0x6e, 0x67, 0x22, 0x85, 0x07, 0x0a, 0x19, 0x41, 0x75, 0x74, 0x68, 0x65, 0x6e, 0x74,
	...
	,
	...
	0x6f, 0x6e, 0x50, 0x72, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x73, 0x2e, 0x45, 0x6d,
	0x61, 0x69, 0x6c, 0x4d, 0x66, 0x61, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x52, 0x10,
	0x65, 0x6d, 0x61, 0x69, 0x6c, 0x4d, 0x66, 0x61, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73,
	0x12, 0x63, 0x0a, 0x10, 0x64, 0x75, 0x6f, 0x5f, 0x6d, 0x66, 0x61, 0x5f, 0x73, 0x65, 0x74, 0x74,
	0x69, 0x6e, 0x67, 0x73, 0x18, 0x10, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x39, 0x2e, 0x61, 0x70, 0x69,
	...
	,
	...
	0x5f, 0x73, 0x6d, 0x61, 0x6c, 0x6c, 0x5f, 0x69, 0x63, 0x6f, 0x6e, 0x18, 0x0c, 0x20, 0x01, 0x28,
	...
	,
	...
	,
	...
	0x75, 0x74, 0x65, 0x73, 0x12, 0x31, 0x0a, 0x08, 0x74, 0x69, 0x6d, 0x65, 0x7a, 0x6f, 0x6e, 0x65,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x15, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x63, 0x6f, 0x6d,
	0x6d, 0x6f, 0x6e, 0x73, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x5a, 0x6f, 0x6e, 0x65, 0x52, 0x08, 0x74,
	0x69, 0x6d, 0x65, 0x7a, 0x6f, 0x6e, 0x65, 0x22, 0xbe, 0x06, 0x0a, 0x13, 0x53, 0x63, 0x68, 0x65,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x72, 0x52, 0x1c, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x42, 0x72, 0x6f, 0x61, 0x64,
	0x63, 0x61, 0x73, 0x74, 0x52, 0x65, 0x73, 0x65, 0x6e, 0x64, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72,
	0x22, 0x73, 0x0a, 0x0c, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72,
	...
	,
	...
	,
	...
	0x6e, 0x76, 0x65, 0x6e, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x08, 0x6f, 0x75, 0x74, 0x62, 0x6f, 0x75,
	0x6e, 0x64, 0x12, 0x41, 0x0a, 0x08, 0x63, 0x6f, 0x6d, 0x62, 0x69, 0x6e, 0x65, 0x64, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	0x6e, 0x73, 0x2e, 0x6f, 0x72, 0x67, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x4e, 0x61, 0x6d, 0x69, 0x6e,
	0x67, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x08, 0x63, 0x6f, 0x6d,
	0x62, 0x69, 0x6e, 0x65, 0x64, 0x22, 0x54, 0x0a, 0x14, 0x46, 0x69, 0x6c, 0x65, 0x4e, 0x61, 0x6d,
	0x69, 0x6e, 0x67, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x3c, 0x0a,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x12, 0x34, 0x0a, 0x04, 0x64, 0x61, 0x79, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x20,
	0x2e, 0x61, 0x70, 0x69, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x73, 0x2e, 0x6f, 0x72, 0x67,
	0x2e, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x64, 0x48, 0x6f, 0x6c, 0x69, 0x64, 0x61, 0x79,
	0x52, 0x04, 0x64, 0x61, 0x79, 0x73, 0x12, 0x3d, 0x0a, 0x0c, 0x6c, 0x61, 0x73, 0x74, 0x5f, 0x75,
	...
	,
	...
	0x74, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x49, 0x64, 0x12, 0x15, 0x0a, 0x06, 0x6f, 0x72, 0x67, 0x5f,
	...
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x12, 0x0a, 0x04, 0x68, 0x61, 0x73, 0x68, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x04, 0x68, 0x61, 0x73, 0x68, 0x12, 0x43, 0x0a, 0x0f, 0x65, 0x78, 0x70,
	0x69, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x64, 0x61, 0x74, 0x65, 0x18, 0x06, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x0e,
	0x65, 0x78, 0x70, 0x69, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x61, 0x74, 0x65, 0x12, 0x3f,
	...
	,
...
var file_api_commons_org_preferences_proto_msgTypes = make([]protoimpl.MessageInfo, 57)
var file_api_commons_org_preferences_proto_goTypes = []any{
	...
	(*TimeOfDay)(nil),                                  // 42: api.commons.org.TimeOfDay
	(*DayInterval)(nil),                                // 43: api.commons.org.DayInterval
	(*MonthDayDate)(nil),                               // 44: api.commons.org.MonthDayDate
	(*CountryHoliday)(nil),                             // 45: api.commons.org.CountryHoliday
	(*ProgrammedDay)(nil),                              // 46: api.commons.org.ProgrammedDay
	(*ProgrammedDates)(nil),                            // 47: api.commons.org.ProgrammedDates
	(*ObservedHolidays)(nil),                           // 48: api.commons.org.ObservedHolidays
	(*ObservedHoliday)(nil),                            // 49: api.commons.org.ObservedHoliday
	(*CertificateInfo)(nil),                            // 50: api.commons.org.CertificateInfo
	(*AuthenticationPreferences_DuoMfaSettings)(nil),   // 51: api.commons.org.AuthenticationPreferences.DuoMfaSettings
	(*AuthenticationPreferences_EmailMfaSettings)(nil), // 52: api.commons.org.AuthenticationPreferences.EmailMfaSettings
	(*BargeInFiltering_HuntGroup)(nil),                 // 53: api.commons.org.BargeInFiltering.HuntGroup
	(*BargeInFiltering_AgentStatus)(nil),               // 54: api.commons.org.BargeInFiltering.AgentStatus
	nil,                                                // 55: api.commons.org.SchedulePreferences.CampaignLinksEntry
	(*VoiceAnalytics_Redact)(nil),                      // 56: api.commons.org.VoiceAnalytics.Redact
	(*VoiceAnalytics_Number)(nil),                      // 57: api.commons.org.VoiceAnalytics.Number
	(*VoiceAnalytics_Notify)(nil),                      // 58: api.commons.org.VoiceAnalytics.Notify
	(commons.Country)(0),                               // 59: api.commons.Country
	(commons.TimeZone)(0),                              // 60: api.commons.TimeZone
	(commons.DisplayLanguage)(0),                       // 61: api.commons.DisplayLanguage
	(*commons.LocalePreferences)(nil),                  // 62: api.commons.LocalePreferences
	(commons.DefaultDuplicateHandling)(0),              // 63: api.commons.DefaultDuplicateHandling
	(commons.StandardImportFormat)(0),                  // 64: api.commons.StandardImportFormat
	(commons.AgentInfoSortBy)(0),                       // 65: api.commons.AgentInfoSortBy
	(commons.QueueInfoSortBy)(0),                       // 66: api.commons.QueueInfoSortBy
	(commons.AnsweringMachineDetection)(0),             // 67: api.commons.AnsweringMachineDetection
	(commons.DialOrderType)(0),                         // 68: api.commons.DialOrderType
	(commons.BroadcastTemplateOrdering)(0),             // 69: api.commons.BroadcastTemplateOrdering
	(commons.ScheduleByTimeZoneScope)(0),               // 70: api.commons.ScheduleByTimeZoneScope
	(commons.AnaTimeZone)(0),                           // 71: api.commons.AnaTimeZone
	(commons.StandardReportFilter)(0),                  // 72: api.commons.StandardReportFilter
	(commons.RecordingFileType)(0),                     // 73: api.commons.RecordingFileType
...
var file_api_commons_org_preferences_proto_depIdxs = []int32{
	...
	60, // 1: api.commons.org.OrganizationPreferences.time_zone:type_name -> api.commons.TimeZone
	61, // 2: api.commons.org.OrganizationPreferences.display_language:type_name -> api.commons.DisplayLanguage
	62, // 3: api.commons.org.OrganizationPreferences.locale_preferences:type_name -> api.commons.LocalePreferences
	...
	63, // 6: api.commons.org.ContactPreferences.default_duplicate_handling:type_name -> api.commons.DefaultDuplicateHandling
	64, // 7: api.commons.org.ImportFormat.standard:type_name -> api.commons.StandardImportFormat
	...
	52, // 10: api.commons.org.AuthenticationPreferences.email_mfa_settings:type_name -> api.commons.org.AuthenticationPreferences.EmailMfaSettings
	51, // 11: api.commons.org.AuthenticationPreferences.duo_mfa_settings:type_name -> api.commons.org.AuthenticationPreferences.DuoMfaSettings
	12, // 12: api.commons.org.DashboardPreferences.default_call_types:type_name -> api.commons.org.IncludedCallTypes
	65, // 13: api.commons.org.DashboardPreferences.default_info_sort_by_value:type_name -> api.commons.AgentInfoSortBy
	13, // 14: api.commons.org.DashboardPreferences.default_barge_in_filtering:type_name -> api.commons.org.BargeInFiltering
	53, // 15: api.commons.org.BargeInFiltering.hunt_group:type_name -> api.commons.org.BargeInFiltering.HuntGroup
	54, // 16: api.commons.org.BargeInFiltering.agent_status:type_name -> api.commons.org.BargeInFiltering.AgentStatus
	66, // 17: api.commons.org.DashboardQueuePreferences.default_info_sort_by_value:type_name -> api.commons.QueueInfoSortBy
	16, // 18: api.commons.org.PhonePreferences.default_dial_order:type_name -> api.commons.org.DialOrder
	67, // 19: api.commons.org.PhonePreferences.answering_machine_detection:type_name -> api.commons.AnsweringMachineDetection
	68, // 20: api.commons.org.DialOrder.standard:type_name -> api.commons.DialOrderType
	17, // 21: api.commons.org.DialOrder.custom:type_name -> api.commons.org.CustomDialOrder
	18, // 22: api.commons.org.CustomDialOrder.dial_order_fields:type_name -> api.commons.org.DialOrderField
	20, // 23: api.commons.org.CompliancePreferences.default_schedule_rule:type_name -> api.commons.org.ScheduleRuleField
	21, // 24: api.commons.org.CompliancePreferences.zip_code_scrub:type_name -> api.commons.org.ZipCodeField
	69, // 25: api.commons.org.BroadcastPreferences.broadcast_template_ordering:type_name -> api.commons.BroadcastTemplateOrdering
	23, // 26: api.commons.org.BroadcastPreferences.default_start_time:type_name -> api.commons.org.BroadcastTime
	23, // 27: api.commons.org.BroadcastPreferences.default_stop_time:type_name -> api.commons.org.BroadcastTime
	60, // 28: api.commons.org.BroadcastTime.timezone:type_name -> api.commons.TimeZone
	70, // 29: api.commons.org.SchedulePreferences.schedule_by_time_zone_scope:type_name -> api.commons.ScheduleByTimeZoneScope
	55, // 30: api.commons.org.SchedulePreferences.campaign_links:type_name -> api.commons.org.SchedulePreferences.CampaignLinksEntry
	71, // 31: api.commons.org.BusinessPreferences.time_zone:type_name -> api.commons.AnaTimeZone
	0,  // 32: api.commons.org.ScorecardsPreferences.evaluation_interval:type_name -> api.commons.org.Scorecards.EvaluationInterval
	56, // 33: api.commons.org.VoiceAnalyticsPreferences.redact:type_name -> api.commons.org.VoiceAnalytics.Redact
	58, // 34: api.commons.org.VoiceAnalyticsPreferences.notify:type_name -> api.commons.org.VoiceAnalytics.Notify
	58, // 35: api.commons.org.VoiceAnalyticsPreferences.billing_notify:type_name -> api.commons.org.VoiceAnalytics.Notify
	33, // 36: api.commons.org.FilterPreferences.default_auto_report_filter:type_name -> api.commons.org.ReportFilter
	33, // 37: api.commons.org.FilterPreferences.default_broadcast_resend_filter:type_name -> api.commons.org.ReportFilter
	72, // 38: api.commons.org.ReportFilter.standard:type_name -> api.commons.StandardReportFilter
	35, // 39: api.commons.org.RecordingPreferences.file_name_convention:type_name -> api.commons.org.RecordingsFileNamingConvention
	36, // 40: api.commons.org.RecordingPreferences.zip_file_name_convention:type_name -> api.commons.org.RecordingsZipFileNamingConvention
	73, // 41: api.commons.org.RecordingPreferences.export_file_type:type_name -> api.commons.RecordingFileType
	37, // 42: api.commons.org.RecordingsFileNamingConvention.inbound:type_name -> api.commons.org.FileNamingConvention
	37, // 43: api.commons.org.RecordingsFileNamingConvention.manual:type_name -> api.commons.org.FileNamingConvention
	37, // 44: api.commons.org.RecordingsFileNamingConvention.outbound:type_name -> api.commons.org.FileNamingConvention
	37, // 45: api.commons.org.RecordingsFileNamingConvention.preview:type_name -> api.commons.org.FileNamingConvention
	37, // 46: api.commons.org.RecordingsZipFileNamingConvention.inbound:type_name -> api.commons.org.FileNamingConvention
	37, // 47: api.commons.org.RecordingsZipFileNamingConvention.manual:type_name -> api.commons.org.FileNamingConvention
	37, // 48: api.commons.org.RecordingsZipFileNamingConvention.outbound:type_name -> api.commons.org.FileNamingConvention
	37, // 49: api.commons.org.RecordingsZipFileNamingConvention.combined:type_name -> api.commons.org.FileNamingConvention
	38, // 50: api.commons.org.FileNamingConvention.segments:type_name -> api.commons.org.FileNameSegment
	59, // 51: api.commons.org.AdminClientPreferences.allowed_countries:type_name -> api.commons.Country
	60, // 52: api.commons.org.BusinessHours.timezone:type_name -> api.commons.TimeZone
	43, // 53: api.commons.org.BusinessHours.day_intervals:type_name -> api.commons.org.DayInterval
	74, // 54: api.commons.org.BusinessHours.last_updated:type_name -> google.protobuf.Timestamp
	75, // 55: api.commons.org.DayInterval.day:type_name -> api.commons.Weekday.Enum
	42, // 56: api.commons.org.DayInterval.start:type_name -> api.commons.org.TimeOfDay
	42, // 57: api.commons.org.DayInterval.end:type_name -> api.commons.org.TimeOfDay
	76, // 58: api.commons.org.MonthDayDate.month:type_name -> api.commons.Month
	59, // 59: api.commons.org.CountryHoliday.country:type_name -> api.commons.Country
	44, // 60: api.commons.org.ProgrammedDay.day:type_name -> api.commons.org.MonthDayDate
	45, // 61: api.commons.org.ProgrammedDay.holiday:type_name -> api.commons.org.CountryHoliday
	60, // 62: api.commons.org.ProgrammedDates.timezone:type_name -> api.commons.TimeZone
	46, // 63: api.commons.org.ProgrammedDates.days:type_name -> api.commons.org.ProgrammedDay
	74, // 64: api.commons.org.ProgrammedDates.last_updated:type_name -> google.protobuf.Timestamp
	60, // 65: api.commons.org.ObservedHolidays.timezone:type_name -> api.commons.TimeZone
	49, // 66: api.commons.org.ObservedHolidays.days:type_name -> api.commons.org.ObservedHoliday
	74, // 67: api.commons.org.ObservedHolidays.last_updated:type_name -> google.protobuf.Timestamp
	44, // 68: api.commons.org.ObservedHoliday.day:type_name -> api.commons.org.MonthDayDate
	45, // 69: api.commons.org.ObservedHoliday.holiday:type_name -> api.commons.org.CountryHoliday
...
func file_api_commons_org_preferences_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_commons_org_preferences_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[12].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[13].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[14].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[15].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[16].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[17].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[18].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[19].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[20].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[21].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[22].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[23].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[24].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[25].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[26].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[27].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[28].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[29].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[30].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[31].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[32].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[33].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[34].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[35].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[36].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[37].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[38].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[39].Exporter = func(v any, i int) any {
			switch v := v.(*Range); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_commons_org_preferences_proto_msgTypes[40].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[41].Exporter = func(v any, i int) any {
			switch v := v.(*DayInterval); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_commons_org_preferences_proto_msgTypes[42].Exporter = func(v any, i int) any {
			switch v := v.(*MonthDayDate); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_commons_org_preferences_proto_msgTypes[43].Exporter = func(v any, i int) any {
			switch v := v.(*CountryHoliday); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_commons_org_preferences_proto_msgTypes[44].Exporter = func(v any, i int) any {
			switch v := v.(*ProgrammedDay); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_commons_org_preferences_proto_msgTypes[45].Exporter = func(v any, i int) any {
			switch v := v.(*ProgrammedDates); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_commons_org_preferences_proto_msgTypes[46].Exporter = func(v any, i int) any {
			switch v := v.(*ObservedHolidays); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_commons_org_preferences_proto_msgTypes[47].Exporter = func(v any, i int) any {
			switch v := v.(*ObservedHoliday); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_commons_org_preferences_proto_msgTypes[48].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[49].Exporter = func(v any, i int) any {
			switch v := v.(*AuthenticationPreferences_DuoMfaSettings); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_commons_org_preferences_proto_msgTypes[50].Exporter = func(v any, i int) any {
			switch v := v.(*AuthenticationPreferences_EmailMfaSettings); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_commons_org_preferences_proto_msgTypes[51].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[52].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[54].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[55].Exporter = func(v any, i int) any {
		...
		file_api_commons_org_preferences_proto_msgTypes[56].Exporter = func(v any, i int) any {
	...
	file_api_commons_org_preferences_proto_msgTypes[3].OneofWrappers = []any{
		(*ImportFormat_Standard)(nil),
		(*ImportFormat_Custom)(nil),
	}
	file_api_commons_org_preferences_proto_msgTypes[5].OneofWrappers = []any{
		(*ContactAreaCode_Cfd)(nil),
		(*ContactAreaCode_Custom)(nil),
	}
	file_api_commons_org_preferences_proto_msgTypes[14].OneofWrappers = []any{
		(*DialOrder_Standard)(nil),
		(*DialOrder_Custom)(nil),
	}
	file_api_commons_org_preferences_proto_msgTypes[31].OneofWrappers = []any{
		(*ReportFilter_Standard)(nil),
		(*ReportFilter_Custom)(nil),
	}
	file_api_commons_org_preferences_proto_msgTypes[44].OneofWrappers = []any{
		(*ProgrammedDay_Day)(nil),
		(*ProgrammedDay_Holiday)(nil),
	}
	file_api_commons_org_preferences_proto_msgTypes[47].OneofWrappers = []any{
		(*ObservedHoliday_Day)(nil),
		(*ObservedHoliday_Holiday)(nil),
	}
