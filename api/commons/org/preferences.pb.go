...
const file_api_commons_org_preferences_proto_rawDesc = "" +
	...
	" \x01(\x0e2\x14.api.commons.CountryR\x0edefaultCountry\x122\n" +
	"\ttime_zone\x18\v \x01(\x0e2\x15.api.commons.TimeZoneR\btimeZone\x12G\n" +
	"\x10display_language\x18\f \x01(\x0e2\x1c.api.commons.DisplayLanguageR\x0fdisplayLanguage\x12M\n" +
	"\x12locale_preferences\x18\r \x01(\v2\x1e.api.commons.LocalePreferencesR\x11localePreferences\"\x83\x04\n" +
	"\x10AgentPreferences\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x121\n" +
	"\x15default_agent_dial_in\x18\n" +
	" \x01(\tR\x12defaultAgentDialIn\x120\n" +
	"\x14pbx_extension_length\x18\v \x01(\x05R\x12pbxExtensionLength\x12=\n" +
	"\x1bdefault_softphone_volume_in\x18\f \x01(\x05R\x18defaultSoftphoneVolumeIn\x12?\n" +
	"\x1cdefault_softphone_volume_out\x18\r \x01(\x05R\x19defaultSoftphoneVolumeOut\x123\n" +
	"\x16config_dial_in_numbers\x18\x0e \x03(\tR\x13configDialInNumbers\x123\n" +
	"\x16client_dial_in_numbers\x18\x0f \x03(\tR\x13clientDialInNumbers\x12@\n" +
	"\x1dmanual_dial_caller_id_privacy\x18\x10 \x01(\bR\x19manualDialCallerIdPrivacy\x12G\n" +
	"!use_manual_dial_caller_id_privacy\x18\x11 \x01(\bR\x1cuseManualDialCallerIdPrivacy\"\xa5\x05\n" +
	"\x12ContactPreferences\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x12`\n" +
	"\x1ddefault_contact_import_format\x18\n" +
	" \x01(\v2\x1d.api.commons.org.ImportFormatR\x1adefaultContactImportFormat\x129\n" +
	"\x19use_contact_import_format\x18\v \x01(\bR\x16useContactImportFormat\x12[\n" +
	"\x19default_contact_area_code\x18\f \x01(\v2 .api.commons.org.ContactAreaCodeR\x16defaultContactAreaCode\x121\n" +
	"\x15use_contact_area_code\x18\r \x01(\bR\x12useContactAreaCode\x12a\n" +
	".discard_record_default_absent_numbers_handling\x18\x0e \x01(\bR)discardRecordDefaultAbsentNumbersHandling\x12Q\n" +
	"%default_contacts_import_randomization\x18\x0f \x01(\bR\"defaultContactsImportRandomization\x120\n" +
	"\x14default_email_column\x18\x10 \x01(\tR\x12defaultEmailColumn\x12c\n" +
	"\x1adefault_duplicate_handling\x18\x11 \x01(\x0e2%.api.commons.DefaultDuplicateHandlingR\x18defaultDuplicateHandling\"\x98\x01\n" +
	"\fImportFormat\x12?\n" +
	"\bstandard\x18\x01 \x01(\x0e2!.api.commons.StandardImportFormatH\x00R\bstandard\x12=\n" +
	"\x06custom\x18\x02 \x01(\v2#.api.commons.org.CustomImportFormatH\x00R\x06customB\b\n" +
	"\x06format\"8\n" +
	"\x12CustomImportFormat\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\"v\n" +
	"\x0fContactAreaCode\x12<\n" +
	"\x03cfd\x18\x01 \x01(\v2(.api.commons.org.ContactFieldDescriptionH\x00R\x03cfd\x12\x18\n" +
	"\x06custom\x18\x02 \x01(\x05H\x00R\x06customB\v\n" +
	"\tarea_code\"\x97\x01\n" +
	"\x17ContactFieldDescription\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x1d\n" +
	"\n" +
	"field_name\x18\x02 \x01(\tR\tfieldName\x12\x19\n" +
	"\bis_phone\x18\x03 \x01(\bR\aisPhone\x122\n" +
	"\x15display_format_string\x18\x04 \x01(\tR\x13displayFormatString\"\x85\a\n" +
	"\x19AuthenticationPreferences\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x120\n" +
	"\x14authorization_via_ip\x18\n" +
	" \x01(\bR\x12authorizationViaIp\x12\x1f\n" +
	"\vallowed_ips\x18\v \x03(\tR\n" +
	"allowedIps\x12\"\n" +
	"\ragent_api_key\x18\f \x01(\tR\vagentApiKey\x12\x1d\n" +
	"\n" +
	"enable_2fa\x18\r \x01(\bR\tenable2fa\x124\n" +
	"\x16block_unverified_users\x18\x0e \x01(\bR\x14blockUnverifiedUsers\x12i\n" +
	"\x12email_mfa_settings\x18\x0f \x01(\v2;.api.commons.org.AuthenticationPreferences.EmailMfaSettingsR\x10emailMfaSettings\x12c\n" +
	"\x10duo_mfa_settings\x18\x10 \x01(\v29.api.commons.org.AuthenticationPreferences.DuoMfaSettingsR\x0eduoMfaSettings\x12L\n" +
	"#allow_force_password_reset_interval\x18\x11 \x01(\bR\x1fallowForcePasswordResetInterval\x12=\n" +
	"\x1bpassword_reset_day_interval\x18\x12 \x01(\x05R\x18passwordResetDayInterval\x129\n" +
	"\x19user_authorization_via_ip\x18\x13 \x01(\bR\x16userAuthorizationViaIp\x12,\n" +
	"\x12force_sso_provider\x18\x14 \x01(\bR\x10forceSsoProvider\x12\x1f\n" +
	"\venable_totp\x18\x15 \x01(\bR\n" +
	"enableTotp\x1ap\n" +
	"\x0eDuoMfaSettings\x12\"\n" +
	"\rduo_client_id\x18\x01 \x01(\tR\vduoClientId\x12 \n" +
	"\fduo_api_host\x18\x02 \x01(\tR\n" +
	"duoApiHost\x12\x18\n" +
	"\aenabled\x18\x03 \x01(\bR\aenabled\x1a,\n" +
	"\x10EmailMfaSettings\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\"\xbf\x01\n" +
	"\x12WebhookPreferences\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x12*\n" +
	"\x11push_urls_enabled\x18\n" +
	" \x01(\bR\x0fpushUrlsEnabled\x12/\n" +
	"\x14call_result_push_url\x18\v \x01(\tR\x11callResultPushUrl\x125\n" +
	"\x17agent_response_push_url\x18\f \x01(\tR\x14agentResponsePushUrl\"\xe5\x04\n" +
	"\x14DashboardPreferences\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x12*\n" +
	"\x11default_info_view\x18\n" +
	" \x01(\bR\x0fdefaultInfoView\x126\n" +
	"\x17default_table_inclusion\x18\v \x01(\bR\x15defaultTableInclusion\x122\n" +
	"\x15default_info_grouping\x18\f \x01(\bR\x13defaultInfoGrouping\x12,\n" +
	"\x12default_small_icon\x18\r \x01(\bR\x10defaultSmallIcon\x126\n" +
	"\x17default_descending_sort\x18\x0e \x01(\bR\x15defaultDescendingSort\x12,\n" +
	"\x12table_template_sid\x18\x0f \x01(\x03R\x10tableTemplateSid\x12P\n" +
	"\x12default_call_types\x18\x10 \x01(\v2\".api.commons.org.IncludedCallTypesR\x10defaultCallTypes\x12X\n" +
	"\x1adefault_info_sort_by_value\x18\x11 \x01(\x0e2\x1c.api.commons.AgentInfoSortByR\x16defaultInfoSortByValue\x12^\n" +
	"\x1adefault_barge_in_filtering\x18\x12 \x01(\v2!.api.commons.org.BargeInFilteringR\x17defaultBargeInFiltering\"\x8d\x01\n" +
	"\x11IncludedCallTypes\x12\x1a\n" +
	"\boutbound\x18\x01 \x01(\bR\boutbound\x12\x18\n" +
	"\ainbound\x18\x02 \x01(\bR\ainbound\x12\x1f\n" +
	"\vmanual_dial\x18\x03 \x01(\bR\n" +
	"manualDial\x12!\n" +
	"\fpreview_dial\x18\x04 \x01(\bR\vpreviewDial\"\xf7\x03\n" +
	"\x10BargeInFiltering\x12J\n" +
	"\n" +
	"hunt_group\x18\x01 \x01(\v2+.api.commons.org.BargeInFiltering.HuntGroupR\thuntGroup\x12P\n" +
	"\fagent_status\x18\x02 \x01(\v2-.api.commons.org.BargeInFiltering.AgentStatusR\vagentStatus\x1aC\n" +
	"\tHuntGroup\x12\x10\n" +
	"\x03any\x18\x01 \x01(\bR\x03any\x12$\n" +
	"\x0ehunt_group_sid\x18\x02 \x01(\x03R\fhuntGroupSid\x1a\xff\x01\n" +
	"\vAgentStatus\x12\x10\n" +
	"\x03any\x18\x01 \x01(\bR\x03any\x12\x18\n" +
	"\awaiting\x18\x02 \x01(\bR\awaiting\x12\x17\n" +
	"\aon_call\x18\x03 \x01(\bR\x06onCall\x12\x17\n" +
	"\awrap_up\x18\x04 \x01(\bR\x06wrapUp\x12\x16\n" +
	"\x06paused\x18\x05 \x01(\bR\x06paused\x12\x1a\n" +
	"\btransfer\x18\x06 \x01(\bR\btransfer\x12\x18\n" +
	"\apreview\x18\a \x01(\bR\apreview\x12\x16\n" +
	"\x06manual\x18\b \x01(\bR\x06manual\x12\x10\n" +
	"\x03pbx\x18\t \x01(\bR\x03pbx\x12\x1a\n" +
	"\bintercom\x18\n" +
	" \x01(\bR\bintercom\"\xd0\x03\n" +
	"\x19DashboardQueuePreferences\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x12*\n" +
	"\x11default_info_view\x18\n" +
	" \x01(\bR\x0fdefaultInfoView\x122\n" +
	"\x15default_info_grouping\x18\v \x01(\bR\x13defaultInfoGrouping\x12,\n" +
	"\x12default_small_icon\x18\f \x01(\bR\x10defaultSmallIcon\x126\n" +
	"\x17default_descending_sort\x18\r \x01(\bR\x15defaultDescendingSort\x12=\n" +
	"\x1bdefault_agent_skills_filter\x18\x0e \x01(\x03R\x18defaultAgentSkillsFilter\x12=\n" +
	"\x1bdefault_info_table_template\x18\x0f \x01(\x03R\x18defaultInfoTableTemplate\x12X\n" +
	"\x1adefault_info_sort_by_value\x18\x10 \x01(\x0e2\x1c.api.commons.QueueInfoSortByR\x16defaultInfoSortByValue\"\x88\x05\n" +
	"\x10PhonePreferences\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x122\n" +
	"\x15agent_preview_dialing\x18\n" +
	" \x01(\bR\x13agentPreviewDialing\x12A\n" +
	"\x1ddefault_ring_length_threshold\x18\v \x01(\x05R\x1adefaultRingLengthThreshold\x12A\n" +
	"\x1ddisplay_ring_length_threshold\x18\f \x01(\bR\x1adisplayRingLengthThreshold\x12$\n" +
	"\x0eshow_caller_id\x18\r \x01(\bR\fshowCallerId\x121\n" +
	"\x15default_use_caller_id\x18\x0e \x01(\bR\x12defaultUseCallerId\x12>\n" +
	"\x1boverride_linkback_recording\x18\x0f \x01(\bR\x19overrideLinkbackRecording\x12)\n" +
	"\x11caller_id_cfd_sid\x18\x10 \x01(\x03R\x0ecallerIdCfdSid\x12H\n" +
	"\x12default_dial_order\x18\x11 \x01(\v2\x1a.api.commons.org.DialOrderR\x10defaultDialOrder\x12f\n" +
	"\x1banswering_machine_detection\x18\x12 \x01(\x0e2&.api.commons.AnsweringMachineDetectionR\x19answeringMachineDetection\x12-\n" +
	"\x12linkback_recording\x18\x13 \x01(\bR\x11linkbackRecording\"\x89\x01\n" +
	"\tDialOrder\x128\n" +
	"\bstandard\x18\x01 \x01(\x0e2\x1a.api.commons.DialOrderTypeH\x00R\bstandard\x12:\n" +
	"\x06custom\x18\x02 \x01(\v2 .api.commons.org.CustomDialOrderH\x00R\x06customB\x06\n" +
	"\x04type\"^\n" +
	"\x0fCustomDialOrder\x12K\n" +
	"\x11dial_order_fields\x18\x01 \x03(\v2\x1f.api.commons.org.DialOrderFieldR\x0fdialOrderFields\"H\n" +
	"\x0eDialOrderField\x12\x17\n" +
	"\acfd_sid\x18\x01 \x01(\x03R\x06cfdSid\x12\x1d\n" +
	"\n" +
	"field_name\x18\x02 \x01(\tR\tfieldName\"\xd9\x06\n" +
	"\x15CompliancePreferences\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x129\n" +
	"\x19display_after_hours_calls\x18\n" +
	" \x01(\bR\x16displayAfterHoursCalls\x12*\n" +
	"\x11after_hours_calls\x18\v \x01(\bR\x0fafterHoursCalls\x12<\n" +
	"\x1adisplay_natural_compliance\x18\f \x01(\bR\x18displayNaturalCompliance\x124\n" +
	"\x16use_natural_compliance\x18\r \x01(\bR\x14useNaturalCompliance\x12=\n" +
	"\x1bdefault_compliance_rule_set\x18\x0e \x01(\tR\x18defaultComplianceRuleSet\x127\n" +
	"\x18display_cell_phone_scrub\x18\x0f \x01(\bR\x15displayCellPhoneScrub\x12(\n" +
	"\x10cell_phone_scrub\x18\x10 \x01(\bR\x0ecellPhoneScrub\x124\n" +
	"\x16display_schedule_rules\x18\x11 \x01(\bR\x14displayScheduleRules\x12,\n" +
	"\x12use_schedule_rules\x18\x12 \x01(\bR\x10useScheduleRules\x12V\n" +
	"\x15default_schedule_rule\x18\x13 \x01(\v2\".api.commons.org.ScheduleRuleFieldR\x13defaultScheduleRule\x12)\n" +
	"\x11do_zip_code_scrub\x18\x14 \x01(\bR\x0edoZipCodeScrub\x12C\n" +
	"\x0ezip_code_scrub\x18\x15 \x01(\v2\x1d.api.commons.org.ZipCodeFieldR\fzipCodeScrub\x12A\n" +
	"\x1ddefault_email_compliance_list\x18\x16 \x01(\tR\x1adefaultEmailComplianceList\x12=\n" +
	"\x1bdefault_sms_compliance_list\x18\x17 \x01(\tR\x18defaultSmsComplianceList\"@\n" +
	"\x11ScheduleRuleField\x12\x17\n" +
	"\arule_id\x18\x01 \x01(\x03R\x06ruleId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\"F\n" +
	"\fZipCodeField\x12\x17\n" +
	"\acfd_sid\x18\x01 \x01(\x03R\x06cfdSid\x12\x1d\n" +
	"\n" +
	"field_name\x18\x02 \x01(\tR\tfieldName\"\xb6\x05\n" +
	"\x14BroadcastPreferences\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x12I\n" +
	"!display_list_penetration_strategy\x18\n" +
	" \x01(\bR\x1edisplayListPenetrationStrategy\x12C\n" +
	"\x1edial_list_penetration_strategy\x18\v \x01(\bR\x1bdialListPenetrationStrategy\x123\n" +
	"\x16display_follow_the_sun\x18\f \x01(\bR\x13displayFollowTheSun\x12$\n" +
	"\x0efollow_the_sun\x18\r \x01(\bR\ffollowTheSun\x12@\n" +
	"\x1csequence_terminator_override\x18\x0e \x01(\bR\x1asequenceTerminatorOverride\x12f\n" +
	"\x1bbroadcast_template_ordering\x18\x0f \x01(\x0e2&.api.commons.BroadcastTemplateOrderingR\x19broadcastTemplateOrdering\x12,\n" +
	"\x12start_time_enabled\x18\x10 \x01(\bR\x10startTimeEnabled\x12L\n" +
	"\x12default_start_time\x18\x11 \x01(\v2\x1e.api.commons.org.BroadcastTimeR\x10defaultStartTime\x12*\n" +
	"\x11stop_time_enabled\x18\x12 \x01(\bR\x0fstopTimeEnabled\x12J\n" +
	"\x11default_stop_time\x18\x13 \x01(\v2\x1e.api.commons.org.BroadcastTimeR\x0fdefaultStopTime\"r\n" +
	"\rBroadcastTime\x12\x14\n" +
	"\x05hours\x18\x01 \x01(\x05R\x05hours\x12\x18\n" +
	"\aminutes\x18\x02 \x01(\x05R\aminutes\x121\n" +
	"\btimezone\x18\x03 \x01(\x0e2\x15.api.commons.TimeZoneR\btimezone\"\xbe\x06\n" +
	"\x13SchedulePreferences\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x12@\n" +
	"\x1ddisplay_schedule_by_time_zone\x18\n" +
	" \x01(\bR\x19displayScheduleByTimeZone\x128\n" +
	"\x19use_schedule_by_time_zone\x18\v \x01(\bR\x15useScheduleByTimeZone\x12b\n" +
	"\x1bschedule_by_time_zone_scope\x18\f \x01(\x0e2$.api.commons.ScheduleByTimeZoneScopeR\x17scheduleByTimeZoneScope\x12;\n" +
	"\x1adisplay_schedule_as_paused\x18\r \x01(\bR\x17displayScheduleAsPaused\x12,\n" +
	"\x12schedule_as_paused\x18\x0e \x01(\bR\x10scheduleAsPaused\x12@\n" +
	"\x1cdefault_completion_threshold\x18\x0f \x01(\x03R\x1adefaultCompletionThreshold\x128\n" +
	"\x18display_campaign_linking\x18\x10 \x01(\bR\x16displayCampaignLinking\x120\n" +
	"\x14use_campaign_linking\x18\x11 \x01(\bR\x12useCampaignLinking\x12^\n" +
	"\x0ecampaign_links\x18\x12 \x03(\v27.api.commons.org.SchedulePreferences.CampaignLinksEntryR\rcampaignLinks\x127\n" +
	"\x18default_campaign_link_id\x18\x13 \x01(\tR\x15defaultCampaignLinkId\x12<\n" +
	"\x1aresend_cancelled_campaigns\x18\x14 \x01(\bR\x18resendCancelledCampaigns\x1a@\n" +
	"\x12CampaignLinksEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xbf\x01\n" +
	"\x13EmailSmsPreferences\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x12(\n" +
	"\x10use_custom_links\x18\n" +
	" \x01(\bR\x0euseCustomLinks\x125\n" +
	"\x16client_acknowledgement\x18\v \x01(\bR\x15clientAcknowledgement\x120\n" +
	"\x14email_from_addresses\x18\f \x03(\tR\x12emailFromAddresses\"\x8d\x02\n" +
	"\x13BusinessPreferences\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x12\"\n" +
	"\rweeks_of_data\x18\n" +
	" \x01(\x05R\vweeksOfData\x125\n" +
	"\ttime_zone\x18\v \x01(\x0e2\x18.api.commons.AnaTimeZoneR\btimeZone\x12.\n" +
	"\x13multi_client_access\x18\f \x01(\bR\x11multiClientAccess\x123\n" +
	"\x15custom_visualizations\x18\r \x01(\bR\x14customVisualizations\x12\x1f\n" +
	"\vtime_filter\x18\x0e \x01(\tR\n" +
	"timeFilter\"\xf7\x01\n" +
	"\x15ScorecardsPreferences\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x124\n" +
	"\x16call_sample_percentage\x18\x02 \x01(\rR\x14callSamplePercentage\x120\n" +
	"\x14max_user_evaluations\x18\x03 \x01(\rR\x12maxUserEvaluations\x12_\n" +
	"\x13evaluation_interval\x18\x04 \x01(\x0e2..api.commons.org.Scorecards.EvaluationIntervalR\x12evaluationInterval\"\x88\x01\n" +
	"\n" +
	"Scorecards\"z\n" +
	"\x12EvaluationInterval\x12'\n" +
	"#EVALUATION_INTERVAL_DAY_UNSPECIFIED\x10\x00\x12\x1c\n" +
	"\x18EVALUATION_INTERVAL_WEEK\x10\x01\x12\x1d\n" +
	"\x19EVALUATION_INTERVAL_MONTH\x10\x02\"\xca\x03\n" +
	"\x19VoiceAnalyticsPreferences\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x12\x18\n" +
	"\aenabled\x18\x02 \x01(\bR\aenabled\x12>\n" +
	"\x06redact\x18\x03 \x03(\v2&.api.commons.org.VoiceAnalytics.RedactR\x06redact\x12>\n" +
	"\x06notify\x18\x04 \x01(\v2&.api.commons.org.VoiceAnalytics.NotifyR\x06notify\x12M\n" +
	"\x0ebilling_notify\x18\x05 \x01(\v2&.api.commons.org.VoiceAnalytics.NotifyR\rbillingNotify\x12#\n" +
	"\rnumber_format\x18\x06 \x01(\tR\fnumberFormat\x12*\n" +
	...
	"\fKIND_ORDINAL\x10\x01\x12\f\n" +
	"\bKIND_ANY\x10\x02\x1a\x1c\n" +
	"\x06Notify\x12\x12\n" +
	"\x04cron\x18\x01 \x01(\tR\x04cron\"\x95\x02\n" +
	"\x13EndOfDayPreferences\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x12\x1d\n" +
	"\n" +
	"eod_monday\x18\n" +
	" \x01(\x05R\teodMonday\x12\x1f\n" +
	"\veod_tuesday\x18\v \x01(\x05R\n" +
	"eodTuesday\x12#\n" +
	"\reod_wednesday\x18\f \x01(\x05R\feodWednesday\x12!\n" +
	"\feod_thursday\x18\r \x01(\x05R\veodThursday\x12\x1d\n" +
	"\n" +
	"eod_friday\x18\x0e \x01(\x05R\teodFriday\x12!\n" +
	"\feod_saturday\x18\x0f \x01(\x05R\veodSaturday\x12\x1d\n" +
	"\n" +
	"eod_sunday\x18\x10 \x01(\x05R\teodSunday\"\xea\x02\n" +
	"\x11FilterPreferences\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x12Z\n" +
	"\x1adefault_auto_report_filter\x18\n" +
	" \x01(\v2\x1d.api.commons.org.ReportFilterR\x17defaultAutoReportFilter\x125\n" +
	"\x17send_empty_auto_reports\x18\v \x01(\bR\x14sendEmptyAutoReports\x12E\n" +
	"\x1fdisplay_broadcast_resend_filter\x18\f \x01(\bR\x1cdisplayBroadcastResendFilter\x12d\n" +
	"\x1fdefault_broadcast_resend_filter\x18\r \x01(\v2\x1d.api.commons.org.ReportFilterR\x1cdefaultBroadcastResendFilter\"s\n" +
	"\fReportFilter\x12?\n" +
	"\bstandard\x18\x01 \x01(\x0e2!.api.commons.StandardReportFilterH\x00R\bstandard\x12\x18\n" +
	"\x06custom\x18\x02 \x01(\x03H\x00R\x06customB\b\n" +
	"\x06choice\"\xac\x03\n" +
	"\x14RecordingPreferences\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x12-\n" +
	"\x12convention_enabled\x18\n" +
	" \x01(\bR\x11conventionEnabled\x12a\n" +
	"\x14file_name_convention\x18\v \x01(\v2/.api.commons.org.RecordingsFileNamingConventionR\x12fileNameConvention\x124\n" +
	"\x16zip_convention_enabled\x18\f \x01(\bR\x14zipConventionEnabled\x12k\n" +
	"\x18zip_file_name_convention\x18\r \x01(\v22.api.commons.org.RecordingsZipFileNamingConventionR\x15zipFileNameConvention\x12H\n" +
	"\x10export_file_type\x18\x0e \x01(\x0e2\x1e.api.commons.RecordingFileTypeR\x0eexportFileType\"\xdb\x02\n" +
	"\x1eRecordingsFileNamingConvention\x125\n" +
	"\x17xml_client_property_sid\x18\x01 \x01(\x03R\x14xmlClientPropertySid\x12?\n" +
	"\ainbound\x18\x02 \x01(\v2%.api.commons.org.FileNamingConventionR\ainbound\x12=\n" +
	"\x06manual\x18\x03 \x01(\v2%.api.commons.org.FileNamingConventionR\x06manual\x12A\n" +
	"\boutbound\x18\x04 \x01(\v2%.api.commons.org.FileNamingConventionR\boutbound\x12?\n" +
	"\apreview\x18\x05 \x01(\v2%.api.commons.org.FileNamingConventionR\apreview\"\xe0\x02\n" +
	"!RecordingsZipFileNamingConvention\x125\n" +
	"\x17xml_client_property_sid\x18\x01 \x01(\x03R\x14xmlClientPropertySid\x12?\n" +
	"\ainbound\x18\x02 \x01(\v2%.api.commons.org.FileNamingConventionR\ainbound\x12=\n" +
	"\x06manual\x18\x03 \x01(\v2%.api.commons.org.FileNamingConventionR\x06manual\x12A\n" +
	"\boutbound\x18\x04 \x01(\v2%.api.commons.org.FileNamingConventionR\boutbound\x12A\n" +
	"\bcombined\x18\x05 \x01(\v2%.api.commons.org.FileNamingConventionR\bcombined\"T\n" +
	"\x14FileNamingConvention\x12<\n" +
	"\bsegments\x18\x01 \x03(\v2 .api.commons.org.FileNameSegmentR\bsegments\"}\n" +
	"\x0fFileNameSegment\x12!\n" +
	"\fsegment_type\x18\x01 \x01(\tR\vsegmentType\x12%\n" +
	"\x0eformat_pattern\x18\x02 \x01(\tR\rformatPattern\x12 \n" +
	"\ftime_zone_id\x18\x03 \x01(\tR\n" +
	"timeZoneId\"\xe2\x03\n" +
	"\x16AdminClientPreferences\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x120\n" +
	"\x14use_reserved_carrier\x18\n" +
	" \x01(\bR\x12useReservedCarrier\x12+\n" +
	"\x11reserved_carriers\x18\v \x03(\tR\x10reservedCarriers\x12\x1b\n" +
	"\temail_key\x18\f \x01(\tR\bemailKey\x12\x19\n" +
	"\bemail_id\x18\r \x01(\tR\aemailId\x12\x1d\n" +
	"\n" +
	"email_name\x18\x0e \x01(\tR\temailName\x12#\n" +
	"\rwhitelist_ips\x18\x0f \x03(\tR\fwhitelistIps\x12+\n" +
	"\x11whitelist_domains\x18\x10 \x03(\tR\x10whitelistDomains\x120\n" +
	"\x14callbacks_service_id\x18\x11 \x01(\tR\x12callbacksServiceId\x124\n" +
	"\x16agent_screen_recording\x18\x12 \x01(\bR\x14agentScreenRecording\x12A\n" +
	"\x11allowed_countries\x18\x13 \x03(\x0e2\x14.api.commons.CountryR\x10allowedCountries\"\xfd\x02\n" +
	"\rBusinessHours\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x12 \n" +
	"\vdescription\x18\x04 \x01(\tR\vdescription\x12*\n" +
	"\x11business_hours_id\x18\x06 \x01(\tR\x0fbusinessHoursId\x12.\n" +
	"\x13business_hours_name\x18\a \x01(\tR\x11businessHoursName\x121\n" +
	"\btimezone\x18\b \x01(\x0e2\x15.api.commons.TimeZoneR\btimezone\x12A\n" +
	"\rday_intervals\x18\t \x03(\v2\x1c.api.commons.org.DayIntervalR\fdayIntervals\x12=\n" +
	"\flast_updated\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampR\vlastUpdatedJ\x04\b\x02\x10\x03J\x04\b\x03\x10\x04J\x04\b\x05\x10\x06R\x02idR\x04nameR\x06ranges\"\x87\x01\n" +
	"\x05Range\x12\x1d\n" +
	"\n" +
	"start_hour\x18\x01 \x01(\x05R\tstartHour\x12!\n" +
	"\fstart_minute\x18\x02 \x01(\x05R\vstartMinute\x12\x19\n" +
	"\bend_hour\x18\x03 \x01(\x05R\aendHour\x12\x1d\n" +
	"\n" +
	...
	"\vDayInterval\x12+\n" +
	"\x03day\x18\x01 \x01(\x0e2\x19.api.commons.Weekday.EnumR\x03day\x120\n" +
	"\x05start\x18\x02 \x01(\v2\x1a.api.commons.org.TimeOfDayR\x05start\x12,\n" +
	"\x03end\x18\x03 \x01(\v2\x1a.api.commons.org.TimeOfDayR\x03end\"w\n" +
	"\fMonthDayDate\x12\x1b\n" +
	"\tdate_name\x18\x01 \x01(\tR\bdateName\x12(\n" +
	"\x05month\x18\x02 \x01(\x0e2\x12.api.commons.MonthR\x05month\x12 \n" +
	"\fday_of_month\x18\x03 \x01(\x05R\n" +
	"dayOfMonth\"\xb8\x01\n" +
	"\x0eCountryHoliday\x12!\n" +
	"\fholiday_name\x18\x01 \x01(\tR\vholidayName\x122\n" +
	"\acountry\x18\x02 \x01(\x0e2\x14.api.commons.CountryB\x02\x18\x01R\acountry\x12!\n" +
	"\fcountry_name\x18\x03 \x01(\tR\vcountryName\x12\x14\n" +
	"\x05types\x18\x04 \x03(\tR\x05types\x12\x16\n" +
	"\x06states\x18\x05 \x03(\tR\x06states\"\x8a\x01\n" +
	"\rProgrammedDay\x121\n" +
	"\x03day\x18\x01 \x01(\v2\x1d.api.commons.org.MonthDayDateH\x00R\x03day\x12;\n" +
	"\aholiday\x18\x02 \x01(\v2\x1f.api.commons.org.CountryHolidayH\x00R\aholidayB\t\n" +
	"\aDayType\"\xd4\x02\n" +
	"\x0fProgrammedDates\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x12.\n" +
	"\x13programmed_dates_id\x18\x02 \x01(\tR\x11programmedDatesId\x122\n" +
	"\x15programmed_dates_name\x18\x03 \x01(\tR\x13programmedDatesName\x12 \n" +
	"\vdescription\x18\x04 \x01(\tR\vdescription\x121\n" +
	"\btimezone\x18\x05 \x01(\x0e2\x15.api.commons.TimeZoneR\btimezone\x122\n" +
	"\x04days\x18\x06 \x03(\v2\x1e.api.commons.org.ProgrammedDayR\x04days\x12=\n" +
	"\flast_updated\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\vlastUpdated\"\xdb\x02\n" +
	"\x10ObservedHolidays\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x120\n" +
	"\x14observed_holidays_id\x18\x02 \x01(\tR\x12observedHolidaysId\x124\n" +
	"\x16observed_holidays_name\x18\x03 \x01(\tR\x14observedHolidaysName\x12 \n" +
	"\vdescription\x18\x04 \x01(\tR\vdescription\x121\n" +
	"\btimezone\x18\x05 \x01(\x0e2\x15.api.commons.TimeZoneR\btimezone\x124\n" +
	"\x04days\x18\x06 \x03(\v2 .api.commons.org.ObservedHolidayR\x04days\x12=\n" +
	"\flast_updated\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\vlastUpdated\"\x8c\x01\n" +
	"\x0fObservedHoliday\x121\n" +
	"\x03day\x18\x01 \x01(\v2\x1d.api.commons.org.MonthDayDateH\x00R\x03day\x12;\n" +
	"\aholiday\x18\x02 \x01(\v2\x1f.api.commons.org.CountryHolidayH\x00R\aholidayB\t\n" +
	"\aDayType\"\xff\x02\n" +
	"\x0fCertificateInfo\x12.\n" +
	"\x13certificate_info_id\x18\x01 \x01(\tR\x11certificateInfoId\x12\x15\n" +
	...
	"\adeleted\x18\t \x01(\bR\adeleted\x12\x18\n" +
	"\arevoked\x18\n" +
	" \x01(\bR\arevoked:\x02\x18\x01B\xb1\x01\n" +
	"\x13com.api.commons.orgB\x10PreferencesProtoP\x01Z*github.com/tcncloud/api-go/api/commons/org\xa2\x02\x03ACO\xaa\x02\x0fApi.Commons.Org\xca\x02\x0fApi\\Commons\\Org\xe2\x02\x1bApi\\Commons\\Org\\GPBMetadata\xea\x02\x11Api::Commons::Orgb\x06proto3"
