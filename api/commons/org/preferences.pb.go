...
func (x *ImportFormat) GetStandard() commons.StandardImportFormat {
	if x != nil {
		if x, ok := x.Format.(*ImportFormat_Standard); ok {
			return x.Standard
		}
	}
...
func (x *ImportFormat) GetCustom() *CustomImportFormat {
	if x != nil {
		if x, ok := x.Format.(*ImportFormat_Custom); ok {
			return x.Custom
		}
	}
	return nil
...
type ContactAreaCode struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to AreaCode:
	//
	//	*ContactAreaCode_Cfd
...
func (x *ContactAreaCode) GetCfd() *ContactFieldDescription {
	if x != nil {
		if x, ok := x.AreaCode.(*ContactAreaCode_Cfd); ok {
			return x.Cfd
		}
	}
	return nil
...
func (x *ContactAreaCode) GetCustom() int32 {
	if x != nil {
		if x, ok := x.AreaCode.(*ContactAreaCode_Custom); ok {
			return x.Custom
		}
	}
	return 0
...
func (x *DialOrder) GetStandard() commons.DialOrderType {
	if x != nil {
		if x, ok := x.Type.(*DialOrder_Standard); ok {
			return x.Standard
		}
	}
...
func (x *DialOrder) GetCustom() *CustomDialOrder {
	if x != nil {
		if x, ok := x.Type.(*DialOrder_Custom); ok {
			return x.Custom
		}
	}
	return nil
...
type SchedulePreferences struct {
	...
	CampaignLinks map[string]string `protobuf:"bytes,18,rep,name=campaign_links,json=campaignLinks,proto3" json:"campaign_links,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (x *ReportFilter) GetStandard() commons.StandardReportFilter {
	if x != nil {
		if x, ok := x.Choice.(*ReportFilter_Standard); ok {
			return x.Standard
		}
	}
...
func (x *ReportFilter) GetCustom() int64 {
	if x != nil {
		if x, ok := x.Choice.(*ReportFilter_Custom); ok {
			return x.Custom
		}
	}
	return 0
...
type ProgrammedDay struct {
	...
	// A date or holiday
	//
	// Types that are valid to be assigned to DayType:
	//
	//	*ProgrammedDay_Day
...
func (x *ProgrammedDay) GetDay() *MonthDayDate {
	if x != nil {
		if x, ok := x.DayType.(*ProgrammedDay_Day); ok {
			return x.Day
		}
	}
	return nil
...
func (x *ProgrammedDay) GetHoliday() *CountryHoliday {
	if x != nil {
		if x, ok := x.DayType.(*ProgrammedDay_Holiday); ok {
			return x.Holiday
		}
	}
	return nil
...
func (x *ObservedHoliday) GetDay() *MonthDayDate {
	if x != nil {
		if x, ok := x.DayType.(*ObservedHoliday_Day); ok {
			return x.Day
		}
	}
	return nil
...
func (x *ObservedHoliday) GetHoliday() *CountryHoliday {
	if x != nil {
		if x, ok := x.DayType.(*ObservedHoliday_Holiday); ok {
			return x.Holiday
		}
	}
	return nil
...
func (x *VoiceAnalytics_Redact) GetNumber() *VoiceAnalytics_Number {
	if x != nil {
		if x, ok := x.Where.(*VoiceAnalytics_Redact_Number); ok {
			return x.Number
		}
	}
	return nil
