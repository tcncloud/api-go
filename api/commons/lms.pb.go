...
func (x *PaginationTerminator) GetOp() isPaginationTerminator_Op {
	if x != nil {
		return x.Op
	}
	return nil
...
func (x *PaginationTerminator) GetExistsCheck() bool {
	if x != nil {
		if x, ok := x.Op.(*PaginationTerminator_ExistsCheck); ok {
...
func (x *PaginationTerminator) GetNumGreaterThan() float64 {
	if x != nil {
		if x, ok := x.Op.(*PaginationTerminator_NumGreaterThan); ok {
...
func (x *PaginationTerminator) GetNumLessThan() float64 {
	if x != nil {
		if x, ok := x.Op.(*PaginationTerminator_NumLessThan); ok {
...
func (x *PaginationTerminator) GetNumEquals() float64 {
	if x != nil {
		if x, ok := x.Op.(*PaginationTerminator_NumEquals); ok {
			return x.NumEquals
		}
	}
	return 0
...
func (x *PaginationTerminator) GetCountLessThan() int64 {
	if x != nil {
		if x, ok := x.Op.(*PaginationTerminator_CountLessThan); ok {
...
func (x *PaginationTerminator) GetStrEquals() string {
	if x != nil {
		if x, ok := x.Op.(*PaginationTerminator_StrEquals); ok {
			return x.StrEquals
		}
	}
	return ""
...
func (x *PaginationTerminator) GetStrContains() string {
	if x != nil {
		if x, ok := x.Op.(*PaginationTerminator_StrContains); ok {
...
func (x *PaginationTerminator) GetBoolEquals() bool {
	if x != nil {
		if x, ok := x.Op.(*PaginationTerminator_BoolEquals); ok {
			return x.BoolEquals
		}
	}
	return false
...
const file_api_commons_lms_proto_rawDesc = "" +
	"\n" +
	"\x15api/commons/lms.proto\x12\vapi.commons\x1a\x1egoogle/protobuf/wrappers.proto\"N\n" +
	"\vRecordField\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12+\n" +
	"\x04type\x18\x02 \x01(\x0e2\x17.api.commons.RecordTypeR\x04type\"\xce\x02\n" +
	"\vFilePattern\x120\n" +
	"\x04type\x18\x01 \x01(\x0e2\x1c.api.commons.FilePatternTypeR\x04type\x12\x1c\n" +
	"\tdirectory\x18\x02 \x01(\tR\tdirectory\x12\x1a\n" +
	"\bfilename\x18\x03 \x01(\tR\bfilename\x12\x1a\n" +
	"\bprefixes\x18\x04 \x03(\tR\bprefixes\x12\x1f\n" +
	"\vdate_format\x18\x05 \x01(\tR\n" +
	"dateFormat\x12\x16\n" +
	"\x06suffix\x18\x06 \x01(\tR\x06suffix\x12%\n" +
	"\x0efile_extension\x18\a \x01(\tR\rfileExtension\x12\x1f\n" +
	"\vdate_prefix\x18\b \x01(\bR\n" +
	"datePrefix\x126\n" +
	"\n" +
	"day_to_use\x18\t \x01(\x0e2\x18.api.commons.RelativeDayR\bdayToUse\"\xd0\x02\n" +
	"\x13ConstructedFilename\x12I\n" +
	"\x11override_filename\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\x10overrideFilename\x12\x16\n" +
	"\x06prefix\x18\x04 \x01(\tR\x06prefix\x12\x1f\n" +
	"\vdate_format\x18\x05 \x01(\tR\n" +
	"dateFormat\x12\x16\n" +
	"\x06suffix\x18\x06 \x01(\tR\x06suffix\x12%\n" +
	"\x0efile_extension\x18\a \x01(\tR\rfileExtension\x12>\n" +
	"\rdate_position\x18\b \x01(\x0e2\x19.api.commons.DatePositionR\fdatePosition\x126\n" +
	"\n" +
	"day_to_use\x18\t \x01(\x0e2\x18.api.commons.RelativeDayR\bdayToUse\"\xf1\x02\n" +
	"\x14PaginationTerminator\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x16\n" +
	"\x06negate\x18\x02 \x01(\bR\x06negate\x12#\n" +
	"\fexists_check\x18\x03 \x01(\bH\x00R\vexistsCheck\x12*\n" +
	"\x10num_greater_than\x18\x04 \x01(\x01H\x00R\x0enumGreaterThan\x12$\n" +
	"\rnum_less_than\x18\x05 \x01(\x01H\x00R\vnumLessThan\x12\x1f\n" +
	"\n" +
	"num_equals\x18\x06 \x01(\x01H\x00R\tnumEquals\x12(\n" +
	"\x0fcount_less_than\x18\a \x01(\x03H\x00R\rcountLessThan\x12\x1f\n" +
	"\n" +
	"str_equals\x18\b \x01(\tH\x00R\tstrEquals\x12#\n" +
	"\fstr_contains\x18\t \x01(\tH\x00R\vstrContains\x12!\n" +
	"\vbool_equals\x18\n" +
	" \x01(\bH\x00R\n" +
	"boolEqualsB\x04\n" +
	"\x02op\"U\n" +
	"\n" +
	"Expiration\x12+\n" +
	"\x05units\x18\x01 \x01(\x0e2\x15.api.commons.TimeUnitR\x05units\x12\x1a\n" +
	"\bquantity\x18\x02 \x01(\x03R\bquantity*4\n" +
	"\bCronType\x12\x11\n" +
	"\rCRON_TYPE_LMS\x10\x00\x12\x15\n" +
	"\x11CRON_TYPE_JOURNEY\x10\x01*\x8d\x01\n" +
	"\x0eEnrichmentType\x12\x16\n" +
	"\x12ENRICHMENT_TYPE_OR\x10\x00\x12\x17\n" +
	"\x13ENRICHMENT_TYPE_XOR\x10\x01\x12\x17\n" +
	"\x13ENRICHMENT_TYPE_AND\x10\x02\x12\x18\n" +
	"\x14ENRICHMENT_TYPE_JOIN\x10\x03\x12\x17\n" +
	"\x13ENRICHMENT_TYPE_NOT\x10\x04*?\n" +
	"\rPrimarySource\x12\x16\n" +
	"\x12PRIMARY_SOURCE_LMS\x10\x00\x12\x16\n" +
	"\x12PRIMARY_SOURCE_CJS\x10\x01*=\n" +
	"\x0eDedupKeyPolicy\x12\x0e\n" +
	"\n" +
	"KEEP_FIRST\x10\x00\x12\r\n" +
	"\tKEEP_LAST\x10\x01\x12\f\n" +
	"\bKEEP_ALL\x10\x02*I\n" +
	"\aRunType\x12\x14\n" +
	"\x10RUN_TYPE_ENABLED\x10\x00\x12\x15\n" +
	"\x11RUN_TYPE_DISABLED\x10\x01\x12\x11\n" +
	"\rRUN_TYPE_TEST\x10\x02*P\n" +
	"\x11ConsentActionType\x12\x1b\n" +
	"\x17CONSENT_ACTION_TYPE_ADD\x10\x00\x12\x1e\n" +
	"\x1aCONSENT_ACTION_TYPE_REVOKE\x10\x01*\xbb\x05\n" +
	"\n" +
	"RecordType\x12\x13\n" +
	...
	"\x17RECORD_TYPE_POSTAL_CODE\x10\a\x12\x15\n" +
	"\x11RECORD_TYPE_EMAIL\x10\b\x12\x1c\n" +
	"\x18RECORD_TYPE_DATETIME_NOW\x10\t\x12\"\n" +
	"\x1eRECORD_TYPE_DATETIME_TIMESTAMP\x10\n" +
	"\x12\x1d\n" +
	"\x19RECORD_TYPE_DATETIME_DATE\x10\v\x12&\n" +
	"\"RECORD_TYPE_DATETIME_MONTH_AND_DAY\x10\f\x12$\n" +
	...
	"\tFieldType\x12\x15\n" +
	"\x11FIELD_TYPE_STRING\x10\x00\x12\x15\n" +
	"\x11FIELD_TYPE_NUMBER\x10\x01\x12\x16\n" +
	"\x12FIELD_TYPE_BOOLEAN\x10\x02\x12\x14\n" +
	"\x10FIELD_TYPE_PHONE\x10\x03\x12\x17\n" +
	"\x13FIELD_TYPE_CURRENCY\x10\x04\x12\x14\n" +
	"\x10FIELD_TYPE_EMAIL\x10\x05\x12\x1b\n" +
	"\x17FIELD_TYPE_DATETIME_NOW\x10\x06\x12!\n" +
	"\x1dFIELD_TYPE_DATETIME_TIMESTAMP\x10\a\x12\x1c\n" +
	"\x18FIELD_TYPE_DATETIME_DATE\x10\b\x12%\n" +
	"!FIELD_TYPE_DATETIME_MONTH_AND_DAY\x10\t\x12#\n" +
	"\x1fFIELD_TYPE_DATETIME_TIME_OF_DAY\x10\n" +
	"\x12\x1a\n" +
	"\x16FIELD_TYPE_POSTAL_CODE\x10\f\x12\x1d\n" +
	"\x19FIELD_TYPE_ENRICHED_PHONE\x10\r\x12\x1b\n" +
	"\x17FIELD_TYPE_ENRICHED_ZIP\x10\x0e\x12\x15\n" +
	"\x11FIELD_TYPE_SOCIAL\x10\x0f\x12\x1c\n" +
	"\x18FIELD_TYPE_DATE_OF_BIRTH\x10\x10\x12\x18\n" +
	"\x14FIELD_TYPE_FULL_NAME\x10\x11\x12\x1d\n" +
	"\x19FIELD_TYPE_ACCOUNT_NUMBER\x10\x12\x12\x14\n" +
	"\x10FIELD_TYPE_ERROR\x10\x13\x12\x1b\n" +
	"\x17FIELD_TYPE_STRUCT_VALUE\x10\x14\x12\x1a\n" +
	"\x16FIELD_TYPE_EHR_DETAILS\x10\x15*\x88\x01\n" +
	"\n" +
	"FileFormat\x12\x13\n" +
	"\x0fFILE_FORMAT_CSV\x10\x00\x12\x1c\n" +
	"\x18FILE_FORMAT_CUSTOM_DELIM\x10\x01\x12\x1c\n" +
	"\x18FILE_FORMAT_FIXED_FORMAT\x10\x02\x12\x13\n" +
	"\x0fFILE_FORMAT_TAB\x10\x03\x12\x14\n" +
	"\x10FILE_FORMAT_JSON\x10\x04*\xc6\x01\n" +
	...
	"\x0eEntrypointType\x12\x17\n" +
	"\x13ENTRYPOINT_TYPE_NON\x10\x00\x12\x17\n" +
	"\x13ENTRYPOINT_TYPE_API\x10\x01\x12\x18\n" +
	"\x14ENTRYPOINT_TYPE_SFTP\x10\x02*\xd3\x01\n" +
	"\x13DuplicatePolicyType\x124\n" +
	"0DUPLICATE_POLICY_TYPE_KEEP_RECORD_DISCARD_NUMBER\x10\x00\x122\n" +
	...
	"\x10AbsentPolicyType\x12\x1b\n" +
	"\x17ABSENT_POLICY_TYPE_KEEP\x10\x00\x12\x1e\n" +
	"\x1aABSENT_POLICY_TYPE_DISCARD\x10\x01*c\n" +
	"\rDialOrderType\x12\x19\n" +
	"\x15DIAL_ORDER_TYPE_FIRST\x10\x00\x12\x1b\n" +
	"\x17DIAL_ORDER_TYPE_NATURAL\x10\x01\x12\x1a\n" +
	"\x16DIAL_ORDER_TYPE_CUSTOM\x10\x02*<\n" +
	"\n" +
	"ExportType\x12\x18\n" +
	"\x14EXPORT_TYPE_FILENAME\x10\x00\x12\x14\n" +
	"\x10EXPORT_TYPE_SFTP\x10\x01*@\n" +
	"\tSortOrder\x12\x18\n" +
	"\x14SORT_ORDER_ASCENDING\x10\x00\x12\x19\n" +
	"\x15SORT_ORDER_DESCENDING\x10\x01*V\n" +
	"\vCompareType\x12\x17\n" +
	"\x13COMPARE_TYPE_STRING\x10\x00\x12\x17\n" +
	"\x13COMPARE_TYPE_NUMBER\x10\x01\x12\x15\n" +
	"\x11COMPARE_TYPE_BOOL\x10\x02*\x8f\x02\n" +
	"\x0fCompareOperator\x12\x1d\n" +
	"\x19COMPARE_OPERATOR_EQUAL_TO\x10\x00\x12\x1c\n" +
	"\x18COMPARE_OPERATOR_GREATER\x10\x01\x12\"\n" +
	"\x1eCOMPARE_OPERATOR_GREATER_EQUAL\x10\x02\x12\x19\n" +
	"\x15COMPARE_OPERATOR_LESS\x10\x03\x12\x1f\n" +
	"\x1bCOMPARE_OPERATOR_LESS_EQUAL\x10\x04\x12 \n" +
	"\x1cCOMPARE_OPERATOR_STARTS_WITH\x10\x05\x12\x1e\n" +
	"\x1aCOMPARE_OPERATOR_ENDS_WITH\x10\x06\x12\x1d\n" +
	"\x19COMPARE_OPERATOR_CONTAINS\x10\a*>\n" +
	"\rChainOperator\x12\x16\n" +
	"\x12CHAIN_OPERATOR_AND\x10\x00\x12\x15\n" +
	"\x11CHAIN_OPERATOR_OR\x10\x01*\x8a\x01\n" +
	"\fDeDupActions\x12\x1d\n" +
	"\x19DE_DUP_ACTIONS_KEEP_FIRST\x10\x00\x12\x1c\n" +
	"\x18DE_DUP_ACTIONS_KEEP_BOTH\x10\x03\x12\x1c\n" +
	"\x18DE_DUP_ACTIONS_KEEP_LAST\x10\x04\x12\x1f\n" +
	"\x1bDE_DUP_ACTIONS_KEEP_NEITHER\x10\x05*\x84\x01\n" +
	"\fDatePosition\x12\x17\n" +
	"\x13DATE_POSITION_FIRST\x10\x00\x12!\n" +
	"\x1dDATE_POSITION_BEFORE_FILENAME\x10\x01\x12 \n" +
	"\x1cDATE_POSITION_AFTER_FILENAME\x10\x02\x12\x16\n" +
	"\x12DATE_POSITION_LAST\x10\x03*_\n" +
	"\vRelativeDay\x12\x16\n" +
	"\x12RELATIVE_DAY_TODAY\x10\x00\x12\x1a\n" +
	"\x16RELATIVE_DAY_YESTERDAY\x10\x01\x12\x1c\n" +
	"\x18RELATIVE_DAY_LAST_FRIDAY\x10\x02*p\n" +
	"\x0fFilePatternType\x12\x1a\n" +
	"\x16FILE_PATTERN_TYPE_GLOB\x10\x00\x12!\n" +
	"\x1dFILE_PATTERN_TYPE_CONSTRUCTED\x10\x01\x12\x1e\n" +
	"\x1aFILE_PATTERN_TYPE_ORIGINAL\x10\x02*\xb8\x01\n" +
	"\x11DateTimePrecision\x12\x1a\n" +
	"\x16DATETIME_PRECISION_NOW\x10\x00\x12 \n" +
	"\x1cDATETIME_PRECISION_TIMESTAMP\x10\x01\x12\x1b\n" +
	"\x17DATETIME_PRECISION_DATE\x10\x02\x12$\n" +
	" DATETIME_PRECISION_MONTH_AND_DAY\x10\x03\x12\"\n" +
	"\x1eDATETIME_PRECISION_TIME_OF_DAY\x10\x04*1\n" +
	"\bHttpVerb\x12\x11\n" +
	"\rHTTP_VERB_GET\x10\x00\x12\x12\n" +
	"\x0eHTTP_VERB_POST\x10\x01*V\n" +
	"\x12ComplianceListType\x12\x1e\n" +
	"\x1aCOMPLIANCE_LIST_TYPE_SCRUB\x10\x00\x12 \n" +
	"\x1cCOMPLIANCE_LIST_TYPE_CONSENT\x10\x01*\x9e\x01\n" +
	"\n" +
	"EventState\x12\x14\n" +
	"\x10EVENT_STATE_NONE\x10\x00\x12\x17\n" +
	"\x13EVENT_STATE_KICKOFF\x10\x01\x12\x15\n" +
	"\x11EVENT_STATE_CHECK\x10\x02\x12\x17\n" +
	"\x13EVENT_STATE_PROCESS\x10\x03\x12\x17\n" +
	"\x13EVENT_STATE_CLEANUP\x10\x04\x12\x18\n" +
	"\x14EVENT_STATE_FINISHED\x10\x05*F\n" +
	"\bTimeUnit\x12\v\n" +
	...
	"\n" +
	"TIME_HOURS\x10\x03B\x90\x01\n" +
	"\x0fcom.api.commonsB\bLmsProtoP\x01Z&github.com/tcncloud/api-go/api/commons\xa2\x02\x03ACX\xaa\x02\vApi.Commons\xca\x02\vApi\\Commons\xe2\x02\x17Api\\Commons\\GPBMetadata\xea\x02\fApi::Commonsb\x06proto3"

var (
	file_api_commons_lms_proto_rawDescOnce sync.Once
	file_api_commons_lms_proto_rawDescData []byte
)

func file_api_commons_lms_proto_rawDescGZIP() []byte {
	file_api_commons_lms_proto_rawDescOnce.Do(func() {
		file_api_commons_lms_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_commons_lms_proto_rawDesc), len(file_api_commons_lms_proto_rawDesc)))
	})
...
var file_api_commons_lms_proto_goTypes = []any{
...
func file_api_commons_lms_proto_init() {
	...
	file_api_commons_lms_proto_msgTypes[3].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_commons_lms_proto_rawDesc), len(file_api_commons_lms_proto_rawDesc)),
			NumEnums:      28,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
