...
var file_api_commons_callmonitor_proto_rawDesc = []byte{
...
var (
	...
	file_api_commons_callmonitor_proto_rawDescData = file_api_commons_callmonitor_proto_rawDesc
)

func file_api_commons_callmonitor_proto_rawDescGZIP() []byte {
	file_api_commons_callmonitor_proto_rawDescOnce.Do(func() {
		file_api_commons_callmonitor_proto_rawDescData = protoimpl.X.CompressGZIP(file_api_commons_callmonitor_proto_rawDescData)
	})
...
func file_api_commons_callmonitor_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_api_commons_callmonitor_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_api_commons_callmonitor_proto_rawDesc = nil
