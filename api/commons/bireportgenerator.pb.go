...
func file_api_commons_bireportgenerator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_commons_bireportgenerator_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_commons_bireportgenerator_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
