...
type ScrublistAction int32

const (
	ScrublistAction_ADD    ScrublistAction = 0
	ScrublistAction_REMOVE ScrublistAction = 1
)

// Enum value maps for ScrublistAction.
var (
	ScrublistAction_name = map[int32]string{
		0: "ADD",
		1: "REMOVE",
	}
	ScrublistAction_value = map[string]int32{
		"ADD":    0,
		"REMOVE": 1,
	}
)

func (x ScrublistAction) Enum() *ScrublistAction {
	p := new(ScrublistAction)
	*p = x
	return p
}

func (x ScrublistAction) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ScrublistAction) Descriptor() protoreflect.EnumDescriptor {
	return file_api_commons_workflows_omni_proto_enumTypes[0].Descriptor()
}

func (ScrublistAction) Type() protoreflect.EnumType {
	return &file_api_commons_workflows_omni_proto_enumTypes[0]
}

func (x ScrublistAction) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ScrublistAction.Descriptor instead.
func (ScrublistAction) EnumDescriptor() ([]byte, []int) {
...
type OmniNodeScrublist struct {
	...
	Action ScrublistAction `protobuf:"varint,1,opt,name=action,proto3,enum=api.commons.workflows.ScrublistAction" json:"action,omitempty"`
}
...
func (x *OmniNodeScrublist) GetAction() ScrublistAction {
	if x != nil {
		return x.Action
	}
	return ScrublistAction_ADD
}
...
var file_api_commons_workflows_omni_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0xda, 0x01, 0x0a,
	0x0f, 0x4f, 0x6d, 0x6e, 0x69, 0x4e, 0x6f, 0x64, 0x65, 0x57, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b,
	...
	0x33, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x73, 0x2e, 0x77, 0x6f,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x53, 0x0a, 0x11, 0x4f, 0x6d, 0x6e,
	0x69, 0x4e, 0x6f, 0x64, 0x65, 0x53, 0x63, 0x72, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x74, 0x12, 0x3e,
	...
	0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x73, 0x2e, 0x53, 0x63, 0x72, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x74,
	0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x06, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x19,
	0x0a, 0x17, 0x4f, 0x6d, 0x6e, 0x69, 0x4e, 0x6f, 0x64, 0x65, 0x45, 0x6e, 0x64, 0x43, 0x6f, 0x6e,
	0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2a, 0x26, 0x0a, 0x0f, 0x53, 0x63, 0x72,
	0x75, 0x62, 0x6c, 0x69, 0x73, 0x74, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x07, 0x0a, 0x03,
	0x41, 0x44, 0x44, 0x10, 0x00, 0x12, 0x0a, 0x0a, 0x06, 0x52, 0x45, 0x4d, 0x4f, 0x56, 0x45, 0x10,
	0x01, 0x42, 0xce, 0x01, 0x0a, 0x19, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x63, 0x6f,
...
var file_api_commons_workflows_omni_proto_goTypes = []interface{}{
	(ScrublistAction)(0),            // 0: api.commons.workflows.ScrublistAction
	...
	(*OmniNodeWebhook)(nil),         // 5: api.commons.workflows.OmniNodeWebhook
	(*OmniNodeScrublist)(nil),       // 6: api.commons.workflows.OmniNodeScrublist
	(*OmniNodeEndConversation)(nil), // 7: api.commons.workflows.OmniNodeEndConversation
	nil,                             // 8: api.commons.workflows.OmniNodeWebhook.HeadersEntry
}
var file_api_commons_workflows_omni_proto_depIdxs = []int32{
	8, // 0: api.commons.workflows.OmniNodeWebhook.headers:type_name -> api.commons.workflows.OmniNodeWebhook.HeadersEntry
	0, // 1: api.commons.workflows.OmniNodeScrublist.action:type_name -> api.commons.workflows.ScrublistAction
