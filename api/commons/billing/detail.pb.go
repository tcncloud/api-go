...
func file_api_commons_billing_detail_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_commons_billing_detail_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Plan); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_commons_billing_detail_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Detail); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_commons_billing_detail_proto_msgTypes[2].Exporter = func(v any, i int) any {
