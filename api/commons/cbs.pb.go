...
var file_api_commons_cbs_proto_rawDesc = []byte{
	...
	0x04, 0x42, 0x4c, 0x0a, 0x1a, 0x63, 0x6f, 0x6d, 0x2e, 0x74, 0x63, 0x6e, 0x2e, 0x6d, 0x61, 0x74,
...
var (
	...
	file_api_commons_cbs_proto_rawDescData = file_api_commons_cbs_proto_rawDesc
)

func file_api_commons_cbs_proto_rawDescGZIP() []byte {
	file_api_commons_cbs_proto_rawDescOnce.Do(func() {
		file_api_commons_cbs_proto_rawDescData = protoimpl.X.CompressGZIP(file_api_commons_cbs_proto_rawDescData)
	})
	return file_api_commons_cbs_proto_rawDescData
}

var file_api_commons_cbs_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_api_commons_cbs_proto_goTypes = []interface{}{
...
func file_api_commons_cbs_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_api_commons_cbs_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_api_commons_cbs_proto_rawDesc = nil
