...
const (
	...
	SmsNumberProvider_SINCH_SMS_PROVIDER     SmsNumberProvider = 13
	SmsNumberProvider_PRONTO_SMS_PROVIDER    SmsNumberProvider = 12
	SmsNumberProvider_UNKNOWN1_SMS_PROVIDER  SmsNumberProvider = 14
	SmsNumberProvider_UNKNOWN2_SMS_PROVIDER  SmsNumberProvider = 15
	SmsNumberProvider_UNKNOWN3_SMS_PROVIDER  SmsNumberProvider = 16
	SmsNumberProvider_UNKNOWN4_SMS_PROVIDER  SmsNumberProvider = 17
	SmsNumberProvider_UNKNOWN5_SMS_PROVIDER  SmsNumberProvider = 18
	SmsNumberProvider_UNKNOWN6_SMS_PROVIDER  SmsNumberProvider = 19
	SmsNumberProvider_UNKNOWN7_SMS_PROVIDER  SmsNumberProvider = 20
	SmsNumberProvider_UNKNOWN8_SMS_PROVIDER  SmsNumberProvider = 21
	SmsNumberProvider_UNKNOWN9_SMS_PROVIDER  SmsNumberProvider = 22
	SmsNumberProvider_UNKNOWN10_SMS_PROVIDER SmsNumberProvider = 23
)
...
var (
	SmsNumberProvider_name = map[int32]string{
		...
		13: "SINCH_SMS_PROVIDER",
		12: "PRONTO_SMS_PROVIDER",
		14: "UNKNOWN1_SMS_PROVIDER",
		15: "UNKNOWN2_SMS_PROVIDER",
		16: "UNKNOWN3_SMS_PROVIDER",
		17: "UNKNOWN4_SMS_PROVIDER",
		18: "UNKNOWN5_SMS_PROVIDER",
		19: "UNKNOWN6_SMS_PROVIDER",
		20: "UNKNOWN7_SMS_PROVIDER",
		21: "UNKNOWN8_SMS_PROVIDER",
		22: "UNKNOWN9_SMS_PROVIDER",
		23: "UNKNOWN10_SMS_PROVIDER",
	}
	SmsNumberProvider_value = map[string]int32{
		...
		"SINCH_SMS_PROVIDER":     13,
		"PRONTO_SMS_PROVIDER":    12,
		"UNKNOWN1_SMS_PROVIDER":  14,
		"UNKNOWN2_SMS_PROVIDER":  15,
		"UNKNOWN3_SMS_PROVIDER":  16,
		"UNKNOWN4_SMS_PROVIDER":  17,
		"UNKNOWN5_SMS_PROVIDER":  18,
		"UNKNOWN6_SMS_PROVIDER":  19,
		"UNKNOWN7_SMS_PROVIDER":  20,
		"UNKNOWN8_SMS_PROVIDER":  21,
		"UNKNOWN9_SMS_PROVIDER":  22,
		"UNKNOWN10_SMS_PROVIDER": 23,
	}
)
...
type OmniTaskCarryOverBehavior int32

const (
	OmniTaskCarryOverBehavior_OMNI_TASK_CARRY_OVER_PAUSE  OmniTaskCarryOverBehavior = 0
	OmniTaskCarryOverBehavior_OMNI_TASK_CARRY_OVER_CANCEL OmniTaskCarryOverBehavior = 1
)

// Enum value maps for OmniTaskCarryOverBehavior.
var (
	OmniTaskCarryOverBehavior_name = map[int32]string{
		0: "OMNI_TASK_CARRY_OVER_PAUSE",
		1: "OMNI_TASK_CARRY_OVER_CANCEL",
	}
	OmniTaskCarryOverBehavior_value = map[string]int32{
		"OMNI_TASK_CARRY_OVER_PAUSE":  0,
		"OMNI_TASK_CARRY_OVER_CANCEL": 1,
	}
)

func (x OmniTaskCarryOverBehavior) Enum() *OmniTaskCarryOverBehavior {
	p := new(OmniTaskCarryOverBehavior)
	*p = x
	return p
}

func (x OmniTaskCarryOverBehavior) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (OmniTaskCarryOverBehavior) Descriptor() protoreflect.EnumDescriptor {
	return file_api_commons_omnichannel_proto_enumTypes[24].Descriptor()
}

func (OmniTaskCarryOverBehavior) Type() protoreflect.EnumType {
	return &file_api_commons_omnichannel_proto_enumTypes[24]
}

func (x OmniTaskCarryOverBehavior) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use OmniTaskCarryOverBehavior.Descriptor instead.
func (OmniTaskCarryOverBehavior) EnumDescriptor() ([]byte, []int) {
...
type OmniCampaignModule struct {
	...
	TaskCarryOverBehavior OmniTaskCarryOverBehavior `protobuf:"varint,15,opt,name=task_carry_over_behavior,json=taskCarryOverBehavior,proto3,enum=api.commons.OmniTaskCarryOverBehavior" json:"task_carry_over_behavior,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *OmniCampaignModule) GetTaskCarryOverBehavior() OmniTaskCarryOverBehavior {
	if x != nil {
		return x.TaskCarryOverBehavior
	}
	return OmniTaskCarryOverBehavior_OMNI_TASK_CARRY_OVER_PAUSE
}
...
type OmniConversation struct {
	...
	// the id of the task
	TaskSid       *wrapperspb.Int64Value `protobuf:"bytes,24,opt,name=task_sid,json=taskSid,proto3" json:"task_sid,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *OmniConversation) GetTaskSid() *wrapperspb.Int64Value {
	if x != nil {
		return x.TaskSid
	}
	return nil
...
const file_api_commons_omnichannel_proto_rawDesc = "" +
	"\n" +
	"\x1dapi/commons/omnichannel.proto\x12\vapi.commons\x1a\x16api/commons/chat.proto\x1a\x17api/commons/enums.proto\x1a\x15api/commons/lms.proto\x1a\x15api/commons/org.proto\x1a\x17api/commons/types.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\xe9\x05\n" +
	"\fOmniCampaign\x12%\n" +
	"\fcampaign_sid\x18\x01 \x01(\x03B\x020\x01R\vcampaignSid\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12?\n" +
	"\x06skills\x18\x04 \x01(\v2#.api.commons.OmniConversationSkillsB\x02\x18\x01R\x06skills\x129\n" +
	"\n" +
	"start_date\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\tstartDate\x127\n" +
	"\x06status\x18\x06 \x01(\x0e2\x1f.api.commons.OmniCampaignStatusR\x06status\x12;\n" +
	"\fchannel_type\x18\a \x01(\x0e2\x18.api.commons.ChannelTypeR\vchannelType\x12=\n" +
	"\fdate_created\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\vdateCreated\x12?\n" +
	"\rdate_modified\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\fdateModified\x12#\n" +
	"\vproject_sid\x18\n" +
	" \x01(\x03B\x020\x01R\n" +
	"projectSid\x129\n" +
	"\amodules\x18\v \x03(\v2\x1f.api.commons.OmniCampaignModuleR\amodules\x129\n" +
	"\ttime_zone\x18\f \x01(\v2\x1c.api.commons.TimeZoneWrapperR\btimeZone\x12\x1f\n" +
	"\vshorten_url\x18\r \x01(\bR\n" +
	"shortenUrl\x12N\n" +
	"\x11compliance_config\x18\x0e \x01(\v2!.api.commons.OmniComplianceConfigR\x10complianceConfig\"\xba\f\n" +
	...
	"\vmodule_type\x18\x03 \x01(\x0e2#.api.commons.OmniCampaignModuleTypeR\n" +
	"moduleType\x12=\n" +
	"\x06status\x18\x04 \x01(\x0e2%.api.commons.OmniCampaignModuleStatusR\x06status\x12=\n" +
	"\x06config\x18\x05 \x01(\v2%.api.commons.OmniCampaignModuleConfigR\x06config\x12=\n" +
	"\fdate_created\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\vdateCreated\x12?\n" +
	"\rdate_modified\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\fdateModified\x12J\n" +
	"\x13scheduled_stop_date\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\x11scheduledStopDate\x12D\n" +
	"\x10actual_stop_date\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\x0eactualStopDate\x12K\n" +
	...
	"\x18global_timezone_ordering\x18\x0e \x01(\bR\x16globalTimezoneOrdering\x12_\n" +
	"\x18task_carry_over_behavior\x18\x0f \x01(\x0e2&.api.commons.OmniTaskCarryOverBehaviorR\x15taskCarryOverBehavior\x1a\xaa\x04\n" +
	"\aDetails\x12E\n" +
	...
	"\x17connected_inbox_address\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\x15connectedInboxAddress\x12R\n" +
	"\x16verified_email_address\x18\x04 \x01(\v2\x1c.google.protobuf.StringValueR\x14verifiedEmailAddress\x12I\n" +
	"\x12pending_task_count\x18\x05 \x01(\v2\x1b.google.protobuf.Int64ValueR\x10pendingTaskCount\x12G\n" +
	"\x11failed_task_count\x18\x06 \x01(\v2\x1b.google.protobuf.Int64ValueR\x0ffailedTaskCount\x12K\n" +
	"\x13canceled_task_count\x18\a \x01(\v2\x1b.google.protobuf.Int64ValueR\x11canceledTaskCount\"\xf3\r\n" +
	"\x18OmniCampaignModuleConfig\x12D\n" +
	"\x0fapi_key_primary\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\rapiKeyPrimary\x12H\n" +
	"\x11api_key_secondary\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x0fapiKeySecondary\x12K\n" +
	"\x10color_properties\x18\x03 \x01(\v2 .api.commons.ChatColorPropertiesR\x0fcolorProperties\x12D\n" +
	"\x13connected_inbox_sid\x18\x04 \x01(\v2\x14.api.commons.Int64IdR\x11connectedInboxSid\x12<\n" +
	"\fdispositions\x18\x05 \x03(\v2\x18.api.commons.DispositionR\fdispositions\x122\n" +
	"\x05email\x18\x06 \x01(\v2\x1c.google.protobuf.StringValueR\x05email\x12?\n" +
	"\fmessage_body\x18\a \x01(\v2\x1c.google.protobuf.StringValueR\vmessageBody\x12A\n" +
	"\remail_subject\x18\b \x01(\v2\x1c.google.protobuf.StringValueR\femailSubject\x125\n" +
	"\n" +
	"sms_number\x18\t \x01(\v2\x16.api.commons.SmsNumberR\tsmsNumber\x12/\n" +
	"\x06header\x18\n" +
	" \x01(\v2\x17.api.commons.ChatHeaderR\x06header\x12;\n" +
	"\fsla_timeouts\x18\v \x01(\v2\x18.api.commons.SLATimeoutsR\vslaTimeouts\x12A\n" +
	"\x0esends_per_hour\x18\f \x01(\v2\x1b.google.protobuf.Int64ValueR\fsendsPerHour\x12F\n" +
	"\x14unsubscribe_link_sid\x18\r \x01(\v2\x14.api.commons.Int64IdR\x12unsubscribeLinkSid\x12B\n" +
	"\x12verified_email_sid\x18\x0f \x01(\v2\x14.api.commons.Int64IdR\x10verifiedEmailSid\x12K\n" +
	"\x14stop_on_task_deplete\x18\x10 \x01(\v2\x1a.google.protobuf.BoolValueR\x11stopOnTaskDeplete\x12=\n" +
	"\vattachments\x18\x11 \x03(\v2\x1b.api.commons.OmniAttachmentR\vattachments\x12Q\n" +
	"\x16compliance_rule_set_id\x18\x12 \x01(\v2\x1c.google.protobuf.StringValueR\x13complianceRuleSetId\x12,\n" +
	"\x12payment_portal_ids\x18\x13 \x03(\tR\x10paymentPortalIds\x12-\n" +
	"\aflow_id\x18\x14 \x01(\v2\x14.api.commons.Int64IdR\x06flowId\x12;\n" +
	"\x06skills\x18\x15 \x01(\v2#.api.commons.OmniConversationSkillsR\x06skills\x12D\n" +
	"\x0fwhatsapp_number\x18\x16 \x01(\v2\x1b.api.commons.WhatsAppNumberR\x0ewhatsappNumber\x12h\n" +
	"\x11provider_metadata\x18\x17 \x03(\v2;.api.commons.OmniCampaignModuleConfig.ProviderMetadataEntryR\x10providerMetadata\x12!\n" +
	"\fcountry_code\x18\x18 \x01(\x05R\vcountryCode\x12(\n" +
	"\x10country_code_sid\x18\x1b \x01(\x03R\x0ecountryCodeSid\x12*\n" +
	"\x11postal_code_field\x18\x19 \x01(\tR\x0fpostalCodeField\x12c\n" +
	"\x16timeout_message_config\x18\x1a \x01(\v2-.api.commons.ConversationTimeoutMessageConfigR\x14timeoutMessageConfig\x1aC\n" +
	"\x15ProviderMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"U\n" +
	" ConversationTimeoutMessageConfig\x12\x1f\n" +
	"\vis_disabled\x18\x01 \x01(\bR\n" +
	"isDisabled\x12\x10\n" +
	"\x03msg\x18\x02 \x01(\tR\x03msg\"\xb2\x01\n" +
	"\tSmsNumber\x12\x16\n" +
	"\x06number\x18\x01 \x01(\tR\x06number\x12.\n" +
	"\x04type\x18\x02 \x01(\x0e2\x1a.api.commons.SmsNumberTypeR\x04type\x12:\n" +
	"\bprovider\x18\x03 \x01(\x0e2\x1e.api.commons.SmsNumberProviderR\bprovider\x12!\n" +
	"\fcountry_code\x18\x04 \x01(\x05R\vcountryCode\"}\n" +
	"\x1fConversationCustomerInformation\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12!\n" +
	"\fphone_number\x18\x02 \x01(\tR\vphoneNumber\x12#\n" +
	"\remail_address\x18\x03 \x01(\tR\femailAddress\"s\n" +
	"\vSLATimeouts\x12\x0e\n" +
	...
	"\x03t11\x18\v \x01(\x03R\x03t11\x12\x10\n" +
	"\x03t12\x18\f \x01(\x03R\x03t12\"^\n" +
	"\x19ConversationCollectedData\x12A\n" +
	"\x05items\x18\x01 \x03(\v2+.api.commons.ConversationCollectedData_ItemR\x05items\"\xd2\x02\n" +
	"\x1eConversationCollectedData_Item\x12I\n" +
	"\x1fconversation_collected_data_sid\x18\x01 \x01(\x03B\x020\x01R\x1cconversationCollectedDataSid\x12-\n" +
	"\x10conversation_sid\x18\x02 \x01(\x03B\x020\x01R\x0fconversationSid\x12\x1b\n" +
	"\tdata_name\x18\x03 \x01(\tR\bdataName\x12\x1d\n" +
	"\n" +
	"data_value\x18\x04 \x01(\tR\tdataValue\x12C\n" +
	"\x0fcollection_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\x0ecollectionTime\x125\n" +
	"\auser_id\x18\x06 \x01(\v2\x1c.google.protobuf.StringValueR\x06userId\"\x9e\a\n" +
	"\vOmniMessage\x12#\n" +
	"\vmessage_sid\x18\x01 \x01(\x03B\x020\x01R\n" +
	"messageSid\x125\n" +
	"\auser_id\x18\x04 \x01(\v2\x1c.google.protobuf.StringValueR\x06userId\x12\x1b\n" +
	"\tsent_from\x18\x05 \x01(\tR\bsentFrom\x12\x17\n" +
	"\asent_to\x18\x06 \x01(\tR\x06sentTo\x12;\n" +
	"\fchannel_type\x18\a \x01(\x0e2\x18.api.commons.ChannelTypeR\vchannelType\x12?\n" +
	"\freference_id\x18\b \x01(\v2\x1c.google.protobuf.StringValueR\vreferenceId\x12&\n" +
	"\x0fui_reference_id\x18\n" +
	" \x01(\tR\ruiReferenceId\x129\n" +
	"\apayload\x18\v \x01(\v2\x1f.api.commons.OmniMessagePayloadR\apayload\x12?\n" +
	"\x10conversation_sid\x18\f \x01(\v2\x14.api.commons.Int64IdR\x0fconversationSid\x126\n" +
	"\x06status\x18\x0e \x01(\x0e2\x1e.api.commons.OmniMessageStatusR\x06status\x12=\n" +
	...
	"\fcampaign_sid\x18\x11 \x01(\x03B\x020\x01R\vcampaignSid\x126\n" +
	"\asubject\x18\x13 \x01(\v2\x1c.google.protobuf.StringValueR\asubject\x12<\n" +
	"\vsender_type\x18\x15 \x01(\x0e2\x1b.api.commons.OmniSenderTypeR\n" +
	"senderType\x12C\n" +
	"\x0estatus_message\x18\x16 \x01(\v2\x1c.google.protobuf.StringValueR\rstatusMessage\x12A\n" +
	"\x0emessage_format\x18\x17 \x01(\x0e2\x1a.api.commons.MessageFormatR\rmessageFormat\"\xc3\x02\n" +
	"\x19CustomerChatWidgetMessage\x12#\n" +
	"\vmessage_sid\x18\x01 \x01(\x03B\x020\x01R\n" +
	"messageSid\x129\n" +
	"\apayload\x18\x02 \x01(\v2\x1f.api.commons.OmniMessagePayloadR\apayload\x12=\n" +
	...
	"\x14customer_information\x18\x05 \x01(\v2,.api.commons.ConversationCustomerInformationR\x13customerInformation\"\xb9\x03\n" +
	"\x16AgentChatWidgetMessage\x12#\n" +
	"\vmessage_sid\x18\x01 \x01(\x03B\x020\x01R\n" +
	"messageSid\x129\n" +
	"\apayload\x18\x02 \x01(\v2\x1f.api.commons.OmniMessagePayloadR\apayload\x12=\n" +
	"\fdate_created\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\vdateCreated\x12&\n" +
	"\x0fui_reference_id\x18\x04 \x01(\tR\ruiReferenceId\x12W\n" +
	"\x10user_information\x18\x05 \x01(\v2,.api.commons.OmniConversationUserInformationR\x0fuserInformation\x12<\n" +
	"\vsender_type\x18\x06 \x01(\x0e2\x1b.api.commons.OmniSenderTypeR\n" +
	"senderType\x12A\n" +
	"\x0emessage_format\x18\a \x01(\x0e2\x1a.api.commons.MessageFormatR\rmessageFormat\"\x8a\v\n" +
	"\x12OmniMessagePayload\x12A\n" +
	"\ftext_message\x18d \x01(\v2\x1c.api.commons.OmniTextMessageH\x00R\vtextMessage\x12V\n" +
	"\x13typing_notification\x18e \x01(\v2#.api.commons.OmniTypingNotificationH\x00R\x12typingNotification\x12O\n" +
	"\freassignment\x18f \x01(\v2).api.commons.OmniReassignmentNotificationH\x00R\freassignment\x12p\n" +
	"\x1drequest_attachment_upload_url\x18g \x01(\v2+.api.commons.OmniRequestAttachmentUploadURLH\x00R\x1arequestAttachmentUploadUrl\x12Z\n" +
	"\x15attachment_upload_url\x18h \x01(\v2$.api.commons.OmniAttachmentUploadURLH\x00R\x13attachmentUploadUrl\x12=\n" +
	"\n" +
	"attachment\x18i \x01(\v2\x1b.api.commons.OmniAttachmentH\x00R\n" +
	"attachment\x12S\n" +
	"\x12close_conversation\x18j \x01(\v2\".api.commons.OmniCloseConversationH\x00R\x11closeConversation\x12V\n" +
	"\x13assign_conversation\x18k \x01(\v2#.api.commons.OmniAssignConversationH\x00R\x12assignConversation\x12\\\n" +
	"\x15unassign_conversation\x18l \x01(\v2%.api.commons.OmniUnassignConversationH\x00R\x14unassignConversation\x12E\n" +
	"\x0efinish_wrap_up\x18m \x01(\v2\x1d.api.commons.OmniFinishWrapUpH\x00R\ffinishWrapUp\x124\n" +
	"\asuspend\x18n \x01(\v2\x18.api.commons.OmniSuspendH\x00R\asuspend\x12B\n" +
	"\rstart_wrap_up\x18o \x01(\v2\x1c.api.commons.OmniStartWrapUpH\x00R\vstartWrapUp\x12P\n" +
	"\x11queue_information\x18p \x01(\v2!.api.commons.OmniQueueInformationH\x00R\x10queueInformation\x12f\n" +
	"\x19request_queue_information\x18q \x01(\v2(.api.commons.OmniRequestQueueInformationH\x00R\x17requestQueueInformation\x12^\n" +
	"\x17off_loaded_text_message\x18r \x01(\v2%.api.commons.OmniOffLoadedTextMessageH\x00R\x14offLoadedTextMessage\x12G\n" +
	"\x0ecanned_message\x18s \x01(\v2\x1e.api.commons.OmniCannedMessageH\x00R\rcannedMessage\x12A\n" +
	"\fdata_message\x18t \x01(\v2\x1c.api.commons.OmniDataMessageH\x00R\vdataMessageB\t\n" +
	"\apayload\"\xbe\x01\n" +
	"\x0fOmniTextMessage\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\x12=\n" +
	"\vattachments\x18\x02 \x03(\v2\x1b.api.commons.OmniAttachmentR\vattachments\x12R\n" +
	"\x17primary_asm_session_sid\x18\x03 \x01(\v2\x1b.google.protobuf.Int64ValueR\x14primaryAsmSessionSid\"u\n" +
	"\x18OmniOffLoadedTextMessage\x12\x1a\n" +
	"\blocation\x18\x01 \x01(\tR\blocation\x12=\n" +
	"\vattachments\x18\x02 \x03(\v2\x1b.api.commons.OmniAttachmentR\vattachments\"\x18\n" +
	...
	"\x0fcurrent_user_id\x18\x01 \x01(\tR\rcurrentUserId\x12*\n" +
	"\x11current_user_name\x18\x02 \x01(\tR\x0fcurrentUserName\x12\x1e\n" +
	"\vnew_user_id\x18\x03 \x01(\tR\tnewUserId\x12\"\n" +
	"\rnew_user_name\x18\x04 \x01(\tR\vnewUserName\x12S\n" +
	"\x18new_user_asm_session_sid\x18\x05 \x01(\v2\x1b.google.protobuf.Int64ValueR\x14newUserAsmSessionSid\"\xd4\x01\n" +
	"\x18OmniUnassignConversation\x125\n" +
	"\auser_id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x06userId\x12\x1b\n" +
	"\tuser_name\x18\x04 \x01(\tR\buserName\x12\x10\n" +
	"\x03all\x18\x02 \x01(\bR\x03all\x12R\n" +
	"\x17primary_asm_session_sid\x18\x05 \x01(\v2\x1b.google.protobuf.Int64ValueR\x14primaryAsmSessionSid\" \n" +
	...
	"\x0eOmniAttachment\x122\n" +
	"\x13omni_attachment_sid\x18\x01 \x01(\x03B\x020\x01R\x11omniAttachmentSid\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x1b\n" +
	"\tfile_type\x18\x03 \x01(\tR\bfileType\x12\x1b\n" +
	"\tfile_size\x18\x04 \x01(\x03R\bfileSize\x12\x12\n" +
	"\x04path\x18\x05 \x01(\tR\x04path\x125\n" +
	"\atemp_id\x18\x06 \x01(\v2\x1c.google.protobuf.StringValueR\x06tempId\x12!\n" +
	"\fdownload_url\x18\a \x01(\tR\vdownloadUrl\x12=\n" +
	"\fdate_created\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\vdateCreated\x12?\n" +
	"\rdate_modified\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\fdateModified\x12;\n" +
	"\n" +
	"content_id\x18\n" +
	" \x01(\v2\x1c.google.protobuf.StringValueR\tcontentId\x122\n" +
	"\x05width\x18\v \x01(\v2\x1c.google.protobuf.StringValueR\x05width\x124\n" +
	"\x06height\x18\f \x01(\v2\x1c.google.protobuf.StringValueR\x06height\"e\n" +
	"\x0fOmniStartWrapUp\x12R\n" +
	"\x17primary_asm_session_sid\x18\x01 \x01(\v2\x1b.google.protobuf.Int64ValueR\x14primaryAsmSessionSid\"f\n" +
	"\x10OmniFinishWrapUp\x12R\n" +
	"\x17primary_asm_session_sid\x18\x01 \x01(\v2\x1b.google.protobuf.Int64ValueR\x14primaryAsmSessionSid\"a\n" +
	"\vOmniSuspend\x12R\n" +
	"\x17primary_asm_session_sid\x18\x01 \x01(\v2\x1b.google.protobuf.Int64ValueR\x14primaryAsmSessionSid\"\x88\x01\n" +
	"\x15OmniCloseConversation\x12R\n" +
	"\x17primary_asm_session_sid\x18\x01 \x01(\v2\x1b.google.protobuf.Int64ValueR\x14primaryAsmSessionSid\x12\x1b\n" +
	"\tuser_name\x18\x02 \x01(\tR\buserName\"2\n" +
	"\x14OmniQueueInformation\x12\x1a\n" +
	"\bposition\x18\x01 \x01(\x03R\bposition\"9\n" +
	"\x1bOmniRequestQueueInformation\x12\x1a\n" +
	"\bposition\x18\x01 \x01(\bR\bposition\"?\n" +
	"\x11OmniCannedMessage\x12*\n" +
	"\x11canned_message_id\x18\x01 \x01(\tR\x0fcannedMessageId\"P\n" +
	"\x0fOmniDataMessage\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\x12#\n" +
	"\vmessage_sid\x18\x02 \x01(\x03B\x020\x01R\n" +
	"messageSid\"N\n" +
	"\x1fOmniConversationUserInformation\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\"U\n" +
	"\x15CustomerCollectedData\x12<\n" +
	"\x05items\x18\x01 \x03(\v2&.api.commons.CustomerCollectedDataItemR\x05items\"C\n" +
	"\x19CustomerCollectedDataItem\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\"\x81\x0e\n" +
	"\x10OmniConversation\x12-\n" +
	"\x10conversation_sid\x18\x01 \x01(\x03B\x020\x01R\x0fconversationSid\x12;\n" +
	"\fchannel_type\x18\x02 \x01(\x0e2\x18.api.commons.ChannelTypeR\vchannelType\x12;\n" +
	"\x06skills\x18\x03 \x01(\v2#.api.commons.OmniConversationSkillsR\x06skills\x12=\n" +
	"\fdate_created\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\vdateCreated\x12?\n" +
	"\rdate_modified\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\fdateModified\x127\n" +
	"\x06status\x18\x06 \x01(\x0e2\x1f.api.commons.ConversationStatusR\x06status\x12R\n" +
	"\x16customer_email_address\x18\a \x01(\v2\x1c.google.protobuf.StringValueR\x14customerEmailAddress\x12P\n" +
	"\x15customer_phone_number\x18\b \x01(\v2\x1c.google.protobuf.StringValueR\x13customerPhoneNumber\x12A\n" +
	"\rcustomer_name\x18\t \x01(\v2\x1c.google.protobuf.StringValueR\fcustomerName\x12%\n" +
	"\fcampaign_sid\x18\n" +
	" \x01(\x03B\x020\x01R\vcampaignSid\x12?\n" +
	"\freference_id\x18\v \x01(\v2\x1c.google.protobuf.StringValueR\vreferenceId\x12F\n" +
	"\x11last_message_time\x18\f \x01(\v2\x1a.google.protobuf.TimestampR\x0flastMessageTime\x12f\n" +
	"\x1bconversation_collected_data\x18\r \x01(\v2&.api.commons.ConversationCollectedDataR\x19conversationCollectedData\x12;\n" +
	"\fsla_timeouts\x18\x0e \x01(\v2\x18.api.commons.SLATimeoutsR\vslaTimeouts\x12b\n" +
	"\x18conversation_assignments\x18\x0f \x03(\v2'.api.commons.OmniConversationAssignmentR\x17conversationAssignments\x12M\n" +
	"\bmetadata\x18\x10 \x01(\v21.api.commons.OmniConversation.ConversationDetailsR\bmetadata\x125\n" +
	"\bend_time\x18\x12 \x01(\v2\x1a.google.protobuf.TimestampR\aendTime\x122\n" +
	"\x13campaign_module_sid\x18\x13 \x01(\x03B\x020\x01R\x11campaignModuleSid\x12Q\n" +
	"\x17last_message_group_time\x18\x14 \x01(\v2\x1a.google.protobuf.TimestampR\x14lastMessageGroupTime\x12R\n" +
	"\x17last_message_group_type\x18\x15 \x01(\x0e2\x1b.api.commons.OmniSenderTypeR\x14lastMessageGroupType\x12;\n" +
	"\x06result\x18\x16 \x01(\x0e2#.api.commons.OmniConversationResultR\x06result\x12Q\n" +
	"\x17last_state_changed_time\x18\x17 \x01(\v2\x1a.google.protobuf.TimestampR\x14lastStateChangedTime\x126\n" +
	"\btask_sid\x18\x18 \x01(\v2\x1b.google.protobuf.Int64ValueR\ataskSid\x1a\xbf\x01\n" +
	"\x13ConversationDetails\x12#\n" +
	"\rcampaign_name\x18\x01 \x01(\tR\fcampaignName\x12#\n" +
	"\rsupport_email\x18\x02 \x01(\tR\fsupportEmail\x120\n" +
	"\x14campaign_shorten_url\x18\x03 \x01(\bR\x12campaignShortenUrl\x12,\n" +
	"\x12payment_portal_ids\x18\x04 \x03(\tR\x10paymentPortalIds\"\xe5\x04\n" +
	"\x1aOmniConversationAssignment\x12B\n" +
	"\x1bconversation_assignment_sid\x18\x01 \x01(\x03B\x020\x01R\x19conversationAssignmentSid\x12-\n" +
	"\x10conversation_sid\x18\x02 \x01(\x03B\x020\x01R\x0fconversationSid\x12\x1b\n" +
	"\tis_active\x18\x05 \x01(\bR\bisActive\x12U\n" +
	"\x0fassignment_type\x18\x06 \x01(\x0e2,.api.commons.AgentConversationAssignmentTypeR\x0eassignmentType\x12=\n" +
	"\fdate_created\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\vdateCreated\x12?\n" +
	"\rdate_modified\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\fdateModified\x12\x17\n" +
	"\auser_id\x18\t \x01(\tR\x06userId\x12a\n" +
	"\bmetadata\x18\n" +
	" \x01(\v2E.api.commons.OmniConversationAssignment.ConversationAssignmentDetailsR\bmetadata\x12&\n" +
	"\x0fasm_session_sid\x18\v \x01(\x03R\rasmSessionSid\x1a<\n" +
	"\x1dConversationAssignmentDetails\x12\x1b\n" +
	"\tuser_name\x18\x01 \x01(\tR\buserName\"\x9c\x01\n" +
	"\x16OmniConversationSkills\x12G\n" +
	"\x06skills\x18\x01 \x03(\v2/.api.commons.OmniConversationSkills.SkillsEntryR\x06skills\x1a9\n" +
	"\vSkillsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\bR\x05value:\x028\x01\"P\n" +
	"\x10WeekdayTimeRange\x12<\n" +
	"\aentries\x18\x01 \x03(\v2\".api.commons.WeekdayTimeRangeEntryR\aentries\"\xff\x01\n" +
	"\x15WeekdayTimeRangeEntry\x126\n" +
	"\tstart_day\x18\x01 \x01(\x0e2\x19.api.commons.Weekday.EnumR\bstartDay\x12\x1d\n" +
	"\n" +
	"start_hour\x18\x02 \x01(\x03R\tstartHour\x12!\n" +
	"\fstart_minute\x18\x03 \x01(\x03R\vstartMinute\x122\n" +
	"\aend_day\x18\x04 \x01(\x0e2\x19.api.commons.Weekday.EnumR\x06endDay\x12\x19\n" +
	"\bend_hour\x18\x05 \x01(\x03R\aendHour\x12\x1d\n" +
	"\n" +
	"end_minute\x18\x06 \x01(\x03R\tendMinute\"\xf6\x01\n" +
	"\vDisposition\x12+\n" +
	"\x0fdisposition_sid\x18\x01 \x01(\x03B\x020\x01R\x0edispositionSid\x12=\n" +
	"\fdate_created\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\vdateCreated\x12?\n" +
	"\rdate_modified\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\fdateModified\x12 \n" +
	"\vdisposition\x18\x04 \x01(\tR\vdisposition\x12\x18\n" +
	"\adeleted\x18\x05 \x01(\bR\adeleted\"\xd4\x01\n" +
	"\x13GetQueuesDetailsRes\x12R\n" +
	"\rqueue_details\x18\x01 \x03(\v2-.api.commons.GetQueuesDetailsRes.QueueDetailsR\fqueueDetails\x1ai\n" +
	"\fQueueDetails\x12;\n" +
	"\fchannel_type\x18\x01 \x01(\x0e2\x18.api.commons.ChannelTypeR\vchannelType\x12\x1c\n" +
	"\tqueueSize\x18\x02 \x01(\x03R\tqueueSize\"\xb3\x03\n" +
	"\x19OmniCustomUnsubscribeLink\x12A\n" +
	...
	"\rdate_modified\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\fdateModified\x12A\n" +
	"\x0edate_validated\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\rdateValidated\x12 \n" +
	"\vdescription\x18\t \x01(\tR\vdescription\x12\x18\n" +
	"\adeleted\x18\n" +
	" \x01(\bR\adeleted\"\xf9\x03\n" +
	"\vContactList\x12,\n" +
	"\x10contact_list_sid\x18\x01 \x01(\x03B\x020\x01R\x0econtactListSid\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12\x1f\n" +
	"\vfield_names\x18\x04 \x03(\tR\n" +
	"fieldNames\x125\n" +
	"\vproject_sid\x18\x06 \x01(\v2\x14.api.commons.Int64IdR\n" +
	"projectSid\x12=\n" +
	"\fdate_created\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\vdateCreated\x12?\n" +
	"\rdate_modified\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\fdateModified\x12B\n" +
	"\x0fcontact_entries\x18\t \x03(\v2\x19.api.commons.ContactEntryR\x0econtactEntries\x12=\n" +
	"\bmetadata\x18\n" +
	" \x01(\v2!.api.commons.ContactList.MetadataR\bmetadata\x1a+\n" +
	"\bMetadata\x12\x1f\n" +
	"\ventry_count\x18\x01 \x01(\x03R\n" +
	"entryCount\"\xca\x02\n" +
	"\fContactEntry\x12.\n" +
	"\x11contact_entry_sid\x18\x01 \x01(\x03B\x020\x01R\x0fcontactEntrySid\x12,\n" +
	"\x10contact_list_sid\x18\x02 \x01(\x03B\x020\x01R\x0econtactListSid\x12=\n" +
	"\fdate_created\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\vdateCreated\x12?\n" +
	"\rdate_modified\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\fdateModified\x12\x1f\n" +
	...
	"\fdate_created\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\vdateCreated\x12?\n" +
	"\rdate_modified\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\fdateModified\x122\n" +
	"\x13campaign_module_sid\x18\x05 \x01(\x03B\x020\x01R\x11campaignModuleSid\x12%\n" +
	"\fcampaign_sid\x18\x06 \x01(\x03B\x020\x01R\vcampaignSid\x12@\n" +
	"\x11contact_entry_sid\x18\a \x01(\v2\x14.api.commons.Int64IdR\x0fcontactEntrySid\x120\n" +
	"\x05state\x18\b \x01(\v2\x1a.api.commons.OmniTaskStateR\x05state\x12;\n" +
	"\vdata_fields\x18\t \x03(\v2\x1a.api.commons.OmniDataFieldR\n" +
	"dataFields\x127\n" +
	"\adetails\x18\n" +
	" \x01(\v2\x1d.api.commons.OmniTask.DetailsR\adetails\x12\x12\n" +
	...
	"\x06skills\x18\x01 \x01(\v2#.api.commons.OmniConversationSkillsR\x06skills\x12U\n" +
	"\x19absolute_timeout_duration\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\x17absoluteTimeoutDuration\x12O\n" +
	"\x16agent_timeout_duration\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\x14agentTimeoutDuration\x12\x18\n" +
	"\asubject\x18\x04 \x01(\tR\asubject\x129\n" +
	"\amessage\x18\x05 \x01(\v2\x1f.api.commons.OmniMessagePayloadR\amessage\x12\x17\n" +
	"\auser_id\x18\x06 \x01(\tR\x06userId\"\x89\x03\n" +
	"\rOmniTaskState\x12D\n" +
	"\fdestinations\x18\x01 \x03(\v2 .api.commons.OmniTaskState.EntryR\fdestinations\x12:\n" +
	"\asources\x18\x02 \x03(\v2 .api.commons.OmniTaskState.EntryR\asources\x129\n" +
	"\brule_set\x18\x03 \x01(\v2\x1e.api.commons.ComplianceRuleSetR\aruleSet\x12@\n" +
	"\rscrub_list_id\x18\x04 \x01(\v2\x1c.google.protobuf.StringValueR\vscrubListId\x1ay\n" +
	"\x05Entry\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\tR\aaddress\x12\x1d\n" +
	"\n" +
	"times_used\x18\x02 \x01(\x03R\ttimesUsed\x127\n" +
	"\tlast_used\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\blastUsed\"|\n" +
	"\x11ComplianceRuleSet\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x10\n" +
	"\x03sha\x18\x03 \x01(\tR\x03sha\x121\n" +
	"\x05rules\x18\x04 \x03(\v2\x1b.api.commons.ComplianceRuleR\x05rules\"e\n" +
	...
	"\tfield_sid\x18\x01 \x01(\x03B\x020\x01R\bfieldSid\x12!\n" +
	"\n" +
	"parent_sid\x18\x02 \x01(\x03B\x020\x01R\tparentSid\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x14\n" +
	"\x05value\x18\x04 \x01(\tR\x05value\x12*\n" +
	"\x04type\x18\x05 \x01(\x0e2\x16.api.commons.FieldTypeR\x04type\"\xa9\n" +
	"\n" +
	"\x0eConnectedInbox\x122\n" +
	"\x13connected_inbox_sid\x18\x01 \x01(\x03B\x020\x01R\x11connectedInboxSid\x12#\n" +
	"\remail_address\x18\x02 \x01(\tR\femailAddress\x12\x1a\n" +
	"\busername\x18\x03 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x04 \x01(\tR\bpassword\x126\n" +
	"\x17check_frequency_minutes\x18\x05 \x01(\x03R\x15checkFrequencyMinutes\x12\x1f\n" +
	"\vserver_name\x18\x06 \x01(\tR\n" +
	"serverName\x12\x1f\n" +
	"\vserver_port\x18\a \x01(\x03R\n" +
	"serverPort\x12J\n" +
	"\x13last_scheduled_time\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\x11lastScheduledTime\x12=\n" +
	...
	"\n" +
	"email_salt\x18\v \x01(\tR\temailSalt\x128\n" +
	"\x18num_consecutive_failures\x18\f \x01(\x05R\x16numConsecutiveFailures\x12;\n" +
	"\n" +
	"last_error\x18\r \x01(\v2\x1c.google.protobuf.StringValueR\tlastError\x12H\n" +
	"\x12standby_error_time\x18\x0e \x01(\v2\x1a.google.protobuf.TimestampR\x10standbyErrorTime\x12=\n" +
	...
	"\fmax_messages\x18\x11 \x01(\x05R\vmaxMessages\x12a\n" +
	"\x1cgoogle_xoauth2_refresh_token\x18\x12 \x01(\v2\x1c.google.protobuf.StringValueB\x02\x18\x01R\x19googleXoauth2RefreshToken\x12_\n" +
	"\x1bgoogle_xoauth2_access_token\x18\x13 \x01(\v2\x1c.google.protobuf.StringValueB\x02\x18\x01R\x18googleXoauth2AccessToken\x12r\n" +
	"&google_xoauth2_access_token_expiration\x18\x14 \x01(\v2\x1a.google.protobuf.TimestampB\x02\x18\x01R\"googleXoauth2AccessTokenExpiration\x12^\n" +
	"\x13authentication_type\x18\x15 \x01(\x0e2-.api.commons.ConnectedInboxAuthenticationTypeR\x12authenticationType\x12T\n" +
	"\x12oauth_reference_id\x18\x16 \x01(\v2&.api.commons.ConnectedInboxOAuthConfigR\x10oauthReferenceId\"\xa5\x01\n" +
	"\x19ConnectedInboxOAuthConfig\x12!\n" +
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken\x12#\n" +
	"\rrefresh_token\x18\x02 \x01(\tR\frefreshToken\x12\x1d\n" +
	"\n" +
	"expires_at\x18\x03 \x01(\x03R\texpiresAt\x12!\n" +
	"\freference_id\x18\x04 \x01(\tR\vreferenceId\"\xd4\x02\n" +
	"\rVerifiedEmail\x120\n" +
	"\x12verified_email_sid\x18\x01 \x01(\x03B\x020\x01R\x10verifiedEmailSid\x12#\n" +
	"\remail_address\x18\x03 \x01(\tR\femailAddress\x12\x1a\n" +
	"\bverified\x18\x04 \x01(\bR\bverified\x129\n" +
	"\n" +
	"created_on\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedOn\x12;\n" +
	"\vverified_on\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"verifiedOn\x12\x18\n" +
	"\adeleted\x18\a \x01(\bR\adeleted\x12>\n" +
	"\vdescription\x18\b \x01(\v2\x1c.google.protobuf.StringValueR\vdescription\"\xc3\x02\n" +
	"\tSignature\x12'\n" +
	"\rsignature_sid\x18\x01 \x01(\x03B\x020\x01R\fsignatureSid\x12\x1c\n" +
	"\tsignature\x18\x02 \x01(\tR\tsignature\x12=\n" +
	"\fdate_created\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\vdateCreated\x12?\n" +
	"\rdate_modified\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\fdateModified\x129\n" +
	"\n" +
	"deleted_on\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\tdeletedOn\x12\x12\n" +
	"\x04name\x18\x06 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\a \x01(\tR\vdescription\"\xca\x01\n" +
	"\x1bOmniProjectComplianceConfig\x127\n" +
	"\x05email\x18\x01 \x01(\v2!.api.commons.OmniComplianceConfigR\x05email\x123\n" +
	"\x03sms\x18\x02 \x01(\v2!.api.commons.OmniComplianceConfigR\x03sms\x12=\n" +
	"\bwhatsapp\x18\x03 \x01(\v2!.api.commons.OmniComplianceConfigR\bwhatsapp\"\x8b\x01\n" +
	"\x14OmniComplianceAction\x12\x1a\n" +
	"\bkeywords\x18\x01 \x03(\tR\bkeywords\x121\n" +
	"\x14confirmation_message\x18\x02 \x01(\tR\x13confirmationMessage\x12$\n" +
	"\x0eis_fuzzy_match\x18\x03 \x01(\bR\fisFuzzyMatch\"\xea\x02\n" +
	"\x14OmniComplianceConfig\x128\n" +
	"\x06opt_in\x18\x01 \x01(\v2!.api.commons.OmniComplianceActionR\x05optIn\x12:\n" +
	"\aopt_out\x18\x02 \x01(\v2!.api.commons.OmniComplianceActionR\x06optOut\x125\n" +
	"\x04help\x18\x03 \x01(\v2!.api.commons.OmniComplianceActionR\x04help\x12C\n" +
	"\vinformation\x18\x04 \x01(\v2!.api.commons.OmniComplianceActionR\vinformation\x12\"\n" +
	"\rscrub_list_id\x18\x05 \x01(\tR\vscrubListId\x12<\n" +
	"\vrule_set_id\x18\x06 \x01(\v2\x1c.google.protobuf.StringValueR\truleSetId\"\xe3\x02\n" +
	"\x0eWhatsAppNumber\x12\x16\n" +
	"\x06number\x18\x01 \x01(\tR\x06number\x12?\n" +
	"\bprovider\x18\x02 \x01(\x0e2#.api.commons.WhatsAppNumberProviderR\bprovider\x12!\n" +
	"\fcountry_code\x18\x03 \x01(\x05R\vcountryCode\x122\n" +
	"\x13whatsapp_number_sid\x18\x04 \x01(\x03B\x020\x01R\x11whatsappNumberSid\x12!\n" +
	"\fdisplay_name\x18\x05 \x01(\tR\vdisplayName\x12=\n" +
	"\fdate_created\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\vdateCreated\x12?\n" +
	"\rdate_modified\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\fdateModified*X\n" +
	"\rSmsNumberType\x12\x17\n" +
	"\x13SMS_SHORT_CODE_TYPE\x10\x00\x12\x19\n" +
	"\x15SMS_ALPHANUMERIC_TYPE\x10\x01\x12\x13\n" +
	"\x0fSMS_NUMBER_TYPE\x10\x02*\xb1\x04\n" +
	"\x11SmsNumberProvider\x12\x14\n" +
	"\x10UNKNOWN_PROVIDER\x10\x00\x12\x16\n" +
	"\x12BANDWIDTH_PROVIDER\x10\x01\x12\x16\n" +
	"\x12BURST_SMS_PROVIDER\x10\x02\x12\x12\n" +
	"\x0ePLIVO_PROVIDER\x10\x03\x12\x14\n" +
	"\x10APEIRON_PROVIDER\x10\x04\x12\x19\n" +
	"\x15AUSBURST_SMS_PROVIDER\x10\x05\x12\x19\n" +
	"\x15MEDIASAT_SMS_PROVIDER\x10\x06\x12\x1a\n" +
	"\x16TEXTLOCAL_SMS_PROVIDER\x10\a\x12\x1a\n" +
	"\x16SMARTPING_SMS_PROVIDER\x10\b\x12\x16\n" +
	"\x12SINCH_SMS_PROVIDER\x10\r\x12\x17\n" +
	"\x13PRONTO_SMS_PROVIDER\x10\f\x12\x19\n" +
	"\x15UNKNOWN1_SMS_PROVIDER\x10\x0e\x12\x19\n" +
	"\x15UNKNOWN2_SMS_PROVIDER\x10\x0f\x12\x19\n" +
	"\x15UNKNOWN3_SMS_PROVIDER\x10\x10\x12\x19\n" +
	"\x15UNKNOWN4_SMS_PROVIDER\x10\x11\x12\x19\n" +
	"\x15UNKNOWN5_SMS_PROVIDER\x10\x12\x12\x19\n" +
	"\x15UNKNOWN6_SMS_PROVIDER\x10\x13\x12\x19\n" +
	"\x15UNKNOWN7_SMS_PROVIDER\x10\x14\x12\x19\n" +
	"\x15UNKNOWN8_SMS_PROVIDER\x10\x15\x12\x19\n" +
	"\x15UNKNOWN9_SMS_PROVIDER\x10\x16\x12\x1a\n" +
	"\x16UNKNOWN10_SMS_PROVIDER\x10\x17*\x84\x01\n" +
	"\x16OmniCampaignModuleType\x12\x17\n" +
	"\x13MODULE_TYPE_INBOUND\x10\x00\x12\x18\n" +
	"\x14MODULE_TYPE_OUTBOUND\x10\x01\x12\x1f\n" +
	"\x1bMODULE_TYPE_MANUAL_APPROVAL\x10\x02\x12\x16\n" +
	"\x12MODULE_TYPE_MANUAL\x10\x03*\x85\x01\n" +
	"\vChannelType\x12\x16\n" +
	"\x12CHANNEL_TYPE_EMAIL\x10\x00\x12\x14\n" +
	"\x10CHANNEL_TYPE_SMS\x10\x01\x12\x15\n" +
	"\x11CHANNEL_TYPE_CHAT\x10\x02\x12\x16\n" +
	"\x12CHANNEL_TYPE_VOICE\x10\x03\x12\x19\n" +
	"\x15CHANNEL_TYPE_WHATSAPP\x10\x04*2\n" +
	"\x15OmniCampaignDirection\x12\v\n" +
	"\aINBOUND\x10\x00\x12\f\n" +
	"\bOUTBOUND\x10\x01*\xf6\x01\n" +
	"\x12OmniCampaignStatus\x12\x0e\n" +
	"\n" +
	"SCHEDULING\x10\x00\x12\f\n" +
	"\aRUNNING\x10\xc8\x01\x12\v\n" +
	"\x06PAUSED\x10\x90\x03\x12\x0e\n" +
	"\tCOMPLETED\x10\xd8\x04\x12\r\n" +
	"\bARCHIVED\x10\xa0\x06\"\x06\b\x8a\x05\x10\x8a\x05\"\x06\b\xbc\x05\x10\xbc\x05\"\x06\b\xee\x05\x10\xee\x05\"\x04\bd\x10d\"\x06\b\xfa\x01\x10\xfa\x01\"\x06\b\xac\x02\x10\xac\x02\"\x06\b\xf4\x03\x10\xf4\x03*\x10COMPLETED_SUMMED*\tCANCELLED*\x10CANCELLED_SUMMED*\tPREPARING*\rRUNNING_ERROR*\rERROR_STANDBY*\bRESUMING*\xe9\x01\n" +
	"\x18OmniCampaignModuleStatus\x12\x14\n" +
	"\x10MODULE_PREPARING\x10\x00\x12\x15\n" +
	"\x11MODULE_SCHEDULING\x10d\x12\x13\n" +
	...
	"\x17CONVERSATION_STATUS_NEW\x10\x00\x124\n" +
	"0CONVERSATION_STATUS_AWAITING_REPLY_FROM_CUSTOMER\x10\x01\x121\n" +
	...
	"'CONVERSATION_STATUS_AWAITING_ASSIGNMENT\x10\a\x12&\n" +
	"\"CONVERSATION_STATUS_NEWLY_ASSIGNED\x10\b\x12(\n" +
	"$CONVERSATION_STATUS_WRAP_UP_CUSTOMER\x10\t\x12'\n" +
	"#CONVERSATION_STATUS_WRAP_UP_TIMEOUT\x10\n" +
	"\x12&\n" +
	"\"CONVERSATION_STATUS_CLOSED_MANAGER\x10\v\x122\n" +
	".CONVERSATION_STATUS_NEW_PENDING_CUSTOMER_REPLY\x10\f\x12\x1c\n" +
	"\x18CONVERSATION_STATUS_FLOW\x10\r\x12/\n" +
	"+CONVERSATION_STATUS_CLOSED_DUPLICATE_THREAD\x10\x0e*\xb0\x01\n" +
	"\x1fAgentAssignmentActiveSearchType\x12.\n" +
	"*AGENT_ASSIGNMENT_ACTIVE_SEARCH_TYPE_ACTIVE\x10\x00\x120\n" +
	...
	"\fACTIVE_AGENT\x10\x00\x12\x12\n" +
	"\x0eINACTIVE_AGENT\x10\x01*I\n" +
	"\x1fAgentConversationAssignmentType\x12\x11\n" +
	"\rPRIMARY_AGENT\x10\x00\x12\x13\n" +
	"\x0fSECONDARY_AGENT\x10\x01*f\n" +
	"\rMessageFormat\x12\x1e\n" +
	"\x1aMESSAGE_FORMAT_UNSPECIFIED\x10\x00\x12\x17\n" +
	"\x13MESSAGE_FORMAT_HTML\x10\x01\x12\x1c\n" +
	"\x18MESSAGE_FORMAT_HTML_FORM\x10\x02*\x98\x06\n" +
	...
	"\x1dOMNI_OUTBOUND_MESSAGE_BLOCKED\x10\xfa~\x12/\n" +
	"*OMNI_OUTBOUND_MESSAGE_UNCONFIRMED_DELIVERY\x10\x84\x7f\x12\x18\n" +
	"\x13OMNI_SYSTEM_MESSAGE\x10\xb2}*1\n" +
	"\x16OmniConversationResult\x12\b\n" +
	"\x04NONE\x10\x00\x12\r\n" +
	"\tABANDONED\x10\x01*\xa9\x02\n" +
	"\x0eOmniTaskStatus\x12\x15\n" +
	"\x11OMNI_TASK_WAITING\x10\x00\x12\x1f\n" +
	"\x1bOMNI_TASK_WAITING_FOR_QUEUE\x10\x01\x12\"\n" +
	"\x1eOMNI_TASK_WAITING_FOR_APPROVAL\x10\x02\x12\x15\n" +
	"\x11OMNI_TASK_SENDING\x10d\x12\x1c\n" +
	"\x18OMNI_TASK_SENDING_FAILED\x10n\x12 \n" +
	"\x1cOMNI_TASK_SENDING_INCOMPLETE\x10o\x12\x1d\n" +
	"\x19OMNI_TASK_SENDING_INVALID\x10p\x12\x12\n" +
	"\x0eOMNI_TASK_SENT\x10x\x12\x17\n" +
	"\x12OMNI_TASK_RECEIVED\x10\x82\x01\x12\x18\n" +
	"\x13OMNI_TASK_CANCELLED\x10\x8c\x01*\xa1\x01\n" +
	...
	"\x18OMNI_SENDER_TYPE_MANAGER\x10\x03\x12\x19\n" +
	"\x15OMNI_SENDER_TYPE_FLOW\x10\x04*\xc3\x01\n" +
	" ConnectedInboxAuthenticationType\x120\n" +
	",CONNECTED_INBOX_AUTHENTICATION_TYPE_PASSWORD\x10\x00\x126\n" +
	"2CONNECTED_INBOX_AUTHENTICATION_TYPE_GOOGLE_XOAUTH2\x10\x01\x125\n" +
	"1CONNECTED_INBOX_AUTHENTICATION_TYPE_MICROSOFT_365\x10\x02*\xe1\x03\n" +
	" ConversationStateChangeTimerName\x12-\n" +
	")CONVERSATION_STATE_CHANGE_TIMER_NAME_WAIT\x10\x00\x12-\n" +
	")CONVERSATION_STATE_CHANGE_TIMER_NAME_TALK\x10d\x12D\n" +
	"@CONVERSATION_STATE_CHANGE_TIMER_NAME_TALK_INITIAL_AGENT_RESPONSE\x10e\x12<\n" +
	"8CONVERSATION_STATE_CHANGE_TIMER_NAME_TALK_AGENT_RESPONSE\x10f\x12?\n" +
	";CONVERSATION_STATE_CHANGE_TIMER_NAME_TALK_CUSTOMER_RESPONSE\x10g\x127\n" +
	"3CONVERSATION_STATE_CHANGE_TIMER_NAME_TALK_SUSPENDED\x10h\x121\n" +
	",CONVERSATION_STATE_CHANGE_TIMER_NAME_WRAP_UP\x10\xc8\x01\x12.\n" +
	")CONVERSATION_STATE_CHANGE_TIMER_NAME_IDLE\x10\xac\x02*\x9b\x05\n" +
	"\x1cOmniConversationMetadataName\x12\x17\n" +
	"\x13AGENT_RESPONSE_TIME\x10\x00\x12\x16\n" +
	"\x12CUSTOMER_WAIT_TIME\x10\x01\x12\x0f\n" +
	"\vHANDLE_TIME\x10\x02\x12\x13\n" +
	"\x0fTRANSCRIPT_PATH\x10\x03\x12-\n" +
	")OMNI_CONVERSATION_METADATA_NAME_FLOW_DATA\x10\x04\x12.\n" +
	"*OMNI_CONVERSATION_METADATA_NAME_VOICE_DATA\x10\x05\x12.\n" +
	"*OMNI_CONVERSATION_METADATA_NAME_TIMER_WAIT\x10\n" +
	"\x12.\n" +
	"*OMNI_CONVERSATION_METADATA_NAME_TIMER_TALK\x10d\x12E\n" +
	"AOMNI_CONVERSATION_METADATA_NAME_TIMER_TALK_INITIAL_AGENT_RESPONSE\x10e\x12=\n" +
	"9OMNI_CONVERSATION_METADATA_NAME_TIMER_TALK_AGENT_RESPONSE\x10f\x12@\n" +
	"<OMNI_CONVERSATION_METADATA_NAME_TIMER_TALK_CUSTOMER_RESPONSE\x10g\x128\n" +
	"4OMNI_CONVERSATION_METADATA_NAME_TIMER_TALK_SUSPENDED\x10h\x122\n" +
	...
	"\x19CAMPAIGN_STATUS_SCHEDULED\x10\x00\x12\x1b\n" +
	"\x17CAMPAIGN_STATUS_RUNNING\x10\x01\x12\x1a\n" +
	"\x16CAMPAIGN_STATUS_PAUSED\x10\x02\x12\x1d\n" +
	"\x19CAMPAIGN_STATUS_COMPLETED\x10\x03\x12\x1c\n" +
	"\x18CAMPAIGN_STATUS_CANCELED\x10\x04\x12 \n" +
	"\x1cCAMPAIGN_STATUS_ERROR_PAUSED\x10\x05*T\n" +
	"\x11CampaignDirection\x12\x1e\n" +
	"\x1aCAMPAIGN_DIRECTION_INBOUND\x10\x00\x12\x1f\n" +
	"\x1bCAMPAIGN_DIRECTION_OUTBOUND\x10\x01*R\n" +
	"\x16WhatsAppNumberProvider\x12\x1d\n" +
	"\x19UNKNOWN_WHATSAPP_PROVIDER\x10\x00\x12\x19\n" +
	"\x15WHATSAPP_SMS_PROVIDER\x10\x01*\xce\x05\n" +
	"\x0fOmniMessageType\x12\"\n" +
	"\x1eOMNI_MESSAGE_TYPE_TEXT_MESSAGE\x10\x00\x12)\n" +
	"%OMNI_MESSAGE_TYPE_TYPING_NOTIFICATION\x10\x01\x12/\n" +
	"+OMNI_MESSAGE_TYPE_REASSIGNMENT_NOTIFICATION\x10\x02\x12)\n" +
	"%OMNI_MESSAGE_TYPE_ASSIGN_CONVERSATION\x10\x03\x12+\n" +
	"'OMNI_MESSAGE_TYPE_UNASSIGN_CONVERSATION\x10\x04\x12 \n" +
	"\x1cOMNI_MESSAGE_TYPE_ATTACHMENT\x10\x05\x12+\n" +
	"'OMNI_MESSAGE_TYPE_ATTACHMENT_UPLOAD_URL\x10\x06\x123\n" +
	"/OMNI_MESSAGE_TYPE_REQUEST_ATTACHMENT_UPLOAD_URL\x10\a\x12(\n" +
	"$OMNI_MESSAGE_TYPE_CLOSE_CONVERSATION\x10\b\x12#\n" +
	"\x1fOMNI_MESSAGE_TYPE_START_WRAP_UP\x10\t\x12$\n" +
	" OMNI_MESSAGE_TYPE_FINISH_WRAP_UP\x10\n" +
	"\x12\x1d\n" +
	"\x19OMNI_MESSAGE_TYPE_UNKNOWN\x10\v\x12\x1d\n" +
	"\x19OMNI_MESSAGE_TYPE_SUSPEND\x10\f\x12'\n" +
	"#OMNI_MESSAGE_TYPE_QUEUE_INFORMATION\x10\r\x12/\n" +
	"+OMNI_MESSAGE_TYPE_REQUEST_QUEUE_INFORMATION\x10\x0e\x12,\n" +
	"(OMNI_MESSAGE_TYPE_OFFLOADED_TEXT_MESSAGE\x10\x0f\x12$\n" +
	" OMNI_MESSAGE_TYPE_CANNED_MESSAGE\x10\x10*\\\n" +
	"\x19OmniTaskCarryOverBehavior\x12\x1e\n" +
	"\x1aOMNI_TASK_CARRY_OVER_PAUSE\x10\x00\x12\x1f\n" +
	"\x1bOMNI_TASK_CARRY_OVER_CANCEL\x10\x01B\x98\x01\n" +
	"\x0fcom.api.commonsB\x10OmnichannelProtoP\x01Z&github.com/tcncloud/api-go/api/commons\xa2\x02\x03ACX\xaa\x02\vApi.Commons\xca\x02\vApi\\Commons\xe2\x02\x17Api\\Commons\\GPBMetadata\xea\x02\fApi::Commonsb\x06proto3"
...
var file_api_commons_omnichannel_proto_enumTypes = make([]protoimpl.EnumInfo, 25)
...
var file_api_commons_omnichannel_proto_goTypes = []any{
	...
	(OmniTaskCarryOverBehavior)(0),               // 24: api.commons.OmniTaskCarryOverBehavior
	(*OmniCampaign)(nil),                         // 25: api.commons.OmniCampaign
	(*OmniCampaignModule)(nil),                   // 26: api.commons.OmniCampaignModule
	(*OmniCampaignModuleConfig)(nil),             // 27: api.commons.OmniCampaignModuleConfig
	(*ConversationTimeoutMessageConfig)(nil),     // 28: api.commons.ConversationTimeoutMessageConfig
	(*SmsNumber)(nil),                            // 29: api.commons.SmsNumber
	(*ConversationCustomerInformation)(nil),      // 30: api.commons.ConversationCustomerInformation
	(*SLATimeouts)(nil),                          // 31: api.commons.SLATimeouts
	(*ConversationCollectedData)(nil),            // 32: api.commons.ConversationCollectedData
	(*ConversationCollectedData_Item)(nil),       // 33: api.commons.ConversationCollectedData_Item
	(*OmniMessage)(nil),                          // 34: api.commons.OmniMessage
	(*CustomerChatWidgetMessage)(nil),            // 35: api.commons.CustomerChatWidgetMessage
	(*AgentChatWidgetMessage)(nil),               // 36: api.commons.AgentChatWidgetMessage
	(*OmniMessagePayload)(nil),                   // 37: api.commons.OmniMessagePayload
	(*OmniTextMessage)(nil),                      // 38: api.commons.OmniTextMessage
	(*OmniOffLoadedTextMessage)(nil),             // 39: api.commons.OmniOffLoadedTextMessage
	(*OmniTypingNotification)(nil),               // 40: api.commons.OmniTypingNotification
	(*OmniAssignConversation)(nil),               // 41: api.commons.OmniAssignConversation
	(*OmniReassignmentNotification)(nil),         // 42: api.commons.OmniReassignmentNotification
	(*OmniUnassignConversation)(nil),             // 43: api.commons.OmniUnassignConversation
	(*OmniRequestAttachmentUploadURL)(nil),       // 44: api.commons.OmniRequestAttachmentUploadURL
	(*OmniAttachmentUploadURL)(nil),              // 45: api.commons.OmniAttachmentUploadURL
	(*OmniAttachment)(nil),                       // 46: api.commons.OmniAttachment
	(*OmniStartWrapUp)(nil),                      // 47: api.commons.OmniStartWrapUp
	(*OmniFinishWrapUp)(nil),                     // 48: api.commons.OmniFinishWrapUp
	(*OmniSuspend)(nil),                          // 49: api.commons.OmniSuspend
	(*OmniCloseConversation)(nil),                // 50: api.commons.OmniCloseConversation
	(*OmniQueueInformation)(nil),                 // 51: api.commons.OmniQueueInformation
	(*OmniRequestQueueInformation)(nil),          // 52: api.commons.OmniRequestQueueInformation
	(*OmniCannedMessage)(nil),                    // 53: api.commons.OmniCannedMessage
	(*OmniDataMessage)(nil),                      // 54: api.commons.OmniDataMessage
	(*OmniConversationUserInformation)(nil),      // 55: api.commons.OmniConversationUserInformation
	(*CustomerCollectedData)(nil),                // 56: api.commons.CustomerCollectedData
	(*CustomerCollectedDataItem)(nil),            // 57: api.commons.CustomerCollectedDataItem
	(*OmniConversation)(nil),                     // 58: api.commons.OmniConversation
	(*OmniConversationAssignment)(nil),           // 59: api.commons.OmniConversationAssignment
	(*OmniConversationSkills)(nil),               // 60: api.commons.OmniConversationSkills
	(*WeekdayTimeRange)(nil),                     // 61: api.commons.WeekdayTimeRange
	(*WeekdayTimeRangeEntry)(nil),                // 62: api.commons.WeekdayTimeRangeEntry
	(*Disposition)(nil),                          // 63: api.commons.Disposition
	(*GetQueuesDetailsRes)(nil),                  // 64: api.commons.GetQueuesDetailsRes
	(*OmniCustomUnsubscribeLink)(nil),            // 65: api.commons.OmniCustomUnsubscribeLink
	(*ContactList)(nil),                          // 66: api.commons.ContactList
	(*ContactEntry)(nil),                         // 67: api.commons.ContactEntry
	(*OmniTask)(nil),                             // 68: api.commons.OmniTask
	(*OmniTaskConfig)(nil),                       // 69: api.commons.OmniTaskConfig
	(*OmniTaskState)(nil),                        // 70: api.commons.OmniTaskState
	(*ComplianceRuleSet)(nil),                    // 71: api.commons.ComplianceRuleSet
	(*ComplianceRule)(nil),                       // 72: api.commons.ComplianceRule
	(*OmniDataField)(nil),                        // 73: api.commons.OmniDataField
	(*ConnectedInbox)(nil),                       // 74: api.commons.ConnectedInbox
	(*ConnectedInboxOAuthConfig)(nil),            // 75: api.commons.ConnectedInboxOAuthConfig
	(*VerifiedEmail)(nil),                        // 76: api.commons.VerifiedEmail
	(*Signature)(nil),                            // 77: api.commons.Signature
	(*OmniProjectComplianceConfig)(nil),          // 78: api.commons.OmniProjectComplianceConfig
	(*OmniComplianceAction)(nil),                 // 79: api.commons.OmniComplianceAction
	(*OmniComplianceConfig)(nil),                 // 80: api.commons.OmniComplianceConfig
	(*WhatsAppNumber)(nil),                       // 81: api.commons.WhatsAppNumber
	(*OmniCampaignModule_Details)(nil),           // 82: api.commons.OmniCampaignModule.Details
	nil,                                          // 83: api.commons.OmniCampaignModuleConfig.ProviderMetadataEntry
	(*OmniConversation_ConversationDetails)(nil), // 84: api.commons.OmniConversation.ConversationDetails
	(*OmniConversationAssignment_ConversationAssignmentDetails)(nil), // 85: api.commons.OmniConversationAssignment.ConversationAssignmentDetails
	nil,                                      // 86: api.commons.OmniConversationSkills.SkillsEntry
	(*GetQueuesDetailsRes_QueueDetails)(nil), // 87: api.commons.GetQueuesDetailsRes.QueueDetails
	(*ContactList_Metadata)(nil),             // 88: api.commons.ContactList.Metadata
	(*OmniTask_Details)(nil),                 // 89: api.commons.OmniTask.Details
	(*OmniTaskState_Entry)(nil),              // 90: api.commons.OmniTaskState.Entry
	(*timestamppb.Timestamp)(nil),            // 91: google.protobuf.Timestamp
	(*TimeZoneWrapper)(nil),                  // 92: api.commons.TimeZoneWrapper
	(*wrapperspb.StringValue)(nil),           // 93: google.protobuf.StringValue
	(*ChatColorProperties)(nil),              // 94: api.commons.ChatColorProperties
	(*Int64Id)(nil),                          // 95: api.commons.Int64Id
	(*ChatHeader)(nil),                       // 96: api.commons.ChatHeader
	(*wrapperspb.Int64Value)(nil),            // 97: google.protobuf.Int64Value
	(*wrapperspb.BoolValue)(nil),             // 98: google.protobuf.BoolValue
	(Weekday_Enum)(0),                        // 99: api.commons.Weekday.Enum
	(*durationpb.Duration)(nil),              // 100: google.protobuf.Duration
	(FieldType)(0),                           // 101: api.commons.FieldType
}
var file_api_commons_omnichannel_proto_depIdxs = []int32{
	60,  // 0: api.commons.OmniCampaign.skills:type_name -> api.commons.OmniConversationSkills
	91,  // 1: api.commons.OmniCampaign.start_date:type_name -> google.protobuf.Timestamp
	...
	91,  // 4: api.commons.OmniCampaign.date_created:type_name -> google.protobuf.Timestamp
	91,  // 5: api.commons.OmniCampaign.date_modified:type_name -> google.protobuf.Timestamp
	26,  // 6: api.commons.OmniCampaign.modules:type_name -> api.commons.OmniCampaignModule
	92,  // 7: api.commons.OmniCampaign.time_zone:type_name -> api.commons.TimeZoneWrapper
	80,  // 8: api.commons.OmniCampaign.compliance_config:type_name -> api.commons.OmniComplianceConfig
	...
	27,  // 11: api.commons.OmniCampaignModule.config:type_name -> api.commons.OmniCampaignModuleConfig
	91,  // 12: api.commons.OmniCampaignModule.date_created:type_name -> google.protobuf.Timestamp
	91,  // 13: api.commons.OmniCampaignModule.date_modified:type_name -> google.protobuf.Timestamp
	91,  // 14: api.commons.OmniCampaignModule.scheduled_stop_date:type_name -> google.protobuf.Timestamp
	91,  // 15: api.commons.OmniCampaignModule.actual_stop_date:type_name -> google.protobuf.Timestamp
	61,  // 16: api.commons.OmniCampaignModule.hours_of_operation:type_name -> api.commons.WeekdayTimeRange
	82,  // 17: api.commons.OmniCampaignModule.details:type_name -> api.commons.OmniCampaignModule.Details
	46,  // 18: api.commons.OmniCampaignModule.attachments:type_name -> api.commons.OmniAttachment
	61,  // 19: api.commons.OmniCampaignModule.hours_of_operation_timezone:type_name -> api.commons.WeekdayTimeRange
	24,  // 20: api.commons.OmniCampaignModule.task_carry_over_behavior:type_name -> api.commons.OmniTaskCarryOverBehavior
	93,  // 21: api.commons.OmniCampaignModuleConfig.api_key_primary:type_name -> google.protobuf.StringValue
	93,  // 22: api.commons.OmniCampaignModuleConfig.api_key_secondary:type_name -> google.protobuf.StringValue
	94,  // 23: api.commons.OmniCampaignModuleConfig.color_properties:type_name -> api.commons.ChatColorProperties
	95,  // 24: api.commons.OmniCampaignModuleConfig.connected_inbox_sid:type_name -> api.commons.Int64Id
	63,  // 25: api.commons.OmniCampaignModuleConfig.dispositions:type_name -> api.commons.Disposition
	93,  // 26: api.commons.OmniCampaignModuleConfig.email:type_name -> google.protobuf.StringValue
	93,  // 27: api.commons.OmniCampaignModuleConfig.message_body:type_name -> google.protobuf.StringValue
	93,  // 28: api.commons.OmniCampaignModuleConfig.email_subject:type_name -> google.protobuf.StringValue
	29,  // 29: api.commons.OmniCampaignModuleConfig.sms_number:type_name -> api.commons.SmsNumber
	96,  // 30: api.commons.OmniCampaignModuleConfig.header:type_name -> api.commons.ChatHeader
	31,  // 31: api.commons.OmniCampaignModuleConfig.sla_timeouts:type_name -> api.commons.SLATimeouts
	97,  // 32: api.commons.OmniCampaignModuleConfig.sends_per_hour:type_name -> google.protobuf.Int64Value
	95,  // 33: api.commons.OmniCampaignModuleConfig.unsubscribe_link_sid:type_name -> api.commons.Int64Id
	95,  // 34: api.commons.OmniCampaignModuleConfig.verified_email_sid:type_name -> api.commons.Int64Id
	98,  // 35: api.commons.OmniCampaignModuleConfig.stop_on_task_deplete:type_name -> google.protobuf.BoolValue
	46,  // 36: api.commons.OmniCampaignModuleConfig.attachments:type_name -> api.commons.OmniAttachment
	93,  // 37: api.commons.OmniCampaignModuleConfig.compliance_rule_set_id:type_name -> google.protobuf.StringValue
	95,  // 38: api.commons.OmniCampaignModuleConfig.flow_id:type_name -> api.commons.Int64Id
	60,  // 39: api.commons.OmniCampaignModuleConfig.skills:type_name -> api.commons.OmniConversationSkills
	81,  // 40: api.commons.OmniCampaignModuleConfig.whatsapp_number:type_name -> api.commons.WhatsAppNumber
	83,  // 41: api.commons.OmniCampaignModuleConfig.provider_metadata:type_name -> api.commons.OmniCampaignModuleConfig.ProviderMetadataEntry
	28,  // 42: api.commons.OmniCampaignModuleConfig.timeout_message_config:type_name -> api.commons.ConversationTimeoutMessageConfig
	0,   // 43: api.commons.SmsNumber.type:type_name -> api.commons.SmsNumberType
	1,   // 44: api.commons.SmsNumber.provider:type_name -> api.commons.SmsNumberProvider
	33,  // 45: api.commons.ConversationCollectedData.items:type_name -> api.commons.ConversationCollectedData_Item
	91,  // 46: api.commons.ConversationCollectedData_Item.collection_time:type_name -> google.protobuf.Timestamp
	93,  // 47: api.commons.ConversationCollectedData_Item.user_id:type_name -> google.protobuf.StringValue
	93,  // 48: api.commons.OmniMessage.user_id:type_name -> google.protobuf.StringValue
	3,   // 49: api.commons.OmniMessage.channel_type:type_name -> api.commons.ChannelType
	93,  // 50: api.commons.OmniMessage.reference_id:type_name -> google.protobuf.StringValue
	37,  // 51: api.commons.OmniMessage.payload:type_name -> api.commons.OmniMessagePayload
	95,  // 52: api.commons.OmniMessage.conversation_sid:type_name -> api.commons.Int64Id
	12,  // 53: api.commons.OmniMessage.status:type_name -> api.commons.OmniMessageStatus
	91,  // 54: api.commons.OmniMessage.date_created:type_name -> google.protobuf.Timestamp
	91,  // 55: api.commons.OmniMessage.date_modified:type_name -> google.protobuf.Timestamp
	93,  // 56: api.commons.OmniMessage.subject:type_name -> google.protobuf.StringValue
	15,  // 57: api.commons.OmniMessage.sender_type:type_name -> api.commons.OmniSenderType
	93,  // 58: api.commons.OmniMessage.status_message:type_name -> google.protobuf.StringValue
	11,  // 59: api.commons.OmniMessage.message_format:type_name -> api.commons.MessageFormat
	37,  // 60: api.commons.CustomerChatWidgetMessage.payload:type_name -> api.commons.OmniMessagePayload
	91,  // 61: api.commons.CustomerChatWidgetMessage.date_created:type_name -> google.protobuf.Timestamp
	30,  // 62: api.commons.CustomerChatWidgetMessage.customer_information:type_name -> api.commons.ConversationCustomerInformation
	37,  // 63: api.commons.AgentChatWidgetMessage.payload:type_name -> api.commons.OmniMessagePayload
	91,  // 64: api.commons.AgentChatWidgetMessage.date_created:type_name -> google.protobuf.Timestamp
	55,  // 65: api.commons.AgentChatWidgetMessage.user_information:type_name -> api.commons.OmniConversationUserInformation
	15,  // 66: api.commons.AgentChatWidgetMessage.sender_type:type_name -> api.commons.OmniSenderType
	11,  // 67: api.commons.AgentChatWidgetMessage.message_format:type_name -> api.commons.MessageFormat
	38,  // 68: api.commons.OmniMessagePayload.text_message:type_name -> api.commons.OmniTextMessage
	40,  // 69: api.commons.OmniMessagePayload.typing_notification:type_name -> api.commons.OmniTypingNotification
	42,  // 70: api.commons.OmniMessagePayload.reassignment:type_name -> api.commons.OmniReassignmentNotification
	44,  // 71: api.commons.OmniMessagePayload.request_attachment_upload_url:type_name -> api.commons.OmniRequestAttachmentUploadURL
	45,  // 72: api.commons.OmniMessagePayload.attachment_upload_url:type_name -> api.commons.OmniAttachmentUploadURL
	46,  // 73: api.commons.OmniMessagePayload.attachment:type_name -> api.commons.OmniAttachment
	50,  // 74: api.commons.OmniMessagePayload.close_conversation:type_name -> api.commons.OmniCloseConversation
	41,  // 75: api.commons.OmniMessagePayload.assign_conversation:type_name -> api.commons.OmniAssignConversation
	43,  // 76: api.commons.OmniMessagePayload.unassign_conversation:type_name -> api.commons.OmniUnassignConversation
	48,  // 77: api.commons.OmniMessagePayload.finish_wrap_up:type_name -> api.commons.OmniFinishWrapUp
	49,  // 78: api.commons.OmniMessagePayload.suspend:type_name -> api.commons.OmniSuspend
	47,  // 79: api.commons.OmniMessagePayload.start_wrap_up:type_name -> api.commons.OmniStartWrapUp
	51,  // 80: api.commons.OmniMessagePayload.queue_information:type_name -> api.commons.OmniQueueInformation
	52,  // 81: api.commons.OmniMessagePayload.request_queue_information:type_name -> api.commons.OmniRequestQueueInformation
	39,  // 82: api.commons.OmniMessagePayload.off_loaded_text_message:type_name -> api.commons.OmniOffLoadedTextMessage
	53,  // 83: api.commons.OmniMessagePayload.canned_message:type_name -> api.commons.OmniCannedMessage
	54,  // 84: api.commons.OmniMessagePayload.data_message:type_name -> api.commons.OmniDataMessage
	46,  // 85: api.commons.OmniTextMessage.attachments:type_name -> api.commons.OmniAttachment
	97,  // 86: api.commons.OmniTextMessage.primary_asm_session_sid:type_name -> google.protobuf.Int64Value
	46,  // 87: api.commons.OmniOffLoadedTextMessage.attachments:type_name -> api.commons.OmniAttachment
	97,  // 88: api.commons.OmniReassignmentNotification.new_user_asm_session_sid:type_name -> google.protobuf.Int64Value
	93,  // 89: api.commons.OmniUnassignConversation.user_id:type_name -> google.protobuf.StringValue
	97,  // 90: api.commons.OmniUnassignConversation.primary_asm_session_sid:type_name -> google.protobuf.Int64Value
	93,  // 91: api.commons.OmniAttachment.temp_id:type_name -> google.protobuf.StringValue
	91,  // 92: api.commons.OmniAttachment.date_created:type_name -> google.protobuf.Timestamp
	91,  // 93: api.commons.OmniAttachment.date_modified:type_name -> google.protobuf.Timestamp
	93,  // 94: api.commons.OmniAttachment.content_id:type_name -> google.protobuf.StringValue
	93,  // 95: api.commons.OmniAttachment.width:type_name -> google.protobuf.StringValue
	93,  // 96: api.commons.OmniAttachment.height:type_name -> google.protobuf.StringValue
	97,  // 97: api.commons.OmniStartWrapUp.primary_asm_session_sid:type_name -> google.protobuf.Int64Value
	97,  // 98: api.commons.OmniFinishWrapUp.primary_asm_session_sid:type_name -> google.protobuf.Int64Value
	97,  // 99: api.commons.OmniSuspend.primary_asm_session_sid:type_name -> google.protobuf.Int64Value
	97,  // 100: api.commons.OmniCloseConversation.primary_asm_session_sid:type_name -> google.protobuf.Int64Value
	57,  // 101: api.commons.CustomerCollectedData.items:type_name -> api.commons.CustomerCollectedDataItem
	3,   // 102: api.commons.OmniConversation.channel_type:type_name -> api.commons.ChannelType
	60,  // 103: api.commons.OmniConversation.skills:type_name -> api.commons.OmniConversationSkills
	91,  // 104: api.commons.OmniConversation.date_created:type_name -> google.protobuf.Timestamp
	91,  // 105: api.commons.OmniConversation.date_modified:type_name -> google.protobuf.Timestamp
	7,   // 106: api.commons.OmniConversation.status:type_name -> api.commons.ConversationStatus
	93,  // 107: api.commons.OmniConversation.customer_email_address:type_name -> google.protobuf.StringValue
	93,  // 108: api.commons.OmniConversation.customer_phone_number:type_name -> google.protobuf.StringValue
	93,  // 109: api.commons.OmniConversation.customer_name:type_name -> google.protobuf.StringValue
	93,  // 110: api.commons.OmniConversation.reference_id:type_name -> google.protobuf.StringValue
	91,  // 111: api.commons.OmniConversation.last_message_time:type_name -> google.protobuf.Timestamp
	32,  // 112: api.commons.OmniConversation.conversation_collected_data:type_name -> api.commons.ConversationCollectedData
	31,  // 113: api.commons.OmniConversation.sla_timeouts:type_name -> api.commons.SLATimeouts
	59,  // 114: api.commons.OmniConversation.conversation_assignments:type_name -> api.commons.OmniConversationAssignment
	84,  // 115: api.commons.OmniConversation.metadata:type_name -> api.commons.OmniConversation.ConversationDetails
	91,  // 116: api.commons.OmniConversation.end_time:type_name -> google.protobuf.Timestamp
	91,  // 117: api.commons.OmniConversation.last_message_group_time:type_name -> google.protobuf.Timestamp
	15,  // 118: api.commons.OmniConversation.last_message_group_type:type_name -> api.commons.OmniSenderType
	13,  // 119: api.commons.OmniConversation.result:type_name -> api.commons.OmniConversationResult
	91,  // 120: api.commons.OmniConversation.last_state_changed_time:type_name -> google.protobuf.Timestamp
	97,  // 121: api.commons.OmniConversation.task_sid:type_name -> google.protobuf.Int64Value
	10,  // 122: api.commons.OmniConversationAssignment.assignment_type:type_name -> api.commons.AgentConversationAssignmentType
	91,  // 123: api.commons.OmniConversationAssignment.date_created:type_name -> google.protobuf.Timestamp
	91,  // 124: api.commons.OmniConversationAssignment.date_modified:type_name -> google.protobuf.Timestamp
	85,  // 125: api.commons.OmniConversationAssignment.metadata:type_name -> api.commons.OmniConversationAssignment.ConversationAssignmentDetails
	86,  // 126: api.commons.OmniConversationSkills.skills:type_name -> api.commons.OmniConversationSkills.SkillsEntry
	62,  // 127: api.commons.WeekdayTimeRange.entries:type_name -> api.commons.WeekdayTimeRangeEntry
	99,  // 128: api.commons.WeekdayTimeRangeEntry.start_day:type_name -> api.commons.Weekday.Enum
	99,  // 129: api.commons.WeekdayTimeRangeEntry.end_day:type_name -> api.commons.Weekday.Enum
	91,  // 130: api.commons.Disposition.date_created:type_name -> google.protobuf.Timestamp
	91,  // 131: api.commons.Disposition.date_modified:type_name -> google.protobuf.Timestamp
	87,  // 132: api.commons.GetQueuesDetailsRes.queue_details:type_name -> api.commons.GetQueuesDetailsRes.QueueDetails
	91,  // 133: api.commons.OmniCustomUnsubscribeLink.date_created:type_name -> google.protobuf.Timestamp
	91,  // 134: api.commons.OmniCustomUnsubscribeLink.date_modified:type_name -> google.protobuf.Timestamp
	91,  // 135: api.commons.OmniCustomUnsubscribeLink.date_validated:type_name -> google.protobuf.Timestamp
	95,  // 136: api.commons.ContactList.project_sid:type_name -> api.commons.Int64Id
	91,  // 137: api.commons.ContactList.date_created:type_name -> google.protobuf.Timestamp
	91,  // 138: api.commons.ContactList.date_modified:type_name -> google.protobuf.Timestamp
	67,  // 139: api.commons.ContactList.contact_entries:type_name -> api.commons.ContactEntry
	88,  // 140: api.commons.ContactList.metadata:type_name -> api.commons.ContactList.Metadata
	91,  // 141: api.commons.ContactEntry.date_created:type_name -> google.protobuf.Timestamp
	91,  // 142: api.commons.ContactEntry.date_modified:type_name -> google.protobuf.Timestamp
	73,  // 143: api.commons.ContactEntry.data_fields:type_name -> api.commons.OmniDataField
	14,  // 144: api.commons.OmniTask.status:type_name -> api.commons.OmniTaskStatus
	91,  // 145: api.commons.OmniTask.date_created:type_name -> google.protobuf.Timestamp
	91,  // 146: api.commons.OmniTask.date_modified:type_name -> google.protobuf.Timestamp
	95,  // 147: api.commons.OmniTask.contact_entry_sid:type_name -> api.commons.Int64Id
	70,  // 148: api.commons.OmniTask.state:type_name -> api.commons.OmniTaskState
	73,  // 149: api.commons.OmniTask.data_fields:type_name -> api.commons.OmniDataField
	89,  // 150: api.commons.OmniTask.details:type_name -> api.commons.OmniTask.Details
	93,  // 151: api.commons.OmniTask.status_message:type_name -> google.protobuf.StringValue
	91,  // 152: api.commons.OmniTask.scheduled_time:type_name -> google.protobuf.Timestamp
	69,  // 153: api.commons.OmniTask.task_config:type_name -> api.commons.OmniTaskConfig
	60,  // 154: api.commons.OmniTaskConfig.skills:type_name -> api.commons.OmniConversationSkills
	100, // 155: api.commons.OmniTaskConfig.absolute_timeout_duration:type_name -> google.protobuf.Duration
	100, // 156: api.commons.OmniTaskConfig.agent_timeout_duration:type_name -> google.protobuf.Duration
	37,  // 157: api.commons.OmniTaskConfig.message:type_name -> api.commons.OmniMessagePayload
	90,  // 158: api.commons.OmniTaskState.destinations:type_name -> api.commons.OmniTaskState.Entry
	90,  // 159: api.commons.OmniTaskState.sources:type_name -> api.commons.OmniTaskState.Entry
	71,  // 160: api.commons.OmniTaskState.rule_set:type_name -> api.commons.ComplianceRuleSet
	93,  // 161: api.commons.OmniTaskState.scrub_list_id:type_name -> google.protobuf.StringValue
	72,  // 162: api.commons.ComplianceRuleSet.rules:type_name -> api.commons.ComplianceRule
	101, // 163: api.commons.OmniDataField.type:type_name -> api.commons.FieldType
	91,  // 164: api.commons.ConnectedInbox.last_scheduled_time:type_name -> google.protobuf.Timestamp
	91,  // 165: api.commons.ConnectedInbox.last_checked:type_name -> google.protobuf.Timestamp
	93,  // 166: api.commons.ConnectedInbox.last_error:type_name -> google.protobuf.StringValue
	91,  // 167: api.commons.ConnectedInbox.standby_error_time:type_name -> google.protobuf.Timestamp
	91,  // 168: api.commons.ConnectedInbox.last_updated:type_name -> google.protobuf.Timestamp
	93,  // 169: api.commons.ConnectedInbox.google_xoauth2_refresh_token:type_name -> google.protobuf.StringValue
	93,  // 170: api.commons.ConnectedInbox.google_xoauth2_access_token:type_name -> google.protobuf.StringValue
	91,  // 171: api.commons.ConnectedInbox.google_xoauth2_access_token_expiration:type_name -> google.protobuf.Timestamp
	16,  // 172: api.commons.ConnectedInbox.authentication_type:type_name -> api.commons.ConnectedInboxAuthenticationType
	75,  // 173: api.commons.ConnectedInbox.oauth_reference_id:type_name -> api.commons.ConnectedInboxOAuthConfig
	91,  // 174: api.commons.VerifiedEmail.created_on:type_name -> google.protobuf.Timestamp
	91,  // 175: api.commons.VerifiedEmail.verified_on:type_name -> google.protobuf.Timestamp
	93,  // 176: api.commons.VerifiedEmail.description:type_name -> google.protobuf.StringValue
	91,  // 177: api.commons.Signature.date_created:type_name -> google.protobuf.Timestamp
	91,  // 178: api.commons.Signature.date_modified:type_name -> google.protobuf.Timestamp
	91,  // 179: api.commons.Signature.deleted_on:type_name -> google.protobuf.Timestamp
	80,  // 180: api.commons.OmniProjectComplianceConfig.email:type_name -> api.commons.OmniComplianceConfig
	80,  // 181: api.commons.OmniProjectComplianceConfig.sms:type_name -> api.commons.OmniComplianceConfig
	80,  // 182: api.commons.OmniProjectComplianceConfig.whatsapp:type_name -> api.commons.OmniComplianceConfig
	79,  // 183: api.commons.OmniComplianceConfig.opt_in:type_name -> api.commons.OmniComplianceAction
	79,  // 184: api.commons.OmniComplianceConfig.opt_out:type_name -> api.commons.OmniComplianceAction
	79,  // 185: api.commons.OmniComplianceConfig.help:type_name -> api.commons.OmniComplianceAction
	79,  // 186: api.commons.OmniComplianceConfig.information:type_name -> api.commons.OmniComplianceAction
	93,  // 187: api.commons.OmniComplianceConfig.rule_set_id:type_name -> google.protobuf.StringValue
	22,  // 188: api.commons.WhatsAppNumber.provider:type_name -> api.commons.WhatsAppNumberProvider
	91,  // 189: api.commons.WhatsAppNumber.date_created:type_name -> google.protobuf.Timestamp
	91,  // 190: api.commons.WhatsAppNumber.date_modified:type_name -> google.protobuf.Timestamp
	97,  // 191: api.commons.OmniCampaignModule.Details.total_task_count:type_name -> google.protobuf.Int64Value
	97,  // 192: api.commons.OmniCampaignModule.Details.completed_task_count:type_name -> google.protobuf.Int64Value
	93,  // 193: api.commons.OmniCampaignModule.Details.connected_inbox_address:type_name -> google.protobuf.StringValue
	93,  // 194: api.commons.OmniCampaignModule.Details.verified_email_address:type_name -> google.protobuf.StringValue
	97,  // 195: api.commons.OmniCampaignModule.Details.pending_task_count:type_name -> google.protobuf.Int64Value
	97,  // 196: api.commons.OmniCampaignModule.Details.failed_task_count:type_name -> google.protobuf.Int64Value
	97,  // 197: api.commons.OmniCampaignModule.Details.canceled_task_count:type_name -> google.protobuf.Int64Value
	3,   // 198: api.commons.GetQueuesDetailsRes.QueueDetails.channel_type:type_name -> api.commons.ChannelType
	93,  // 199: api.commons.OmniTask.Details.contact_list_name:type_name -> google.protobuf.StringValue
	91,  // 200: api.commons.OmniTaskState.Entry.last_used:type_name -> google.protobuf.Timestamp
