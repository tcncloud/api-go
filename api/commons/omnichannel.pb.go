...
func file_api_commons_omnichannel_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_commons_omnichannel_proto_msgTypes[58].Exporter = func(v any, i int) any {
		...
		file_api_commons_omnichannel_proto_msgTypes[61].Exporter = func(v any, i int) any {
	...
	file_api_commons_omnichannel_proto_msgTypes[11].OneofWrappers = []any{
