...
const (
	...
	OmniMessageStatus_OMNI_OUTBOUND_MESSAGE_UNCONFIRMED_DELIVERY OmniMessageStatus = 16260 // message did not recieve delivery confirmation, this could be that the destination carrier does not send delivery confirmations, or this could be a failure
...
var (
	OmniMessageStatus_name = map[int32]string{
		...
		16260: "OMNI_OUTBOUND_MESSAGE_UNCONFIRMED_DELIVERY",
...
const (
	...
	OmniTaskStatus_OMNI_TASK_SENDING_INVALID      OmniTaskStatus = 112 // invalid destination number that is not a cell number
...
const (
	...
	OmniConversationMetadataName_OMNI_CONVERSATION_METADATA_NAME_VOICE_DATA                        OmniConversationMetadataName = 5
...
var (
	OmniConversationMetadataName_name = map[int32]string{
		...
		5:   "OMNI_CONVERSATION_METADATA_NAME_VOICE_DATA",
...
type OmniMessageType int32

const (
	OmniMessageType_OMNI_MESSAGE_TYPE_TEXT_MESSAGE                  OmniMessageType = 0
	OmniMessageType_OMNI_MESSAGE_TYPE_TYPING_NOTIFICATION           OmniMessageType = 1
	OmniMessageType_OMNI_MESSAGE_TYPE_REASSIGNMENT_NOTIFICATION     OmniMessageType = 2
	OmniMessageType_OMNI_MESSAGE_TYPE_ASSIGN_CONVERSATION           OmniMessageType = 3
	OmniMessageType_OMNI_MESSAGE_TYPE_UNASSIGN_CONVERSATION         OmniMessageType = 4
	OmniMessageType_OMNI_MESSAGE_TYPE_ATTACHMENT                    OmniMessageType = 5
	OmniMessageType_OMNI_MESSAGE_TYPE_ATTACHMENT_UPLOAD_URL         OmniMessageType = 6
	OmniMessageType_OMNI_MESSAGE_TYPE_REQUEST_ATTACHMENT_UPLOAD_URL OmniMessageType = 7
	OmniMessageType_OMNI_MESSAGE_TYPE_CLOSE_CONVERSATION            OmniMessageType = 8
	OmniMessageType_OMNI_MESSAGE_TYPE_START_WRAP_UP                 OmniMessageType = 9
	OmniMessageType_OMNI_MESSAGE_TYPE_FINISH_WRAP_UP                OmniMessageType = 10
	OmniMessageType_OMNI_MESSAGE_TYPE_UNKNOWN                       OmniMessageType = 11
	OmniMessageType_OMNI_MESSAGE_TYPE_SUSPEND                       OmniMessageType = 12
	OmniMessageType_OMNI_MESSAGE_TYPE_QUEUE_INFORMATION             OmniMessageType = 13
	OmniMessageType_OMNI_MESSAGE_TYPE_REQUEST_QUEUE_INFORMATION     OmniMessageType = 14
	OmniMessageType_OMNI_MESSAGE_TYPE_OFFLOADED_TEXT_MESSAGE        OmniMessageType = 15
	OmniMessageType_OMNI_MESSAGE_TYPE_CANNED_MESSAGE                OmniMessageType = 16
)

// Enum value maps for OmniMessageType.
var (
	OmniMessageType_name = map[int32]string{
		0:  "OMNI_MESSAGE_TYPE_TEXT_MESSAGE",
		1:  "OMNI_MESSAGE_TYPE_TYPING_NOTIFICATION",
		2:  "OMNI_MESSAGE_TYPE_REASSIGNMENT_NOTIFICATION",
		3:  "OMNI_MESSAGE_TYPE_ASSIGN_CONVERSATION",
		4:  "OMNI_MESSAGE_TYPE_UNASSIGN_CONVERSATION",
		5:  "OMNI_MESSAGE_TYPE_ATTACHMENT",
		6:  "OMNI_MESSAGE_TYPE_ATTACHMENT_UPLOAD_URL",
		7:  "OMNI_MESSAGE_TYPE_REQUEST_ATTACHMENT_UPLOAD_URL",
		8:  "OMNI_MESSAGE_TYPE_CLOSE_CONVERSATION",
		9:  "OMNI_MESSAGE_TYPE_START_WRAP_UP",
		10: "OMNI_MESSAGE_TYPE_FINISH_WRAP_UP",
		11: "OMNI_MESSAGE_TYPE_UNKNOWN",
		12: "OMNI_MESSAGE_TYPE_SUSPEND",
		13: "OMNI_MESSAGE_TYPE_QUEUE_INFORMATION",
		14: "OMNI_MESSAGE_TYPE_REQUEST_QUEUE_INFORMATION",
		15: "OMNI_MESSAGE_TYPE_OFFLOADED_TEXT_MESSAGE",
		16: "OMNI_MESSAGE_TYPE_CANNED_MESSAGE",
	}
	OmniMessageType_value = map[string]int32{
...
func (x OmniMessageType) Enum() *OmniMessageType {
	p := new(OmniMessageType)
	*p = x
	return p
}

func (x OmniMessageType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (OmniMessageType) Descriptor() protoreflect.EnumDescriptor {
	return file_api_commons_omnichannel_proto_enumTypes[23].Descriptor()
}

func (OmniMessageType) Type() protoreflect.EnumType {
	return &file_api_commons_omnichannel_proto_enumTypes[23]
}

func (x OmniMessageType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use OmniMessageType.Descriptor instead.
func (OmniMessageType) EnumDescriptor() ([]byte, []int) {
...
type OmniCampaignModuleConfig struct {
	...
	ProviderMetadata map[string]string `protobuf:"bytes,23,rep,name=provider_metadata,json=providerMetadata,proto3" json:"provider_metadata,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	...
	// country code sid
	CountryCodeSid int64 `protobuf:"varint,27,opt,name=country_code_sid,json=countryCodeSid,proto3" json:"country_code_sid,omitempty"`
	// postal code field
...
func (x *OmniCampaignModuleConfig) GetCountryCodeSid() int64 {
	if x != nil {
		return x.CountryCodeSid
	}
	return 0
}
...
func (x *OmniMessagePayload) GetPayload() isOmniMessagePayload_Payload {
	if x != nil {
		return x.Payload
	}
	return nil
...
func (x *OmniMessagePayload) GetTextMessage() *OmniTextMessage {
	if x != nil {
		if x, ok := x.Payload.(*OmniMessagePayload_TextMessage); ok {
...
func (x *OmniMessagePayload) GetTypingNotification() *OmniTypingNotification {
	if x != nil {
		if x, ok := x.Payload.(*OmniMessagePayload_TypingNotification); ok {
...
func (x *OmniMessagePayload) GetReassignment() *OmniReassignmentNotification {
	if x != nil {
		if x, ok := x.Payload.(*OmniMessagePayload_Reassignment); ok {
...
func (x *OmniMessagePayload) GetRequestAttachmentUploadUrl() *OmniRequestAttachmentUploadURL {
	if x != nil {
		if x, ok := x.Payload.(*OmniMessagePayload_RequestAttachmentUploadUrl); ok {
...
func (x *OmniMessagePayload) GetAttachmentUploadUrl() *OmniAttachmentUploadURL {
	if x != nil {
		if x, ok := x.Payload.(*OmniMessagePayload_AttachmentUploadUrl); ok {
...
func (x *OmniMessagePayload) GetAttachment() *OmniAttachment {
	if x != nil {
		if x, ok := x.Payload.(*OmniMessagePayload_Attachment); ok {
			return x.Attachment
		}
	}
	return nil
...
func (x *OmniMessagePayload) GetCloseConversation() *OmniCloseConversation {
	if x != nil {
		if x, ok := x.Payload.(*OmniMessagePayload_CloseConversation); ok {
...
func (x *OmniMessagePayload) GetAssignConversation() *OmniAssignConversation {
	if x != nil {
		if x, ok := x.Payload.(*OmniMessagePayload_AssignConversation); ok {
...
func (x *OmniMessagePayload) GetUnassignConversation() *OmniUnassignConversation {
	if x != nil {
		if x, ok := x.Payload.(*OmniMessagePayload_UnassignConversation); ok {
...
func (x *OmniMessagePayload) GetFinishWrapUp() *OmniFinishWrapUp {
	if x != nil {
		if x, ok := x.Payload.(*OmniMessagePayload_FinishWrapUp); ok {
...
func (x *OmniMessagePayload) GetSuspend() *OmniSuspend {
	if x != nil {
		if x, ok := x.Payload.(*OmniMessagePayload_Suspend); ok {
			return x.Suspend
		}
	}
	return nil
...
func (x *OmniMessagePayload) GetStartWrapUp() *OmniStartWrapUp {
	if x != nil {
		if x, ok := x.Payload.(*OmniMessagePayload_StartWrapUp); ok {
...
func (x *OmniMessagePayload) GetQueueInformation() *OmniQueueInformation {
	if x != nil {
		if x, ok := x.Payload.(*OmniMessagePayload_QueueInformation); ok {
...
func (x *OmniMessagePayload) GetRequestQueueInformation() *OmniRequestQueueInformation {
	if x != nil {
		if x, ok := x.Payload.(*OmniMessagePayload_RequestQueueInformation); ok {
...
func (x *OmniMessagePayload) GetOffLoadedTextMessage() *OmniOffLoadedTextMessage {
	if x != nil {
		if x, ok := x.Payload.(*OmniMessagePayload_OffLoadedTextMessage); ok {
...
func (x *OmniMessagePayload) GetCannedMessage() *OmniCannedMessage {
	if x != nil {
		if x, ok := x.Payload.(*OmniMessagePayload_CannedMessage); ok {
...
func (x *OmniMessagePayload) GetDataMessage() *OmniDataMessage {
	if x != nil {
		if x, ok := x.Payload.(*OmniMessagePayload_DataMessage); ok {
...
func (x *OmniCloseConversation) GetUserName() string {
	if x != nil {
		return x.UserName
	}
	return ""
...
var file_api_commons_omnichannel_proto_rawDesc = string([]byte{
	...
	0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xf3, 0x0d, 0x0a, 0x18, 0x4f, 0x6d, 0x6e, 0x69, 0x43, 0x61,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x6e, 0x63, 0x65, 0x49, 0x64, 0x12, 0x5f, 0x0a, 0x14, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d,
	0x65, 0x72, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x05,
	...
	0x6f, 0x6e, 0x52, 0x13, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f,
	0x72, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xb9, 0x03, 0x0a, 0x16, 0x41, 0x67, 0x65, 0x6e,
	0x74, 0x43, 0x68, 0x61, 0x74, 0x57, 0x69, 0x64, 0x67, 0x65, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61,
	...
	0x73, 0x61, 0x67, 0x65, 0x53, 0x69, 0x64, 0x12, 0x39, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f,
	0x61, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x63,
	...
	0x61, 0x64, 0x12, 0x3d, 0x0a, 0x0c, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x63, 0x72, 0x65, 0x61, 0x74,
	...
	0x64, 0x12, 0x26, 0x0a, 0x0f, 0x75, 0x69, 0x5f, 0x72, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63,
	0x65, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x75, 0x69, 0x52, 0x65,
	0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x49, 0x64, 0x12, 0x57, 0x0a, 0x10, 0x75, 0x73, 0x65,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x48, 0x00, 0x52, 0x0d, 0x63, 0x61, 0x6e, 0x6e, 0x65, 0x64, 0x4d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x12, 0x41, 0x0a, 0x0c, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x6d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x18, 0x74, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x63,
	0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x73, 0x2e, 0x4f, 0x6d, 0x6e, 0x69, 0x44, 0x61, 0x74, 0x61, 0x4d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x48, 0x00, 0x52, 0x0b, 0x64, 0x61, 0x74, 0x61, 0x4d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0x09, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64,
	0x22, 0xbe, 0x01, 0x0a, 0x0f, 0x4f, 0x6d, 0x6e, 0x69, 0x54, 0x65, 0x78, 0x74, 0x4d, 0x65, 0x73,
	...
	0x52, 0x0b, 0x61, 0x74, 0x74, 0x61, 0x63, 0x68, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x52, 0x0a,
	0x17, 0x70, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x5f, 0x61, 0x73, 0x6d, 0x5f, 0x73, 0x65, 0x73,
	0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x73, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b,
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66,
	...
	,
	...
	0x61, 0x6d, 0x65, 0x12, 0x35, 0x0a, 0x17, 0x70, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x5f, 0x61,
	0x73, 0x6d, 0x5f, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x73, 0x69, 0x64, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x14, 0x70, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x41, 0x73, 0x6d,
	0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x53, 0x69, 0x64, 0x22, 0x8b, 0x02, 0x0a, 0x1c, 0x4f,
	0x6d, 0x6e, 0x69, 0x52, 0x65, 0x61, 0x73, 0x73, 0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x4e,
	0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x26, 0x0a, 0x0f, 0x63,
	...
	0x72, 0x49, 0x64, 0x12, 0x2a, 0x0a, 0x11, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x5f, 0x75,
	0x73, 0x65, 0x72, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f,
	0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x55, 0x73, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x12,
	0x1e, 0x0a, 0x0b, 0x6e, 0x65, 0x77, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x03,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x6e, 0x65, 0x77, 0x55, 0x73, 0x65, 0x72, 0x4e,
	0x61, 0x6d, 0x65, 0x12, 0x53, 0x0a, 0x18, 0x6e, 0x65, 0x77, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x5f,
	...
	,
	...
	,
	...
	0x70, 0x61, 0x74, 0x68, 0x12, 0x35, 0x0a, 0x07, 0x74, 0x65, 0x6d, 0x70, 0x5f, 0x69, 0x64, 0x18,
	0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x56, 0x61,
	0x6c, 0x75, 0x65, 0x52, 0x06, 0x74, 0x65, 0x6d, 0x70, 0x49, 0x64, 0x12, 0x21, 0x0a, 0x0c, 0x64,
	0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x07, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0b, 0x64, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x55, 0x72, 0x6c, 0x12, 0x3d,
	...
	,
	...
	0x73, 0x6d, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x53, 0x69, 0x64, 0x22, 0x66, 0x0a, 0x10,
	...
	0x6e, 0x53, 0x69, 0x64, 0x22, 0x61, 0x0a, 0x0b, 0x4f, 0x6d, 0x6e, 0x69, 0x53, 0x75, 0x73, 0x70,
	0x65, 0x6e, 0x64, 0x12, 0x52, 0x0a, 0x17, 0x70, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x5f, 0x61,
	...
	0x73, 0x69, 0x6f, 0x6e, 0x53, 0x69, 0x64, 0x22, 0x88, 0x01, 0x0a, 0x15, 0x4f, 0x6d, 0x6e, 0x69,
	0x43, 0x6c, 0x6f, 0x73, 0x65, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x12, 0x52, 0x0a, 0x17, 0x70, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x5f, 0x61, 0x73, 0x6d,
	...
	0x6f, 0x6e, 0x53, 0x69, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x6e, 0x61,
	0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x4e, 0x61,
	0x6d, 0x65, 0x22, 0x32, 0x0a, 0x14, 0x4f, 0x6d, 0x6e, 0x69, 0x51, 0x75, 0x65, 0x75, 0x65, 0x49,
	0x6e, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x6f,
	0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x70, 0x6f,
	0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x39, 0x0a, 0x1b, 0x4f, 0x6d, 0x6e, 0x69, 0x52, 0x65,
	...
	0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f,
	0x6e, 0x22, 0x3f, 0x0a, 0x11, 0x4f, 0x6d, 0x6e, 0x69, 0x43, 0x61, 0x6e, 0x6e, 0x65, 0x64, 0x4d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x2a, 0x0a, 0x11, 0x63, 0x61, 0x6e, 0x6e, 0x65, 0x64,
	...
	0x49, 0x64, 0x22, 0x50, 0x0a, 0x0f, 0x4f, 0x6d, 0x6e, 0x69, 0x44, 0x61, 0x74, 0x61, 0x4d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12,
	0x23, 0x0a, 0x0b, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x5f, 0x73, 0x69, 0x64, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x03, 0x42, 0x02, 0x30, 0x01, 0x52, 0x0a, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x53, 0x69, 0x64, 0x22, 0x4e, 0x0a, 0x1f, 0x4f, 0x6d, 0x6e, 0x69, 0x43, 0x6f, 0x6e, 0x76,
	...
	0x6e, 0x61, 0x6d, 0x65, 0x22, 0x55, 0x0a, 0x15, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72,
	0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x65, 0x64, 0x44, 0x61, 0x74, 0x61, 0x12, 0x3c, 0x0a,
	...
	0x49, 0x74, 0x65, 0x6d, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x43, 0x0a, 0x19, 0x43,
	0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x65, 0x64,
	0x44, 0x61, 0x74, 0x61, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61,
	0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65,
	0x22, 0xc9, 0x0d, 0x0a, 0x10, 0x4f, 0x6d, 0x6e, 0x69, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73,
	...
	0x65, 0x12, 0x3b, 0x0a, 0x06, 0x73, 0x6b, 0x69, 0x6c, 0x6c, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28,
	...
	0x53, 0x6b, 0x69, 0x6c, 0x6c, 0x73, 0x52, 0x06, 0x73, 0x6b, 0x69, 0x6c, 0x6c, 0x73, 0x12, 0x3d,
	...
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70,
	0x52, 0x0c, 0x64, 0x61, 0x74, 0x65, 0x4d, 0x6f, 0x64, 0x69, 0x66, 0x69, 0x65, 0x64, 0x12, 0x37,
	...
	0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x52, 0x0a, 0x16, 0x63, 0x75, 0x73, 0x74, 0x6f,
	...
	,
	...
	0x65, 0x6f, 0x75, 0x74, 0x73, 0x12, 0x62, 0x0a, 0x18, 0x63, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x61, 0x73, 0x73, 0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e, 0x74,
	0x73, 0x18, 0x0f, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x63, 0x6f,
	...
	0x52, 0x17, 0x63, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x41, 0x73,
	0x73, 0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x4d, 0x0a, 0x08, 0x6d, 0x65, 0x74,
	0x61, 0x64, 0x61, 0x74, 0x61, 0x18, 0x10, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x31, 0x2e, 0x61, 0x70,
	0x69, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x73, 0x2e, 0x4f, 0x6d, 0x6e, 0x69, 0x43, 0x6f,
	0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x43, 0x6f, 0x6e, 0x76, 0x65,
	0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x52, 0x08,
	0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x35, 0x0a, 0x08, 0x65, 0x6e, 0x64, 0x5f,
	...
	,
	...
	,
	...
	0x08, 0x52, 0x08, 0x69, 0x73, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x12, 0x55, 0x0a, 0x0f, 0x61,
	0x73, 0x73, 0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x06,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x2c, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	0x6e, 0x73, 0x2e, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x41, 0x73, 0x73, 0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x54, 0x79,
	0x70, 0x65, 0x52, 0x0e, 0x61, 0x73, 0x73, 0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x54, 0x79,
	0x70, 0x65, 0x12, 0x3d, 0x0a, 0x0c, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x63, 0x72, 0x65, 0x61, 0x74,
	...
	,
	...
	,
	...
	0x6e, 0x53, 0x69, 0x64, 0x12, 0x3d, 0x0a, 0x0c, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x63, 0x72, 0x65,
	...
	,
	...
	0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x71, 0x75, 0x65,
	0x75, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x71, 0x75,
	0x65, 0x75, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x22, 0xb3, 0x03, 0x0a, 0x19, 0x4f, 0x6d, 0x6e, 0x69,
	0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x55, 0x6e, 0x73, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62,
	0x65, 0x4c, 0x69, 0x6e, 0x6b, 0x12, 0x41, 0x0a, 0x1b, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x5f,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x2e, 0x4f, 0x6d, 0x6e, 0x69, 0x54, 0x61, 0x73, 0x6b, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52,
	...
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e,
	0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x0c, 0x64, 0x61, 0x74, 0x65, 0x4d,
	0x6f, 0x64, 0x69, 0x66, 0x69, 0x65, 0x64, 0x12, 0x32, 0x0a, 0x13, 0x63, 0x61, 0x6d, 0x70, 0x61,
	...
	0x67, 0x6e, 0x4d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x53, 0x69, 0x64, 0x12, 0x25, 0x0a, 0x0c, 0x63,
	...
	,
	...
	0x6c, 0x64, 0x73, 0x12, 0x37, 0x0a, 0x07, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x18, 0x0a,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	0x6e, 0x73, 0x2e, 0x4f, 0x6d, 0x6e, 0x69, 0x54, 0x61, 0x73, 0x6b, 0x2e, 0x44, 0x65, 0x74, 0x61,
	...
	0x12, 0x43, 0x0a, 0x0e, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x5f, 0x6d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x53, 0x74, 0x72, 0x69, 0x6e,
	0x67, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x0d, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x4d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x41, 0x0a, 0x0e, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c,
	...
	0x75, 0x6c, 0x65, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x3c, 0x0a, 0x0b, 0x74, 0x61, 0x73, 0x6b,
	0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e,
	0x61, 0x70, 0x69, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x73, 0x2e, 0x4f, 0x6d, 0x6e, 0x69,
	0x54, 0x61, 0x73, 0x6b, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x0a, 0x74, 0x61, 0x73, 0x6b,
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x1a, 0x53, 0x0a, 0x07, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c,
	0x73, 0x12, 0x48, 0x0a, 0x11, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x63, 0x74, 0x5f, 0x6c, 0x69, 0x73,
	...
	0x61, 0x63, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x4a, 0x04, 0x08, 0x0e, 0x10,
	0x0f, 0x22, 0xe3, 0x02, 0x0a, 0x0e, 0x4f, 0x6d, 0x6e, 0x69, 0x54, 0x61, 0x73, 0x6b, 0x43, 0x6f,
	0x6e, 0x66, 0x69, 0x67, 0x12, 0x3b, 0x0a, 0x06, 0x73, 0x6b, 0x69, 0x6c, 0x6c, 0x73, 0x18, 0x01,
	...
	0x73, 0x12, 0x55, 0x0a, 0x19, 0x61, 0x62, 0x73, 0x6f, 0x6c, 0x75, 0x74, 0x65, 0x5f, 0x74, 0x69,
	0x6d, 0x65, 0x6f, 0x75, 0x74, 0x5f, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x44, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52,
	0x17, 0x61, 0x62, 0x73, 0x6f, 0x6c, 0x75, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74,
	0x44, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x4f, 0x0a, 0x16, 0x61, 0x67, 0x65, 0x6e,
	...
	0x69, 0x6f, 0x6e, 0x52, 0x14, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75,
	0x74, 0x44, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x75, 0x62,
	0x6a, 0x65, 0x63, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x73, 0x75, 0x62, 0x6a,
	0x65, 0x63, 0x74, 0x12, 0x39, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x05,
	...
	0x79, 0x6c, 0x6f, 0x61, 0x64, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x17,
	0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x89, 0x03, 0x0a, 0x0d, 0x4f, 0x6d, 0x6e, 0x69,
	...
	,
	...
	0x74, 0x65, 0x64, 0x49, 0x6e, 0x62, 0x6f, 0x78, 0x53, 0x69, 0x64, 0x12, 0x23, 0x0a, 0x0d, 0x65,
	...
	0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x12, 0x36, 0x0a, 0x17, 0x63, 0x68, 0x65, 0x63,
	0x6b, 0x5f, 0x66, 0x72, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x79, 0x5f, 0x6d, 0x69, 0x6e, 0x75,
	0x74, 0x65, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x15, 0x63, 0x68, 0x65, 0x63, 0x6b,
	0x46, 0x72, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x79, 0x4d, 0x69, 0x6e, 0x75, 0x74, 0x65, 0x73,
	...
	,
	...
	,
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61,
	0x6d, 0x70, 0x42, 0x02, 0x18, 0x01, 0x52, 0x22, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x58, 0x6f,
	0x61, 0x75, 0x74, 0x68, 0x32, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e,
	0x45, 0x78, 0x70, 0x69, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x5e, 0x0a, 0x13, 0x61, 0x75,
	0x74, 0x68, 0x65, 0x6e, 0x74, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x74, 0x79, 0x70,
	0x65, 0x18, 0x15, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2d, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x63, 0x6f,
	...
	,
	...
	0x72, 0x65, 0x73, 0x41, 0x74, 0x12, 0x21, 0x0a, 0x0c, 0x72, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e,
	0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x72, 0x65, 0x66,
	0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x49, 0x64, 0x22, 0xd4, 0x02, 0x0a, 0x0d, 0x56, 0x65, 0x72,
	0x69, 0x66, 0x69, 0x65, 0x64, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x30, 0x0a, 0x12, 0x76, 0x65,
	...
	0x66, 0x69, 0x65, 0x64, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x53, 0x69, 0x64, 0x12, 0x23, 0x0a, 0x0d,
	...
	,
	...
	0x75, 0x72, 0x65, 0x53, 0x69, 0x64, 0x12, 0x1c, 0x0a, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74,
	0x75, 0x72, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61,
	0x74, 0x75, 0x72, 0x65, 0x12, 0x3d, 0x0a, 0x0c, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x63, 0x72, 0x65,
	...
	0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d,
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x0c, 0x64, 0x61, 0x74, 0x65, 0x4d, 0x6f, 0x64, 0x69,
	0x66, 0x69, 0x65, 0x64, 0x12, 0x39, 0x0a, 0x0a, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x5f,
	...
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xca, 0x01, 0x0a, 0x1b, 0x4f, 0x6d, 0x6e, 0x69, 0x50, 0x72,
	0x6f, 0x6a, 0x65, 0x63, 0x74, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x69, 0x61, 0x6e, 0x63, 0x65, 0x43,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x37, 0x0a, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x18, 0x01,
	...
	0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x33,
	0x0a, 0x03, 0x73, 0x6d, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x61, 0x70,
	0x69, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x73, 0x2e, 0x4f, 0x6d, 0x6e, 0x69, 0x43, 0x6f,
	0x6d, 0x70, 0x6c, 0x69, 0x61, 0x6e, 0x63, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x03,
	0x73, 0x6d, 0x73, 0x12, 0x3d, 0x0a, 0x08, 0x77, 0x68, 0x61, 0x74, 0x73, 0x61, 0x70, 0x70, 0x18,
	...
	,
	...
	,
	...
	,
	...
	0x5f, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x4e, 0x45, 0x57, 0x10, 0x00, 0x12, 0x34, 0x0a,
	0x30, 0x43, 0x4f, 0x4e, 0x56, 0x45, 0x52, 0x53, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x53, 0x54,
	...
	,
	...
	,
	...
	,
	...
	0x33, 0x36, 0x35, 0x10, 0x02, 0x2a, 0xe1, 0x03, 0x0a, 0x20, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72,
	0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x43, 0x68, 0x61, 0x6e, 0x67,
	0x65, 0x54, 0x69, 0x6d, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x2d, 0x0a, 0x29, 0x43, 0x4f,
	...
	0x4d, 0x45, 0x5f, 0x57, 0x41, 0x49, 0x54, 0x10, 0x00, 0x12, 0x2d, 0x0a, 0x29, 0x43, 0x4f, 0x4e,
	...
	0x45, 0x5f, 0x54, 0x41, 0x4c, 0x4b, 0x10, 0x64, 0x12, 0x44, 0x0a, 0x40, 0x43, 0x4f, 0x4e, 0x56,
	...
	,
	...
	,
	...
	0x5f, 0x54, 0x41, 0x4c, 0x4b, 0x5f, 0x41, 0x47, 0x45, 0x4e, 0x54, 0x5f, 0x52, 0x45, 0x53, 0x50,
	0x4f, 0x4e, 0x53, 0x45, 0x10, 0x66, 0x12, 0x40, 0x0a, 0x3c, 0x4f, 0x4d, 0x4e, 0x49, 0x5f, 0x43,
	...
	0x54, 0x41, 0x4c, 0x4b, 0x5f, 0x43, 0x55, 0x53, 0x54, 0x4f, 0x4d, 0x45, 0x52, 0x5f, 0x52, 0x45,
	0x53, 0x50, 0x4f, 0x4e, 0x53, 0x45, 0x10, 0x67, 0x12, 0x38, 0x0a, 0x34, 0x4f, 0x4d, 0x4e, 0x49,
	...
	,
	...
	,
...
var (
	...
	file_api_commons_omnichannel_proto_rawDescData []byte
)

func file_api_commons_omnichannel_proto_rawDescGZIP() []byte {
	file_api_commons_omnichannel_proto_rawDescOnce.Do(func() {
		file_api_commons_omnichannel_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_commons_omnichannel_proto_rawDesc), len(file_api_commons_omnichannel_proto_rawDesc)))
	})
	return file_api_commons_omnichannel_proto_rawDescData
}

var file_api_commons_omnichannel_proto_enumTypes = make([]protoimpl.EnumInfo, 24)
...
var file_api_commons_omnichannel_proto_goTypes = []any{
	...
	(OmniMessageType)(0),                         // 23: api.commons.OmniMessageType
	(*OmniCampaign)(nil),                         // 24: api.commons.OmniCampaign
	(*OmniCampaignModule)(nil),                   // 25: api.commons.OmniCampaignModule
	(*OmniCampaignModuleConfig)(nil),             // 26: api.commons.OmniCampaignModuleConfig
	(*ConversationTimeoutMessageConfig)(nil),     // 27: api.commons.ConversationTimeoutMessageConfig
	(*SmsNumber)(nil),                            // 28: api.commons.SmsNumber
	(*ConversationCustomerInformation)(nil),      // 29: api.commons.ConversationCustomerInformation
	(*SLATimeouts)(nil),                          // 30: api.commons.SLATimeouts
	(*ConversationCollectedData)(nil),            // 31: api.commons.ConversationCollectedData
	(*ConversationCollectedData_Item)(nil),       // 32: api.commons.ConversationCollectedData_Item
	(*OmniMessage)(nil),                          // 33: api.commons.OmniMessage
	(*CustomerChatWidgetMessage)(nil),            // 34: api.commons.CustomerChatWidgetMessage
	(*AgentChatWidgetMessage)(nil),               // 35: api.commons.AgentChatWidgetMessage
	(*OmniMessagePayload)(nil),                   // 36: api.commons.OmniMessagePayload
	(*OmniTextMessage)(nil),                      // 37: api.commons.OmniTextMessage
	(*OmniOffLoadedTextMessage)(nil),             // 38: api.commons.OmniOffLoadedTextMessage
	(*OmniTypingNotification)(nil),               // 39: api.commons.OmniTypingNotification
	(*OmniAssignConversation)(nil),               // 40: api.commons.OmniAssignConversation
	(*OmniReassignmentNotification)(nil),         // 41: api.commons.OmniReassignmentNotification
	(*OmniUnassignConversation)(nil),             // 42: api.commons.OmniUnassignConversation
	(*OmniRequestAttachmentUploadURL)(nil),       // 43: api.commons.OmniRequestAttachmentUploadURL
	(*OmniAttachmentUploadURL)(nil),              // 44: api.commons.OmniAttachmentUploadURL
	(*OmniAttachment)(nil),                       // 45: api.commons.OmniAttachment
	(*OmniStartWrapUp)(nil),                      // 46: api.commons.OmniStartWrapUp
	(*OmniFinishWrapUp)(nil),                     // 47: api.commons.OmniFinishWrapUp
	(*OmniSuspend)(nil),                          // 48: api.commons.OmniSuspend
	(*OmniCloseConversation)(nil),                // 49: api.commons.OmniCloseConversation
	(*OmniQueueInformation)(nil),                 // 50: api.commons.OmniQueueInformation
	(*OmniRequestQueueInformation)(nil),          // 51: api.commons.OmniRequestQueueInformation
	(*OmniCannedMessage)(nil),                    // 52: api.commons.OmniCannedMessage
	(*OmniDataMessage)(nil),                      // 53: api.commons.OmniDataMessage
	(*OmniConversationUserInformation)(nil),      // 54: api.commons.OmniConversationUserInformation
	(*CustomerCollectedData)(nil),                // 55: api.commons.CustomerCollectedData
	(*CustomerCollectedDataItem)(nil),            // 56: api.commons.CustomerCollectedDataItem
	(*OmniConversation)(nil),                     // 57: api.commons.OmniConversation
	(*OmniConversationAssignment)(nil),           // 58: api.commons.OmniConversationAssignment
	(*OmniConversationSkills)(nil),               // 59: api.commons.OmniConversationSkills
	(*WeekdayTimeRange)(nil),                     // 60: api.commons.WeekdayTimeRange
	(*WeekdayTimeRangeEntry)(nil),                // 61: api.commons.WeekdayTimeRangeEntry
	(*Disposition)(nil),                          // 62: api.commons.Disposition
	(*GetQueuesDetailsRes)(nil),                  // 63: api.commons.GetQueuesDetailsRes
	(*OmniCustomUnsubscribeLink)(nil),            // 64: api.commons.OmniCustomUnsubscribeLink
	(*ContactList)(nil),                          // 65: api.commons.ContactList
	(*ContactEntry)(nil),                         // 66: api.commons.ContactEntry
	(*OmniTask)(nil),                             // 67: api.commons.OmniTask
	(*OmniTaskConfig)(nil),                       // 68: api.commons.OmniTaskConfig
	(*OmniTaskState)(nil),                        // 69: api.commons.OmniTaskState
	(*ComplianceRuleSet)(nil),                    // 70: api.commons.ComplianceRuleSet
	(*ComplianceRule)(nil),                       // 71: api.commons.ComplianceRule
	(*OmniDataField)(nil),                        // 72: api.commons.OmniDataField
	(*ConnectedInbox)(nil),                       // 73: api.commons.ConnectedInbox
	(*ConnectedInboxOAuthConfig)(nil),            // 74: api.commons.ConnectedInboxOAuthConfig
	(*VerifiedEmail)(nil),                        // 75: api.commons.VerifiedEmail
	(*Signature)(nil),                            // 76: api.commons.Signature
	(*OmniProjectComplianceConfig)(nil),          // 77: api.commons.OmniProjectComplianceConfig
	(*OmniComplianceAction)(nil),                 // 78: api.commons.OmniComplianceAction
	(*OmniComplianceConfig)(nil),                 // 79: api.commons.OmniComplianceConfig
	(*WhatsAppNumber)(nil),                       // 80: api.commons.WhatsAppNumber
	(*OmniCampaignModule_Details)(nil),           // 81: api.commons.OmniCampaignModule.Details
	nil,                                          // 82: api.commons.OmniCampaignModuleConfig.ProviderMetadataEntry
	(*OmniConversation_ConversationDetails)(nil), // 83: api.commons.OmniConversation.ConversationDetails
	(*OmniConversationAssignment_ConversationAssignmentDetails)(nil), // 84: api.commons.OmniConversationAssignment.ConversationAssignmentDetails
	nil,                                      // 85: api.commons.OmniConversationSkills.SkillsEntry
	(*GetQueuesDetailsRes_QueueDetails)(nil), // 86: api.commons.GetQueuesDetailsRes.QueueDetails
	(*ContactList_Metadata)(nil),             // 87: api.commons.ContactList.Metadata
	(*OmniTask_Details)(nil),                 // 88: api.commons.OmniTask.Details
	(*OmniTaskState_Entry)(nil),              // 89: api.commons.OmniTaskState.Entry
	(*timestamppb.Timestamp)(nil),            // 90: google.protobuf.Timestamp
	(*TimeZoneWrapper)(nil),                  // 91: api.commons.TimeZoneWrapper
	(*wrapperspb.StringValue)(nil),           // 92: google.protobuf.StringValue
	(*ChatColorProperties)(nil),              // 93: api.commons.ChatColorProperties
	(*Int64Id)(nil),                          // 94: api.commons.Int64Id
	(*ChatHeader)(nil),                       // 95: api.commons.ChatHeader
	(*wrapperspb.Int64Value)(nil),            // 96: google.protobuf.Int64Value
	(*wrapperspb.BoolValue)(nil),             // 97: google.protobuf.BoolValue
	(Weekday_Enum)(0),                        // 98: api.commons.Weekday.Enum
	(*durationpb.Duration)(nil),              // 99: google.protobuf.Duration
	(FieldType)(0),                           // 100: api.commons.FieldType
}
var file_api_commons_omnichannel_proto_depIdxs = []int32{
	59,  // 0: api.commons.OmniCampaign.skills:type_name -> api.commons.OmniConversationSkills
	90,  // 1: api.commons.OmniCampaign.start_date:type_name -> google.protobuf.Timestamp
	...
	90,  // 4: api.commons.OmniCampaign.date_created:type_name -> google.protobuf.Timestamp
	90,  // 5: api.commons.OmniCampaign.date_modified:type_name -> google.protobuf.Timestamp
	25,  // 6: api.commons.OmniCampaign.modules:type_name -> api.commons.OmniCampaignModule
	91,  // 7: api.commons.OmniCampaign.time_zone:type_name -> api.commons.TimeZoneWrapper
	79,  // 8: api.commons.OmniCampaign.compliance_config:type_name -> api.commons.OmniComplianceConfig
	...
	26,  // 11: api.commons.OmniCampaignModule.config:type_name -> api.commons.OmniCampaignModuleConfig
	90,  // 12: api.commons.OmniCampaignModule.date_created:type_name -> google.protobuf.Timestamp
	90,  // 13: api.commons.OmniCampaignModule.date_modified:type_name -> google.protobuf.Timestamp
	90,  // 14: api.commons.OmniCampaignModule.scheduled_stop_date:type_name -> google.protobuf.Timestamp
	90,  // 15: api.commons.OmniCampaignModule.actual_stop_date:type_name -> google.protobuf.Timestamp
	...
	90,  // 120: api.commons.OmniConversationAssignment.date_created:type_name -> google.protobuf.Timestamp
	90,  // 121: api.commons.OmniConversationAssignment.date_modified:type_name -> google.protobuf.Timestamp
	84,  // 122: api.commons.OmniConversationAssignment.metadata:type_name -> api.commons.OmniConversationAssignment.ConversationAssignmentDetails
	85,  // 123: api.commons.OmniConversationSkills.skills:type_name -> api.commons.OmniConversationSkills.SkillsEntry
	61,  // 124: api.commons.WeekdayTimeRange.entries:type_name -> api.commons.WeekdayTimeRangeEntry
	98,  // 125: api.commons.WeekdayTimeRangeEntry.start_day:type_name -> api.commons.Weekday.Enum
	98,  // 126: api.commons.WeekdayTimeRangeEntry.end_day:type_name -> api.commons.Weekday.Enum
	90,  // 127: api.commons.Disposition.date_created:type_name -> google.protobuf.Timestamp
	90,  // 128: api.commons.Disposition.date_modified:type_name -> google.protobuf.Timestamp
	86,  // 129: api.commons.GetQueuesDetailsRes.queue_details:type_name -> api.commons.GetQueuesDetailsRes.QueueDetails
	90,  // 130: api.commons.OmniCustomUnsubscribeLink.date_created:type_name -> google.protobuf.Timestamp
	90,  // 131: api.commons.OmniCustomUnsubscribeLink.date_modified:type_name -> google.protobuf.Timestamp
	90,  // 132: api.commons.OmniCustomUnsubscribeLink.date_validated:type_name -> google.protobuf.Timestamp
	94,  // 133: api.commons.ContactList.project_sid:type_name -> api.commons.Int64Id
	90,  // 134: api.commons.ContactList.date_created:type_name -> google.protobuf.Timestamp
	90,  // 135: api.commons.ContactList.date_modified:type_name -> google.protobuf.Timestamp
	66,  // 136: api.commons.ContactList.contact_entries:type_name -> api.commons.ContactEntry
	87,  // 137: api.commons.ContactList.metadata:type_name -> api.commons.ContactList.Metadata
	90,  // 138: api.commons.ContactEntry.date_created:type_name -> google.protobuf.Timestamp
	90,  // 139: api.commons.ContactEntry.date_modified:type_name -> google.protobuf.Timestamp
	72,  // 140: api.commons.ContactEntry.data_fields:type_name -> api.commons.OmniDataField
	14,  // 141: api.commons.OmniTask.status:type_name -> api.commons.OmniTaskStatus
	90,  // 142: api.commons.OmniTask.date_created:type_name -> google.protobuf.Timestamp
	90,  // 143: api.commons.OmniTask.date_modified:type_name -> google.protobuf.Timestamp
	94,  // 144: api.commons.OmniTask.contact_entry_sid:type_name -> api.commons.Int64Id
	69,  // 145: api.commons.OmniTask.state:type_name -> api.commons.OmniTaskState
	72,  // 146: api.commons.OmniTask.data_fields:type_name -> api.commons.OmniDataField
	88,  // 147: api.commons.OmniTask.details:type_name -> api.commons.OmniTask.Details
	92,  // 148: api.commons.OmniTask.status_message:type_name -> google.protobuf.StringValue
	90,  // 149: api.commons.OmniTask.scheduled_time:type_name -> google.protobuf.Timestamp
	68,  // 150: api.commons.OmniTask.task_config:type_name -> api.commons.OmniTaskConfig
	59,  // 151: api.commons.OmniTaskConfig.skills:type_name -> api.commons.OmniConversationSkills
	99,  // 152: api.commons.OmniTaskConfig.absolute_timeout_duration:type_name -> google.protobuf.Duration
	99,  // 153: api.commons.OmniTaskConfig.agent_timeout_duration:type_name -> google.protobuf.Duration
	36,  // 154: api.commons.OmniTaskConfig.message:type_name -> api.commons.OmniMessagePayload
	89,  // 155: api.commons.OmniTaskState.destinations:type_name -> api.commons.OmniTaskState.Entry
	89,  // 156: api.commons.OmniTaskState.sources:type_name -> api.commons.OmniTaskState.Entry
	70,  // 157: api.commons.OmniTaskState.rule_set:type_name -> api.commons.ComplianceRuleSet
	92,  // 158: api.commons.OmniTaskState.scrub_list_id:type_name -> google.protobuf.StringValue
	71,  // 159: api.commons.ComplianceRuleSet.rules:type_name -> api.commons.ComplianceRule
	100, // 160: api.commons.OmniDataField.type:type_name -> api.commons.FieldType
	90,  // 161: api.commons.ConnectedInbox.last_scheduled_time:type_name -> google.protobuf.Timestamp
	90,  // 162: api.commons.ConnectedInbox.last_checked:type_name -> google.protobuf.Timestamp
	92,  // 163: api.commons.ConnectedInbox.last_error:type_name -> google.protobuf.StringValue
	90,  // 164: api.commons.ConnectedInbox.standby_error_time:type_name -> google.protobuf.Timestamp
	90,  // 165: api.commons.ConnectedInbox.last_updated:type_name -> google.protobuf.Timestamp
	92,  // 166: api.commons.ConnectedInbox.google_xoauth2_refresh_token:type_name -> google.protobuf.StringValue
	92,  // 167: api.commons.ConnectedInbox.google_xoauth2_access_token:type_name -> google.protobuf.StringValue
	90,  // 168: api.commons.ConnectedInbox.google_xoauth2_access_token_expiration:type_name -> google.protobuf.Timestamp
	16,  // 169: api.commons.ConnectedInbox.authentication_type:type_name -> api.commons.ConnectedInboxAuthenticationType
	74,  // 170: api.commons.ConnectedInbox.oauth_reference_id:type_name -> api.commons.ConnectedInboxOAuthConfig
	90,  // 171: api.commons.VerifiedEmail.created_on:type_name -> google.protobuf.Timestamp
	90,  // 172: api.commons.VerifiedEmail.verified_on:type_name -> google.protobuf.Timestamp
	92,  // 173: api.commons.VerifiedEmail.description:type_name -> google.protobuf.StringValue
	90,  // 174: api.commons.Signature.date_created:type_name -> google.protobuf.Timestamp
	90,  // 175: api.commons.Signature.date_modified:type_name -> google.protobuf.Timestamp
	90,  // 176: api.commons.Signature.deleted_on:type_name -> google.protobuf.Timestamp
	79,  // 177: api.commons.OmniProjectComplianceConfig.email:type_name -> api.commons.OmniComplianceConfig
	79,  // 178: api.commons.OmniProjectComplianceConfig.sms:type_name -> api.commons.OmniComplianceConfig
	79,  // 179: api.commons.OmniProjectComplianceConfig.whatsapp:type_name -> api.commons.OmniComplianceConfig
	78,  // 180: api.commons.OmniComplianceConfig.opt_in:type_name -> api.commons.OmniComplianceAction
	78,  // 181: api.commons.OmniComplianceConfig.opt_out:type_name -> api.commons.OmniComplianceAction
	78,  // 182: api.commons.OmniComplianceConfig.help:type_name -> api.commons.OmniComplianceAction
	78,  // 183: api.commons.OmniComplianceConfig.information:type_name -> api.commons.OmniComplianceAction
	92,  // 184: api.commons.OmniComplianceConfig.rule_set_id:type_name -> google.protobuf.StringValue
	22,  // 185: api.commons.WhatsAppNumber.provider:type_name -> api.commons.WhatsAppNumberProvider
	90,  // 186: api.commons.WhatsAppNumber.date_created:type_name -> google.protobuf.Timestamp
	90,  // 187: api.commons.WhatsAppNumber.date_modified:type_name -> google.protobuf.Timestamp
	96,  // 188: api.commons.OmniCampaignModule.Details.total_task_count:type_name -> google.protobuf.Int64Value
	96,  // 189: api.commons.OmniCampaignModule.Details.completed_task_count:type_name -> google.protobuf.Int64Value
	92,  // 190: api.commons.OmniCampaignModule.Details.connected_inbox_address:type_name -> google.protobuf.StringValue
	92,  // 191: api.commons.OmniCampaignModule.Details.verified_email_address:type_name -> google.protobuf.StringValue
	96,  // 192: api.commons.OmniCampaignModule.Details.pending_task_count:type_name -> google.protobuf.Int64Value
	96,  // 193: api.commons.OmniCampaignModule.Details.failed_task_count:type_name -> google.protobuf.Int64Value
	96,  // 194: api.commons.OmniCampaignModule.Details.canceled_task_count:type_name -> google.protobuf.Int64Value
	3,   // 195: api.commons.GetQueuesDetailsRes.QueueDetails.channel_type:type_name -> api.commons.ChannelType
	92,  // 196: api.commons.OmniTask.Details.contact_list_name:type_name -> google.protobuf.StringValue
	90,  // 197: api.commons.OmniTaskState.Entry.last_used:type_name -> google.protobuf.Timestamp
...
func file_api_commons_omnichannel_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_commons_omnichannel_proto_rawDesc), len(file_api_commons_omnichannel_proto_rawDesc)),
			NumEnums:      24,
			NumMessages:   66,
			NumExtensions: 0,
			NumServices:   0,
