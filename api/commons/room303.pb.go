...
var file_api_commons_room303_proto_rawDesc = []byte{
	...
	0x61, 0x72, 0x63, 0x68, 0x69, 0x76, 0x65, 0x2a, 0x4b, 0x0a, 0x08, 0x52, 0x6f, 0x6f, 0x6d, 0x54,
	...
	0x02, 0x42, 0x94, 0x01, 0x0a, 0x0f, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x63, 0x6f,
	0x6d, 0x6d, 0x6f, 0x6e, 0x73, 0x42, 0x0c, 0x52, 0x6f, 0x6f, 0x6d, 0x33, 0x30, 0x33, 0x50, 0x72,
...
var file_api_commons_room303_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_api_commons_room303_proto_goTypes = []interface{}{
	...
	(*RoomConfig)(nil),            // 8: api.commons.RoomConfig
...
var file_api_commons_room303_proto_depIdxs = []int32{
	...
	9,  // 2: api.commons.Member.added_at:type_name -> google.protobuf.Timestamp
	0,  // 3: api.commons.Room.type:type_name -> api.commons.RoomType
	9,  // 4: api.commons.Room.created_at:type_name -> google.protobuf.Timestamp
	9,  // 5: api.commons.Room.updated_at:type_name -> google.protobuf.Timestamp
	2,  // 6: api.commons.Room.status:type_name -> api.commons.RoomStatus
	8,  // 7: api.commons.Room.config:type_name -> api.commons.RoomConfig
	3,  // 8: api.commons.Message.from_user:type_name -> api.commons.UserSid
	1,  // 9: api.commons.Message.status:type_name -> api.commons.MessageStatus
	9,  // 10: api.commons.Message.received_at:type_name -> google.protobuf.Timestamp
	9,  // 11: api.commons.Message.updated_at:type_name -> google.protobuf.Timestamp
