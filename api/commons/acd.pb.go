...
const file_api_commons_acd_proto_rawDesc = "" +
	"\n" +
	"\x15api/commons/acd.proto\x12\vapi.commons\x1a\x1fgoogle/protobuf/timestamp.proto\"\xe0\x01\n" +
	"\fAgentSession\x12\x1b\n" +
	"\tagent_sid\x18\x01 \x01(\x03R\bagentSid\x12\x1d\n" +
	"\n" +
	"tenant_sid\x18\x02 \x01(\x03R\ttenantSid\x12\x1f\n" +
	"\vsession_sid\x18\x03 \x01(\x03R\n" +
	"sessionSid\x12&\n" +
	"\x0fasm_session_sid\x18\x04 \x01(\x03R\rasmSessionSid\x12\x15\n" +
	"\x06org_id\x18\x05 \x01(\tR\x05orgId\x12\x1b\n" +
	"\tregion_id\x18\x06 \x01(\tR\bregionId\x12\x17\n" +
	"\auser_id\x18\b \x01(\tR\x06userId\"\x90\x01\n" +
	"\tCallerSid\x12\x1d\n" +
	"\n" +
	"caller_sid\x18\x01 \x01(\x03R\tcallerSid\x12.\n" +
	"\x04type\x18\x02 \x01(\x0e2\x1a.api.commons.CallType.EnumR\x04type\x12\x1d\n" +
	"\n" +
	"tenant_sid\x18\x03 \x01(\x03R\ttenantSid\x12\x15\n" +
	"\x06org_id\x18\x04 \x01(\tR\x05orgId\"\xdb\b\n" +
	"\vAgentStatus\"\xcb\b\n" +
	"\x04Enum\x12\x0f\n" +
	"\vUNAVALIABLE\x10\x00\x12\b\n" +
	"\x04IDLE\x10\x01\x12\t\n" +
	...
	"\n" +
	"\x06WRAPUP\x10\a\x12\x18\n" +
	"\x14PREPARING_AFTER_IDLE\x10\b\x12\x1a\n" +
	"\x16PREPARING_AFTER_WRAPUP\x10\t\x12\x19\n" +
	"\x15PREPARING_AFTER_PAUSE\x10\n" +
	"\x12\x1f\n" +
	"\x1bPREPARING_AFTER_DIAL_CANCEL\x10\v\x12\x1e\n" +
	"\x1aPREPARING_AFTER_PBX_REJECT\x10\f\x12\x1e\n" +
	...
	"\x11CALLBACK_RESUMING\x10\x1b\x12\f\n" +
	"\bGUI_BUSY\x10\x1c\x12\f\n" +
	"\bINTERCOM\x10\x1d\x12\x1b\n" +
	...
	"\x17CALLER_TRANSFER_STARTED\x10#\x12\x1d\n" +
	"\x19CALLER_TRANSFER_LOST_PEER\x10$\x12&\n" +
	"\"CALLER_TRANSFER_LOST_MERGED_CALLER\x10%\x12\"\n" +
	"\x1eCOLD_OUTBOUND_TRANSFER_STARTED\x10&\x12\x1f\n" +
	"\x1bCOLD_AGENT_TRANSFER_STARTED\x10'\x12\x18\n" +
	"\x14SECURE_FORM_HANDLING\x10(\"\xfb\x03\n" +
	"\fCallerStatus\"\xea\x03\n" +
	"\x04Enum\x12\x0f\n" +
	"\vUNAVALIABLE\x10\x00\x12\b\n" +
	"\x04IDLE\x10\x01\x12\t\n" +
	"\x05READY\x10\x02\x12\n" +
	...
	"\x0fOUTBOUND_PEERED\x10\a\x12\x14\n" +
	"\x10PBX_POPUP_LOCKED\x10\b\x12\r\n" +
	"\tVOICEMAIL\x10\t\x12\x1c\n" +
	"\x18PEERED_WITH_CALL_ON_HOLD\x10\n" +
	"\x12\x16\n" +
	"\x12CALLBACK_SUSPENDED\x10\v\x12\x1f\n" +
	"\x1bWARM_AGENT_TRANSFER_STARTED\x10\f\x12\"\n" +
	...
	"\x14CALLER_TRANSFER_PEER\x10\x11\x12!\n" +
	"\x1dCALLER_TRANSFER_MERGED_CALLER\x10\x12\x12\x11\n" +
	"\rCALLER_PEERED\x10\x13\x12 \n" +
	"\x1cSECURE_FORM_HANDLING_COLLECT\x10\x14\"O\n" +
	"\bCallType\"C\n" +
	"\x04Enum\x12\v\n" +
	...
	"\rHuntGroupType\"5\n" +
	"\x04Enum\x12\x0f\n" +
	"\vUNCONNECTED\x10\x00\x12\r\n" +
	"\tCONNECTED\x10\x01\x12\r\n" +
	"\tSOFTPHONE\x10\x02\"\x9b\r\n" +
	"\x18AgentSessionLogActionKey\"\xfe\f\n" +
	"\x04Enum\x12\x15\n" +
	"\x11AGENT_PAUSE_START\x10\x00\x12\x14\n" +
	"\x10AGENT_PAUSE_STOP\x10\x01\x12\x18\n" +
	"\x14AGENT_SKILLS_INITIAL\x10\x02\x12\x10\n" +
	"\fAGENT_LOGOUT\x10\x03\x12\x1a\n" +
	"\x16EXECUTED_AGENT_TRIGGER\x10\x04\x12\x1d\n" +
	"\x19DURATION_SINCE_LAST_LOGON\x10\x05\x12\x12\n" +
	"\x0eAGENT_LOGIN_IP\x10\x06\x12\x10\n" +
	"\fMAC_DECISION\x10\a\x12\x17\n" +
	"\x13MAC_10_KEY_DECISION\x10\b\x12\x16\n" +
	"\x12MAC_10_KEY_CONFIRM\x10\t\x12\x1b\n" +
	"\x17HUNT_GROUP_REASSIGNMENT\x10\n" +
	"\x12\x0e\n" +
	"\n" +
	"PBX_ACCEPT\x10\v\x12\x0e\n" +
	"\n" +
	"PBX_HANGUP\x10\f\x12\f\n" +
	"\bPBX_LOST\x10\r\x12\x0e\n" +
	"\n" +
	"PBX_REJECT\x10\x0e\x12\x0f\n" +
	"\vPBX_TIMEOUT\x10\x0f\x12-\n" +
	...
	"#WARM_TRANSFER_AGENT_END_DESTINATION\x10\x15\x120\n" +
	...
	"\x1cCOLD_TRANSFER_OUTBOUND_START\x10\x1a\x12$\n" +
	" COLD_TRANSFER_AGENT_START_SOURCE\x10\x1b\x12\"\n" +
	"\x1eCOLD_TRANSFER_AGENT_END_SOURCE\x10\x1c\x12)\n" +
	"%COLD_TRANSFER_AGENT_START_DESTINATION\x10\x1d\x12'\n" +
	"#COLD_TRANSFER_AGENT_END_DESTINATION\x10\x1e\x12\x0e\n" +
	"\n" +
	"HOLD_START\x10\x1f\x12\f\n" +
	"\bHOLD_END\x10 \x12\v\n" +
	"\aREQUEUE\x10!\x12\x1c\n" +
	"\x18CALLER_SENT_TO_VOICEMAIL\x10\"\x12\x13\n" +
	...
	"\fACD_REGISTER\x10(\x12\x1a\n" +
	"\x16EXECUTED_AGENT_WEBLINK\x10)\x12\x18\n" +
	...
	"\x16TRANSFER_HOLD_OUTBOUND\x100\x12\x1c\n" +
	"\x18TRANSFER_UNHOLD_OUTBOUND\x101\x12\x19\n" +
	"\x15TRANSFER_ADD_OUTBOUND\x102\x12\x1c\n" +
	"\x18TRANSFER_REMOVE_OUTBOUND\x103\x12\x1e\n" +
	"\x1aWARM_CALLER_TRANSFER_START\x104\x12.\n" +
	"*WARM_CALLER_TRANSFER_INVITE_CALLER_INITIAL\x105\x12&\n" +
	"\"WARM_CALLER_TRANSFER_INVITE_CALLER\x106\x12\x1c\n" +
	"\x18WARM_CALLER_TRANSFER_END\x107\x12\x12\n" +
	"\x0eBARGE_IN_START\x108\x12\x11\n" +
	"\rBARGE_IN_STOP\x109\x12\x15\n" +
	"\x11BargeInCallJoined\x10:\x12\x13\n" +
	"\x0fBargeInCallLeft\x10;\"\xd2\n" +
	"\n" +
	"\x15AgentCallLogActionKey\"\xb8\n" +
	"\n" +
	"\x04Enum\x12\f\n" +
	"\bDNCL_ADD\x10\x00\x12\x0e\n" +
	"\n" +
	"CALL_ENDED\x10\x01\x12\x13\n" +
	"\x0fCALL_DISCONNECT\x10\x02\x12\x11\n" +
	...
	"\x17WARM_TRANSFER_AGENT_END\x10\a\x12(\n" +
	"$WARM_TRANSFER_OUTBOUND_INVITE_CALLER\x10\b\x120\n" +
	",WARM_TRANSFER_OUTBOUND_INVITE_CALLER_INITIAL\x10\t\x12 \n" +
	"\x1cWARM_TRANSFER_OUTBOUND_START\x10\n" +
	"\x12\x1e\n" +
	"\x1aWARM_TRANSFER_OUTBOUND_END\x10\v\x12\x1d\n" +
	"\x19COLD_TRANSFER_AGENT_START\x10\f\x12\x1b\n" +
	"\x17COLD_TRANSFER_AGENT_END\x10\r\x12 \n" +
	"\x1cCOLD_TRANSFER_OUTBOUND_START\x10\x0e\x12\x1a\n" +
	"\x16CALLBACK_SUSPEND_START\x10\x0f\x12\x15\n" +
	"\x11CALLBACK_RESUMING\x10\x10\x12\x11\n" +
	"\rVOICEMAIL_END\x10\x11\x12\x1c\n" +
	"\x18CALLER_SENT_TO_VOICEMAIL\x10\x12\x12\x0e\n" +
	"\n" +
	"HOLD_START\x10\x13\x12\f\n" +
	"\bHOLD_END\x10\x14\x12\x13\n" +
	"\x0fRECORDING_START\x10\x15\x12\x12\n" +
	"\x0eRECORDING_STOP\x10\x16\x12\x15\n" +
	"\x11CALL_SKILLS_SCORE\x10\x17\x12\x17\n" +
	"\x13CALL_SKILLS_MATCHED\x10\x18\x12\x17\n" +
	"\x13CALL_SKILLS_CURRENT\x10\x19\x12\x17\n" +
	"\x13CALL_SKILLS_INITIAL\x10\x1a\x12\x1d\n" +
	"\x19SKILLS_CHANGED_DROPSKILLS\x10\x1b\x12\x1c\n" +
	"\x18SKILLS_CHANGED_ADDSKILLS\x10\x1c\x12\v\n" +
	"\aREQUEUE\x10\x1d\x12\x1a\n" +
	...
	"\x0eBARGE_IN_START\x10+\x12\x11\n" +
	"\rBARGE_IN_STOP\x10,\"n\n" +
	"\x17AgentCallLogActionValue\"S\n" +
	"\x04Enum\x12\x0f\n" +
	"\vUNSPECIFIED\x10\x00\x12\x16\n" +
	"\x12DNCL_RESULT_FAILED\x10\x01\x12\"\n" +
	"\x1eCALL_ENDED_CALLER_DISCONNECTED\x10\x02\"\xc1\x1b\n" +
	"\x11HuntGroupParamKey\"\xab\x1b\n" +
	"\x04Enum\x12\x18\n" +
	"\x14AGENT_DIAL_IN_NUMBER\x10\x00\x12'\n" +
	"#AGENT_LOGIN_GUI_STATISTICS_TEMPLATE\x10\x01\x12\"\n" +
	"\x1eAGENT_PASSWORD_REQUIRES_LETTER\x10\x02\x12\"\n" +
	"\x1eAGENT_PASSWORD_REQUIRES_NUMBER\x10\x03\x12\"\n" +
	"\x1eAGENT_PASSWORD_REQUIRES_SYMBOL\x10\x04\x12'\n" +
	"#AGENT_PASSWORD_REQUIRES_UPPER_LOWER\x10\x05\x12\x1d\n" +
	"\x19AGENT_SKILLS_REASSIGNMENT\x10\x06\x12\x1c\n" +
	"\x18AGENT_STATS_CALL_HISTORY\x10\a\x12\x11\n" +
	"\rAGENT_TRIGGER\x10\b\x12&\n" +
	"\"AGENT_DISPOSITION_CONDITIONAL_DNCL\x10\t\x12\x0f\n" +
	"\vALLOWED_IPS\x10\n" +
	"\x12\x14\n" +
	"\x10ALLOW_AGENT_HOLD\x10\v\x12\x18\n" +
	"\x14ALLOW_AGENT_INTERCOM\x10\f\x12\x1e\n" +
	"\x1aALLOW_AGENT_PASSWORD_RESET\x10\r\x12 \n" +
	"\x1cALLOW_AGENT_PAUSE_CODE_RESET\x10\x0e\x12\x18\n" +
	"\x14ALLOW_AGENT_TO_PAUSE\x10\x0f\x12\x1d\n" +
	"\x19ALLOW_CALLBACK_SCHEDULING\x10\x10\x12&\n" +
	"\"ALLOW_EXPORT_PHONE_NUMBER_ACTIVITY\x10\x11\x12\"\n" +
	"\x1eALLOW_MANUAL_APPROVAL_OF_CALLS\x10\x12\x12\x18\n" +
	"\x14ALLOW_MANUAL_DIALING\x10\x13\x12\x1f\n" +
	"\x1bALLOW_PHONE_NUMBER_ACTIVITY\x10\x14\x12\x1d\n" +
	"\x19ALLOW_PREVIEW_DIAL_CANCEL\x10\x15\x12$\n" +
	" ALLOW_SCHEDULED_CALLBACK_CALLING\x10\x16\x12\x18\n" +
	"\x14ALLOW_TRANSFER_CALLS\x10\x17\x12\x17\n" +
	"\x13ALPHANUMERIC_KEYPAD\x10\x18\x12\x1c\n" +
	"\x18AUTO_PAUSE_ON_MULTI_HOLD\x10\x19\x12 \n" +
	"\x1cAUTO_PAUSE_ON_PREVIEW_CANCEL\x10\x1a\x12\x1c\n" +
	"\x18DEFAULT_AGENT_PAUSE_CODE\x10\x1b\x12%\n" +
	"!DEFAULT_AGENT_TRANSFERS_FILTERING\x10\x1c\x12\x18\n" +
	"\x14DEFAULT_DNCL_COUNTRY\x10\x1d\x12\x1b\n" +
	"\x17DEFAULT_DNCL_EXPIRATION\x10\x1e\x12(\n" +
	...
	"\x1cDISCONNECT_CALL_CONFIRMATION\x10$\x12%\n" +
	"!DISPLAY_AGENT_TRANSFERS_FILTERING\x10%\x12\x1d\n" +
	"\x19DISPLAY_DATA_COLLECT_DATA\x10&\x12\x1c\n" +
	"\x18DISPLAY_DATA_DIPPED_DATA\x10'\x12\x1c\n" +
	"\x18DISPLAY_IVR_KEYS_PRESSED\x10(\x12\x1e\n" +
	"\x1aDISPLAY_PHONE_ZIP_METADATA\x10)\x12\x1f\n" +
	"\x1bDISPLAY_RECORDING_INDICATOR\x10*\x12\x15\n" +
	"\x11DO_ALLOW_ADD_DNCL\x10+\x12\x1a\n" +
	"\x16ENABLE_RECORDING_PAUSE\x10,\x12\x19\n" +
	"\x15HOLD_QUEUE_MONITORING\x10-\x12'\n" +
	"#HOLD_QUEUE_MONITORING_AGENT_ROUTING\x10.\x126\n" +
	"2HOLD_QUEUE_MONITORING_PREFERRED_HUNT_GROUP_ROUTING\x10/\x125\n" +
	"1HOLD_QUEUE_MONITORING_REQUIRED_HUNT_GROUP_ROUTING\x100\x12+\n" +
	"'HUNT_GROUP_CLIENT_INFO_DISPLAY_TEMPLATE\x101\x12\x15\n" +
	"\x11HUNT_GROUP_SCRIPT\x102\x12\x17\n" +
	"\x13HUNT_GROUP_WEB_LINK\x103\x12'\n" +
	"#MANUAL_APPROVAL_NUMBER_CONFIRMATION\x104\x12\x1d\n" +
	"\x19MANUAL_DIAL_AUTO_DNCL_ADD\x105\x12!\n" +
	"\x1dMANUAL_DIAL_DEFAULT_CALLER_ID\x106\x12\x1f\n" +
	"\x1bMANUAL_DIAL_DEFAULT_COUNTRY\x107\x12+\n" +
	"'MANUAL_DIAL_DISPLAY_COUNTRY_SELECT_MENU\x108\x12)\n" +
	"%MANUAL_DIAL_DEFAULT_CALLER_ID_COUNTRY\x109\x125\n" +
	"1MANUAL_DIAL_DISPLAY_CALLER_ID_COUNTRY_SELECT_MENU\x10:\x122\n" +
	...
	"\x1aMANUAL_DIAL_SCRUB_OVERRIDE\x10A\x12!\n" +
	"\x1dMANUAL_DIAL_TIMEZONE_OVERRIDE\x10B\x12'\n" +
	"#MANUAL_DIAL_USER_EDITABLE_CALLER_ID\x10C\x12#\n" +
	"\x1fMANUAL_QUEUE_CONFIGURATION_NAME\x10D\x12!\n" +
	"\x1dMINIMUM_AGENT_PASSWORD_LENGTH\x10E\x12(\n" +
	"$PHONE_NUMBER_ACTIVITY_EDIT_RESPONSES\x10F\x12-\n" +
	...
	"*TRANSFER_CALLS_DISPLAY_COUNTRY_SELECT_MENU\x10T\x125\n" +
	...
	"&TRANSFER_CALLS_USER_EDITABLE_CALLER_ID\x10X\x120\n" +
	...
	"\x0eDISPLAY_SKILLS\x10a\x12&\n" +
	"\"PBX_TRANSFER_DISALLOWED_EXTENSIONS\x10b\"?\n" +
	"\rReplaceConfig\".\n" +
	"\x04Enum\x12\r\n" +
	"\tNO_CHANGE\x10\x00\x12\n" +
	"\n" +
	"\x06TENANT\x10\x01\x12\v\n" +
	"\aREPLACE\x10\x02\"\x85\x03\n" +
	"\x0eTransferMember\x12\x1e\n" +
	"\n" +
	"identifier\x18\x01 \x01(\tR\n" +
	"identifier\x12#\n" +
	"\rdisplay_label\x18\x02 \x01(\tR\fdisplayLabel\x12@\n" +
	"\vmember_type\x18\x03 \x01(\x0e2\x1f.api.commons.TransferMemberTypeR\n" +
	"memberType\x12!\n" +
	"\fphone_number\x18\x04 \x01(\tR\vphoneNumber\x12\x19\n" +
	"\bis_muted\x18\x05 \x01(\bR\aisMuted\x12@\n" +
	"\ragent_session\x18d \x01(\v2\x19.api.commons.AgentSessionH\x00R\fagentSession\x127\n" +
	"\n" +
	"caller_sid\x18e \x01(\v2\x16.api.commons.CallerSidH\x00R\tcallerSid\x12!\n" +
	"\voutbound_id\x18f \x01(\tH\x00R\n" +
	"outboundIdB\x10\n" +
	"\x0elocatable_data\"\xb1\x02\n" +
	"\n" +
	"AgentAlert\x12Y\n" +
	"\x12backoffice_message\x18\x01 \x01(\v2(.api.commons.AgentBackofficeMessageAlertH\x00R\x11backofficeMessage\x12`\n" +
	"\x15directed_call_ringing\x18\x02 \x01(\v2*.api.commons.AgentDirectedCallRingingAlertH\x00R\x13directedCallRinging\x12]\n" +
	"\x14directed_call_hangup\x18\x03 \x01(\v2).api.commons.AgentDirectedCallHangupAlertH\x00R\x12directedCallHangupB\a\n" +
	"\x05alert\"\xf7\x01\n" +
	"\x1bAgentBackofficeMessageAlert\x12'\n" +
	"\x0fexpire_duration\x18\x01 \x01(\x03R\x0eexpireDuration\x128\n" +
	"\ttimestamp\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp\x12K\n" +
	"\x14target_agent_session\x18\x03 \x01(\v2\x19.api.commons.AgentSessionR\x12targetAgentSession\x12\x18\n" +
	"\amessage\x18\x04 \x01(\tR\amessage\x12\x0e\n" +
	"\x02id\x18\x05 \x01(\tR\x02id\"\xe2\x02\n" +
	"\x1dAgentDirectedCallRingingAlert\x12'\n" +
	"\x0fexpire_duration\x18\x01 \x01(\x03R\x0eexpireDuration\x128\n" +
	"\ttimestamp\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp\x12K\n" +
	"\x14target_agent_session\x18\x03 \x01(\v2\x19.api.commons.AgentSessionR\x12targetAgentSession\x125\n" +
	"\n" +
	"caller_sid\x18\x04 \x01(\v2\x16.api.commons.CallerSidR\tcallerSid\x12\x1b\n" +
	"\tcaller_id\x18\x05 \x01(\tR\bcallerId\x12-\n" +
	"\x12destination_number\x18\x06 \x01(\tR\x11destinationNumber\x12\x0e\n" +
	"\x02id\x18\a \x01(\tR\x02id\"\x95\x02\n" +
	"\x1cAgentDirectedCallHangupAlert\x12'\n" +
	"\x0fexpire_duration\x18\x01 \x01(\x03R\x0eexpireDuration\x128\n" +
	"\ttimestamp\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp\x12K\n" +
	"\x14target_agent_session\x18\x03 \x01(\v2\x19.api.commons.AgentSessionR\x12targetAgentSession\x125\n" +
	"\n" +
	"caller_sid\x18\x04 \x01(\v2\x16.api.commons.CallerSidR\tcallerSid\x12\x0e\n" +
	"\x02id\x18\x05 \x01(\tR\x02id\"\xf8\x05\n" +
	"\n" +
	"AgentState\x12\x16\n" +
	...
	"\x14caller_was_suspended\x18\r \x01(\bR\x12callerWasSuspended\x12F\n" +
	"\x10transfer_members\x18\x0e \x03(\v2\x1b.api.commons.TransferMemberR\x0ftransferMembers\x12?\n" +
	"\x1dagent_peer_is_direct_to_agent\x18\x0f \x01(\bR\x18agentPeerIsDirectToAgent\x12\x17\n" +
	"\auser_id\x18\x10 \x01(\tR\x06userId\x12\x1b\n" +
	"\tagent_sid\x18\x11 \x01(\x03R\bagentSid\x12&\n" +
	"\x0fasm_session_sid\x18\x12 \x01(\x03R\rasmSessionSid\x12$\n" +
	"\x0eagent_is_muted\x18\x13 \x01(\bR\fagentIsMuted\x12\x12\n" +
	"\x04uuid\x18\x14 \x01(\tR\x04uuid*\xb7\x01\n" +
	"\tACDStatus\x12\x0f\n" +
	"\vACD_UNKNOWN\x10\x00\x12\x1d\n" +
	"\x18AGENT_SESSION_LOGGING_IN\x10\x84 \x12\x1c\n" +
	"\x17AGENT_SESSION_LOGGED_IN\x10\x8e \x12\x1c\n" +
	"\x17AGENT_SESSION_COMPLETED\x10\xe8 \x12\x19\n" +
	"\x14AGENT_SESSION_SUMMED\x10\xcc!\x12#\n" +
	"\x1eAGENT_SESSION_ACCOUNTINGEXPORT\x10\xb0\"*\xa4\x01\n" +
	"\x15AgentCallLogCallEnded\x12\x13\n" +
	"\x0fAGENT_CANCELLED\x10\x00\x12\x17\n" +
	"\x13CALLER_DISCONNECTED\x10\x01\x12\x11\n" +
	"\rNOT_CONNECTED\x10\x02\x12\x0e\n" +
	"\n" +
	"AGENT_LOST\x10\x03\x12\x10\n" +
	"\fAGENT_HANGUP\x10\x04\x12\x11\n" +
	"\rCALLER_HANGUP\x10\x05\x12\x15\n" +
	"\x11CALL_END_ESTIMATE\x10\x06*.\n" +
	"\bHoldType\x12\v\n" +
	...
	"\tDTMFDigit\x12\x0f\n" +
	"\vDTMFDigit_0\x10\x00\x12\x0f\n" +
	"\vDTMFDigit_1\x10\x01\x12\x0f\n" +
	"\vDTMFDigit_2\x10\x02\x12\x0f\n" +
	"\vDTMFDigit_3\x10\x03\x12\x0f\n" +
	"\vDTMFDigit_4\x10\x04\x12\x0f\n" +
	"\vDTMFDigit_5\x10\x05\x12\x0f\n" +
	"\vDTMFDigit_6\x10\x06\x12\x0f\n" +
	"\vDTMFDigit_7\x10\a\x12\x0f\n" +
	"\vDTMFDigit_8\x10\b\x12\x0f\n" +
	"\vDTMFDigit_9\x10\t\x12\x0f\n" +
	"\vDTMFDigit_A\x10\n" +
	"\x12\x0f\n" +
	"\vDTMFDigit_B\x10\v\x12\x0f\n" +
	"\vDTMFDigit_C\x10\f\x12\x0f\n" +
	"\vDTMFDigit_D\x10\r\x12\x12\n" +
	"\x0eDTMFDigit_STAR\x10\x0e\x12\x13\n" +
	"\x0fDTMFDigit_POUND\x10\x0fB\x90\x01\n" +
	"\x0fcom.api.commonsB\bAcdProtoP\x01Z&github.com/tcncloud/api-go/api/commons\xa2\x02\x03ACX\xaa\x02\vApi.Commons\xca\x02\vApi\\Commons\xe2\x02\x17Api\\Commons\\GPBMetadata\xea\x02\fApi::Commonsb\x06proto3"
