...
type TransferMember struct {
	...
	//	*TransferMember_CallerId
	//	*TransferMember_DestinationNumber
...
func (x *TransferMember) GetCallerId() string {
	if x, ok := x.GetLocatableData().(*TransferMember_CallerId); ok {
		return x.CallerId
	}
	return ""
}

func (x *TransferMember) GetDestinationNumber() string {
	if x, ok := x.GetLocatableData().(*TransferMember_DestinationNumber); ok {
...
type TransferMember_CallerId struct {
	// the number the caller called from
	CallerId string `protobuf:"bytes,103,opt,name=caller_id,json=callerId,proto3,oneof"`
}

type TransferMember_DestinationNumber struct {
	// the number the caller called
	DestinationNumber string `protobuf:"bytes,104,opt,name=destination_number,json=destinationNumber,proto3,oneof"`
}
...
func (*TransferMember_CallerId) isTransferMember_LocatableData() {}

func (*TransferMember_DestinationNumber) isTransferMember_LocatableData() {}
...
var file_api_commons_acd_proto_rawDesc = []byte{
	...
	0x0b, 0x0a, 0x07, 0x52, 0x45, 0x50, 0x4c, 0x41, 0x43, 0x45, 0x10, 0x02, 0x22, 0x97, 0x03, 0x0a,
	...
	0x6e, 0x64, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x09, 0x63, 0x61, 0x6c, 0x6c, 0x65, 0x72, 0x5f, 0x69,
	0x64, 0x18, 0x67, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x08, 0x63, 0x61, 0x6c, 0x6c, 0x65,
	0x72, 0x49, 0x64, 0x12, 0x2f, 0x0a, 0x12, 0x64, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x5f, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x68, 0x20, 0x01, 0x28, 0x09, 0x48,
	0x00, 0x52, 0x11, 0x64, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x4e, 0x75,
	0x6d, 0x62, 0x65, 0x72, 0x42, 0x10, 0x0a, 0x0e, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x61, 0x62, 0x6c,
...
func file_api_commons_acd_proto_init() {
	...
	file_api_commons_acd_proto_msgTypes[12].OneofWrappers = []interface{}{
		...
		(*TransferMember_CallerId)(nil),
		(*TransferMember_DestinationNumber)(nil),
	}
