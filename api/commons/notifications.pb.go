...
const file_api_commons_notifications_proto_rawDesc = "" +
	"\n" +
	"\x1fapi/commons/notifications.proto\x12\vapi.commons\":\n" +
	"\x10FieldValueFilter\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\"b\n" +
	"\x10NotificationType\"N\n" +
	"\x04Enum\x12\v\n" +
	"\aINVALID\x10\x00\x12\t\n" +
	"\x05EMAIL\x10\x01\x12\x0f\n" +
	"\vSERVER_PUSH\x10\x02\x12\a\n" +
	"\x03IOS\x10\x03\x12\v\n" +
	"\aANDROID\x10\x04\x12\a\n" +
	"\x03SMS\x10\x05B\x9a\x01\n" +
	"\x0fcom.api.commonsB\x12NotificationsProtoP\x01Z&github.com/tcncloud/api-go/api/commons\xa2\x02\x03ACX\xaa\x02\vApi.Commons\xca\x02\vApi\\Commons\xe2\x02\x17Api\\Commons\\GPBMetadata\xea\x02\fApi::Commonsb\x06proto3"

var (
	file_api_commons_notifications_proto_rawDescOnce sync.Once
	file_api_commons_notifications_proto_rawDescData []byte
)

func file_api_commons_notifications_proto_rawDescGZIP() []byte {
	file_api_commons_notifications_proto_rawDescOnce.Do(func() {
		file_api_commons_notifications_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_commons_notifications_proto_rawDesc), len(file_api_commons_notifications_proto_rawDesc)))
	})
...
func file_api_commons_notifications_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_commons_notifications_proto_rawDesc), len(file_api_commons_notifications_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
