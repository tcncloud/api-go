...
var file_api_commons_integrations_integrations_proto_rawDesc = []byte{
	...
	0x9a, 0xc1, 0x01, 0x0a, 0x0b, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x46, 0x6c, 0x6f, 0x77,
	...
	0x74, 0x69, 0x65, 0x6e, 0x74, 0x42, 0x69, 0x6c, 0x6c, 0x69, 0x6e, 0x67, 0x44, 0x65, 0x74, 0x61,
	0x69, 0x6c, 0x73, 0x12, 0x6b, 0x0a, 0x15, 0x6e, 0x65, 0x77, 0x7a, 0x77, 0x61, 0x72, 0x65, 0x5f,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x33, 0x22, 0x23, 0x0a, 0x21, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65,
	0x45, 0x70, 0x69, 0x63, 0x50, 0x6f, 0x73, 0x74, 0x50, 0x61, 0x74, 0x69, 0x65, 0x6e, 0x74, 0x4d,
	0x61, 0x64, 0x65, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x22, 0x25, 0x0a, 0x23, 0x45, 0x78,
	...
	0x73, 0x22, 0x1c, 0x0a, 0x1a, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x4e, 0x65, 0x77, 0x7a,
	...
	0x4f, 0x4e, 0x44, 0x53, 0x10, 0x84, 0x20, 0x2a, 0x96, 0x4a, 0x0a, 0x0d, 0x52, 0x65, 0x71, 0x75,
	...
	0x5f, 0x43, 0x4f, 0x4e, 0x56, 0x45, 0x52, 0x53, 0x49, 0x4f, 0x4e, 0x10, 0x96, 0x1c, 0x12, 0x22,
	...
	0x41, 0x49, 0x4c, 0x53, 0x10, 0xff, 0x1c, 0x12, 0x29, 0x0a, 0x24, 0x52, 0x45, 0x51, 0x55, 0x45,
...
var file_api_commons_integrations_integrations_proto_msgTypes = make([]protoimpl.MessageInfo, 250)
var file_api_commons_integrations_integrations_proto_goTypes = []interface{}{
	...
	(*ExecuteNewzwarePhoneLookup)(nil),                       // 248: api.commons.integrations.ExecuteNewzwarePhoneLookup
	(*ExecuteNewzwareAccountInquiry)(nil),                    // 249: api.commons.integrations.ExecuteNewzwareAccountInquiry
	(*ExecuteNewzwareCcPayment)(nil),                         // 250: api.commons.integrations.ExecuteNewzwareCcPayment
	(*ExecuteNewzwareAchPayment)(nil),                        // 251: api.commons.integrations.ExecuteNewzwareAchPayment
	(*ExecuteNewzwareComplaintHistory)(nil),                  // 252: api.commons.integrations.ExecuteNewzwareComplaintHistory
	(*ExecuteNewzwareComplaintUpdate)(nil),                   // 253: api.commons.integrations.ExecuteNewzwareComplaintUpdate
	(*ExecuteNewzwareVacationRestart)(nil),                   // 254: api.commons.integrations.ExecuteNewzwareVacationRestart
	(*ExecuteNewzwareVacationUpdate)(nil),                    // 255: api.commons.integrations.ExecuteNewzwareVacationUpdate
	(*ExecuteNewzwarePhoneLookupMulti)(nil),                  // 256: api.commons.integrations.ExecuteNewzwarePhoneLookupMulti
	(*ExecutePriocommerceAchPayment)(nil),                    // 257: api.commons.integrations.ExecutePriocommerceAchPayment
	(*ExecutePriocommerceCcPayment)(nil),                     // 258: api.commons.integrations.ExecutePriocommerceCcPayment
	(*ExecuteNavigaCreatePayment)(nil),                       // 259: api.commons.integrations.ExecuteNavigaCreatePayment
	(*ExecuteNavigaChangeBilling)(nil),                       // 260: api.commons.integrations.ExecuteNavigaChangeBilling
	(*ExecutePaynsecondsTokenizeCard)(nil),                   // 261: api.commons.integrations.ExecutePaynsecondsTokenizeCard
	nil,                                                      // 262: api.commons.integrations.InvoiceDynamicJourney.JourneyFieldsEntry
}
var file_api_commons_integrations_integrations_proto_depIdxs = []int32{
	...
	248, // 241: api.commons.integrations.ExecuteFlow.newzware_phone_lookup:type_name -> api.commons.integrations.ExecuteNewzwarePhoneLookup
	249, // 242: api.commons.integrations.ExecuteFlow.newzware_account_inquiry:type_name -> api.commons.integrations.ExecuteNewzwareAccountInquiry
	250, // 243: api.commons.integrations.ExecuteFlow.newzware_cc_payment:type_name -> api.commons.integrations.ExecuteNewzwareCcPayment
	251, // 244: api.commons.integrations.ExecuteFlow.newzware_ach_Payment:type_name -> api.commons.integrations.ExecuteNewzwareAchPayment
	252, // 245: api.commons.integrations.ExecuteFlow.newzware_complaint_history:type_name -> api.commons.integrations.ExecuteNewzwareComplaintHistory
	253, // 246: api.commons.integrations.ExecuteFlow.newzware_complaint_update:type_name -> api.commons.integrations.ExecuteNewzwareComplaintUpdate
	254, // 247: api.commons.integrations.ExecuteFlow.newzware_vacation_restart:type_name -> api.commons.integrations.ExecuteNewzwareVacationRestart
	255, // 248: api.commons.integrations.ExecuteFlow.newzware_vacation_update:type_name -> api.commons.integrations.ExecuteNewzwareVacationUpdate
	256, // 249: api.commons.integrations.ExecuteFlow.newzware_phone_lookup_multi:type_name -> api.commons.integrations.ExecuteNewzwarePhoneLookupMulti
	257, // 250: api.commons.integrations.ExecuteFlow.priocommerce_ach_payment:type_name -> api.commons.integrations.ExecutePriocommerceAchPayment
	258, // 251: api.commons.integrations.ExecuteFlow.priocommerce_cc_payment:type_name -> api.commons.integrations.ExecutePriocommerceCcPayment
	259, // 252: api.commons.integrations.ExecuteFlow.naviga_create_payment:type_name -> api.commons.integrations.ExecuteNavigaCreatePayment
	260, // 253: api.commons.integrations.ExecuteFlow.naviga_change_billing:type_name -> api.commons.integrations.ExecuteNavigaChangeBilling
	261, // 254: api.commons.integrations.ExecuteFlow.paynseconds_tokenize_card:type_name -> api.commons.integrations.ExecutePaynsecondsTokenizeCard
	262, // 255: api.commons.integrations.InvoiceDynamicJourney.journey_fields:type_name -> api.commons.integrations.InvoiceDynamicJourney.JourneyFieldsEntry
	20,  // 256: api.commons.integrations.InvoiceDynamicJourney.JourneyFieldsEntry.value:type_name -> api.commons.integrations.ListOfStrings
