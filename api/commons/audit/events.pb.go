...
var file_api_commons_audit_events_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0x56, 0x0a, 0x20, 0x63,
...
var (
	...
	file_api_commons_audit_events_proto_rawDescData = file_api_commons_audit_events_proto_rawDesc
)

func file_api_commons_audit_events_proto_rawDescGZIP() []byte {
	file_api_commons_audit_events_proto_rawDescOnce.Do(func() {
		file_api_commons_audit_events_proto_rawDescData = protoimpl.X.CompressGZIP(file_api_commons_audit_events_proto_rawDescData)
	})
...
var file_api_commons_audit_events_proto_goTypes = []interface{}{
...
func file_api_commons_audit_events_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_commons_audit_events_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_api_commons_audit_events_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_api_commons_audit_events_proto_rawDesc = nil
