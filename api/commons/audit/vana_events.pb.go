...
var file_api_commons_audit_vana_events_proto_rawDesc = []byte{
	...
	0x52, 0x08, 0x66, 0x6c, 0x61, 0x67, 0x53, 0x69, 0x64, 0x73, 0x42, 0x56, 0x0a, 0x20, 0x63, 0x6f,
...
var file_api_commons_audit_vana_events_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_api_commons_audit_vana_events_proto_goTypes = []interface{}{
	...
	(*VanaFlagSummaryEvent_FlagSummary)(nil), // 4: api.commons.audit.VanaFlagSummaryEvent.FlagSummary
	(*timestamppb.Timestamp)(nil),            // 5: google.protobuf.Timestamp
}
var file_api_commons_audit_vana_events_proto_depIdxs = []int32{
	5, // 0: api.commons.audit.VanaBillingReportEvent.start_time:type_name -> google.protobuf.Timestamp
	5, // 1: api.commons.audit.VanaBillingReportEvent.end_time:type_name -> google.protobuf.Timestamp
	5, // 2: api.commons.audit.VanaFlagSummaryEvent.start_time:type_name -> google.protobuf.Timestamp
	5, // 3: api.commons.audit.VanaFlagSummaryEvent.end_time:type_name -> google.protobuf.Timestamp
	4, // 4: api.commons.audit.VanaFlagSummaryEvent.flag_summaries:type_name -> api.commons.audit.VanaFlagSummaryEvent.FlagSummary
