...
func (m *VanaCreateTranscriptEvent) GetMetadata() isVanaCreateTranscriptEvent_Metadata {
	if m != nil {
		return m.Metadata
	}
	return nil
...
func (x *VanaCreateTranscriptEvent) GetCall() *VanaCreateTranscriptEvent_Call {
	if x, ok := x.GetMetadata().(*VanaCreateTranscriptEvent_Call_); ok {
		return x.Call
	}
	return nil
}
...
func (x *VanaCreateTranscriptEvent) GetSms() *VanaCreateTranscriptEvent_Sms {
	if x, ok := x.GetMetadata().(*VanaCreateTranscriptEvent_Sms_); ok {
		return x.Sms
	}
	return nil
}
...
func file_api_commons_audit_vana_events_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_commons_audit_vana_events_proto_msgTypes[7].Exporter = func(v any, i int) any {
			switch v := v.(*VanaCreateTranscriptEvent_Call); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_commons_audit_vana_events_proto_msgTypes[8].Exporter = func(v any, i int) any {
			switch v := v.(*VanaCreateTranscriptEvent_Sms); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
