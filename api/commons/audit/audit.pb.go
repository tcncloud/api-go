...
var file_api_commons_audit_audit_proto_rawDesc = string([]byte{
	...
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x93, 0x82, 0x01, 0x0a,
	...
	,
...
var file_api_commons_audit_audit_proto_goTypes = []any{
	...
	(*BillingAccumulateItemsEvent)(nil),                  // 116: api.commons.audit.BillingAccumulateItemsEvent
	(*DeliveryFailureEvent)(nil),                         // 117: api.commons.audit.DeliveryFailureEvent
	(*DeliverySuccessEvent)(nil),                         // 118: api.commons.audit.DeliverySuccessEvent
	(*ContactManagerEntryAddEvent)(nil),                  // 119: api.commons.audit.ContactManagerEntryAddEvent
	(*ContactManagerEntryGetEncEvent)(nil),               // 120: api.commons.audit.ContactManagerEntryGetEncEvent
	(*ContactManagerDeleteEvent)(nil),                    // 121: api.commons.audit.ContactManagerDeleteEvent
	(*ContactManagerKycEvent)(nil),                       // 122: api.commons.audit.ContactManagerKycEvent
	(*ContactManagerEntryEditEvent)(nil),                 // 123: api.commons.audit.ContactManagerEntryEditEvent
	(*ContactManagerListUploadEvent)(nil),                // 124: api.commons.audit.ContactManagerListUploadEvent
	(*ContactManagerEntityAssociationEvent)(nil),         // 125: api.commons.audit.ContactManagerEntityAssociationEvent
	(*AccessTokensExpiringEvent)(nil),                    // 126: api.commons.audit.AccessTokensExpiringEvent
}
var file_api_commons_audit_audit_proto_depIdxs = []int32{
	...
	116, // 116: api.commons.audit.AuditEvent.billing_accumulate_items_event:type_name -> api.commons.audit.BillingAccumulateItemsEvent
	117, // 117: api.commons.audit.AuditEvent.delivery_failure_event:type_name -> api.commons.audit.DeliveryFailureEvent
	118, // 118: api.commons.audit.AuditEvent.delivery_success_event:type_name -> api.commons.audit.DeliverySuccessEvent
	119, // 119: api.commons.audit.AuditEvent.contact_manager_entry_add_event:type_name -> api.commons.audit.ContactManagerEntryAddEvent
	120, // 120: api.commons.audit.AuditEvent.contact_manager_entry_get_enc_event:type_name -> api.commons.audit.ContactManagerEntryGetEncEvent
	121, // 121: api.commons.audit.AuditEvent.contact_manager_delete_event:type_name -> api.commons.audit.ContactManagerDeleteEvent
	122, // 122: api.commons.audit.AuditEvent.contact_manager_kyc_event:type_name -> api.commons.audit.ContactManagerKycEvent
	123, // 123: api.commons.audit.AuditEvent.contact_manager_entry_edit_event:type_name -> api.commons.audit.ContactManagerEntryEditEvent
	124, // 124: api.commons.audit.AuditEvent.contact_manager_list_upload_event:type_name -> api.commons.audit.ContactManagerListUploadEvent
	122, // 125: api.commons.audit.AuditEvent.contact_manager_kyc_verification_event:type_name -> api.commons.audit.ContactManagerKycEvent
	121, // 126: api.commons.audit.AuditEvent.contact_manager_entry_delete_event:type_name -> api.commons.audit.ContactManagerDeleteEvent
	121, // 127: api.commons.audit.AuditEvent.contact_manager_entry_expunge_event:type_name -> api.commons.audit.ContactManagerDeleteEvent
	125, // 128: api.commons.audit.AuditEvent.contact_manager_entity_association_event:type_name -> api.commons.audit.ContactManagerEntityAssociationEvent
	126, // 129: api.commons.audit.AuditEvent.access_tokens_expiring_event:type_name -> api.commons.audit.AccessTokensExpiringEvent
