...
var file_api_commons_audit_audit_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xcc, 0x55, 0x0a, 0x0a,
	...
	0x6e, 0x6e, 0x65, 0x6c, 0x5f, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x6c, 0x69, 0x6e,
	0x6b, 0x5f, 0x73, 0x65, 0x6e, 0x74, 0x5f, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x18, 0xe5, 0x02, 0x20,
	...
	0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x4c, 0x69, 0x6e,
	0x6b, 0x53, 0x65, 0x6e, 0x74, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x5b, 0x0a, 0x15, 0x61, 0x73,
...
var file_api_commons_audit_audit_proto_goTypes = []interface{}{
	...
	(*ScorecardsCreateQuestionEvent)(nil),                // 61: api.commons.audit.ScorecardsCreateQuestionEvent
	(*ScorecardsUpdateQuestionEvent)(nil),                // 62: api.commons.audit.ScorecardsUpdateQuestionEvent
	(*ScorecardsDeleteQuestionEvent)(nil),                // 63: api.commons.audit.ScorecardsDeleteQuestionEvent
	(*ScorecardsCreateScorecardEvent)(nil),               // 64: api.commons.audit.ScorecardsCreateScorecardEvent
	(*ScorecardsUpdateScorecardEvent)(nil),               // 65: api.commons.audit.ScorecardsUpdateScorecardEvent
	(*ScorecardsDeleteScorecardEvent)(nil),               // 66: api.commons.audit.ScorecardsDeleteScorecardEvent
	(*ScorecardsCloneScorecardEvent)(nil),                // 67: api.commons.audit.ScorecardsCloneScorecardEvent
	(*ScorecardsCreateEvaluationEvent)(nil),              // 68: api.commons.audit.ScorecardsCreateEvaluationEvent
	(*ScorecardsDeleteEvaluationEvent)(nil),              // 69: api.commons.audit.ScorecardsDeleteEvaluationEvent
	(*ScorecardsCreateSectionEvent)(nil),                 // 70: api.commons.audit.ScorecardsCreateSectionEvent
	(*ScorecardsUpdateSectionEvent)(nil),                 // 71: api.commons.audit.ScorecardsUpdateSectionEvent
	(*ScorecardsDeleteSectionEvent)(nil),                 // 72: api.commons.audit.ScorecardsDeleteSectionEvent
	(*ScorecardsCreateCategoryEvent)(nil),                // 73: api.commons.audit.ScorecardsCreateCategoryEvent
	(*ScorecardsUpdateCategoryEvent)(nil),                // 74: api.commons.audit.ScorecardsUpdateCategoryEvent
	(*ScorecardsDeleteCategoryEvent)(nil),                // 75: api.commons.audit.ScorecardsDeleteCategoryEvent
	(*ScorecardsCreateEvaluationQuestionEvent)(nil),      // 76: api.commons.audit.ScorecardsCreateEvaluationQuestionEvent
	(*ScorecardsUpdateEvaluationQuestionEvent)(nil),      // 77: api.commons.audit.ScorecardsUpdateEvaluationQuestionEvent
	(*ScorecardsDeleteEvaluationQuestionEvent)(nil),      // 78: api.commons.audit.ScorecardsDeleteEvaluationQuestionEvent
	(*ScorecardsCreateScorecardQuestionEvent)(nil),       // 79: api.commons.audit.ScorecardsCreateScorecardQuestionEvent
	(*ScorecardsUpdateScorecardQuestionEvent)(nil),       // 80: api.commons.audit.ScorecardsUpdateScorecardQuestionEvent
	(*ScorecardsDeleteScorecardQuestionEvent)(nil),       // 81: api.commons.audit.ScorecardsDeleteScorecardQuestionEvent
	(*ScorecardsCreateAutoEvaluationEvent)(nil),          // 82: api.commons.audit.ScorecardsCreateAutoEvaluationEvent
	(*ScorecardsUpdateEvaluationEvent)(nil),              // 83: api.commons.audit.ScorecardsUpdateEvaluationEvent
	(*TicketEvent)(nil),                                  // 84: api.commons.audit.TicketEvent
	(*ComplianceRndQueryEvent)(nil),                      // 85: api.commons.audit.ComplianceRndQueryEvent
}
var file_api_commons_audit_audit_proto_depIdxs = []int32{
	...
	61, // 60: api.commons.audit.AuditEvent.scorecards_create_question_event:type_name -> api.commons.audit.ScorecardsCreateQuestionEvent
	62, // 61: api.commons.audit.AuditEvent.scorecards_update_question_event:type_name -> api.commons.audit.ScorecardsUpdateQuestionEvent
	63, // 62: api.commons.audit.AuditEvent.scorecards_delete_question_event:type_name -> api.commons.audit.ScorecardsDeleteQuestionEvent
	64, // 63: api.commons.audit.AuditEvent.scorecards_create_scorecard_event:type_name -> api.commons.audit.ScorecardsCreateScorecardEvent
	65, // 64: api.commons.audit.AuditEvent.scorecards_update_scorecard_event:type_name -> api.commons.audit.ScorecardsUpdateScorecardEvent
	66, // 65: api.commons.audit.AuditEvent.scorecards_delete_scorecard_event:type_name -> api.commons.audit.ScorecardsDeleteScorecardEvent
	67, // 66: api.commons.audit.AuditEvent.scorecards_clone_scorecard_event:type_name -> api.commons.audit.ScorecardsCloneScorecardEvent
	68, // 67: api.commons.audit.AuditEvent.scorecards_create_evaluation_event:type_name -> api.commons.audit.ScorecardsCreateEvaluationEvent
	69, // 68: api.commons.audit.AuditEvent.scorecards_delete_evaluation_event:type_name -> api.commons.audit.ScorecardsDeleteEvaluationEvent
	70, // 69: api.commons.audit.AuditEvent.scorecards_create_section_event:type_name -> api.commons.audit.ScorecardsCreateSectionEvent
	71, // 70: api.commons.audit.AuditEvent.scorecards_update_section_event:type_name -> api.commons.audit.ScorecardsUpdateSectionEvent
	72, // 71: api.commons.audit.AuditEvent.scorecards_delete_section_event:type_name -> api.commons.audit.ScorecardsDeleteSectionEvent
	73, // 72: api.commons.audit.AuditEvent.scorecards_create_category_event:type_name -> api.commons.audit.ScorecardsCreateCategoryEvent
	74, // 73: api.commons.audit.AuditEvent.scorecards_update_category_event:type_name -> api.commons.audit.ScorecardsUpdateCategoryEvent
	75, // 74: api.commons.audit.AuditEvent.scorecards_delete_category_event:type_name -> api.commons.audit.ScorecardsDeleteCategoryEvent
	76, // 75: api.commons.audit.AuditEvent.scorecards_create_evaluation_question_event:type_name -> api.commons.audit.ScorecardsCreateEvaluationQuestionEvent
	77, // 76: api.commons.audit.AuditEvent.scorecards_update_evaluation_question_event:type_name -> api.commons.audit.ScorecardsUpdateEvaluationQuestionEvent
	78, // 77: api.commons.audit.AuditEvent.scorecards_delete_evaluation_question_event:type_name -> api.commons.audit.ScorecardsDeleteEvaluationQuestionEvent
	79, // 78: api.commons.audit.AuditEvent.scorecards_create_scorecard_question_event:type_name -> api.commons.audit.ScorecardsCreateScorecardQuestionEvent
	80, // 79: api.commons.audit.AuditEvent.scorecards_update_scorecard_question_event:type_name -> api.commons.audit.ScorecardsUpdateScorecardQuestionEvent
	81, // 80: api.commons.audit.AuditEvent.scorecards_delete_scorecard_question_event:type_name -> api.commons.audit.ScorecardsDeleteScorecardQuestionEvent
	82, // 81: api.commons.audit.AuditEvent.scorecards_create_auto_evaluation_event:type_name -> api.commons.audit.ScorecardsCreateAutoEvaluationEvent
	83, // 82: api.commons.audit.AuditEvent.scorecards_update_evaluation_event:type_name -> api.commons.audit.ScorecardsUpdateEvaluationEvent
	84, // 83: api.commons.audit.AuditEvent.ticket_event:type_name -> api.commons.audit.TicketEvent
	85, // 84: api.commons.audit.AuditEvent.compliance_rnd_query_event:type_name -> api.commons.audit.ComplianceRndQueryEvent
	85, // 85: api.commons.audit.AuditEvent.compliance_rnd_query_cached_event:type_name -> api.commons.audit.ComplianceRndQueryEvent
