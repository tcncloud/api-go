...
var file_api_commons_enums_proto_rawDesc = []byte{
	...
	0x5f, 0x44, 0x45, 0x43, 0x45, 0x4d, 0x42, 0x45, 0x52, 0x10, 0x0b, 0x42, 0x48, 0x0a, 0x1a, 0x63,
...
var file_api_commons_enums_proto_goTypes = []interface{}{
...
func file_api_commons_enums_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_commons_enums_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_commons_enums_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CronRequestType); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
