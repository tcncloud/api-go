...
const file_api_commons_org_preferences_proto_rawDesc = "" +
	"\n" +
	"!api/commons/org_preferences.proto\x12\vapi.commons\"/\n" +
	"\x17OperatorDisplayLanguage\x12\x14\n" +
	"\x05value\x18\x01 \x01(\tR\x05value\"\xfe\x02\n" +
	"\x11LocalePreferences\x12%\n" +
	"\flanguage_tag\x18\x01 \x01(\tB\x02\x18\x01R\vlanguageTag\x12M\n" +
	"\"use_script_direction_right_to_left\x18\x02 \x01(\bB\x02\x18\x01R\x1duseScriptDirectionRightToLeft\x12)\n" +
	"\x10default_currency\x18\x03 \x01(\tR\x0fdefaultCurrency\x12`\n" +
	"\x19operator_display_language\x18\x04 \x01(\v2$.api.commons.OperatorDisplayLanguageR\x17operatorDisplayLanguage\x12f\n" +
	"\x1boperator_language_direction\x18\x05 \x01(\x0e2&.api.commons.OperatorLanguageDirectionR\x19operatorLanguageDirection*\xac\x01\n" +
	"\x19BroadcastTemplateOrdering\x12\x0f\n" +
	"\vBY_NAME_ASC\x10\x00\x12\x10\n" +
	"\fBY_NAME_DESC\x10\x01\x12\x1a\n" +
	"\x16BY_TEMPLATE_NUMBER_ASC\x10\x02\x12\x1b\n" +
	"\x17BY_TEMPLATE_NUMBER_DESC\x10\x03\x12\x18\n" +
	"\x14BY_MODIFIED_DATE_ASC\x10\x04\x12\x19\n" +
	"\x15BY_MODIFIED_DATE_DESC\x10\x05*B\n" +
	"\x17ScheduleByTimeZoneScope\x12\b\n" +
	"\x04BOTH\x10\x00\x12\r\n" +
	"\tSTOP_DATE\x10\x01\x12\x0e\n" +
	"\n" +
	"START_DATE\x10\x02*\xa9\x01\n" +
	"\x19AnsweringMachineDetection\x12\x1e\n" +
	...
	"\x1fBALANCED_DETECTION_AND_DELIVERY\x10\x03*A\n" +
	"\x1bDialListPenetrationStrategy\x12\x0f\n" +
	"\vDEPTH_FIRST\x10\x00\x12\x11\n" +
	"\rBREADTH_FIRST\x10\x01*\x9b\b\n" +
	"\x14StandardReportFilter\x12\x11\n" +
	"\rNO_PREFERENCE\x10\x00\x12\x1c\n" +
	"\x18FILTER_BY_ANSWERED_CALLS\x10\x01\x12\x1e\n" +
	"\x1aFILTER_BY_ANSWERED_HANGUPS\x10\x02\x12\x1f\n" +
	"\x1bFILTER_BY_ANSWERED_LINKCALL\x10\x03\x12\x1d\n" +
	"\x19FILTER_BY_ANY_KEY_PRESSED\x10\x04\x12\x12\n" +
	"\x0eFILTER_BY_BUSY\x10\x05\x12\x1c\n" +
	"\x18FILTER_BY_CANCELED_CALLS\x10\x06\x12&\n" +
	"\"FILTER_BY_CONFIRM_KEYS_3_THROUGH_6\x10\a\x12\x1d\n" +
	"\x19FILTER_BY_CONNECTED_CALLS\x10\b\x12\x1b\n" +
	"\x17FILTER_BY_DNCL_CANCELED\x10\t\x12\x1a\n" +
	"\x16FILTER_BY_FAILED_CALLS\x10\n" +
	"\x12\x1b\n" +
	"\x17FILTER_BY_INVALID_CALLS\x10\v\x12 \n" +
	"\x1cFILTER_BY_LINKCALL_ABANDONED\x10\f\x12\x1b\n" +
	"\x17FILTER_BY_MACHINE_CALLS\x10\r\x12\x1e\n" +
	"\x1aFILTER_BY_MACHINE_DELIVERY\x10\x0e\x12\x1c\n" +
	"\x18FILTER_BY_MACHINE_HANGUP\x10\x0f\x12!\n" +
	"\x1dFILTER_BY_MACHINE_AND_ANY_KEY\x10\x10\x12\x17\n" +
	"\x13FILTER_BY_NO_ANSWER\x10\x11\x12\x1d\n" +
	"\x19FILTER_BY_NO_KEYS_PRESSED\x10\x12\x12 \n" +
	"\x1cFILTER_BY_NOT_CANCELED_CALLS\x10\x13\x12\x1f\n" +
	"\x1bFILTER_BY_UNCONNECTED_CALLS\x10\x14\x12)\n" +
	"%FILTER_BY_UNCONNECTED_EXCLUDE_INVALID\x10\x15\x12\x13\n" +
	"\x0fFILTER_BY_0_KEY\x10\x16\x12\x13\n" +
	"\x0fFILTER_BY_1_KEY\x10\x17\x12\x13\n" +
	"\x0fFILTER_BY_2_KEY\x10\x18\x12\x13\n" +
	"\x0fFILTER_BY_3_KEY\x10\x19\x12\x13\n" +
	"\x0fFILTER_BY_4_KEY\x10\x1a\x12\x13\n" +
	"\x0fFILTER_BY_5_KEY\x10\x1b\x12\x13\n" +
	"\x0fFILTER_BY_6_KEY\x10\x1c\x12\x13\n" +
	"\x0fFILTER_BY_7_KEY\x10\x1d\x12\x13\n" +
	"\x0fFILTER_BY_8_KEY\x10\x1e\x12\x13\n" +
	"\x0fFILTER_BY_9_KEY\x10\x1f\x12\x16\n" +
	"\x12FILTER_BY_STAR_KEY\x10 \x12\x17\n" +
	"\x13FILTER_BY_POUND_KEY\x10!\x12,\n" +
	...
	")OPERATOR_LANGUAGE_DIRECTION_RIGHT_TO_LEFT\x10\x03B\x9b\x01\n" +
	"\x0fcom.api.commonsB\x13OrgPreferencesProtoP\x01Z&github.com/tcncloud/api-go/api/commons\xa2\x02\x03ACX\xaa\x02\vApi.Commons\xca\x02\vApi\\Commons\xe2\x02\x17Api\\Commons\\GPBMetadata\xea\x02\fApi::Commonsb\x06proto3"
