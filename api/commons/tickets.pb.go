...
type TemplateCondition struct {
	...
	IsMandatory bool `protobuf:"varint,1,opt,name=is_mandatory,json=isMandatory,proto3" json:"is_mandatory,omitempty"`
	IsEditable  bool `protobuf:"varint,2,opt,name=is_editable,json=isEditable,proto3" json:"is_editable,omitempty"`
}

func (x *TemplateCondition) Reset() {
	*x = TemplateCondition{}
	if protoimpl.UnsafeEnabled {
...
func (x *TemplateCondition) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TemplateCondition) ProtoMessage() {}

func (x *TemplateCondition) ProtoReflect() protoreflect.Message {
	mi := &file_api_commons_tickets_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TemplateCondition.ProtoReflect.Descriptor instead.
func (*TemplateCondition) Descriptor() ([]byte, []int) {
	return file_api_commons_tickets_proto_rawDescGZIP(), []int{1}
}

func (x *TemplateCondition) GetIsMandatory() bool {
	if x != nil {
...
func (x *TemplateCondition) GetIsEditable() bool {
	if x != nil {
		return x.IsEditable
	}
	return false
...
type TicketTemplate struct {
	...
	TeplateStartDate     *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=teplate_start_date,json=teplateStartDate,proto3" json:"teplate_start_date,omitempty"`
	TeplateEndDate       *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=teplate_end_date,json=teplateEndDate,proto3" json:"teplate_end_date,omitempty"`
	...
	TitleCondition       *TemplateCondition     `protobuf:"bytes,7,opt,name=title_condition,json=titleCondition,proto3" json:"title_condition,omitempty"`
	DescriptionCondition *TemplateCondition     `protobuf:"bytes,8,opt,name=description_condition,json=descriptionCondition,proto3" json:"description_condition,omitempty"`
	TicketAssignee       []string               `protobuf:"bytes,9,rep,name=ticket_assignee,json=ticketAssignee,proto3" json:"ticket_assignee,omitempty"`
	AssigneeCondition    *TemplateCondition     `protobuf:"bytes,10,opt,name=assignee_condition,json=assigneeCondition,proto3" json:"assignee_condition,omitempty"`
	TicketSla            []*Sla                 `protobuf:"bytes,11,rep,name=ticket_sla,json=ticketSla,proto3" json:"ticket_sla,omitempty"`
	TicketSlaCondition   *TemplateCondition     `protobuf:"bytes,12,opt,name=ticket_sla_condition,json=ticketSlaCondition,proto3" json:"ticket_sla_condition,omitempty"`
	// Action
	ActionType                string                 `protobuf:"bytes,13,opt,name=action_type,json=actionType,proto3" json:"action_type,omitempty"`
	ActionSkills              []*Skills              `protobuf:"bytes,14,rep,name=action_skills,json=actionSkills,proto3" json:"action_skills,omitempty"`
	ActionSkillsCondition     *TemplateCondition     `protobuf:"bytes,15,opt,name=action_skills_condition,json=actionSkillsCondition,proto3" json:"action_skills_condition,omitempty"`
	ActionStartDate           *timestamppb.Timestamp `protobuf:"bytes,16,opt,name=action_start_date,json=actionStartDate,proto3" json:"action_start_date,omitempty"`
	ActionStartDateCondition  *TemplateCondition     `protobuf:"bytes,17,opt,name=action_start_date_condition,json=actionStartDateCondition,proto3" json:"action_start_date_condition,omitempty"`
	ActionExpiryDate          *timestamppb.Timestamp `protobuf:"bytes,18,opt,name=action_expiry_date,json=actionExpiryDate,proto3" json:"action_expiry_date,omitempty"`
	ActionExpiryDateCondition *TemplateCondition     `protobuf:"bytes,19,opt,name=action_expiry_date_condition,json=actionExpiryDateCondition,proto3" json:"action_expiry_date_condition,omitempty"`
	ActionSla                 []*Sla                 `protobuf:"bytes,20,rep,name=action_sla,json=actionSla,proto3" json:"action_sla,omitempty"`
	ActionSlaCondition        *TemplateCondition     `protobuf:"bytes,21,opt,name=action_sla_condition,json=actionSlaCondition,proto3" json:"action_sla_condition,omitempty"`
	IsValid                   bool                   `protobuf:"varint,22,opt,name=is_valid,json=isValid,proto3" json:"is_valid,omitempty"`
	// Action Types
	CallbackDefault *TicketCallbackTemplate `protobuf:"bytes,23,opt,name=callback_default,json=callbackDefault,proto3" json:"callback_default,omitempty"`
	CreatedById     string                  `protobuf:"bytes,24,opt,name=created_by_id,json=createdById,proto3" json:"created_by_id,omitempty"`
	CreatedDate     *timestamppb.Timestamp  `protobuf:"bytes,25,opt,name=created_date,json=createdDate,proto3" json:"created_date,omitempty"`
}
...
func (x *TicketTemplate) GetTeplateStartDate() *timestamppb.Timestamp {
	if x != nil {
		return x.TeplateStartDate
	}
	return nil
}

func (x *TicketTemplate) GetTeplateEndDate() *timestamppb.Timestamp {
	if x != nil {
		return x.TeplateEndDate
	}
	return nil
}

func (x *TicketTemplate) GetTicketTitle() string {
	if x != nil {
...
func (x *TicketTemplate) GetTicketDescription() string {
	if x != nil {
...
func (x *TicketTemplate) GetTitleCondition() *TemplateCondition {
	if x != nil {
		return x.TitleCondition
	}
	return nil
}

func (x *TicketTemplate) GetDescriptionCondition() *TemplateCondition {
	if x != nil {
		return x.DescriptionCondition
	}
	return nil
}

func (x *TicketTemplate) GetTicketAssignee() []string {
	if x != nil {
		return x.TicketAssignee
	}
	return nil
...
func (x *TicketTemplate) GetAssigneeCondition() *TemplateCondition {
	if x != nil {
		return x.AssigneeCondition
	}
	return nil
}

func (x *TicketTemplate) GetTicketSla() []*Sla {
	if x != nil {
		return x.TicketSla
	}
	return nil
...
func (x *TicketTemplate) GetTicketSlaCondition() *TemplateCondition {
	if x != nil {
		return x.TicketSlaCondition
	}
	return nil
}

func (x *TicketTemplate) GetActionType() string {
	if x != nil {
		return x.ActionType
	}
	return ""
...
func (x *TicketTemplate) GetActionSkills() []*Skills {
	if x != nil {
...
func (x *TicketTemplate) GetActionSkillsCondition() *TemplateCondition {
	if x != nil {
		return x.ActionSkillsCondition
	}
	return nil
}

func (x *TicketTemplate) GetActionStartDate() *timestamppb.Timestamp {
	if x != nil {
...
func (x *TicketTemplate) GetActionStartDateCondition() *TemplateCondition {
	if x != nil {
		return x.ActionStartDateCondition
	}
	return nil
}

func (x *TicketTemplate) GetActionExpiryDate() *timestamppb.Timestamp {
	if x != nil {
		return x.ActionExpiryDate
	}
	return nil
}

func (x *TicketTemplate) GetActionExpiryDateCondition() *TemplateCondition {
	if x != nil {
		return x.ActionExpiryDateCondition
	}
	return nil
}

func (x *TicketTemplate) GetActionSla() []*Sla {
	if x != nil {
		return x.ActionSla
	}
	return nil
...
func (x *TicketTemplate) GetActionSlaCondition() *TemplateCondition {
	if x != nil {
		return x.ActionSlaCondition
	}
	return nil
}

func (x *TicketTemplate) GetIsValid() bool {
	if x != nil {
		return x.IsValid
	}
	return false
...
func (x *TicketTemplate) GetCallbackDefault() *TicketCallbackTemplate {
	if x != nil {
		return x.CallbackDefault
	}
	return nil
}
...
type TicketCallbackTemplate struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	CallerId             string             `protobuf:"bytes,1,opt,name=caller_id,json=callerId,proto3" json:"caller_id,omitempty"`
	CallerIdCondition    *TemplateCondition `protobuf:"bytes,2,opt,name=caller_id_condition,json=callerIdCondition,proto3" json:"caller_id_condition,omitempty"`
	CountryCode          string             `protobuf:"bytes,3,opt,name=country_code,json=countryCode,proto3" json:"country_code,omitempty"`
	CountryCodeCondition *TemplateCondition `protobuf:"bytes,4,opt,name=country_code_condition,json=countryCodeCondition,proto3" json:"country_code_condition,omitempty"`
}

func (x *TicketCallbackTemplate) Reset() {
	*x = TicketCallbackTemplate{}
	if protoimpl.UnsafeEnabled {
...
func (x *TicketCallbackTemplate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TicketCallbackTemplate) ProtoMessage() {}

func (x *TicketCallbackTemplate) ProtoReflect() protoreflect.Message {
	mi := &file_api_commons_tickets_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TicketCallbackTemplate.ProtoReflect.Descriptor instead.
func (*TicketCallbackTemplate) Descriptor() ([]byte, []int) {
	return file_api_commons_tickets_proto_rawDescGZIP(), []int{3}
}

func (x *TicketCallbackTemplate) GetCallerId() string {
	if x != nil {
		return x.CallerId
	}
	return ""
...
func (x *TicketCallbackTemplate) GetCallerIdCondition() *TemplateCondition {
	if x != nil {
		return x.CallerIdCondition
	}
	return nil
}

func (x *TicketCallbackTemplate) GetCountryCode() string {
	if x != nil {
...
func (x *TicketCallbackTemplate) GetCountryCodeCondition() *TemplateCondition {
	if x != nil {
		return x.CountryCodeCondition
	}
	return nil
}
...
func (x *ListTemplate) GetProjectSid() int64 {
	if x != nil {
		return x.ProjectSid
	}
	return 0
...
func (x *ListTemplate) GetProjectCode() string {
	if x != nil {
...
func (x *ListTemplate) GetActionType() string {
	if x != nil {
		return x.ActionType
	}
	return ""
...
func (x *ListTemplate) GetIsValid() bool {
	if x != nil {
		return x.IsValid
	}
	return false
...
func (x *AssignProjectTemplate) GetTemplateName() string {
	if x != nil {
		return x.TemplateName
	}
	return ""
...
func (x *AssignProjectTemplate) GetProjectSid() int64 {
	if x != nil {
		return x.ProjectSid
	}
	return 0
...
func (x *AssignProjectTemplate) GetProjectCode() string {
	if x != nil {
		return x.ProjectCode
	}
	return ""
...
func (x *AssignProjectTemplate) GetActionType() string {
	if x != nil {
		return x.ActionType
	}
	return ""
...
var file_api_commons_tickets_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x22, 0x0a, 0x0d, 0x63, 0x72, 0x65, 0x61, 0x74,
	0x65, 0x64, 0x5f, 0x62, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b,
	0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x42, 0x79, 0x49, 0x64, 0x12, 0x26, 0x0a, 0x0f, 0x63,
	0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x62, 0x79, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x42, 0x79, 0x4e,
	0x61, 0x6d, 0x65, 0x12, 0x42, 0x0a, 0x0f, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x62,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_api_commons_tickets_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_api_commons_tickets_proto_goTypes = []interface{}{
	...
	(*TemplateCondition)(nil),      // 3: api.commons.TemplateCondition
	(*TicketTemplate)(nil),         // 4: api.commons.TicketTemplate
	(*TicketCallbackTemplate)(nil), // 5: api.commons.TicketCallbackTemplate
	...
	(*Metadata)(nil),               // 11: api.commons.Metadata
	(*Skills)(nil),                 // 12: api.commons.Skills
	(*Sla)(nil),                    // 13: api.commons.Sla
	(*Comment)(nil),                // 14: api.commons.Comment
	(*CloseTicket)(nil),            // 15: api.commons.CloseTicket
	(*ConfirmClose)(nil),           // 16: api.commons.ConfirmClose
	(*TicketProject)(nil),          // 17: api.commons.TicketProject
	(*TicketSla)(nil),              // 18: api.commons.TicketSla
	(*SlaConditions)(nil),          // 19: api.commons.SlaConditions
	(*ReplyComment)(nil),           // 20: api.commons.ReplyComment
	(*ConfirmReplyComment)(nil),    // 21: api.commons.ConfirmReplyComment
	(*TicketAuditLog)(nil),         // 22: api.commons.TicketAuditLog
	(*EditTicket)(nil),             // 23: api.commons.EditTicket
	(*EditAttribute)(nil),          // 24: api.commons.EditAttribute
	(*timestamppb.Timestamp)(nil),  // 25: google.protobuf.Timestamp
}
var file_api_commons_tickets_proto_depIdxs = []int32{
	25, // 0: api.commons.Ticket.created_by_date:type_name -> google.protobuf.Timestamp
	25, // 1: api.commons.Ticket.due_date:type_name -> google.protobuf.Timestamp
	11, // 2: api.commons.Ticket.metadata:type_name -> api.commons.Metadata
	12, // 3: api.commons.Ticket.ticket_skills:type_name -> api.commons.Skills
	13, // 4: api.commons.Ticket.ticket_sla:type_name -> api.commons.Sla
	...
	25, // 7: api.commons.TicketTemplate.teplate_start_date:type_name -> google.protobuf.Timestamp
	25, // 8: api.commons.TicketTemplate.teplate_end_date:type_name -> google.protobuf.Timestamp
	3,  // 9: api.commons.TicketTemplate.title_condition:type_name -> api.commons.TemplateCondition
	3,  // 10: api.commons.TicketTemplate.description_condition:type_name -> api.commons.TemplateCondition
	3,  // 11: api.commons.TicketTemplate.assignee_condition:type_name -> api.commons.TemplateCondition
	13, // 12: api.commons.TicketTemplate.ticket_sla:type_name -> api.commons.Sla
	3,  // 13: api.commons.TicketTemplate.ticket_sla_condition:type_name -> api.commons.TemplateCondition
	12, // 14: api.commons.TicketTemplate.action_skills:type_name -> api.commons.Skills
	3,  // 15: api.commons.TicketTemplate.action_skills_condition:type_name -> api.commons.TemplateCondition
	25, // 16: api.commons.TicketTemplate.action_start_date:type_name -> google.protobuf.Timestamp
	3,  // 17: api.commons.TicketTemplate.action_start_date_condition:type_name -> api.commons.TemplateCondition
	25, // 18: api.commons.TicketTemplate.action_expiry_date:type_name -> google.protobuf.Timestamp
	3,  // 19: api.commons.TicketTemplate.action_expiry_date_condition:type_name -> api.commons.TemplateCondition
	13, // 20: api.commons.TicketTemplate.action_sla:type_name -> api.commons.Sla
	3,  // 21: api.commons.TicketTemplate.action_sla_condition:type_name -> api.commons.TemplateCondition
	5,  // 22: api.commons.TicketTemplate.callback_default:type_name -> api.commons.TicketCallbackTemplate
	25, // 23: api.commons.TicketTemplate.created_date:type_name -> google.protobuf.Timestamp
	3,  // 24: api.commons.TicketCallbackTemplate.caller_id_condition:type_name -> api.commons.TemplateCondition
	3,  // 25: api.commons.TicketCallbackTemplate.country_code_condition:type_name -> api.commons.TemplateCondition
	25, // 26: api.commons.ListTemplate.created_date:type_name -> google.protobuf.Timestamp
	0,  // 27: api.commons.Duration.scale:type_name -> api.commons.TimeScale
	10, // 28: api.commons.TicketAction.callback_context:type_name -> api.commons.CallbackContext
	25, // 29: api.commons.TicketAction.start_ts:type_name -> google.protobuf.Timestamp
	25, // 30: api.commons.TicketAction.expiry_ts:type_name -> google.protobuf.Timestamp
	13, // 31: api.commons.TicketAction.action_sla_id:type_name -> api.commons.Sla
	8,  // 32: api.commons.Sla.sla_duration:type_name -> api.commons.Duration
	25, // 33: api.commons.Comment.created_by_date:type_name -> google.protobuf.Timestamp
	8,  // 34: api.commons.TicketSla.ticket_sla_duration:type_name -> api.commons.Duration
	25, // 35: api.commons.ReplyComment.created_by_date:type_name -> google.protobuf.Timestamp
	25, // 36: api.commons.TicketAuditLog.created_by_date:type_name -> google.protobuf.Timestamp
	24, // 37: api.commons.EditTicket.edit_value:type_name -> api.commons.EditAttribute
...
func file_api_commons_tickets_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_commons_tickets_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TemplateCondition); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_commons_tickets_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TicketCallbackTemplate); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
