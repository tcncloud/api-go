...
const file_api_commons_wfm_proto_rawDesc = "" +
	"\n" +
	"\x15api/commons/wfm.proto\x12\vapi.commons\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\"k\n" +
	"\tSkillType\"^\n" +
	"\x04Enum\x12\x0f\n" +
	"\vAGENT_SKILL\x10\x00\x12\x0e\n" +
	"\n" +
	"HUNT_GROUP\x10\x01\x12\r\n" +
	"\tAGENT_PBX\x10\x02\x12\x12\n" +
	"\x0eHUNT_GROUP_PBX\x10\x03\x12\a\n" +
	"\x03PBX\x10\x04\x12\t\n" +
	"\x05AGENT\x10\x05\"\x91\x01\n" +
	"\rDatetimeRange\x12A\n" +
	"\x0estart_datetime\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\rstartDatetime\x12=\n" +
	"\fend_datetime\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\vendDatetime\"\xa4\x06\n" +
	"\x15ForecastingParameters\x129\n" +
	"\x19interval_width_in_minutes\x18\x01 \x01(\x05R\x16intervalWidthInMinutes\x12F\n" +
	"\x1fhistorical_data_range_in_months\x18\x06 \x01(\x05H\x00R\x1bhistoricalDataRangeInMonths\x12l\n" +
	"$historical_data_range_start_datetime\x18\a \x01(\v2\x1a.google.protobuf.TimestampH\x00R historicalDataRangeStartDatetime\x12>\n" +
	"\x1cforecast_test_range_in_weeks\x18\b \x01(\x05R\x18forecastTestRangeInWeeks\x127\n" +
	"\x17forecast_range_in_weeks\x18\t \x01(\x05H\x01R\x14forecastRangeInWeeks\x12T\n" +
	"\x17forecast_datetime_range\x18\n" +
	" \x01(\v2\x1a.api.commons.DatetimeRangeH\x01R\x15forecastDatetimeRange\x12B\n" +
	"\x1dtraining_data_range_in_months\x18\v \x01(\x05H\x02R\x19trainingDataRangeInMonths\x12]\n" +
	"\x1ctraining_data_datetime_range\x18\f \x01(\v2\x1a.api.commons.DatetimeRangeH\x02R\x19trainingDataDatetimeRange\x12N\n" +
	"$averages_calculation_range_in_months\x18\r \x01(\x05R averagesCalculationRangeInMonthsB\x17\n" +
	"\x15historical_data_rangeB\x10\n" +
	"\x0eforecast_rangeB\x15\n" +
	"\x13training_data_rangeJ\x04\b\x02\x10\x03J\x04\b\x03\x10\x04J\x04\b\x04\x10\x05J\x04\b\x05\x10\x06\"\xc4\x01\n" +
	"\n" +
	"ProfileTOD\x12\x16\n" +
	"\x06sunday\x18\x01 \x03(\x02R\x06sunday\x12\x16\n" +
	"\x06monday\x18\x02 \x03(\x02R\x06monday\x12\x18\n" +
	"\atuesday\x18\x03 \x03(\x02R\atuesday\x12\x1c\n" +
	"\twednesday\x18\x04 \x03(\x02R\twednesday\x12\x1a\n" +
	"\bthursday\x18\x05 \x03(\x02R\bthursday\x12\x16\n" +
	"\x06friday\x18\x06 \x03(\x02R\x06friday\x12\x1a\n" +
	"\bsaturday\x18\a \x03(\x02R\bsaturday\"\xb1\x02\n" +
	"\vProfileWOMS\x12\x18\n" +
	"\ajanuary\x18\x01 \x03(\x02R\ajanuary\x12\x1a\n" +
	"\bfebruary\x18\x02 \x03(\x02R\bfebruary\x12\x14\n" +
	"\x05march\x18\x03 \x03(\x02R\x05march\x12\x14\n" +
	"\x05april\x18\x04 \x03(\x02R\x05april\x12\x10\n" +
	"\x03may\x18\x05 \x03(\x02R\x03may\x12\x12\n" +
	"\x04june\x18\x06 \x03(\x02R\x04june\x12\x12\n" +
	"\x04july\x18\a \x03(\x02R\x04july\x12\x16\n" +
	"\x06august\x18\b \x03(\x02R\x06august\x12\x1c\n" +
	"\tseptember\x18\t \x03(\x02R\tseptember\x12\x18\n" +
	"\aoctober\x18\n" +
	" \x03(\x02R\aoctober\x12\x1a\n" +
	"\bnovember\x18\v \x03(\x02R\bnovember\x12\x1a\n" +
	"\bdecember\x18\f \x03(\x02R\bdecember\"\xc4\x01\n" +
	"\n" +
	"ProfileDOW\x12\x16\n" +
	"\x06sunday\x18\x01 \x01(\x02R\x06sunday\x12\x16\n" +
	"\x06monday\x18\x02 \x01(\x02R\x06monday\x12\x18\n" +
	"\atuesday\x18\x03 \x01(\x02R\atuesday\x12\x1c\n" +
	"\twednesday\x18\x04 \x01(\x02R\twednesday\x12\x1a\n" +
	"\bthursday\x18\x05 \x01(\x02R\bthursday\x12\x16\n" +
	"\x06friday\x18\x06 \x01(\x02R\x06friday\x12\x1a\n" +
	"\bsaturday\x18\a \x01(\x02R\bsaturday\"\xb0\x02\n" +
	"\n" +
	"ProfileMOY\x12\x18\n" +
	"\ajanuary\x18\x01 \x01(\x02R\ajanuary\x12\x1a\n" +
	"\bfebruary\x18\x02 \x01(\x02R\bfebruary\x12\x14\n" +
	"\x05march\x18\x03 \x01(\x02R\x05march\x12\x14\n" +
	"\x05april\x18\x04 \x01(\x02R\x05april\x12\x10\n" +
	"\x03may\x18\x05 \x01(\x02R\x03may\x12\x12\n" +
	"\x04june\x18\x06 \x01(\x02R\x04june\x12\x12\n" +
	"\x04july\x18\a \x01(\x02R\x04july\x12\x16\n" +
	"\x06august\x18\b \x01(\x02R\x06august\x12\x1c\n" +
	"\tseptember\x18\t \x01(\x02R\tseptember\x12\x18\n" +
	"\aoctober\x18\n" +
	" \x01(\x02R\aoctober\x12\x1a\n" +
	"\bnovember\x18\v \x01(\x02R\bnovember\x12\x1a\n" +
	"\bdecember\x18\f \x01(\x02R\bdecember\"\x80\x02\n" +
	"\x13DistributionProfile\x128\n" +
	"\vprofile_tod\x18\x01 \x01(\v2\x17.api.commons.ProfileTODR\n" +
	"profileTod\x12;\n" +
	"\fprofile_woms\x18\x02 \x01(\v2\x18.api.commons.ProfileWOMSR\vprofileWoms\x128\n" +
	"\vprofile_dow\x18\x03 \x01(\v2\x17.api.commons.ProfileDOWR\n" +
	"profileDow\x128\n" +
	"\vprofile_moy\x18\x04 \x01(\v2\x17.api.commons.ProfileMOYR\n" +
	"profileMoy\"\x8d\x01\n" +
	"\x15CallProfileGroupCalls\x12\x1f\n" +
	"\vtotal_calls\x18\x01 \x01(\x05R\n" +
	"totalCalls\x12S\n" +
	"\x14distribution_profile\x18\x02 \x01(\v2 .api.commons.DistributionProfileR\x13distributionProfile\"\xad\x01\n" +
	"\x14CallProfileGroupAvgs\x12\x1f\n" +
	"\vmin_average\x18\x01 \x01(\x02R\n" +
	"minAverage\x12\x1f\n" +
	"\vmax_average\x18\x02 \x01(\x02R\n" +
	"maxAverage\x12S\n" +
	"\x14distribution_profile\x18\x03 \x01(\v2 .api.commons.DistributionProfileR\x13distributionProfile\"\xbf\x01\n" +
	"\vOptionTypes\x12J\n" +
	"\x11open_times_option\x18\x01 \x01(\x0e2\x1c.api.commons.OpenTimesOptionH\x00R\x0fopenTimesOption\x12R\n" +
	"\x13availability_option\x18\x02 \x01(\x0e2\x1f.api.commons.AvailabilityOptionH\x00R\x12availabilityOptionB\x10\n" +
	"\x0edesired_option\"\xb2\x02\n" +
	"\n" +
	"ReasonCode\x12(\n" +
	"\x0ereason_code_id\x18\x01 \x01(\x03B\x020\x01R\freasonCodeId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12:\n" +
	"\x17scheduling_activity_sid\x18\x03 \x01(\x03B\x020\x01R\x15schedulingActivitySid\x12\x1d\n" +
	"\n" +
	"is_planned\x18\x04 \x01(\bR\tisPlanned\x12\x17\n" +
	"\ais_paid\x18\x05 \x01(\bR\x06isPaid\x12\x1d\n" +
	"\n" +
	"is_default\x18\x06 \x01(\bR\tisDefault\x12S\n" +
	"\x18datetime_set_to_inactive\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\x15datetimeSetToInactive\"u\n" +
	"\x10ScheduleSelector\x12!\n" +
	"\fschedule_sid\x18\x01 \x01(\x03R\vscheduleSid\x12>\n" +
	"\rschedule_type\x18\x02 \x01(\x0e2\x19.api.commons.ScheduleTypeR\fscheduleType\"\x89\x02\n" +
	"\x14SkillProfileCategory\x12?\n" +
	"\x1askill_profile_category_sid\x18\x01 \x01(\x03B\x020\x01R\x17skillProfileCategorySid\x12m\n" +
	"\x1bskill_profile_category_type\x18\x02 \x01(\x0e2..api.commons.SkillProfileCategory.CategoryTypeR\x18skillProfileCategoryType\"A\n" +
	"\fCategoryType\x12\x18\n" +
	"\x14SINGLE_SKILL_PROFILE\x10\x00\x12\x17\n" +
	"\x13SKILL_PROFILE_GROUP\x10\x01\"\xaf\x03\n" +
	"(SchedulingResultMetricForSkillCollection\x128\n" +
	...
	"\bcoverage\x18\x04 \x01(\x02R\bcoverage\x12(\n" +
	"\x10root_mean_square\x18\x05 \x01(\x02R\x0erootMeanSquare\x12\x1d\n" +
	"\n" +
	"has_result\x18\x06 \x01(\bR\thasResult\x12L\n" +
	"\x10skill_collection\x18\a \x01(\v2!.api.commons.SkillProfileCategoryR\x0fskillCollection\"\xc5\x03\n" +
	"\x16SchedulingResultMetric\x128\n" +
	"\x18total_internal_intervals\x18\x01 \x01(\x05R\x16totalInternalIntervals\x12H\n" +
	"!total_intervals_with_fte_required\x18\x02 \x01(\x05R\x1dtotalIntervalsWithFteRequired\x12L\n" +
	"#total_intervals_with_ftes_remaining\x18\x03 \x01(\x05R\x1ftotalIntervalsWithFtesRemaining\x12\x1a\n" +
	"\bcoverage\x18\x04 \x01(\x02R\bcoverage\x12(\n" +
	"\x10root_mean_square\x18\x05 \x01(\x02R\x0erootMeanSquare\x12\x1d\n" +
	"\n" +
	"has_result\x18\x06 \x01(\bR\thasResult\x12t\n" +
	"\x1bmetrics_by_skill_collection\x18\a \x03(\v25.api.commons.SchedulingResultMetricForSkillCollectionR\x18metricsBySkillCollection\"\x7f\n" +
	"\x16ClientHistoryCacheInfo\x124\n" +
	"\x05state\x18\x01 \x01(\x0e2\x1e.api.commons.HistoryCacheStateR\x05state\x12/\n" +
	"\x13progress_percentage\x18\x02 \x01(\x05R\x12progressPercentage\"2\n" +
	"\n" +
	"ErrorTrace\x12$\n" +
	"\x0egrpc_trace_bin\x18\x01 \x01(\tR\fgrpcTraceBin\"\x95\x01\n" +
	"\x12InitialSetupStatus\x124\n" +
	"\x05state\x18\x01 \x01(\x0e2\x1e.api.commons.InitialSetupStateR\x05state\x12/\n" +
	"\x13progress_percentage\x18\x02 \x01(\x05R\x12progressPercentage\x12\x18\n" +
	"\amessage\x18\x03 \x01(\tR\amessage\"\xcf\x01\n" +
	"\x11AgentStateSegment\x12 \n" +
	"\forder_in_rts\x18\x01 \x01(\x05R\n" +
	"orderInRts\x12<\n" +
	"\x06states\x18\x02 \x03(\x0e2$.api.commons.RealTimeManagementStateR\x06states\x12,\n" +
	"\x10width_in_minutes\x18\x03 \x01(\x05B\x02\x18\x01R\x0ewidthInMinutes\x12(\n" +
	"\x10width_in_seconds\x18\x04 \x01(\x05R\x0ewidthInSeconds:\x02\x18\x01\"\xc6\x01\n" +
	"\x12AgentStateSequence\x12\"\n" +
	"\rwfm_agent_sid\x18\x01 \x01(\x03R\vwfmAgentSid\x12A\n" +
	"\x0estart_datetime\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\rstartDatetime\x12E\n" +
	"\x0estate_segments\x18\x03 \x03(\v2\x1e.api.commons.AgentStateSegmentR\rstateSegments:\x02\x18\x01\"\xe0\x01\n" +
	"\x13AdherenceAgentState\x12\"\n" +
	"\rwfm_agent_sid\x18\x01 \x01(\x03R\vwfmAgentSid\x12A\n" +
	"\x0estart_datetime\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\rstartDatetime\x12C\n" +
	"\n" +
	"adm_states\x18\x03 \x03(\x0e2$.api.commons.RealTimeManagementStateR\tadmStates\x12\x1d\n" +
	"\n" +
	"pause_code\x18\x04 \x01(\tR\tpauseCode\"\xa6\b\n" +
	"\x1cAdherenceAgentStateViolation\x12\"\n" +
	"\rwfm_agent_sid\x18\x01 \x01(\x03R\vwfmAgentSid\x12A\n" +
	"\x0estart_datetime\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\rstartDatetime\x12T\n" +
	"\x13expected_rtm_states\x18\x03 \x03(\x0e2$.api.commons.RealTimeManagementStateR\x11expectedRtmStates\x122\n" +
	"\x13expected_pause_code\x18\x04 \x01(\tB\x02\x18\x01R\x11expectedPauseCode\x12P\n" +
	"\x11actual_rtm_states\x18\x05 \x03(\x0e2$.api.commons.RealTimeManagementStateR\x0factualRtmStates\x12*\n" +
	"\x11actual_pause_code\x18\x06 \x01(\tR\x0factualPauseCode\x12<\n" +
	"\x1aviolation_duration_seconds\x18\a \x01(\x05R\x18violationDurationSeconds\x120\n" +
	"\x14expected_pause_codes\x18\b \x03(\tR\x12expectedPauseCodes\x12N\n" +
	"\"adherence_agent_state_violation_id\x18\t \x01(\x03B\x020\x01R\x1eadherenceAgentStateViolationId\x12K\n" +
	" expected_scheduling_activity_sid\x18\n" +
	" \x01(\x03B\x020\x01R\x1dexpectedSchedulingActivitySid\x129\n" +
	"\x17expected_reason_code_id\x18\v \x01(\x03B\x020\x01R\x14expectedReasonCodeId\x12G\n" +
	"\x1eactual_scheduling_activity_sid\x18\f \x01(\x03B\x020\x01R\x1bactualSchedulingActivitySid\x125\n" +
	"\x15actual_reason_code_id\x18\r \x01(\x03B\x020\x01R\x12actualReasonCodeId\x126\n" +
	"\x15resolved_activity_sid\x18\x0e \x01(\x03B\x020\x01R\x13resolvedActivitySid\x129\n" +
	"\x17resolved_reason_code_id\x18\x0f \x01(\x03B\x020\x01R\x14resolvedReasonCodeId\x12-\n" +
	"\x12resolution_comment\x18\x10 \x01(\tR\x11resolutionComment\x12-\n" +
	"\x13resolved_by_user_id\x18\x11 \x01(\tR\x10resolvedByUserId\"[\n" +
	"\x14AdherenceAgentStates\x12C\n" +
	"\fagent_states\x18\x01 \x03(\v2 .api.commons.AdherenceAgentStateR\vagentStates\"j\n" +
	"\x1dAdherenceAgentStateViolations\x12I\n" +
	"\n" +
	"violations\x18\x01 \x03(\v2).api.commons.AdherenceAgentStateViolationR\n" +
	"violations\"\x91\x05\n" +
	"\x12AgentLeavePetition\x129\n" +
	"\x17agent_leave_petition_id\x18\x01 \x01(\x03B\x020\x01R\x14agentLeavePetitionId\x12\"\n" +
	"\rwfm_agent_sid\x18\x02 \x01(\x03R\vwfmAgentSid\x12N\n" +
	"\x0fpetition_status\x18\x03 \x01(\x0e2%.api.commons.AgentLeavePetitionStatusR\x0epetitionStatus\x12)\n" +
	"\x10petition_comment\x18\x04 \x01(\tR\x0fpetitionComment\x12)\n" +
	"\x10response_comment\x18\x05 \x01(\tR\x0fresponseComment\x12V\n" +
	"\x19requested_datetime_ranges\x18\x06 \x03(\v2\x1a.api.commons.DatetimeRangeR\x17requestedDatetimeRanges\x12=\n" +
	"\fcreated_time\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\vcreatedTime\x12?\n" +
	"\rarchived_time\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\farchivedTime\x12?\n" +
	"\rresolved_time\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\fresolvedTime\x12-\n" +
	"\x13resolved_by_user_id\x18\n" +
	" \x01(\tR\x10resolvedByUserId\x12.\n" +
	"\x13requested_hours_off\x18\v \x01(\x02R\x11requestedHoursOff\"q\n" +
	"\fConfigEntity\x12!\n" +
	"\n" +
	"entity_sid\x18\x01 \x01(\x03B\x020\x01R\tentitySid\x12>\n" +
	"\ventity_type\x18\x02 \x01(\x0e2\x1d.api.commons.ConfigEntityTypeR\n" +
	"entityType\"\xd8\x01\n" +
	"\x1fAdherenceRuleNotificationConfig\x12T\n" +
	"%adherence_rule_notification_config_id\x18\x01 \x01(\x03B\x020\x01R!adherenceRuleNotificationConfigId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12K\n" +
	"\aentries\x18\x03 \x03(\v21.api.commons.AdherenceRuleNotificationConfigEntryR\aentries\"\xad\x03\n" +
	"$AdherenceRuleNotificationConfigEntry\x12_\n" +
	"+adherence_rule_notification_config_entry_id\x18\x01 \x01(\x03B\x020\x01R&adherenceRuleNotificationConfigEntryId\x12T\n" +
	"%adherence_rule_notification_config_id\x18\x02 \x01(\x03B\x020\x01R!adherenceRuleNotificationConfigId\x12*\n" +
	"\x11recipient_user_id\x18\x03 \x01(\tR\x0frecipientUserId\x12]\n" +
	"\x13notification_medium\x18\x04 \x01(\x0e2,.api.commons.AdherenceRuleNotificationMediumR\x12notificationMedium\x12C\n" +
	"\x1fseconds_to_wait_for_no_response\x18\x05 \x01(\x05R\x1asecondsToWaitForNoResponse\"t\n" +
	"\x1fAdherenceDepartmentalRuleAction\x12Q\n" +
	"\vaction_type\x18\x01 \x01(\x0e20.api.commons.AdherenceDepartmentalRuleActionTypeR\n" +
	"actionType\"\xd0\x04\n" +
	"\x19AdherenceDepartmentalRule\x12G\n" +
	"\x1eadherence_departmental_rule_id\x18\x01 \x01(\x03B\x020\x01R\x1badherenceDepartmentalRuleId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12B\n" +
	"\x0fselected_entity\x18\x03 \x01(\v2\x19.api.commons.ConfigEntityR\x0eselectedEntity\x12]\n" +
	"\x15rule_requirement_type\x18\x04 \x01(\x0e2).api.commons.AdherenceRuleRequirementTypeR\x13ruleRequirementType\x12T\n" +
	"%adherence_rule_notification_config_id\x18\x05 \x01(\x03B\x020\x01R!adherenceRuleNotificationConfigId\x12>\n" +
	"\n" +
	"rule_range\x18\x06 \x01(\x0e2\x1f.api.commons.AdherenceRuleRangeR\truleRange\x12=\n" +
	"\fcustom_range\x18\a \x01(\v2\x1a.api.commons.DatetimeRangeR\vcustomRange\x12O\n" +
	"\frule_clauses\x18\t \x03(\v2,.api.commons.AdherenceDepartmentalRuleClauseR\vruleClausesJ\x04\b\b\x10\tR\aclauses\"\x8c\x04\n" +
	"\x1fAdherenceDepartmentalRuleClause\x12T\n" +
	"%adherence_departmental_rule_clause_id\x18\x01 \x01(\x03B\x020\x01R!adherenceDepartmentalRuleClauseId\x12G\n" +
	"\x1eadherence_departmental_rule_id\x18\x02 \x01(\x03B\x020\x01R\x1badherenceDepartmentalRuleId\x12D\n" +
	"\x06action\x18\x03 \x01(\v2,.api.commons.AdherenceDepartmentalRuleActionR\x06action\x12A\n" +
	"\tcondition\x18\x04 \x01(\x0e2#.api.commons.AdherenceRuleConditionR\tcondition\x12\x16\n" +
	"\x06amount\x18\x05 \x01(\x05R\x06amount\x122\n" +
	"\x04unit\x18\x06 \x01(\x0e2\x1e.api.commons.AdherenceRuleUnitR\x04unit\x12:\n" +
	"\n" +
	"per_amount\x18\a \x01(\v2\x1b.google.protobuf.Int32ValueR\tperAmount\x129\n" +
	"\bper_unit\x18\b \x01(\x0e2\x1e.api.commons.AdherenceRuleUnitR\aperUnit\"\xb5\x03\n" +
	"\x12AdherenceAgentRule\x129\n" +
	"\x17adherence_agent_rule_id\x18\x01 \x01(\x03B\x020\x01R\x14adherenceAgentRuleId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12B\n" +
	"\x0fselected_entity\x18\x03 \x01(\v2\x19.api.commons.ConfigEntityR\x0eselectedEntity\x12]\n" +
	"\x15rule_requirement_type\x18\x04 \x01(\x0e2).api.commons.AdherenceRuleRequirementTypeR\x13ruleRequirementType\x12T\n" +
	"%adherence_rule_notification_config_id\x18\x05 \x01(\x03B\x020\x01R!adherenceRuleNotificationConfigId\x12H\n" +
	"\frule_clauses\x18\a \x03(\v2%.api.commons.AdherenceAgentRuleClauseR\vruleClausesJ\x04\b\x06\x10\aR\aclauses\"f\n" +
	"\x18AdherenceAgentRuleAction\x12J\n" +
	"\vaction_type\x18\x01 \x01(\x0e2).api.commons.AdherenceAgentRuleActionTypeR\n" +
	"actionType\"\xeb\x02\n" +
	"\x18AdherenceAgentRuleClause\x12F\n" +
	"\x1eadherence_agent_rule_clause_id\x18\x01 \x01(\x03B\x020\x01R\x1aadherenceAgentRuleClauseId\x129\n" +
	"\x17adherence_agent_rule_id\x18\x02 \x01(\x03B\x020\x01R\x14adherenceAgentRuleId\x12=\n" +
	"\x06action\x18\x03 \x01(\v2%.api.commons.AdherenceAgentRuleActionR\x06action\x12A\n" +
	"\tcondition\x18\x04 \x01(\x0e2#.api.commons.AdherenceRuleConditionR\tcondition\x12\x16\n" +
	"\x06amount\x18\x05 \x01(\x05R\x06amount\x122\n" +
	"\x04unit\x18\x06 \x01(\x0e2\x1e.api.commons.AdherenceRuleUnitR\x04unit*\xa8\x01\n" +
	"\x1eRegressionForecasterModelTypes\x12\x11\n" +
	"\rRANDOM_FOREST\x10\x00\x12\f\n" +
	"\bADABOOST\x10\x01\x12\x15\n" +
	"\x11GRADIENT_BOOSTING\x10\x02\x12\x15\n" +
	"\x11LINEAR_REGRESSION\x10\x03\x12\x0e\n" +
	"\n" +
	"LINEAR_AVG\x10\x04\x12\x14\n" +
	"\x10SEGMENTED_LINEAR\x10\x05\x12\a\n" +
	"\x03MLP\x10\x06\x12\b\n" +
	"\x04AUTO\x10\a*X\n" +
	"&RegressionForecasterAvgsProcessingType\x12\f\n" +
	"\bFORECAST\x10\x00\x12\f\n" +
	"\bAVERAGES\x10\x01\x12\x12\n" +
	"\x0eFIXED_AVERAGES\x10\x02*d\n" +
	"\x12ConstraintTimeUnit\x12\v\n" +
	"\aMINUTES\x10\x00\x12\t\n" +
	"\x05HOURS\x10\x01\x12\n" +
	"\n" +
	"\x06SHIFTS\x10\x02\x12\b\n" +
	"\x04DAYS\x10\x03\x12\t\n" +
	"\x05WEEKS\x10\x04\x12\n" +
	"\n" +
	"\x06MONTHS\x10\x05\x12\t\n" +
	"\x05YEARS\x10\x06*\xd0\x03\n" +
	"\x10ConfigEntityType\x12\x14\n" +
	"\x10CALL_CENTER_NODE\x10\x00\x12\x0f\n" +
	"\vCLIENT_NODE\x10\x01\x12\x11\n" +
	"\rLOCATION_NODE\x10\x02\x12\x10\n" +
	"\fPROGRAM_NODE\x10\x03\x12\x0f\n" +
	"\vAGENT_GROUP\x10\x04\x12\x12\n" +
	"\x0eSHIFT_TEMPLATE\x10\x05\x12\r\n" +
	"\tWFM_AGENT\x10\x06\x12\x12\n" +
	"\x0ePLACEMENT_RULE\x10\a\x12\x13\n" +
	"\x0fCONSTRAINT_RULE\x10\b\x12\x16\n" +
	"\x12NON_SKILL_ACTIVITY\x10\t\x12\x16\n" +
	"\x12AGENT_AVAILABILITY\x10\n" +
	"\x12\x0e\n" +
	"\n" +
	"OPEN_TIMES\x10\v\x12\x17\n" +
	"\x13SCHEDULING_ACTIVITY\x10\f\x12\x15\n" +
	"\x11SKILL_PROFICIENCY\x10\r\x12\x15\n" +
	"\x11SCHEDULE_SCENARIO\x10\x0e\x12\t\n" +
	"\x05SKILL\x10\x0f\x12\x10\n" +
	"\fTOUR_PATTERN\x10\x10\x12\x15\n" +
	...
	"\fMIN_TOTAL_ON\x10\x04\x12\x10\n" +
	"\fMAX_TOTAL_ON\x10\x05\x12\x11\n" +
	"\rMIN_TOTAL_OFF\x10\x06\x12\x11\n" +
	"\rMAX_TOTAL_OFF\x10\a\x12\x13\n" +
	"\x0fMIN_SKILL_LEVEL\x10\b*3\n" +
	"\x10DOWPlacementType\x12\f\n" +
	"\bMUST_NOT\x10\x00\x12\a\n" +
	"\x03MAY\x10\x01\x12\b\n" +
	"\x04MUST\x10\x02*'\n" +
	"\x0fOpenTimesOption\x12\n" +
	"\n" +
	"\x06CLOSED\x10\x00\x12\b\n" +
	"\x04OPEN\x10\x01*P\n" +
	"\x12AvailabilityOption\x12\r\n" +
	...
	"\x03WED\x10\x02\x12\a\n" +
	"\x03THU\x10\x03\x12\a\n" +
	"\x03FRI\x10\x04\x12\a\n" +
	"\x03SAT\x10\x05\x12\a\n" +
	"\x03SUN\x10\x06*^\n" +
	"\x16ConfigRelationshipType\x12\x16\n" +
	"\x12IS_ASSOCIATED_WITH\x10\x00\x12\x1a\n" +
	"\x16IS_NOT_ASSOCIATED_WITH\x10\x01\x12\x10\n" +
	"\fIS_MEMBER_OF\x10\x02*i\n" +
	"\x0fDiagnosticLevel\x12\x0f\n" +
	"\vINFORMATION\x10\x00\x12\x0e\n" +
	"\n" +
	"SUGGESTION\x10\x01\x12\v\n" +
	"\aWARNING\x10\x02\x12\x14\n" +
	"\x10DIAGNOSTIC_ERROR\x10\x03\x12\x12\n" +
	"\x0eINTERNAL_ERROR\x10\x04*\xbe\x19\n" +
	"\x0eDiagnosticCode\x12\v\n" +
	"\aGENERAL\x10\x00\x12\x06\n" +
	"\x02OK\x10\x01\x12\x1b\n" +
	"\x17NO_SKILLS_IN_DICTIONARY\x10\x02\x12$\n" +
	" AGENT_HAS_NO_SKILL_PROFICIENCIES\x10\x03\x12\x17\n" +
	"\x13AGENT_HAS_NO_SKILLS\x10\x04\x121\n" +
	"-NO_SCHEDULING_ACTIVITIES_FOR_CONSTRAINT_RULES\x10\x05\x125\n" +
	"1SCHEDULING_ACTIVITY_FOR_CONSTRAINT_RULE_NOT_FOUND\x10\x06\x12!\n" +
	"\x1dSHIFT_TEMPLATE_CANNOT_BE_NONE\x10\a\x12)\n" +
	"%SHIFT_TEMPLATE_HAS_NO_PLACEMENT_RULES\x10\b\x12/\n" +
	"+NO_ONCALL_IN_SHIFT_TEMPLATE_PLACEMENT_RULES\x10\t\x129\n" +
	"5MIN_GT_MAX_DURATION_IN_SHIFT_TEMPLATE_PLACEMENT_RULES\x10\n" +
	"\x12'\n" +
	"#MIN_GT_MAX_AGENTS_IN_SHIFT_TEMPLATE\x10\v\x12)\n" +
	"%NO_PLACEMENT_RULES_FOR_SHIFT_TEMPLATE\x10\f\x12!\n" +
	"\x1dACTIVITIES_SHORTER_THAN_SHIFT\x10\r\x12\x1f\n" +
	...
	"\x17CLIENT_HAS_NO_LOCATIONS\x10\x12\x12\x1e\n" +
	"\x1aCALL_CENTER_HAS_NO_CLIENTS\x10\x13\x12'\n" +
	...
	")SHIFT_TEMPLATE_HAS_INVALID_PARENT_PROGRAM\x10\x18\x12B\n" +
	">NO_SKILL_PROFICIENCY_FOR_MIN_SKILL_PROFICIENCY_CONSTRAINT_RULE\x10\x19\x125\n" +
	...
	"\x1aCONSTRAINT_GENERAL_FAILURE\x10\x1d\x12&\n" +
	"\"CANDIDATE_SHIFT_COLLISION_DETECTED\x10\x1e\x12'\n" +
	"#CANDIDATE_SHIFT_AGENT_NOT_AVAILABLE\x10\x1f\x12\x14\n" +
	"\x10CANDIDATE_CLOSED\x10 \x12!\n" +
	"\x1dCONSTRAINT_ACTIVITY_NOT_FOUND\x10!\x12.\n" +
	"*CONSTRAINT_AGENT_DOES_NOT_HAVE_PROFICIENCY\x10\"\x12(\n" +
	"$CONSTRAINT_AGENT_PROFICIENCY_TOO_LOW\x10#\x12#\n" +
	"\x1fCONSTRAINT_MAX_TOTAL_ON_FAILURE\x10$\x12#\n" +
	"\x1fCONSTRAINT_MIN_TOTAL_ON_FAILURE\x10%\x12$\n" +
	...
	";CONSTRAINT_CANNOT_HAVE_DAY_WEEK_MONTH_YEAR_SHIFT__PER_SHIFT\x10,\x12A\n" +
	"=CONSTRAINT_CANNOT_HAVE_DAY_WEEK_MONTH_YEAR__PER_MINUTES_HOURS\x10-\x122\n" +
	".CONSTRAINT_CONSECUTIVE_SHIFTS_RULE_NOT_ALLOWED\x10.\x12>\n" +
	":CONSTRAINT_WITH_LARGER_PERIOD_PER_SMALL_PERIOD_NOT_ALLOWED\x10/\x126\n" +
	"2CONSTRAINT_MIN_MAX_OFF_TIME_FOR_SHIFTS_NOT_ALLOWED\x100\x12?\n" +
	";CONSTRAINT_CANNOT_HAVE_CONSECUTIVE_TIME_PER_MULTIPLE_SHIFTS\x101\x12=\n" +
	"9CANNOT_GENERATE_TOUR_PATTERNS_FOR_NON_TOUR_SHIFT_TEMPLATE\x102\x12)\n" +
	"%TOUR_PATTERNS_NEEDED_TO_SCHEDULE_TOUR\x103\x12K\n" +
	"GSHIFT_TEMPLATE_ACTIVITY_PLACEMENT_MIN_MAX_MUST_BE_MULTIPLE_OF_5_MINUTES\x104\x12L\n" +
	"HNO_SHIFT_TEMPLATE_ACTIVITY_PLACEMENT_SEQUENCES_MATCH_SHIFT_MIN_MAX_WIDTH\x105\x12\x18\n" +
	"\x14INVALID_TOUR_PATTERN\x106\x12!\n" +
	"\x1dINVALID_TOUR_AGENT_COLLECTION\x107\x12&\n" +
	"\"INVALID_TOUR_SHIFT_INSTANCE_CONFIG\x108\x12%\n" +
	"!INVALID_TOUR_SHIFT_SEGMENT_CONFIG\x109\x12%\n" +
	"!TOUR_SHIFT_SEGMENT_CONFIG_OVERLAP\x10:\x12*\n" +
	"&TOUR_SHIFT_SEGMENT_CONFIG_DOES_NOT_FIT\x10;\x12&\n" +
	"\"TOUR_SHIFT_INSTANCE_CONFIG_OVERLAP\x10<\x129\n" +
	"5WEEK_PATTERN_NUMBERS_NOT_UNIQUE_IN_TOUR_WEEK_PATTERNS\x10=\x127\n" +
	"3WFM_AGENT_SIDS_NOT_UNIQUE_IN_TOUR_AGENT_COLLECTIONS\x10>\x12B\n" +
	...
	"8SHIFT_TEMPLATE_HAS_NO_ASSOCIATED_SCHEDULING_AGENT_GROUPS\x10A\x126\n" +
	"2ATTEMPT_TO_BUILD_SCHEDULES_FOR_INVALID_PARENT_NODE\x10B\x123\n" +
	"/SCHEDULABLE_AGENTS_DO_NOT_MEET_TEMPLATE_MINIMUM\x10C\x123\n" +
	"/SCHEDULABLE_AGENTS_DO_NOT_MEET_TEMPLATE_MAXIMUM\x10D\x12-\n" +
	")NO_OPEN_TIMES_SET_OR_INHERITED_BY_PROGRAM\x10E\x122\n" +
	".TOUR_AGENT_COLLECTIONS_NEEDED_TO_SCHEDULE_TOUR\x10F\x12*\n" +
	...
	"\x1fFTE_REQUIRED_VS_ACHIEVED_SIMPLE\x10\x00\x12%\n" +
	...
	"\x18CONTACT_HANDLING_METRICS\x10\x04\x12\x11\n" +
	...
	"\tPUBLISHED\x10\x01*7\n" +
	"\x14SchedulingTargetType\x12\f\n" +
	"\bCOVERAGE\x10\x00\x12\x11\n" +
	"\rSERVICE_LEVEL\x10\x01*Z\n" +
	"\x10BuildDraftStatus\x12\f\n" +
	"\bNO_BUILD\x10\x00\x12\x0f\n" +
	...
	"\x0eSETUP_COMPLETE\x10\x02\x12\v\n" +
	"\aFAILURE\x10\x03*\xbe\x01\n" +
	"\x17RealTimeManagementState\x12\x0f\n" +
	"\vUNSPECIFIED\x10\x00\x12\r\n" +
	"\tLOGGED_IN\x10\x01\x12\x10\n" +
	"\fCALL_ON_HOLD\x10\x04\x12\x11\n" +
	"\rOUTBOUND_CALL\x10\x05\x12\f\n" +
	"\bTRANSFER\x10\a\x12\x0e\n" +
	"\n" +
	"CONFERENCE\x10\b\x12\t\n" +
	"\x05READY\x10\t\x12\r\n" +
	"\tNOT_READY\x10\n" +
	"\x12\v\n" +
	"\aWRAP_UP\x10\v\x12\x0e\n" +
	"\n" +
	"LOGGED_OUT\x10\r\x12\t\n" +
	"\x05PAUSE\x10\x0e*J\n" +
	"\x19AgentStateSimulationLevel\x12\x11\n" +
	"\rNO_SIMULATION\x10\x00\x12\x1a\n" +
	"\x16SIMULATED_AGENT_STATES\x10\x01*\x95\x01\n" +
	"\x18AgentLeavePetitionStatus\x12\x1f\n" +
	"\x1bUNSPECIFIED_PETITION_STATUS\x10\x00\x12\x14\n" +
	"\x10PENDING_PETITION\x10\x01\x12\x15\n" +
	"\x11APPROVED_PETITION\x10\x02\x12\x13\n" +
	"\x0fDENIED_PETITION\x10\x03\x12\x16\n" +
	"\x12CANCELLED_PETITION\x10\x04*\x87\x01\n" +
	...
	"\x11AdherenceRuleUnit\x12\x1f\n" +
	"\x1bADHERENCE_RULE_UNIT_SECONDS\x10\x00\x12\x1f\n" +
	"\x1bADHERENCE_RULE_UNIT_MINUTES\x10\x01\x12\x1d\n" +
	"\x19ADHERENCE_RULE_UNIT_CALLS\x10\x02\x12\"\n" +
	"\x1eADHERENCE_RULE_UNIT_PERCENTAGE\x10\x03*\x8d\x04\n" +
	"\x1cAdherenceAgentRuleActionType\x12,\n" +
	"(ADHERENCE_AGENT_RULE_ACTION_TYPE_WRAP_UP\x10\x00\x12,\n" +
	"(ADHERENCE_AGENT_RULE_ACTION_TYPE_WAITING\x10\x01\x120\n" +
	",ADHERENCE_AGENT_RULE_ACTION_TYPE_MANUAL_DIAL\x10\x02\x121\n" +
	"-ADHERENCE_AGENT_RULE_ACTION_TYPE_PREVIEW_DIAL\x10\x03\x121\n" +
	"-ADHERENCE_AGENT_RULE_ACTION_TYPE_ANSWER_CALLS\x10\x04\x12,\n" +
	"(ADHERENCE_AGENT_RULE_ACTION_TYPE_ON_CALL\x10\x05\x12,\n" +
	"(ADHERENCE_AGENT_RULE_ACTION_TYPE_ON_HOLD\x10\x06\x120\n" +
	",ADHERENCE_AGENT_RULE_ACTION_TYPE_SHIFT_START\x10\a\x125\n" +
	"1ADHERENCE_AGENT_RULE_ACTION_TYPE_SHIFT_START_LATE\x10\b\x124\n" +
	"0ADHERENCE_AGENT_RULE_ACTION_TYPE_SHIFT_END_EARLY\x10\tB\x90\x01\n" +
	"\x0fcom.api.commonsB\bWfmProtoP\x01Z&github.com/tcncloud/api-go/api/commons\xa2\x02\x03ACX\xaa\x02\vApi.Commons\xca\x02\vApi\\Commons\xe2\x02\x17Api\\Commons\\GPBMetadata\xea\x02\fApi::Commonsb\x06proto3"
