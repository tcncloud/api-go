...
type AgentRTMState int32

const (
	// The agent is logged in, but not in any other call state.
	AgentRTMState_LOGGED_IN AgentRTMState = 0
	// The agent is on an acd inbound call.
	AgentRTMState_ACD_INBOUND_CALL AgentRTMState = 1
	// The agent is on a dicrect outbound call.
	AgentRTMState_DIRECT_OUTBOUND_CALL AgentRTMState = 2
	// cdn The agent's call is on hold.
	AgentRTMState_CALL_ON_HOLD AgentRTMState = 3
	// Agent is on an outbound call.
	AgentRTMState_OUTBOUND_CALL AgentRTMState = 4
	// Agent is taking an inbound call.
	AgentRTMState_INBOUND_CALL AgentRTMState = 5
	// Agent is transferring a call.
	AgentRTMState_TRANSFER AgentRTMState = 6
	// Agent is on a conference call.
	AgentRTMState_CONFERENCE AgentRTMState = 7
	// Agent is ready to accept a call.
	AgentRTMState_READY AgentRTMState = 8
)

// Enum value maps for AgentRTMState.
var (
	AgentRTMState_name = map[int32]string{
		0: "LOGGED_IN",
		1: "ACD_INBOUND_CALL",
		2: "DIRECT_OUTBOUND_CALL",
		3: "CALL_ON_HOLD",
		4: "OUTBOUND_CALL",
		5: "INBOUND_CALL",
		6: "TRANSFER",
	...
	AgentRTMState_value = map[string]int32{
		"LOGGED_IN":            0,
		"ACD_INBOUND_CALL":     1,
...
func (x AgentRTMState) Enum() *AgentRTMState {
	p := new(AgentRTMState)
	*p = x
	return p
}

func (x AgentRTMState) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (AgentRTMState) Descriptor() protoreflect.EnumDescriptor {
	return file_api_commons_wfm_proto_enumTypes[19].Descriptor()
}

func (AgentRTMState) Type() protoreflect.EnumType {
	return &file_api_commons_wfm_proto_enumTypes[19]
}

func (x AgentRTMState) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use AgentRTMState.Descriptor instead.
func (AgentRTMState) EnumDescriptor() ([]byte, []int) {
...
type AgentStateSegment struct {
	...
	State AgentRTMState `protobuf:"varint,2,opt,name=state,proto3,enum=api.commons.AgentRTMState" json:"state,omitempty"`
	...
	AgentStateSegmentSid int64 `protobuf:"varint,4,opt,name=agent_state_segment_sid,json=agentStateSegmentSid,proto3" json:"agent_state_segment_sid,omitempty"`
	// ID of the agent state sequence that the segment belongs to.
	AgentStateSequenceSid int64 `protobuf:"varint,5,opt,name=agent_state_sequence_sid,json=agentStateSequenceSid,proto3" json:"agent_state_sequence_sid,omitempty"`
}
...
func (x *AgentStateSegment) GetState() AgentRTMState {
	if x != nil {
		return x.State
	}
	return AgentRTMState_LOGGED_IN
}
...
func (x *AgentStateSegment) GetAgentStateSegmentSid() int64 {
	if x != nil {
		return x.AgentStateSegmentSid
	}
	return 0
}

func (x *AgentStateSegment) GetAgentStateSequenceSid() int64 {
	if x != nil {
		return x.AgentStateSequenceSid
	}
	return 0
}
...
type AgentStateSequence struct {
	...
	TotalWidthInMinutes int32 `protobuf:"varint,4,opt,name=total_width_in_minutes,json=totalWidthInMinutes,proto3" json:"total_width_in_minutes,omitempty"`
...
func (x *AgentStateSequence) GetTotalWidthInMinutes() int32 {
	if x != nil {
		return x.TotalWidthInMinutes
	}
	return 0
}

func (x *AgentStateSequence) GetAgentStateSequenceSid() int64 {
	if x != nil {
		return x.AgentStateSequenceSid
	}
	return 0
...
var file_api_commons_wfm_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x81, 0x02, 0x0a, 0x11, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x4e, 0x53, 0x10, 0x3e, 0x12, 0x42, 0x0a, 0x3e, 0x46, 0x49, 0x53, 0x54, 0x5f, 0x57, 0x45, 0x45,
	0x4b, 0x5f, 0x50, 0x41, 0x54, 0x54, 0x45, 0x52, 0x4e, 0x5f, 0x4e, 0x55, 0x4d, 0x42, 0x45, 0x52,
	...
	,
	...
	,
...
var file_api_commons_wfm_proto_goTypes = []interface{}{
	...
	(AgentRTMState)(0),                               // 19: api.commons.AgentRTMState
...
var file_api_commons_wfm_proto_depIdxs = []int32{
	...
	19, // 19: api.commons.AgentStateSegment.state:type_name -> api.commons.AgentRTMState
...
func file_api_commons_wfm_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_commons_wfm_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_commons_wfm_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_commons_wfm_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
