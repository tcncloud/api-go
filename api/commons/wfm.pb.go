...
type AgentStateSimulationLevel int32

const (
	// Not set or no simulation active.
	// The default level of simulation.
	AgentStateSimulationLevel_NO_SIMULATION AgentStateSimulationLevel = 0
	// Simulates the agent states, but not the predicted calls.
	AgentStateSimulationLevel_SIMULATED_AGENT_STATES AgentStateSimulationLevel = 1
)

// Enum value maps for AgentStateSimulationLevel.
var (
	AgentStateSimulationLevel_name = map[int32]string{
		0: "NO_SIMULATION",
		1: "SIMULATED_AGENT_STATES",
	}
	AgentStateSimulationLevel_value = map[string]int32{
		"NO_SIMULATION":          0,
		"SIMULATED_AGENT_STATES": 1,
	}
)

func (x AgentStateSimulationLevel) Enum() *AgentStateSimulationLevel {
	p := new(AgentStateSimulationLevel)
	*p = x
	return p
}

func (x AgentStateSimulationLevel) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (AgentStateSimulationLevel) Descriptor() protoreflect.EnumDescriptor {
	return file_api_commons_wfm_proto_enumTypes[21].Descriptor()
}

func (AgentStateSimulationLevel) Type() protoreflect.EnumType {
	return &file_api_commons_wfm_proto_enumTypes[21]
}

func (x AgentStateSimulationLevel) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use AgentStateSimulationLevel.Descriptor instead.
func (AgentStateSimulationLevel) EnumDescriptor() ([]byte, []int) {
...
func (SkillProfileCategory_CategoryType) Descriptor() protoreflect.EnumDescriptor {
	return file_api_commons_wfm_proto_enumTypes[32].Descriptor()
}

func (SkillProfileCategory_CategoryType) Type() protoreflect.EnumType {
	return &file_api_commons_wfm_proto_enumTypes[32]
}
...
func (SkillProfileCategory_CategoryType) EnumDescriptor() ([]byte, []int) {
	return file_api_commons_wfm_proto_rawDescGZIP(), []int{13, 0}
}
...
type ReasonCode struct {
	...
	ReasonCodeId int64 `protobuf:"varint,1,opt,name=reason_code_id,json=reasonCodeId,proto3" json:"reason_code_id,omitempty"`
	// Name of the Reason Code.
	Name string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	// The Scheduling Activity SID that the Reason Code is associated with.
	SchedulingActivitySid int64 `protobuf:"varint,3,opt,name=scheduling_activity_sid,json=schedulingActivitySid,proto3" json:"scheduling_activity_sid,omitempty"`
	// Indicates that this is a planned Reason Code.
	IsPlanned bool `protobuf:"varint,4,opt,name=is_planned,json=isPlanned,proto3" json:"is_planned,omitempty"`
	...
	DatetimeSetToInactive *timestamppb.Timestamp `protobuf:"bytes,7,opt,name=datetime_set_to_inactive,json=datetimeSetToInactive,proto3" json:"datetime_set_to_inactive,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *ReasonCode) GetReasonCodeId() int64 {
	if x != nil {
		return x.ReasonCodeId
	}
	return 0
}

func (x *ReasonCode) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ReasonCode) GetSchedulingActivitySid() int64 {
	if x != nil {
...
func (x *ReasonCode) GetIsPlanned() bool {
	if x != nil {
		return x.IsPlanned
	}
	return false
...
func (x *ReasonCode) GetIsPaid() bool {
	if x != nil {
		return x.IsPaid
	}
	return false
...
func (x *ReasonCode) GetIsDefault() bool {
	if x != nil {
		return x.IsDefault
	}
	return false
...
func (x *ReasonCode) GetDatetimeSetToInactive() *timestamppb.Timestamp {
	if x != nil {
...
type AdherenceAgentStateViolation struct {
	...
	// ID of the violation.
	AdherenceAgentStateViolationId int64 `protobuf:"varint,9,opt,name=adherence_agent_state_violation_id,json=adherenceAgentStateViolationId,proto3" json:"adherence_agent_state_violation_id,omitempty"`
	// The ID of the activity that the agent was scheduled for.
	ExpectedSchedulingActivitySid int64 `protobuf:"varint,10,opt,name=expected_scheduling_activity_sid,json=expectedSchedulingActivitySid,proto3" json:"expected_scheduling_activity_sid,omitempty"`
	// The ID of the reason code that the agent was scheduled for.
	ExpectedReasonCodeId int64 `protobuf:"varint,11,opt,name=expected_reason_code_id,json=expectedReasonCodeId,proto3" json:"expected_reason_code_id,omitempty"`
	// The ID of the activity that the agent's pause code indicated they were actually doing.
	ActualSchedulingActivitySid int64 `protobuf:"varint,12,opt,name=actual_scheduling_activity_sid,json=actualSchedulingActivitySid,proto3" json:"actual_scheduling_activity_sid,omitempty"`
	// The ID of the reason code that the agent's pause code indicated they were actually doing.
	ActualReasonCodeId int64 `protobuf:"varint,13,opt,name=actual_reason_code_id,json=actualReasonCodeId,proto3" json:"actual_reason_code_id,omitempty"`
	// The ID of the scheduling activity that the agent will be reported as.
	ResolvedActivitySid int64 `protobuf:"varint,14,opt,name=resolved_activity_sid,json=resolvedActivitySid,proto3" json:"resolved_activity_sid,omitempty"`
	// The ID of the reason code that the agent will be reported as.
	ResolvedReasonCodeId int64 `protobuf:"varint,15,opt,name=resolved_reason_code_id,json=resolvedReasonCodeId,proto3" json:"resolved_reason_code_id,omitempty"`
	// The comment left by the user upon resolution.
	ResolutionComment string `protobuf:"bytes,16,opt,name=resolution_comment,json=resolutionComment,proto3" json:"resolution_comment,omitempty"`
	// ID of the user who resolved this violation.
	ResolvedByUserId string `protobuf:"bytes,17,opt,name=resolved_by_user_id,json=resolvedByUserId,proto3" json:"resolved_by_user_id,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *AdherenceAgentStateViolation) GetAdherenceAgentStateViolationId() int64 {
	if x != nil {
		return x.AdherenceAgentStateViolationId
	}
	return 0
}

func (x *AdherenceAgentStateViolation) GetExpectedSchedulingActivitySid() int64 {
	if x != nil {
		return x.ExpectedSchedulingActivitySid
	}
	return 0
}

func (x *AdherenceAgentStateViolation) GetExpectedReasonCodeId() int64 {
	if x != nil {
		return x.ExpectedReasonCodeId
	}
	return 0
}

func (x *AdherenceAgentStateViolation) GetActualSchedulingActivitySid() int64 {
	if x != nil {
		return x.ActualSchedulingActivitySid
	}
	return 0
}

func (x *AdherenceAgentStateViolation) GetActualReasonCodeId() int64 {
	if x != nil {
		return x.ActualReasonCodeId
	}
	return 0
}

func (x *AdherenceAgentStateViolation) GetResolvedActivitySid() int64 {
	if x != nil {
		return x.ResolvedActivitySid
	}
	return 0
}

func (x *AdherenceAgentStateViolation) GetResolvedReasonCodeId() int64 {
	if x != nil {
		return x.ResolvedReasonCodeId
	}
	return 0
}

func (x *AdherenceAgentStateViolation) GetResolutionComment() string {
	if x != nil {
...
func (x *AdherenceAgentStateViolation) GetResolvedByUserId() string {
	if x != nil {
...
func (x *AdherenceAgentRuleClause) Reset() {
	*x = AdherenceAgentRuleClause{}
	mi := &file_api_commons_wfm_proto_msgTypes[34]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AdherenceAgentRuleClause) Descriptor() ([]byte, []int) {
	return file_api_commons_wfm_proto_rawDescGZIP(), []int{34}
}
...
var file_api_commons_wfm_proto_rawDesc = string([]byte{
	...
	,
	...
	,
	...
	,
	...
	0x6e, 0x22, 0xc5, 0x03, 0x0a, 0x16, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x69, 0x6e, 0x67,
	0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x12, 0x38, 0x0a, 0x18,
	0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x5f, 0x69,
	0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x16,
	0x74, 0x6f, 0x74, 0x61, 0x6c, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x49, 0x6e, 0x74,
	0x65, 0x72, 0x76, 0x61, 0x6c, 0x73, 0x12, 0x48, 0x0a, 0x21, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f,
	...
	,
	...
	0x53, 0x69, 0x64, 0x12, 0x41, 0x0a, 0x0e, 0x73, 0x74, 0x61, 0x72, 0x74, 0x5f, 0x64, 0x61, 0x74,
	...
	0x74, 0x65, 0x74, 0x69, 0x6d, 0x65, 0x12, 0x45, 0x0a, 0x0e, 0x73, 0x74, 0x61, 0x74, 0x65, 0x5f,
	...
	0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x0d,
	0x73, 0x74, 0x61, 0x74, 0x65, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x3a, 0x02, 0x18,
	0x01, 0x22, 0xe0, 0x01, 0x0a, 0x13, 0x41, 0x64, 0x68, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x41,
	0x67, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x22, 0x0a, 0x0d, 0x77, 0x66, 0x6d,
	0x5f, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x5f, 0x73, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x0b, 0x77, 0x66, 0x6d, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x53, 0x69, 0x64, 0x12, 0x41, 0x0a,
	...
	0x12, 0x43, 0x0a, 0x0a, 0x61, 0x64, 0x6d, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x73, 0x18, 0x03,
	...
	,
	...
	0x74, 0x61, 0x72, 0x74, 0x44, 0x61, 0x74, 0x65, 0x74, 0x69, 0x6d, 0x65, 0x12, 0x54, 0x0a, 0x13,
	0x65, 0x78, 0x70, 0x65, 0x63, 0x74, 0x65, 0x64, 0x5f, 0x72, 0x74, 0x6d, 0x5f, 0x73, 0x74, 0x61,
	0x74, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x24, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	...
	0x11, 0x65, 0x78, 0x70, 0x65, 0x63, 0x74, 0x65, 0x64, 0x52, 0x74, 0x6d, 0x53, 0x74, 0x61, 0x74,
	0x65, 0x73, 0x12, 0x32, 0x0a, 0x13, 0x65, 0x78, 0x70, 0x65, 0x63, 0x74, 0x65, 0x64, 0x5f, 0x70,
	0x61, 0x75, 0x73, 0x65, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x42,
	0x02, 0x18, 0x01, 0x52, 0x11, 0x65, 0x78, 0x70, 0x65, 0x63, 0x74, 0x65, 0x64, 0x50, 0x61, 0x75,
	0x73, 0x65, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x50, 0x0a, 0x11, 0x61, 0x63, 0x74, 0x75, 0x61, 0x6c,
	0x5f, 0x72, 0x74, 0x6d, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28,
	...
	,
	...
	,
	...
	,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x4b, 0x0a, 0x07, 0x65,
	...
	0x07, 0x65, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x22, 0xad, 0x03, 0x0a, 0x24, 0x41, 0x64, 0x68,
	...
	0x79, 0x12, 0x5f, 0x0a, 0x2b, 0x61, 0x64, 0x68, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x5f, 0x72,
	0x75, 0x6c, 0x65, 0x5f, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x5f, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x5f, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x42, 0x02, 0x30, 0x01, 0x52, 0x26, 0x61, 0x64, 0x68, 0x65,
	...
	0x49, 0x64, 0x12, 0x54, 0x0a, 0x25, 0x61, 0x64, 0x68, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x5f,
	...
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x49, 0x64, 0x12, 0x2a, 0x0a, 0x11, 0x72, 0x65, 0x63, 0x69,
	...
	0x65, 0x72, 0x49, 0x64, 0x12, 0x5d, 0x0a, 0x13, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x6d, 0x65, 0x64, 0x69, 0x75, 0x6d, 0x18, 0x04, 0x20, 0x01, 0x28,
	...
	,
	...
	,
	...
	,
	...
	0x6c, 0x65, 0x49, 0x64, 0x12, 0x44, 0x0a, 0x06, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x03,
	...
	,
	...
	,
	...
	0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x42, 0x02, 0x30, 0x01, 0x52, 0x21, 0x61, 0x64,
	...
	,
	...
	0x41, 0x0a, 0x09, 0x63, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x23, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x73,
	0x2e, 0x41, 0x64, 0x68, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x52, 0x75, 0x6c, 0x65, 0x43, 0x6f,
	...
	0x28, 0x05, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x32, 0x0a, 0x04, 0x75, 0x6e,
	0x69, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1e, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x63,
	0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x73, 0x2e, 0x41, 0x64, 0x68, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65,
	0x52, 0x75, 0x6c, 0x65, 0x55, 0x6e, 0x69, 0x74, 0x52, 0x04, 0x75, 0x6e, 0x69, 0x74, 0x2a, 0xa8,
	...
	0x0a, 0x05, 0x59, 0x45, 0x41, 0x52, 0x53, 0x10, 0x06, 0x2a, 0xd0, 0x03, 0x0a, 0x10, 0x43, 0x6f,
	...
	,
	...
	0x54, 0x10, 0x05, 0x12, 0x07, 0x0a, 0x03, 0x53, 0x55, 0x4e, 0x10, 0x06, 0x2a, 0x5e, 0x0a, 0x16,
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x68,
	0x69, 0x70, 0x54, 0x79, 0x70, 0x65, 0x12, 0x16, 0x0a, 0x12, 0x49, 0x53, 0x5f, 0x41, 0x53, 0x53,
	0x4f, 0x43, 0x49, 0x41, 0x54, 0x45, 0x44, 0x5f, 0x57, 0x49, 0x54, 0x48, 0x10, 0x00, 0x12, 0x1a,
	0x0a, 0x16, 0x49, 0x53, 0x5f, 0x4e, 0x4f, 0x54, 0x5f, 0x41, 0x53, 0x53, 0x4f, 0x43, 0x49, 0x41,
	0x54, 0x45, 0x44, 0x5f, 0x57, 0x49, 0x54, 0x48, 0x10, 0x01, 0x12, 0x10, 0x0a, 0x0c, 0x49, 0x53,
	0x5f, 0x4d, 0x45, 0x4d, 0x42, 0x45, 0x52, 0x5f, 0x4f, 0x46, 0x10, 0x02, 0x2a, 0x69, 0x0a, 0x0f,
	...
	,
	...
	,
	...
	,
...
var file_api_commons_wfm_proto_enumTypes = make([]protoimpl.EnumInfo, 33)
var file_api_commons_wfm_proto_msgTypes = make([]protoimpl.MessageInfo, 35)
var file_api_commons_wfm_proto_goTypes = []any{
	...
	(AgentStateSimulationLevel)(0),                   // 21: api.commons.AgentStateSimulationLevel
	(AgentLeavePetitionStatus)(0),                    // 22: api.commons.AgentLeavePetitionStatus
	(SchedulingActivityClassification)(0),            // 23: api.commons.SchedulingActivityClassification
	(AdherenceRuleNotificationMedium)(0),             // 24: api.commons.AdherenceRuleNotificationMedium
	(AdherenceRuleRequirementType)(0),                // 25: api.commons.AdherenceRuleRequirementType
	(AdherenceRuleRange)(0),                          // 26: api.commons.AdherenceRuleRange
	(AdherenceDepartmentalRuleActionType)(0),         // 27: api.commons.AdherenceDepartmentalRuleActionType
	(AdherenceRuleCondition)(0),                      // 28: api.commons.AdherenceRuleCondition
	(AdherenceRuleUnit)(0),                           // 29: api.commons.AdherenceRuleUnit
	(AdherenceAgentRuleActionType)(0),                // 30: api.commons.AdherenceAgentRuleActionType
	(SkillType_Enum)(0),                              // 31: api.commons.SkillType.Enum
	(SkillProfileCategory_CategoryType)(0),           // 32: api.commons.SkillProfileCategory.CategoryType
	(*SkillType)(nil),                                // 33: api.commons.SkillType
	(*DatetimeRange)(nil),                            // 34: api.commons.DatetimeRange
	(*ForecastingParameters)(nil),                    // 35: api.commons.ForecastingParameters
	(*ProfileTOD)(nil),                               // 36: api.commons.ProfileTOD
	(*ProfileWOMS)(nil),                              // 37: api.commons.ProfileWOMS
	(*ProfileDOW)(nil),                               // 38: api.commons.ProfileDOW
	(*ProfileMOY)(nil),                               // 39: api.commons.ProfileMOY
	(*DistributionProfile)(nil),                      // 40: api.commons.DistributionProfile
	(*CallProfileGroupCalls)(nil),                    // 41: api.commons.CallProfileGroupCalls
	(*CallProfileGroupAvgs)(nil),                     // 42: api.commons.CallProfileGroupAvgs
	(*OptionTypes)(nil),                              // 43: api.commons.OptionTypes
	(*ReasonCode)(nil),                               // 44: api.commons.ReasonCode
	(*ScheduleSelector)(nil),                         // 45: api.commons.ScheduleSelector
	(*SkillProfileCategory)(nil),                     // 46: api.commons.SkillProfileCategory
	(*SchedulingResultMetricForSkillCollection)(nil), // 47: api.commons.SchedulingResultMetricForSkillCollection
	(*SchedulingResultMetric)(nil),                   // 48: api.commons.SchedulingResultMetric
	(*ClientHistoryCacheInfo)(nil),                   // 49: api.commons.ClientHistoryCacheInfo
	(*ErrorTrace)(nil),                               // 50: api.commons.ErrorTrace
	(*InitialSetupStatus)(nil),                       // 51: api.commons.InitialSetupStatus
	(*AgentStateSegment)(nil),                        // 52: api.commons.AgentStateSegment
	(*AgentStateSequence)(nil),                       // 53: api.commons.AgentStateSequence
	(*AdherenceAgentState)(nil),                      // 54: api.commons.AdherenceAgentState
	(*AdherenceAgentStateViolation)(nil),             // 55: api.commons.AdherenceAgentStateViolation
	(*AdherenceAgentStates)(nil),                     // 56: api.commons.AdherenceAgentStates
	(*AdherenceAgentStateViolations)(nil),            // 57: api.commons.AdherenceAgentStateViolations
	(*AgentLeavePetition)(nil),                       // 58: api.commons.AgentLeavePetition
	(*ConfigEntity)(nil),                             // 59: api.commons.ConfigEntity
	(*AdherenceRuleNotificationConfig)(nil),          // 60: api.commons.AdherenceRuleNotificationConfig
	(*AdherenceRuleNotificationConfigEntry)(nil),     // 61: api.commons.AdherenceRuleNotificationConfigEntry
	(*AdherenceDepartmentalRuleAction)(nil),          // 62: api.commons.AdherenceDepartmentalRuleAction
	(*AdherenceDepartmentalRule)(nil),                // 63: api.commons.AdherenceDepartmentalRule
	(*AdherenceDepartmentalRuleClause)(nil),          // 64: api.commons.AdherenceDepartmentalRuleClause
	(*AdherenceAgentRule)(nil),                       // 65: api.commons.AdherenceAgentRule
	(*AdherenceAgentRuleAction)(nil),                 // 66: api.commons.AdherenceAgentRuleAction
	(*AdherenceAgentRuleClause)(nil),                 // 67: api.commons.AdherenceAgentRuleClause
	(*timestamppb.Timestamp)(nil),                    // 68: google.protobuf.Timestamp
	(*wrapperspb.Int32Value)(nil),                    // 69: google.protobuf.Int32Value
}
var file_api_commons_wfm_proto_depIdxs = []int32{
	68, // 0: api.commons.DatetimeRange.start_datetime:type_name -> google.protobuf.Timestamp
	68, // 1: api.commons.DatetimeRange.end_datetime:type_name -> google.protobuf.Timestamp
	68, // 2: api.commons.ForecastingParameters.historical_data_range_start_datetime:type_name -> google.protobuf.Timestamp
	34, // 3: api.commons.ForecastingParameters.forecast_datetime_range:type_name -> api.commons.DatetimeRange
	34, // 4: api.commons.ForecastingParameters.training_data_datetime_range:type_name -> api.commons.DatetimeRange
	36, // 5: api.commons.DistributionProfile.profile_tod:type_name -> api.commons.ProfileTOD
	37, // 6: api.commons.DistributionProfile.profile_woms:type_name -> api.commons.ProfileWOMS
	38, // 7: api.commons.DistributionProfile.profile_dow:type_name -> api.commons.ProfileDOW
	39, // 8: api.commons.DistributionProfile.profile_moy:type_name -> api.commons.ProfileMOY
	40, // 9: api.commons.CallProfileGroupCalls.distribution_profile:type_name -> api.commons.DistributionProfile
	40, // 10: api.commons.CallProfileGroupAvgs.distribution_profile:type_name -> api.commons.DistributionProfile
	...
	68, // 13: api.commons.ReasonCode.datetime_set_to_inactive:type_name -> google.protobuf.Timestamp
	14, // 14: api.commons.ScheduleSelector.schedule_type:type_name -> api.commons.ScheduleType
	32, // 15: api.commons.SkillProfileCategory.skill_profile_category_type:type_name -> api.commons.SkillProfileCategory.CategoryType
	46, // 16: api.commons.SchedulingResultMetricForSkillCollection.skill_collection:type_name -> api.commons.SkillProfileCategory
	47, // 17: api.commons.SchedulingResultMetric.metrics_by_skill_collection:type_name -> api.commons.SchedulingResultMetricForSkillCollection
	18, // 18: api.commons.ClientHistoryCacheInfo.state:type_name -> api.commons.HistoryCacheState
	19, // 19: api.commons.InitialSetupStatus.state:type_name -> api.commons.InitialSetupState
	20, // 20: api.commons.AgentStateSegment.states:type_name -> api.commons.RealTimeManagementState
	68, // 21: api.commons.AgentStateSequence.start_datetime:type_name -> google.protobuf.Timestamp
	52, // 22: api.commons.AgentStateSequence.state_segments:type_name -> api.commons.AgentStateSegment
	68, // 23: api.commons.AdherenceAgentState.start_datetime:type_name -> google.protobuf.Timestamp
	20, // 24: api.commons.AdherenceAgentState.adm_states:type_name -> api.commons.RealTimeManagementState
	68, // 25: api.commons.AdherenceAgentStateViolation.start_datetime:type_name -> google.protobuf.Timestamp
	20, // 26: api.commons.AdherenceAgentStateViolation.expected_rtm_states:type_name -> api.commons.RealTimeManagementState
	20, // 27: api.commons.AdherenceAgentStateViolation.actual_rtm_states:type_name -> api.commons.RealTimeManagementState
	54, // 28: api.commons.AdherenceAgentStates.agent_states:type_name -> api.commons.AdherenceAgentState
	55, // 29: api.commons.AdherenceAgentStateViolations.violations:type_name -> api.commons.AdherenceAgentStateViolation
	22, // 30: api.commons.AgentLeavePetition.petition_status:type_name -> api.commons.AgentLeavePetitionStatus
	34, // 31: api.commons.AgentLeavePetition.requested_datetime_ranges:type_name -> api.commons.DatetimeRange
	68, // 32: api.commons.AgentLeavePetition.created_time:type_name -> google.protobuf.Timestamp
	68, // 33: api.commons.AgentLeavePetition.archived_time:type_name -> google.protobuf.Timestamp
	68, // 34: api.commons.AgentLeavePetition.resolved_time:type_name -> google.protobuf.Timestamp
	3,  // 35: api.commons.ConfigEntity.entity_type:type_name -> api.commons.ConfigEntityType
	61, // 36: api.commons.AdherenceRuleNotificationConfig.entries:type_name -> api.commons.AdherenceRuleNotificationConfigEntry
	24, // 37: api.commons.AdherenceRuleNotificationConfigEntry.notification_medium:type_name -> api.commons.AdherenceRuleNotificationMedium
	27, // 38: api.commons.AdherenceDepartmentalRuleAction.action_type:type_name -> api.commons.AdherenceDepartmentalRuleActionType
	59, // 39: api.commons.AdherenceDepartmentalRule.selected_entity:type_name -> api.commons.ConfigEntity
	25, // 40: api.commons.AdherenceDepartmentalRule.rule_requirement_type:type_name -> api.commons.AdherenceRuleRequirementType
	26, // 41: api.commons.AdherenceDepartmentalRule.rule_range:type_name -> api.commons.AdherenceRuleRange
	34, // 42: api.commons.AdherenceDepartmentalRule.custom_range:type_name -> api.commons.DatetimeRange
	64, // 43: api.commons.AdherenceDepartmentalRule.rule_clauses:type_name -> api.commons.AdherenceDepartmentalRuleClause
	62, // 44: api.commons.AdherenceDepartmentalRuleClause.action:type_name -> api.commons.AdherenceDepartmentalRuleAction
	28, // 45: api.commons.AdherenceDepartmentalRuleClause.condition:type_name -> api.commons.AdherenceRuleCondition
	29, // 46: api.commons.AdherenceDepartmentalRuleClause.unit:type_name -> api.commons.AdherenceRuleUnit
	69, // 47: api.commons.AdherenceDepartmentalRuleClause.per_amount:type_name -> google.protobuf.Int32Value
	29, // 48: api.commons.AdherenceDepartmentalRuleClause.per_unit:type_name -> api.commons.AdherenceRuleUnit
	59, // 49: api.commons.AdherenceAgentRule.selected_entity:type_name -> api.commons.ConfigEntity
	25, // 50: api.commons.AdherenceAgentRule.rule_requirement_type:type_name -> api.commons.AdherenceRuleRequirementType
	67, // 51: api.commons.AdherenceAgentRule.rule_clauses:type_name -> api.commons.AdherenceAgentRuleClause
	30, // 52: api.commons.AdherenceAgentRuleAction.action_type:type_name -> api.commons.AdherenceAgentRuleActionType
	66, // 53: api.commons.AdherenceAgentRuleClause.action:type_name -> api.commons.AdherenceAgentRuleAction
	28, // 54: api.commons.AdherenceAgentRuleClause.condition:type_name -> api.commons.AdherenceRuleCondition
	29, // 55: api.commons.AdherenceAgentRuleClause.unit:type_name -> api.commons.AdherenceRuleUnit
