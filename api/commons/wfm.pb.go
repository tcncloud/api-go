...
type ClientHistoryCache struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ClientHistoryCache) Reset() {
	*x = ClientHistoryCache{}
	if protoimpl.UnsafeEnabled {
...
func (x *ClientHistoryCache) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClientHistoryCache) ProtoMessage() {}

func (x *ClientHistoryCache) ProtoReflect() protoreflect.Message {
	mi := &file_api_commons_wfm_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ClientHistoryCache.ProtoReflect.Descriptor instead.
func (*ClientHistoryCache) Descriptor() ([]byte, []int) {
	return file_api_commons_wfm_proto_rawDescGZIP(), []int{14}
}

func (x *ClientHistoryCache) GetState() HistoryCacheState {
	if x != nil {
		return x.State
	}
...
func (x *ClientHistoryCache) GetProgressPercentage() int32 {
	if x != nil {
...
var file_api_commons_wfm_proto_rawDesc = []byte{
	...
	0x61, 0x73, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x7b, 0x0a, 0x12, 0x43, 0x6c, 0x69, 0x65,
	0x6e, 0x74, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x43, 0x61, 0x63, 0x68, 0x65, 0x12, 0x34,
	...
	0x6e, 0x74, 0x61, 0x67, 0x65, 0x2a, 0xa8, 0x01, 0x0a, 0x1e, 0x52, 0x65, 0x67, 0x72, 0x65, 0x73,
	...
	0x54, 0x45, 0x52, 0x4e, 0x41, 0x4c, 0x5f, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x04, 0x2a, 0x9a,
	0x17, 0x0a, 0x0e, 0x44, 0x69, 0x61, 0x67, 0x6e, 0x6f, 0x73, 0x74, 0x69, 0x63, 0x43, 0x6f, 0x64,
	...
	0x52, 0x45, 0x4e, 0x54, 0x5f, 0x4e, 0x4f, 0x44, 0x45, 0x10, 0x42, 0x2a, 0xca, 0x01, 0x0a, 0x15,
	...
	0x44, 0x49, 0x4e, 0x47, 0x5f, 0x46, 0x41, 0x49, 0x4c, 0x45, 0x44, 0x10, 0x03, 0x42, 0x90, 0x01,
...
var file_api_commons_wfm_proto_goTypes = []interface{}{
	...
	(*ClientHistoryCache)(nil),                  // 34: api.commons.ClientHistoryCache
...
var file_api_commons_wfm_proto_depIdxs = []int32{
	...
	17, // 15: api.commons.ClientHistoryCache.state:type_name -> api.commons.HistoryCacheState
...
func file_api_commons_wfm_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_commons_wfm_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ClientHistoryCache); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
