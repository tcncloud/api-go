...
type LearningOpportunity struct {
	...
	//
	// Types that are assignable to OriginIdentifier:
	//
...
func (m *LearningOpportunity) GetOriginIdentifier() isLearningOpportunity_OriginIdentifier {
	if m != nil {
...
func (x *LearningOpportunity) GetEvaluationId() int64 {
	if x, ok := x.GetOriginIdentifier().(*LearningOpportunity_EvaluationId); ok {
...
func (x *LearningOpportunity) GetAutoEvaluationId() int64 {
	if x, ok := x.GetOriginIdentifier().(*LearningOpportunity_AutoEvaluationId); ok {
...
func (x *LearningOpportunity) GetSmartEvaluationId() int64 {
	if x, ok := x.GetOriginIdentifier().(*LearningOpportunity_SmartEvaluationId); ok {
...
func file_api_commons_agent_training_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_commons_agent_training_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_api_commons_agent_training_proto_msgTypes[1].Exporter = func(v any, i int) any {
