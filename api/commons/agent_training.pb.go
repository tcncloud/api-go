...
type LearningOpportunity struct {
	...
	Title                 string                    `protobuf:"bytes,10,opt,name=title,proto3" json:"title,omitempty"`                                                                // Title of the learning opportunity.
	Status                LearningOpportunityStatus `protobuf:"varint,11,opt,name=status,proto3,enum=api.commons.LearningOpportunityStatus" json:"status,omitempty"`                  // Current status (ex: OPEN, COMPLETED).
}
...
var file_api_commons_agent_training_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa6, 0x03, 0x0a, 0x13, 0x4c, 0x65, 0x61, 0x72, 0x6e,
	...
	0x26, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x73, 0x2e, 0x4c, 0x65,
	...
	0x4c, 0x45, 0x54, 0x45, 0x44, 0x10, 0x01, 0x42, 0x9a, 0x01, 0x0a, 0x0f, 0x63, 0x6f, 0x6d, 0x2e,
	0x61, 0x70, 0x69, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x73, 0x42, 0x12, 0x41, 0x67, 0x65,
	0x6e, 0x74, 0x54, 0x72, 0x61, 0x69, 0x6e, 0x69, 0x6e, 0x67, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50,
...
var file_api_commons_agent_training_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_api_commons_agent_training_proto_goTypes = []interface{}{
	...
	(*LearningOpportunity)(nil),    // 1: api.commons.LearningOpportunity
	(*CallIdentifier)(nil),         // 2: api.commons.CallIdentifier
	(CallType_Enum)(0),             // 3: api.commons.CallType.Enum
}
var file_api_commons_agent_training_proto_depIdxs = []int32{
	3, // 0: api.commons.LearningOpportunity.call_type:type_name -> api.commons.CallType.Enum
	0, // 1: api.commons.LearningOpportunity.status:type_name -> api.commons.LearningOpportunityStatus
	3, // 2: api.commons.CallIdentifier.type:type_name -> api.commons.CallType.Enum
