...
var file_services_omnichannel_asm_v1alpha1_service_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x69, 0x74, 0x69, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xda, 0x09,
	...
	0x73, 0x74, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x42, 0xa6, 0x02, 0x0a, 0x25, 0x63,
...
var file_services_omnichannel_asm_v1alpha1_service_proto_goTypes = []interface{}{
	...
	(*CreateSessionResponse)(nil),      // 6: services.omnichannel.asm.v1alpha1.CreateSessionResponse
	(*EndSessionResponse)(nil),         // 7: services.omnichannel.asm.v1alpha1.EndSessionResponse
	(*GetCurrentSessionResponse)(nil),  // 8: services.omnichannel.asm.v1alpha1.GetCurrentSessionResponse
	(*EnableVoiceResponse)(nil),        // 9: services.omnichannel.asm.v1alpha1.EnableVoiceResponse
	(*DisableVoiceResponse)(nil),       // 10: services.omnichannel.asm.v1alpha1.DisableVoiceResponse
...
var file_services_omnichannel_asm_v1alpha1_service_proto_depIdxs = []int32{
	...
	6,  // 6: services.omnichannel.asm.v1alpha1.AsmService.CreateSession:output_type -> services.omnichannel.asm.v1alpha1.CreateSessionResponse
	7,  // 7: services.omnichannel.asm.v1alpha1.AsmService.EndSession:output_type -> services.omnichannel.asm.v1alpha1.EndSessionResponse
	8,  // 8: services.omnichannel.asm.v1alpha1.AsmService.GetCurrentSession:output_type -> services.omnichannel.asm.v1alpha1.GetCurrentSessionResponse
	9,  // 9: services.omnichannel.asm.v1alpha1.AsmService.EnableVoice:output_type -> services.omnichannel.asm.v1alpha1.EnableVoiceResponse
	10, // 10: services.omnichannel.asm.v1alpha1.AsmService.DisableVoice:output_type -> services.omnichannel.asm.v1alpha1.DisableVoiceResponse
	11, // 11: services.omnichannel.asm.v1alpha1.AsmService.ListAsmUserDetails:output_type -> services.omnichannel.asm.v1alpha1.ListAsmUserDetailsResponse
