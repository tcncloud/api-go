...
var file_services_pbx_v2_service_proto_rawDesc = []byte{
	...
	0x54, 0x45, 0x47, 0x59, 0x5f, 0x4f, 0x52, 0x44, 0x45, 0x52, 0x45, 0x44, 0x10, 0x04, 0x32, 0xf4,
	0x0f, 0x0a, 0x0a, 0x50, 0x42, 0x58, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x9a, 0x01,
	...
	,
	...
	0x76, 0x32, 0x2f, 0x70, 0x62, 0x78, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x67, 0x65,
	0x74, 0x73, 0x69, 0x70, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x62, 0x79, 0x75, 0x73, 0x65,
	0x72, 0x69, 0x64, 0x12, 0xa6, 0x01, 0x0a, 0x0f, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x49, 0x50, 0x41,
...
var file_services_pbx_v2_service_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_services_pbx_v2_service_proto_goTypes = []any{
	...
	(*GetSIPAccountByUserIdRequest)(nil),  // 8: services.pbx.v2.GetSIPAccountByUserIdRequest
	(*GetSIPAccountByUserIdResponse)(nil), // 9: services.pbx.v2.GetSIPAccountByUserIdResponse
	(*GetSIPAccountRequest)(nil),          // 10: services.pbx.v2.GetSIPAccountRequest
	(*GetSIPAccountResponse)(nil),         // 11: services.pbx.v2.GetSIPAccountResponse
	(*GetPBXUserRequest)(nil),             // 12: services.pbx.v2.GetPBXUserRequest
	(*GetPBXUserResponse)(nil),            // 13: services.pbx.v2.GetPBXUserResponse
	(*ListRingGroupsRequest)(nil),         // 14: services.pbx.v2.ListRingGroupsRequest
	(*ListRingGroupsResponse)(nil),        // 15: services.pbx.v2.ListRingGroupsResponse
	(*GetRingGroupRequest)(nil),           // 16: services.pbx.v2.GetRingGroupRequest
	(*GetRingGroupResponse)(nil),          // 17: services.pbx.v2.GetRingGroupResponse
	(*UpdateSIPAccountRequest)(nil),       // 18: services.pbx.v2.UpdateSIPAccountRequest
	(*UpdateSIPAccountResponse)(nil),      // 19: services.pbx.v2.UpdateSIPAccountResponse
	(*UpdateRingGroupRequest)(nil),        // 20: services.pbx.v2.UpdateRingGroupRequest
	(*UpdateRingGroupResponse)(nil),       // 21: services.pbx.v2.UpdateRingGroupResponse
	(*AssignRandomExtensionRequest)(nil),  // 22: services.pbx.v2.AssignRandomExtensionRequest
	(*AssignRandomExtensionResponse)(nil), // 23: services.pbx.v2.AssignRandomExtensionResponse
	(*CreateRingGroupRequest)(nil),        // 24: services.pbx.v2.CreateRingGroupRequest
	(*CreateRingGroupResponse)(nil),       // 25: services.pbx.v2.CreateRingGroupResponse
	(*DeleteRingGroupRequest)(nil),        // 26: services.pbx.v2.DeleteRingGroupRequest
	(*DeleteRingGroupResponse)(nil),       // 27: services.pbx.v2.DeleteRingGroupResponse
...
var file_services_pbx_v2_service_proto_depIdxs = []int32{
	...
	2,  // 3: services.pbx.v2.GetSIPAccountByUserIdResponse.sip_account:type_name -> services.pbx.v2.SIPAccount
	2,  // 4: services.pbx.v2.GetSIPAccountResponse.sip_account:type_name -> services.pbx.v2.SIPAccount
	1,  // 5: services.pbx.v2.GetPBXUserResponse.user:type_name -> services.pbx.v2.PBXUser
	3,  // 6: services.pbx.v2.ListRingGroupsResponse.groups:type_name -> services.pbx.v2.RingGroup
	3,  // 7: services.pbx.v2.GetRingGroupResponse.group:type_name -> services.pbx.v2.RingGroup
	2,  // 8: services.pbx.v2.UpdateSIPAccountRequest.sip_account:type_name -> services.pbx.v2.SIPAccount
	28, // 9: services.pbx.v2.UpdateSIPAccountRequest.update_mask:type_name -> google.protobuf.FieldMask
	2,  // 10: services.pbx.v2.UpdateSIPAccountResponse.sip_account:type_name -> services.pbx.v2.SIPAccount
	3,  // 11: services.pbx.v2.UpdateRingGroupRequest.group:type_name -> services.pbx.v2.RingGroup
	28, // 12: services.pbx.v2.UpdateRingGroupRequest.update_mask:type_name -> google.protobuf.FieldMask
	3,  // 13: services.pbx.v2.UpdateRingGroupResponse.group:type_name -> services.pbx.v2.RingGroup
	3,  // 14: services.pbx.v2.CreateRingGroupRequest.group:type_name -> services.pbx.v2.RingGroup
	3,  // 15: services.pbx.v2.CreateRingGroupResponse.group:type_name -> services.pbx.v2.RingGroup
	4,  // 16: services.pbx.v2.PBXService.ListPBXUsers:input_type -> services.pbx.v2.ListPBXUsersRequest
	12, // 17: services.pbx.v2.PBXService.GetPBXUser:input_type -> services.pbx.v2.GetPBXUserRequest
	14, // 18: services.pbx.v2.PBXService.ListRingGroups:input_type -> services.pbx.v2.ListRingGroupsRequest
	16, // 19: services.pbx.v2.PBXService.GetRingGroup:input_type -> services.pbx.v2.GetRingGroupRequest
	10, // 20: services.pbx.v2.PBXService.GetSIPAccount:input_type -> services.pbx.v2.GetSIPAccountRequest
	8,  // 21: services.pbx.v2.PBXService.GetSIPAccountByUserId:input_type -> services.pbx.v2.GetSIPAccountByUserIdRequest
	6,  // 22: services.pbx.v2.PBXService.ListSIPAccounts:input_type -> services.pbx.v2.ListSIPAccountsRequest
	18, // 23: services.pbx.v2.PBXService.UpdateSIPAccount:input_type -> services.pbx.v2.UpdateSIPAccountRequest
	20, // 24: services.pbx.v2.PBXService.UpdateRingGroup:input_type -> services.pbx.v2.UpdateRingGroupRequest
	24, // 25: services.pbx.v2.PBXService.CreateRingGroup:input_type -> services.pbx.v2.CreateRingGroupRequest
	26, // 26: services.pbx.v2.PBXService.DeleteRingGroup:input_type -> services.pbx.v2.DeleteRingGroupRequest
	22, // 27: services.pbx.v2.PBXService.AssignRandomExtension:input_type -> services.pbx.v2.AssignRandomExtensionRequest
	5,  // 28: services.pbx.v2.PBXService.ListPBXUsers:output_type -> services.pbx.v2.ListPBXUsersResponse
	13, // 29: services.pbx.v2.PBXService.GetPBXUser:output_type -> services.pbx.v2.GetPBXUserResponse
	15, // 30: services.pbx.v2.PBXService.ListRingGroups:output_type -> services.pbx.v2.ListRingGroupsResponse
	17, // 31: services.pbx.v2.PBXService.GetRingGroup:output_type -> services.pbx.v2.GetRingGroupResponse
	11, // 32: services.pbx.v2.PBXService.GetSIPAccount:output_type -> services.pbx.v2.GetSIPAccountResponse
	9,  // 33: services.pbx.v2.PBXService.GetSIPAccountByUserId:output_type -> services.pbx.v2.GetSIPAccountByUserIdResponse
	7,  // 34: services.pbx.v2.PBXService.ListSIPAccounts:output_type -> services.pbx.v2.ListSIPAccountsResponse
	19, // 35: services.pbx.v2.PBXService.UpdateSIPAccount:output_type -> services.pbx.v2.UpdateSIPAccountResponse
	21, // 36: services.pbx.v2.PBXService.UpdateRingGroup:output_type -> services.pbx.v2.UpdateRingGroupResponse
	25, // 37: services.pbx.v2.PBXService.CreateRingGroup:output_type -> services.pbx.v2.CreateRingGroupResponse
	27, // 38: services.pbx.v2.PBXService.DeleteRingGroup:output_type -> services.pbx.v2.DeleteRingGroupResponse
	23, // 39: services.pbx.v2.PBXService.AssignRandomExtension:output_type -> services.pbx.v2.AssignRandomExtensionResponse
