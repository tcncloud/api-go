...
// UnimplementedExileCertificateManagerServiceServer must be embedded to have
...
func (UnimplementedExileCertificateManagerServiceServer) testEmbeddedByValue() {}
...
func RegisterExileCertificateManagerServiceServer(s grpc.ServiceRegistrar, srv ExileCertificateManagerServiceServer) {
	// If the following call pancis, it indicates UnimplementedExileCertificateManagerServiceServer was
