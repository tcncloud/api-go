...
const file_services_billing_v1alpha1_core_proto_rawDesc = "" +
	"\n" +
	...
	"\tdirection\x18\x02 \x01(\x0e2 .services.billing.v1alpha1.OrderR\tdirection*.\n" +
	"\x05Order\x12\x15\n" +
	"\x11ORDER_UNSPECIFIED\x10\x00\x12\x0e\n" +
	"\n" +
	"ORDER_DESC\x10\x01B\xf6\x01\n" +
	"\x1dcom.services.billing.v1alpha1B\tCoreProtoP\x01ZDgithub.com/tcncloud/api-go/services/billing/v1alpha1;billingv1alpha1\xa2\x02\x03SBX\xaa\x02\x19Services.Billing.V1alpha1\xca\x02\x19Services\\Billing\\V1alpha1\xe2\x02%Services\\Billing\\V1alpha1\\GPBMetadata\xea\x02\x1bServices::Billing::V1alpha1b\x06proto3"

var (
	file_services_billing_v1alpha1_core_proto_rawDescOnce sync.Once
	file_services_billing_v1alpha1_core_proto_rawDescData []byte
)
...
func file_services_billing_v1alpha1_core_proto_rawDescGZIP() []byte {
	file_services_billing_v1alpha1_core_proto_rawDescOnce.Do(func() {
		file_services_billing_v1alpha1_core_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_services_billing_v1alpha1_core_proto_rawDesc), len(file_services_billing_v1alpha1_core_proto_rawDesc)))
	})
...
func file_services_billing_v1alpha1_core_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_services_billing_v1alpha1_core_proto_rawDesc), len(file_services_billing_v1alpha1_core_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
