...
func file_services_billing_entities_v1alpha3_omni_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_services_billing_entities_v1alpha3_omni_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*OmniSmsConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_services_billing_entities_v1alpha3_omni_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*OmniSmsUnitConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
