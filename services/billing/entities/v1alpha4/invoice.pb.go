...
var file_services_billing_entities_v1alpha4_invoice_proto_rawDesc = []byte{
...
var (
	...
	file_services_billing_entities_v1alpha4_invoice_proto_rawDescData = file_services_billing_entities_v1alpha4_invoice_proto_rawDesc
)
...
func file_services_billing_entities_v1alpha4_invoice_proto_rawDescGZIP() []byte {
	file_services_billing_entities_v1alpha4_invoice_proto_rawDescOnce.Do(func() {
		file_services_billing_entities_v1alpha4_invoice_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_billing_entities_v1alpha4_invoice_proto_rawDescData)
	})
...
func file_services_billing_entities_v1alpha4_invoice_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_services_billing_entities_v1alpha4_invoice_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_services_billing_entities_v1alpha4_invoice_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_services_billing_entities_v1alpha4_invoice_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*InvoiceColumn); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_billing_entities_v1alpha4_invoice_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_services_billing_entities_v1alpha4_invoice_proto_rawDesc = nil
