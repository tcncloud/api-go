...
const file_services_billing_entities_v1alpha4_modules_proto_rawDesc = "" +
	"\n" +
	...
	"&com.services.billing.entities.v1alpha4B\fModulesProtoP\x01ZNgithub.com/tcncloud/api-go/services/billing/entities/v1alpha4;entitiesv1alpha4\xa2\x02\x03SBE\xaa\x02\"Services.Billing.Entities.V1alpha4\xca\x02\"Services\\Billing\\Entities\\V1alpha4\xe2\x02.Services\\Billing\\Entities\\V1alpha4\\GPBMetadata\xea\x02%Services::Billing::Entities::V1alpha4b\x06proto3"

var (
	file_services_billing_entities_v1alpha4_modules_proto_rawDescOnce sync.Once
	file_services_billing_entities_v1alpha4_modules_proto_rawDescData []byte
)
...
func file_services_billing_entities_v1alpha4_modules_proto_rawDescGZIP() []byte {
	file_services_billing_entities_v1alpha4_modules_proto_rawDescOnce.Do(func() {
		file_services_billing_entities_v1alpha4_modules_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_services_billing_entities_v1alpha4_modules_proto_rawDesc), len(file_services_billing_entities_v1alpha4_modules_proto_rawDesc)))
	})
...
func file_services_billing_entities_v1alpha4_modules_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_services_billing_entities_v1alpha4_modules_proto_rawDesc), len(file_services_billing_entities_v1alpha4_modules_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
