...
var file_services_billing_entities_v1alpha4_matching_proto_rawDesc = []byte{
	...
	0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x34, 0x22, 0x90, 0x01, 0x0a, 0x11, 0x43, 0x6f, 0x75, 0x6e,
	0x74, 0x72, 0x79, 0x43, 0x6f, 0x64, 0x65, 0x50, 0x72, 0x65, 0x66, 0x69, 0x78, 0x12, 0x21, 0x0a,
	...
	0x28, 0x09, 0x52, 0x08, 0x70, 0x72, 0x65, 0x66, 0x69, 0x78, 0x65, 0x73, 0x12, 0x28, 0x0a, 0x10,
	0x6d, 0x61, 0x74, 0x63, 0x68, 0x69, 0x6e, 0x67, 0x5f, 0x72, 0x75, 0x6c, 0x65, 0x5f, 0x69, 0x64,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x69, 0x6e, 0x67,
	0x52, 0x75, 0x6c, 0x65, 0x49, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x42, 0xb2, 0x02, 0x0a, 0x26, 0x63,
	...
	0x6c, 0x70, 0x68, 0x61, 0x34, 0x42, 0x0d, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x69, 0x6e, 0x67, 0x50,
...
var file_services_billing_entities_v1alpha4_matching_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_services_billing_entities_v1alpha4_matching_proto_goTypes = []any{
	(*CountryCodePrefix)(nil), // 0: services.billing.entities.v1alpha4.CountryCodePrefix
}
...
func file_services_billing_entities_v1alpha4_matching_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_services_billing_entities_v1alpha4_matching_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*CountryCodePrefix); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
