...
func file_services_billing_entities_v1alpha1_plan_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_services_billing_entities_v1alpha1_plan_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*BillingPlanSnapshot); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_services_billing_entities_v1alpha1_plan_proto_msgTypes[1].Exporter = func(v any, i int) any {
