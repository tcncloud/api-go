...
func file_services_billing_entities_v1alpha2_modules_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_services_billing_entities_v1alpha2_modules_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_services_billing_entities_v1alpha2_modules_proto_msgTypes[1].Exporter = func(v any, i int) any {
