...
var file_services_billing_entities_v1alpha2_matching_proto_rawDesc = []byte{
...
var (
	...
	file_services_billing_entities_v1alpha2_matching_proto_rawDescData = file_services_billing_entities_v1alpha2_matching_proto_rawDesc
)
...
func file_services_billing_entities_v1alpha2_matching_proto_rawDescGZIP() []byte {
	file_services_billing_entities_v1alpha2_matching_proto_rawDescOnce.Do(func() {
		file_services_billing_entities_v1alpha2_matching_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_billing_entities_v1alpha2_matching_proto_rawDescData)
	})
...
var file_services_billing_entities_v1alpha2_matching_proto_goTypes = []interface{}{
...
func file_services_billing_entities_v1alpha2_matching_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_services_billing_entities_v1alpha2_matching_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_billing_entities_v1alpha2_matching_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	file_services_billing_entities_v1alpha2_matching_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_billing_entities_v1alpha2_matching_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_services_billing_entities_v1alpha2_matching_proto_rawDesc = nil
