...
const file_services_billing_v1alpha4_defaults_proto_rawDesc = "" +
	"\n" +
	...
	"\x10billing_plan_ids\x18\x01 \x03(\tR\x0ebillingPlanIds\"^\n" +
	"\x1eCloneDefaultBillingPlanRequest\x12&\n" +
	"\x0fbilling_plan_id\x18\x01 \x01(\tR\rbillingPlanId\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\"I\n" +
	"\x1fCloneDefaultBillingPlanResponse\x12&\n" +
	...
	"\fbilling_plan\x18\x02 \x01(\v2/.services.billing.entities.v1alpha4.BillingPlanR\vbillingPlan\"J\n" +
	...
	"\fbilling_plan\x18\x01 \x01(\v2/.services.billing.entities.v1alpha4.BillingPlanR\vbillingPlan\"\xfe\x01\n" +
	...
	"\x04page\x18\x05 \x01(\v2\x1f.services.billing.v1alpha4.PageR\x04page\"\x8d\x01\n" +
	"\x1fListDefaultBillingPlansResponse\x12T\n" +
	"\rbilling_plans\x18\x01 \x03(\v2/.services.billing.entities.v1alpha4.BillingPlanR\fbillingPlans\x12\x14\n" +
	"\x05token\x18\x02 \x01(\tR\x05token\"\xda\x01\n" +
	"\x1fUpdateDefaultBillingPlanRequest\x12&\n" +
	"\x0fbilling_plan_id\x18\x01 \x01(\tR\rbillingPlanId\x12R\n" +
	"\fbilling_plan\x18\x02 \x01(\v2/.services.billing.entities.v1alpha4.BillingPlanR\vbillingPlan\x12;\n" +
	...
	"\x0frate_definition\x18\x02 \x01(\v22.services.billing.entities.v1alpha4.RateDefinitionR\x0erateDefinition\"S\n" +
	...
	"\x0frate_definition\x18\x01 \x01(\v22.services.billing.entities.v1alpha4.RateDefinitionR\x0erateDefinition\"\x87\x02\n" +
	"!ListDefaultRateDefinitionsRequest\x12,\n" +
	"\x12rate_definition_id\x18\x01 \x01(\tR\x10rateDefinitionId\x12\x16\n" +
	"\x06filter\x18\x02 \x01(\tR\x06filter\x122\n" +
	"\x06fields\x18\x03 \x01(\v2\x1a.google.protobuf.FieldMaskR\x06fields\x123\n" +
	"\x04sort\x18\x04 \x03(\v2\x1f.services.billing.v1alpha4.SortR\x04sort\x123\n" +
	"\x04page\x18\x05 \x01(\v2\x1f.services.billing.v1alpha4.PageR\x04page\"\x99\x01\n" +
	"\"ListDefaultRateDefinitionsResponse\x12]\n" +
	"\x10rate_definitions\x18\x01 \x03(\v22.services.billing.entities.v1alpha4.RateDefinitionR\x0frateDefinitions\x12\x14\n" +
	"\x05token\x18\x02 \x01(\tR\x05token\"\xec\x01\n" +
	"\"UpdateDefaultRateDefinitionRequest\x12,\n" +
	"\x12rate_definition_id\x18\x01 \x01(\tR\x10rateDefinitionId\x12[\n" +
	"\x0frate_definition\x18\x02 \x01(\v22.services.billing.entities.v1alpha4.RateDefinitionR\x0erateDefinition\x12;\n" +
	"\vupdate_mask\x18\x03 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"%\n" +
	"#UpdateDefaultRateDefinitionResponseB\xfa\x01\n" +
	"\x1dcom.services.billing.v1alpha4B\rDefaultsProtoP\x01ZDgithub.com/tcncloud/api-go/services/billing/v1alpha4;billingv1alpha4\xa2\x02\x03SBX\xaa\x02\x19Services.Billing.V1alpha4\xca\x02\x19Services\\Billing\\V1alpha4\xe2\x02%Services\\Billing\\V1alpha4\\GPBMetadata\xea\x02\x1bServices::Billing::V1alpha4b\x06proto3"
