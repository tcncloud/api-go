...
const file_services_billing_v1alpha2_invoices_proto_rawDesc = "" +
	"\n" +
	"(services/billing/v1alpha2/invoices.proto\x12\x19services.billing.v1alpha2\x1a\x1fgoogle/protobuf/timestamp.proto\x1a0services/billing/entities/v1alpha2/invoice.proto\"\x97\x01\n" +
	"\x14ExportInvoiceRequest\x12@\n" +
	"\x06format\x18\x01 \x01(\x0e2(.services.billing.v1alpha2.InvoiceFormatR\x06format\x12=\n" +
	"\finvoice_date\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\vinvoiceDate\"^\n" +
	"\x15ExportInvoiceResponse\x12E\n" +
	"\ainvoice\x18\x01 \x01(\v2+.services.billing.entities.v1alpha2.InvoiceR\ainvoice*G\n" +
	"\rInvoiceFormat\x12\x1e\n" +
	"\x1aINVOICE_FORMAT_UNSPECIFIED\x10\x00\x12\x16\n" +
	"\x12INVOICE_FORMAT_CSV\x10\x01B\xfa\x01\n" +
	"\x1dcom.services.billing.v1alpha2B\rInvoicesProtoP\x01ZDgithub.com/tcncloud/api-go/services/billing/v1alpha2;billingv1alpha2\xa2\x02\x03SBX\xaa\x02\x19Services.Billing.V1alpha2\xca\x02\x19Services\\Billing\\V1alpha2\xe2\x02%Services\\Billing\\V1alpha2\\GPBMetadata\xea\x02\x1bServices::Billing::V1alpha2b\x06proto3"
