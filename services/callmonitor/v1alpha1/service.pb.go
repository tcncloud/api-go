...
const file_services_callmonitor_v1alpha1_service_proto_rawDesc = "" +
	"\n" +
	"+services/callmonitor/v1alpha1/service.proto\x12\x1dservices.callmonitor.v1alpha1\x1a\x17annotations/authz.proto\x1a\x1dapi/commons/callmonitor.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xe3\x02\n" +
	"\x18GetHoldQueueStatsRequest\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x129\n" +
	"\n" +
	"start_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\x125\n" +
	"\bend_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\aendTime\x12V\n" +
	"\x06filter\x18\x04 \x01(\v2>.services.callmonitor.v1alpha1.GetHoldQueueStatsRequest.FilterR\x06filter\x1af\n" +
	"\x06Filter\x12;\n" +
	"\x06status\x18\x01 \x01(\x0e2#.api.commons.HoldQueueMonitorStatusR\x06status\x12\x1f\n" +
	"\vcampaign_id\x18\x03 \x01(\tR\n" +
	"campaignId\"\xbf\x02\n" +
	"\x19GetHoldQueueStatsResponse\x125\n" +
	"\x05stats\x18\x01 \x03(\v2\x1f.api.commons.HoldQueueCallStatsR\x05stats\x12&\n" +
	"\x0ftotal_num_calls\x18\x02 \x01(\x05R\rtotalNumCalls\x120\n" +
	"\x14total_num_successful\x18\x03 \x01(\x05R\x12totalNumSuccessful\x12(\n" +
	"\x10total_num_failed\x18\x04 \x01(\x05R\x0etotalNumFailed\x125\n" +
	"\x17avg_monitor_duration_ms\x18\x05 \x01(\x03R\x14avgMonitorDurationMs\x120\n" +
	"\x14total_num_monitoring\x18\x06 \x01(\x05R\x12totalNumMonitoring2\xe4\x01\n" +
	"\x12CallMonitorService\x12\xcd\x01\n" +
	"\x11GetHoldQueueStats\x127.services.callmonitor.v1alpha1.GetHoldQueueStatsRequest\x1a8.services.callmonitor.v1alpha1.GetHoldQueueStatsResponse\"E\xba\xb8\x91\x02\x05\n" +
	"\x03\b\xb0\t\x82\xd3\xe4\x93\x025:\x01*\"0/services/callmonitor/v1alpha1/getholdqueuestatsB\x95\x02\n" +
	"!com.services.callmonitor.v1alpha1B\fServiceProtoP\x01ZLgithub.com/tcncloud/api-go/services/callmonitor/v1alpha1;callmonitorv1alpha1\xa2\x02\x03SCX\xaa\x02\x1dServices.Callmonitor.V1alpha1\xca\x02\x1dServices\\Callmonitor\\V1alpha1\xe2\x02)Services\\Callmonitor\\V1alpha1\\GPBMetadata\xea\x02\x1fServices::Callmonitor::V1alpha1b\x06proto3"
