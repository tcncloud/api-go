...
var file_wfo_vanalytics_v2_flag_review_proto_rawDesc = []byte{
...
var (
	...
	file_wfo_vanalytics_v2_flag_review_proto_rawDescData = file_wfo_vanalytics_v2_flag_review_proto_rawDesc
)
...
func file_wfo_vanalytics_v2_flag_review_proto_rawDescGZIP() []byte {
	file_wfo_vanalytics_v2_flag_review_proto_rawDescOnce.Do(func() {
		file_wfo_vanalytics_v2_flag_review_proto_rawDescData = protoimpl.X.CompressGZIP(file_wfo_vanalytics_v2_flag_review_proto_rawDescData)
	})
...
var file_wfo_vanalytics_v2_flag_review_proto_goTypes = []interface{}{
...
func file_wfo_vanalytics_v2_flag_review_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_wfo_vanalytics_v2_flag_review_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_wfo_vanalytics_v2_flag_review_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_wfo_vanalytics_v2_flag_review_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_wfo_vanalytics_v2_flag_review_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_wfo_vanalytics_v2_flag_review_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_wfo_vanalytics_v2_flag_review_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_wfo_vanalytics_v2_flag_review_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_wfo_vanalytics_v2_flag_review_proto_rawDesc = nil
