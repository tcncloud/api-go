...
const file_wfo_vanalytics_v2_flag_snapshot_proto_rawDesc = "" +
	"\n" +
	...
	"\x0etranscript_sid\x18\a \x01(\x03R\rtranscriptSid\"\x8b\x01\n" +
	"\x19ListFlagSnapshotsResponse\x12&\n" +
	"\x0fnext_page_token\x18\x01 \x01(\tR\rnextPageToken\x12F\n" +
	"\x0eflag_snapshots\x18\x02 \x03(\v2\x1f.wfo.vanalytics.v2.FlagSnapshotR\rflagSnapshots\"\xa0\x06\n" +
	"\fFlagSnapshot\x12*\n" +
	...
	"mustNotify\x12E\n" +
	"\tbool_expr\x18\f \x01(\v2(.wfo.vanalytics.v2.FlagSnapshot.BoolExprR\bboolExpr\x128\n" +
	"\tdncl_list\x18\r \x03(\v2\x1b.wfo.vanalytics.v2.DnclListR\bdnclList\x1a\xae\x02\n" +
	"\bBoolExpr\x12:\n" +
	"\x03and\x18\x01 \x03(\v2(.wfo.vanalytics.v2.FlagSnapshot.BoolExprR\x03and\x128\n" +
	"\x02or\x18\x02 \x03(\v2(.wfo.vanalytics.v2.FlagSnapshot.BoolExprR\x02or\x12G\n" +
	"\x06filter\x18\x03 \x01(\v2/.wfo.vanalytics.v2.FlagSnapshot.BoolExpr.FilterR\x06filter\x12:\n" +
	"\x03not\x18\x04 \x01(\v2(.wfo.vanalytics.v2.FlagSnapshot.BoolExprR\x03not\x1a'\n" +
	"\x06Filter\x12\x1d\n" +
	"\n" +
	"filter_sid\x18\x01 \x01(\x03R\tfilterSidB\xcb\x01\n" +
	"\x15com.wfo.vanalytics.v2B\x11FlagSnapshotProtoP\x01Z9github.com/tcncloud/api-go/wfo/vanalytics/v2;vanalyticsv2\xa2\x02\x03WVX\xaa\x02\x11Wfo.Vanalytics.V2\xca\x02\x11Wfo\\Vanalytics\\V2\xe2\x02\x1dWfo\\Vanalytics\\V2\\GPBMetadata\xea\x02\x13Wfo::Vanalytics::V2b\x06proto3"

var (
	file_wfo_vanalytics_v2_flag_snapshot_proto_rawDescOnce sync.Once
	file_wfo_vanalytics_v2_flag_snapshot_proto_rawDescData []byte
)
...
func file_wfo_vanalytics_v2_flag_snapshot_proto_rawDescGZIP() []byte {
	file_wfo_vanalytics_v2_flag_snapshot_proto_rawDescOnce.Do(func() {
		file_wfo_vanalytics_v2_flag_snapshot_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_wfo_vanalytics_v2_flag_snapshot_proto_rawDesc), len(file_wfo_vanalytics_v2_flag_snapshot_proto_rawDesc)))
	})
...
func file_wfo_vanalytics_v2_flag_snapshot_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wfo_vanalytics_v2_flag_snapshot_proto_rawDesc), len(file_wfo_vanalytics_v2_flag_snapshot_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
