...
var file_wfo_vanalytics_v2_transcript_proto_rawDesc = []byte{
	...
	0x72, 0x79, 0x52, 0x0a, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x22, 0xf3,
	...
	0x6c, 0x2a, 0x2c, 0x0a, 0x07, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x12, 0x10, 0x0a, 0x0c,
...
var file_wfo_vanalytics_v2_transcript_proto_msgTypes = make([]protoimpl.MessageInfo, 92)
var file_wfo_vanalytics_v2_transcript_proto_goTypes = []interface{}{
	...
	(*FlagSummary_NeedReview)(nil),                           // 19: wfo.vanalytics.v2.FlagSummary.NeedReview
	(*FlagSummary_Flag)(nil),                                 // 20: wfo.vanalytics.v2.FlagSummary.Flag
	(*FlagSummary_Filter)(nil),                               // 21: wfo.vanalytics.v2.FlagSummary.Filter
	(*FlagSummary_Review)(nil),                               // 22: wfo.vanalytics.v2.FlagSummary.Review
	(*Sms_Phone)(nil),                                        // 23: wfo.vanalytics.v2.Sms.Phone
	(*Sms_Thread)(nil),                                       // 24: wfo.vanalytics.v2.Sms.Thread
	(*Sms_Segment)(nil),                                      // 25: wfo.vanalytics.v2.Sms.Segment
	nil,                                                      // 26: wfo.vanalytics.v2.Call.AgentResponseEntry
	(*Call_Phone)(nil),                                       // 27: wfo.vanalytics.v2.Call.Phone
	(*Call_AgentResponse)(nil),                               // 28: wfo.vanalytics.v2.Call.AgentResponse
	(*Call_Thread)(nil),                                      // 29: wfo.vanalytics.v2.Call.Thread
	(*Call_Segment)(nil),                                     // 30: wfo.vanalytics.v2.Call.Segment
	(*Call_TalkOver)(nil),                                    // 31: wfo.vanalytics.v2.Call.TalkOver
	(*Call_Silence)(nil),                                     // 32: wfo.vanalytics.v2.Call.Silence
	(*Call_TalkOver_Duration)(nil),                           // 33: wfo.vanalytics.v2.Call.TalkOver.Duration
	(*Call_TalkOver_Occurrence)(nil),                         // 34: wfo.vanalytics.v2.Call.TalkOver.Occurrence
	(*Call_Silence_Duration)(nil),                            // 35: wfo.vanalytics.v2.Call.Silence.Duration
	(*Call_Silence_Occurrence)(nil),                          // 36: wfo.vanalytics.v2.Call.Silence.Occurrence
	(*SearchTranscriptsResponse_Hit)(nil),                    // 37: wfo.vanalytics.v2.SearchTranscriptsResponse.Hit
	(*TranscriptQuery_Phone)(nil),                            // 38: wfo.vanalytics.v2.TranscriptQuery.Phone
	(*TranscriptQuery_TranscriptSid)(nil),                    // 39: wfo.vanalytics.v2.TranscriptQuery.TranscriptSid
	(*TranscriptQuery_Channel)(nil),                          // 40: wfo.vanalytics.v2.TranscriptQuery.Channel
	(*TranscriptQuery_Metadata)(nil),                         // 41: wfo.vanalytics.v2.TranscriptQuery.Metadata
	(*TranscriptQuery_Call)(nil),                             // 42: wfo.vanalytics.v2.TranscriptQuery.Call
	(*TranscriptQuery_Sms)(nil),                              // 43: wfo.vanalytics.v2.TranscriptQuery.Sms
	(*TranscriptQuery_Threads)(nil),                          // 44: wfo.vanalytics.v2.TranscriptQuery.Threads
	(*TranscriptQuery_FlagSummary)(nil),                      // 45: wfo.vanalytics.v2.TranscriptQuery.FlagSummary
	(*TranscriptQuery_StartTime)(nil),                        // 46: wfo.vanalytics.v2.TranscriptQuery.StartTime
	(*TranscriptQuery_DeleteTime)(nil),                       // 47: wfo.vanalytics.v2.TranscriptQuery.DeleteTime
	(*TranscriptQuery_Phone_Cc)(nil),                         // 48: wfo.vanalytics.v2.TranscriptQuery.Phone.Cc
	(*TranscriptQuery_Phone_Ndc)(nil),                        // 49: wfo.vanalytics.v2.TranscriptQuery.Phone.Ndc
	(*TranscriptQuery_Phone_Prefix)(nil),                     // 50: wfo.vanalytics.v2.TranscriptQuery.Phone.Prefix
	(*TranscriptQuery_Phone_City)(nil),                       // 51: wfo.vanalytics.v2.TranscriptQuery.Phone.City
	(*TranscriptQuery_Phone_Iso2)(nil),                       // 52: wfo.vanalytics.v2.TranscriptQuery.Phone.Iso2
	(*TranscriptQuery_Phone_RegionCode)(nil),                 // 53: wfo.vanalytics.v2.TranscriptQuery.Phone.RegionCode
	(*TranscriptQuery_Phone_RegionName)(nil),                 // 54: wfo.vanalytics.v2.TranscriptQuery.Phone.RegionName
	(*TranscriptQuery_Phone_TimeZone)(nil),                   // 55: wfo.vanalytics.v2.TranscriptQuery.Phone.TimeZone
	(*TranscriptQuery_Phone_Type)(nil),                       // 56: wfo.vanalytics.v2.TranscriptQuery.Phone.Type
	(*TranscriptQuery_Phone_Utc)(nil),                        // 57: wfo.vanalytics.v2.TranscriptQuery.Phone.Utc
	(*TranscriptQuery_Phone_Location)(nil),                   // 58: wfo.vanalytics.v2.TranscriptQuery.Phone.Location
	(*TranscriptQuery_Phone_Raw)(nil),                        // 59: wfo.vanalytics.v2.TranscriptQuery.Phone.Raw
	(*TranscriptQuery_Phone_Location_ZipCodeProximity)(nil),  // 60: wfo.vanalytics.v2.TranscriptQuery.Phone.Location.ZipCodeProximity
	(*TranscriptQuery_Call_HuntGroupSids)(nil),               // 61: wfo.vanalytics.v2.TranscriptQuery.Call.HuntGroupSids
	(*TranscriptQuery_Call_AgentResponse)(nil),               // 62: wfo.vanalytics.v2.TranscriptQuery.Call.AgentResponse
	(*TranscriptQuery_Call_CallType)(nil),                    // 63: wfo.vanalytics.v2.TranscriptQuery.Call.CallType
	(*TranscriptQuery_Call_GroupName)(nil),                   // 64: wfo.vanalytics.v2.TranscriptQuery.Call.GroupName
	(*TranscriptQuery_Call_CallSid)(nil),                     // 65: wfo.vanalytics.v2.TranscriptQuery.Call.CallSid
	(*TranscriptQuery_Call_CallerId)(nil),                    // 66: wfo.vanalytics.v2.TranscriptQuery.Call.CallerId
	(*TranscriptQuery_Call_AudioTime)(nil),                   // 67: wfo.vanalytics.v2.TranscriptQuery.Call.AudioTime
	(*TranscriptQuery_Call_TalkTime)(nil),                    // 68: wfo.vanalytics.v2.TranscriptQuery.Call.TalkTime
	(*TranscriptQuery_Call_TalkOver)(nil),                    // 69: wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver
	(*TranscriptQuery_Call_Silence)(nil),                     // 70: wfo.vanalytics.v2.TranscriptQuery.Call.Silence
	(*TranscriptQuery_Call_AgentResponse_Values)(nil),        // 71: wfo.vanalytics.v2.TranscriptQuery.Call.AgentResponse.Values
	(*TranscriptQuery_Call_AgentResponse_Numbers)(nil),       // 72: wfo.vanalytics.v2.TranscriptQuery.Call.AgentResponse.Numbers
	(*TranscriptQuery_Call_AgentResponse_Key)(nil),           // 73: wfo.vanalytics.v2.TranscriptQuery.Call.AgentResponse.Key
	(*TranscriptQuery_Call_TalkOver_DurationTotal)(nil),      // 74: wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver.DurationTotal
	(*TranscriptQuery_Call_TalkOver_DurationMax)(nil),        // 75: wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver.DurationMax
	(*TranscriptQuery_Call_TalkOver_OccurrenceTotal)(nil),    // 76: wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver.OccurrenceTotal
	(*TranscriptQuery_Call_TalkOver_DurationPercentage)(nil), // 77: wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver.DurationPercentage
	(*TranscriptQuery_Call_Silence_DurationTotal)(nil),       // 78: wfo.vanalytics.v2.TranscriptQuery.Call.Silence.DurationTotal
	(*TranscriptQuery_Call_Silence_DurationMax)(nil),         // 79: wfo.vanalytics.v2.TranscriptQuery.Call.Silence.DurationMax
	(*TranscriptQuery_Call_Silence_OccurrenceTotal)(nil),     // 80: wfo.vanalytics.v2.TranscriptQuery.Call.Silence.OccurrenceTotal
	(*TranscriptQuery_Call_Silence_DurationPercentage)(nil),  // 81: wfo.vanalytics.v2.TranscriptQuery.Call.Silence.DurationPercentage
	(*TranscriptQuery_Sms_ConversationSid)(nil),              // 82: wfo.vanalytics.v2.TranscriptQuery.Sms.ConversationSid
	(*TranscriptQuery_Threads_UserId)(nil),                   // 83: wfo.vanalytics.v2.TranscriptQuery.Threads.UserId
	(*TranscriptQuery_Threads_Id)(nil),                       // 84: wfo.vanalytics.v2.TranscriptQuery.Threads.Id
	(*TranscriptQuery_Threads_Text)(nil),                     // 85: wfo.vanalytics.v2.TranscriptQuery.Threads.Text
	(*TranscriptQuery_Threads_Text_Timespan)(nil),            // 86: wfo.vanalytics.v2.TranscriptQuery.Threads.Text.Timespan
	(*TranscriptQuery_FlagSummary_NeedReview)(nil),           // 87: wfo.vanalytics.v2.TranscriptQuery.FlagSummary.NeedReview
	(*TranscriptQuery_FlagSummary_ReviewStatus)(nil),         // 88: wfo.vanalytics.v2.TranscriptQuery.FlagSummary.ReviewStatus
	(*TranscriptQuery_FlagSummary_Flags)(nil),                // 89: wfo.vanalytics.v2.TranscriptQuery.FlagSummary.Flags
	(*TranscriptQuery_FlagSummary_Count)(nil),                // 90: wfo.vanalytics.v2.TranscriptQuery.FlagSummary.Count
	(*TranscriptQuery_FlagSummary_NeedReview_FlagSids)(nil),  // 91: wfo.vanalytics.v2.TranscriptQuery.FlagSummary.NeedReview.FlagSids
	(*TranscriptQuery_FlagSummary_Flags_FlagSid)(nil),        // 92: wfo.vanalytics.v2.TranscriptQuery.FlagSummary.Flags.FlagSid
	(*SpanNear_Clause)(nil),                                  // 93: wfo.vanalytics.v2.SpanNear.Clause
	(*timestamppb.Timestamp)(nil),                            // 94: google.protobuf.Timestamp
	(commons.CallType_Enum)(0),                               // 95: api.commons.CallType.Enum
	(*durationpb.Duration)(nil),                              // 96: google.protobuf.Duration
	(*AgentCallLog)(nil),                                     // 97: wfo.vanalytics.v2.AgentCallLog
	(*fieldmaskpb.FieldMask)(nil),                            // 98: google.protobuf.FieldMask
	(commons.Interval)(0),                                    // 99: api.commons.Interval
	(*AgentCallLogQuery)(nil),                                // 100: wfo.vanalytics.v2.AgentCallLogQuery
...
var file_wfo_vanalytics_v2_transcript_proto_depIdxs = []int32{
	...
	94,  // 3: wfo.vanalytics.v2.Transcript.start_time:type_name -> google.protobuf.Timestamp
	94,  // 4: wfo.vanalytics.v2.Transcript.delete_time:type_name -> google.protobuf.Timestamp
	3,   // 5: wfo.vanalytics.v2.Transcript.flag_summary:type_name -> wfo.vanalytics.v2.FlagSummary
	19,  // 6: wfo.vanalytics.v2.FlagSummary.need_review:type_name -> wfo.vanalytics.v2.FlagSummary.NeedReview
	20,  // 7: wfo.vanalytics.v2.FlagSummary.flags:type_name -> wfo.vanalytics.v2.FlagSummary.Flag
	1,   // 8: wfo.vanalytics.v2.FlagSummary.review_status:type_name -> wfo.vanalytics.v2.ReviewStatus
	24,  // 9: wfo.vanalytics.v2.Sms.threads:type_name -> wfo.vanalytics.v2.Sms.Thread
	23,  // 10: wfo.vanalytics.v2.Sms.phone:type_name -> wfo.vanalytics.v2.Sms.Phone
	95,  // 11: wfo.vanalytics.v2.Call.call_type:type_name -> api.commons.CallType.Enum
	29,  // 12: wfo.vanalytics.v2.Call.threads:type_name -> wfo.vanalytics.v2.Call.Thread
	32,  // 13: wfo.vanalytics.v2.Call.silence:type_name -> wfo.vanalytics.v2.Call.Silence
	31,  // 14: wfo.vanalytics.v2.Call.talk_over:type_name -> wfo.vanalytics.v2.Call.TalkOver
	96,  // 15: wfo.vanalytics.v2.Call.talk_time:type_name -> google.protobuf.Duration
	26,  // 16: wfo.vanalytics.v2.Call.agent_response:type_name -> wfo.vanalytics.v2.Call.AgentResponseEntry
	97,  // 17: wfo.vanalytics.v2.Call.agent_call_log:type_name -> wfo.vanalytics.v2.AgentCallLog
	27,  // 18: wfo.vanalytics.v2.Call.phone:type_name -> wfo.vanalytics.v2.Call.Phone
	98,  // 19: wfo.vanalytics.v2.SearchTranscriptsRequest.read_mask:type_name -> google.protobuf.FieldMask
	...
	37,  // 22: wfo.vanalytics.v2.SearchTranscriptsResponse.hits:type_name -> wfo.vanalytics.v2.SearchTranscriptsResponse.Hit
	10,  // 23: wfo.vanalytics.v2.TranscriptBoolQuery.transcript:type_name -> wfo.vanalytics.v2.TranscriptQuery
	39,  // 24: wfo.vanalytics.v2.TranscriptQuery.transcript_sid:type_name -> wfo.vanalytics.v2.TranscriptQuery.TranscriptSid
	40,  // 25: wfo.vanalytics.v2.TranscriptQuery.channel:type_name -> wfo.vanalytics.v2.TranscriptQuery.Channel
	41,  // 26: wfo.vanalytics.v2.TranscriptQuery.metadata:type_name -> wfo.vanalytics.v2.TranscriptQuery.Metadata
	44,  // 27: wfo.vanalytics.v2.TranscriptQuery.threads:type_name -> wfo.vanalytics.v2.TranscriptQuery.Threads
	45,  // 28: wfo.vanalytics.v2.TranscriptQuery.flag_summary:type_name -> wfo.vanalytics.v2.TranscriptQuery.FlagSummary
	46,  // 29: wfo.vanalytics.v2.TranscriptQuery.start_time:type_name -> wfo.vanalytics.v2.TranscriptQuery.StartTime
	47,  // 30: wfo.vanalytics.v2.TranscriptQuery.delete_time:type_name -> wfo.vanalytics.v2.TranscriptQuery.DeleteTime
	38,  // 31: wfo.vanalytics.v2.TranscriptQuery.phone:type_name -> wfo.vanalytics.v2.TranscriptQuery.Phone
	99,  // 32: wfo.vanalytics.v2.Moment.interval:type_name -> api.commons.Interval
	12,  // 33: wfo.vanalytics.v2.Match.fuzziness_auto:type_name -> wfo.vanalytics.v2.FuzzinessAuto
	93,  // 34: wfo.vanalytics.v2.SpanNear.clauses:type_name -> wfo.vanalytics.v2.SpanNear.Clause
	12,  // 35: wfo.vanalytics.v2.SpanFuzzy.fuzziness_auto:type_name -> wfo.vanalytics.v2.FuzzinessAuto
	10,  // 36: wfo.vanalytics.v2.BulkDeleteTranscriptsRequest.query:type_name -> wfo.vanalytics.v2.TranscriptQuery
	21,  // 37: wfo.vanalytics.v2.FlagSummary.Flag.filters:type_name -> wfo.vanalytics.v2.FlagSummary.Filter
	22,  // 38: wfo.vanalytics.v2.FlagSummary.Flag.reviews:type_name -> wfo.vanalytics.v2.FlagSummary.Review
	25,  // 39: wfo.vanalytics.v2.Sms.Thread.segments:type_name -> wfo.vanalytics.v2.Sms.Segment
	96,  // 40: wfo.vanalytics.v2.Sms.Segment.offset:type_name -> google.protobuf.Duration
	28,  // 41: wfo.vanalytics.v2.Call.AgentResponseEntry.value:type_name -> wfo.vanalytics.v2.Call.AgentResponse
	30,  // 42: wfo.vanalytics.v2.Call.Thread.segments:type_name -> wfo.vanalytics.v2.Call.Segment
	96,  // 43: wfo.vanalytics.v2.Call.Segment.offset:type_name -> google.protobuf.Duration
	96,  // 44: wfo.vanalytics.v2.Call.Segment.duration:type_name -> google.protobuf.Duration
	33,  // 45: wfo.vanalytics.v2.Call.TalkOver.duration:type_name -> wfo.vanalytics.v2.Call.TalkOver.Duration
	34,  // 46: wfo.vanalytics.v2.Call.TalkOver.occurrence:type_name -> wfo.vanalytics.v2.Call.TalkOver.Occurrence
	35,  // 47: wfo.vanalytics.v2.Call.Silence.duration:type_name -> wfo.vanalytics.v2.Call.Silence.Duration
	36,  // 48: wfo.vanalytics.v2.Call.Silence.occurrence:type_name -> wfo.vanalytics.v2.Call.Silence.Occurrence
	96,  // 49: wfo.vanalytics.v2.Call.TalkOver.Duration.total:type_name -> google.protobuf.Duration
	96,  // 50: wfo.vanalytics.v2.Call.TalkOver.Duration.max:type_name -> google.protobuf.Duration
	96,  // 51: wfo.vanalytics.v2.Call.Silence.Duration.total:type_name -> google.protobuf.Duration
	96,  // 52: wfo.vanalytics.v2.Call.Silence.Duration.max:type_name -> google.protobuf.Duration
	2,   // 53: wfo.vanalytics.v2.SearchTranscriptsResponse.Hit.transcript:type_name -> wfo.vanalytics.v2.Transcript
	48,  // 54: wfo.vanalytics.v2.TranscriptQuery.Phone.cc:type_name -> wfo.vanalytics.v2.TranscriptQuery.Phone.Cc
	49,  // 55: wfo.vanalytics.v2.TranscriptQuery.Phone.ndc:type_name -> wfo.vanalytics.v2.TranscriptQuery.Phone.Ndc
	50,  // 56: wfo.vanalytics.v2.TranscriptQuery.Phone.prefix:type_name -> wfo.vanalytics.v2.TranscriptQuery.Phone.Prefix
	51,  // 57: wfo.vanalytics.v2.TranscriptQuery.Phone.city:type_name -> wfo.vanalytics.v2.TranscriptQuery.Phone.City
	52,  // 58: wfo.vanalytics.v2.TranscriptQuery.Phone.iso2:type_name -> wfo.vanalytics.v2.TranscriptQuery.Phone.Iso2
	53,  // 59: wfo.vanalytics.v2.TranscriptQuery.Phone.region_code:type_name -> wfo.vanalytics.v2.TranscriptQuery.Phone.RegionCode
	54,  // 60: wfo.vanalytics.v2.TranscriptQuery.Phone.region_name:type_name -> wfo.vanalytics.v2.TranscriptQuery.Phone.RegionName
	55,  // 61: wfo.vanalytics.v2.TranscriptQuery.Phone.time_zone:type_name -> wfo.vanalytics.v2.TranscriptQuery.Phone.TimeZone
	56,  // 62: wfo.vanalytics.v2.TranscriptQuery.Phone.type:type_name -> wfo.vanalytics.v2.TranscriptQuery.Phone.Type
	57,  // 63: wfo.vanalytics.v2.TranscriptQuery.Phone.utc:type_name -> wfo.vanalytics.v2.TranscriptQuery.Phone.Utc
	58,  // 64: wfo.vanalytics.v2.TranscriptQuery.Phone.location:type_name -> wfo.vanalytics.v2.TranscriptQuery.Phone.Location
	59,  // 65: wfo.vanalytics.v2.TranscriptQuery.Phone.raw:type_name -> wfo.vanalytics.v2.TranscriptQuery.Phone.Raw
	0,   // 66: wfo.vanalytics.v2.TranscriptQuery.Channel.any:type_name -> wfo.vanalytics.v2.Channel
	42,  // 67: wfo.vanalytics.v2.TranscriptQuery.Metadata.call:type_name -> wfo.vanalytics.v2.TranscriptQuery.Call
	43,  // 68: wfo.vanalytics.v2.TranscriptQuery.Metadata.sms:type_name -> wfo.vanalytics.v2.TranscriptQuery.Sms
	65,  // 69: wfo.vanalytics.v2.TranscriptQuery.Call.call_sid:type_name -> wfo.vanalytics.v2.TranscriptQuery.Call.CallSid
	67,  // 70: wfo.vanalytics.v2.TranscriptQuery.Call.audio_time:type_name -> wfo.vanalytics.v2.TranscriptQuery.Call.AudioTime
	63,  // 71: wfo.vanalytics.v2.TranscriptQuery.Call.call_type:type_name -> wfo.vanalytics.v2.TranscriptQuery.Call.CallType
	70,  // 72: wfo.vanalytics.v2.TranscriptQuery.Call.silence:type_name -> wfo.vanalytics.v2.TranscriptQuery.Call.Silence
	69,  // 73: wfo.vanalytics.v2.TranscriptQuery.Call.talk_over:type_name -> wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver
	68,  // 74: wfo.vanalytics.v2.TranscriptQuery.Call.talk_time:type_name -> wfo.vanalytics.v2.TranscriptQuery.Call.TalkTime
	66,  // 75: wfo.vanalytics.v2.TranscriptQuery.Call.caller_id:type_name -> wfo.vanalytics.v2.TranscriptQuery.Call.CallerId
	64,  // 76: wfo.vanalytics.v2.TranscriptQuery.Call.group_name:type_name -> wfo.vanalytics.v2.TranscriptQuery.Call.GroupName
	62,  // 77: wfo.vanalytics.v2.TranscriptQuery.Call.agent_response:type_name -> wfo.vanalytics.v2.TranscriptQuery.Call.AgentResponse
	61,  // 78: wfo.vanalytics.v2.TranscriptQuery.Call.hunt_group_sids:type_name -> wfo.vanalytics.v2.TranscriptQuery.Call.HuntGroupSids
	100, // 79: wfo.vanalytics.v2.TranscriptQuery.Call.agent_call_log:type_name -> wfo.vanalytics.v2.AgentCallLogQuery
	82,  // 80: wfo.vanalytics.v2.TranscriptQuery.Sms.conversation_sid:type_name -> wfo.vanalytics.v2.TranscriptQuery.Sms.ConversationSid
	44,  // 81: wfo.vanalytics.v2.TranscriptQuery.Threads.and:type_name -> wfo.vanalytics.v2.TranscriptQuery.Threads
	44,  // 82: wfo.vanalytics.v2.TranscriptQuery.Threads.or:type_name -> wfo.vanalytics.v2.TranscriptQuery.Threads
	84,  // 83: wfo.vanalytics.v2.TranscriptQuery.Threads.id:type_name -> wfo.vanalytics.v2.TranscriptQuery.Threads.Id
	85,  // 84: wfo.vanalytics.v2.TranscriptQuery.Threads.text:type_name -> wfo.vanalytics.v2.TranscriptQuery.Threads.Text
	83,  // 85: wfo.vanalytics.v2.TranscriptQuery.Threads.user_id:type_name -> wfo.vanalytics.v2.TranscriptQuery.Threads.UserId
	87,  // 86: wfo.vanalytics.v2.TranscriptQuery.FlagSummary.need_review:type_name -> wfo.vanalytics.v2.TranscriptQuery.FlagSummary.NeedReview
	88,  // 87: wfo.vanalytics.v2.TranscriptQuery.FlagSummary.review_status:type_name -> wfo.vanalytics.v2.TranscriptQuery.FlagSummary.ReviewStatus
	89,  // 88: wfo.vanalytics.v2.TranscriptQuery.FlagSummary.flags:type_name -> wfo.vanalytics.v2.TranscriptQuery.FlagSummary.Flags
	90,  // 89: wfo.vanalytics.v2.TranscriptQuery.FlagSummary.count:type_name -> wfo.vanalytics.v2.TranscriptQuery.FlagSummary.Count
	94,  // 90: wfo.vanalytics.v2.TranscriptQuery.StartTime.gte:type_name -> google.protobuf.Timestamp
	94,  // 91: wfo.vanalytics.v2.TranscriptQuery.StartTime.lte:type_name -> google.protobuf.Timestamp
	94,  // 92: wfo.vanalytics.v2.TranscriptQuery.StartTime.gt:type_name -> google.protobuf.Timestamp
	94,  // 93: wfo.vanalytics.v2.TranscriptQuery.StartTime.lt:type_name -> google.protobuf.Timestamp
	11,  // 94: wfo.vanalytics.v2.TranscriptQuery.StartTime.moment:type_name -> wfo.vanalytics.v2.Moment
	94,  // 95: wfo.vanalytics.v2.TranscriptQuery.DeleteTime.gte:type_name -> google.protobuf.Timestamp
	94,  // 96: wfo.vanalytics.v2.TranscriptQuery.DeleteTime.lte:type_name -> google.protobuf.Timestamp
	94,  // 97: wfo.vanalytics.v2.TranscriptQuery.DeleteTime.gt:type_name -> google.protobuf.Timestamp
	94,  // 98: wfo.vanalytics.v2.TranscriptQuery.DeleteTime.lt:type_name -> google.protobuf.Timestamp
	60,  // 99: wfo.vanalytics.v2.TranscriptQuery.Phone.Location.zip_code_proximity:type_name -> wfo.vanalytics.v2.TranscriptQuery.Phone.Location.ZipCodeProximity
	62,  // 100: wfo.vanalytics.v2.TranscriptQuery.Call.AgentResponse.and:type_name -> wfo.vanalytics.v2.TranscriptQuery.Call.AgentResponse
	62,  // 101: wfo.vanalytics.v2.TranscriptQuery.Call.AgentResponse.or:type_name -> wfo.vanalytics.v2.TranscriptQuery.Call.AgentResponse
	73,  // 102: wfo.vanalytics.v2.TranscriptQuery.Call.AgentResponse.key:type_name -> wfo.vanalytics.v2.TranscriptQuery.Call.AgentResponse.Key
	71,  // 103: wfo.vanalytics.v2.TranscriptQuery.Call.AgentResponse.values:type_name -> wfo.vanalytics.v2.TranscriptQuery.Call.AgentResponse.Values
	72,  // 104: wfo.vanalytics.v2.TranscriptQuery.Call.AgentResponse.numbers:type_name -> wfo.vanalytics.v2.TranscriptQuery.Call.AgentResponse.Numbers
	95,  // 105: wfo.vanalytics.v2.TranscriptQuery.Call.CallType.any:type_name -> api.commons.CallType.Enum
	101, // 106: wfo.vanalytics.v2.TranscriptQuery.Call.AudioTime.gte:type_name -> google.protobuf.Int32Value
	101, // 107: wfo.vanalytics.v2.TranscriptQuery.Call.AudioTime.lte:type_name -> google.protobuf.Int32Value
	101, // 108: wfo.vanalytics.v2.TranscriptQuery.Call.AudioTime.gt:type_name -> google.protobuf.Int32Value
	101, // 109: wfo.vanalytics.v2.TranscriptQuery.Call.AudioTime.lt:type_name -> google.protobuf.Int32Value
	96,  // 110: wfo.vanalytics.v2.TranscriptQuery.Call.TalkTime.gte:type_name -> google.protobuf.Duration
	96,  // 111: wfo.vanalytics.v2.TranscriptQuery.Call.TalkTime.lte:type_name -> google.protobuf.Duration
	96,  // 112: wfo.vanalytics.v2.TranscriptQuery.Call.TalkTime.gt:type_name -> google.protobuf.Duration
	96,  // 113: wfo.vanalytics.v2.TranscriptQuery.Call.TalkTime.lt:type_name -> google.protobuf.Duration
	74,  // 114: wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver.duration_total:type_name -> wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver.DurationTotal
	75,  // 115: wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver.duration_max:type_name -> wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver.DurationMax
	76,  // 116: wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver.occurrence_total:type_name -> wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver.OccurrenceTotal
	77,  // 117: wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver.duration_percentage:type_name -> wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver.DurationPercentage
	78,  // 118: wfo.vanalytics.v2.TranscriptQuery.Call.Silence.duration_total:type_name -> wfo.vanalytics.v2.TranscriptQuery.Call.Silence.DurationTotal
	79,  // 119: wfo.vanalytics.v2.TranscriptQuery.Call.Silence.duration_max:type_name -> wfo.vanalytics.v2.TranscriptQuery.Call.Silence.DurationMax
	80,  // 120: wfo.vanalytics.v2.TranscriptQuery.Call.Silence.occurrence_total:type_name -> wfo.vanalytics.v2.TranscriptQuery.Call.Silence.OccurrenceTotal
	81,  // 121: wfo.vanalytics.v2.TranscriptQuery.Call.Silence.duration_percentage:type_name -> wfo.vanalytics.v2.TranscriptQuery.Call.Silence.DurationPercentage
	102, // 122: wfo.vanalytics.v2.TranscriptQuery.Call.AgentResponse.Numbers.gte:type_name -> google.protobuf.DoubleValue
	102, // 123: wfo.vanalytics.v2.TranscriptQuery.Call.AgentResponse.Numbers.lte:type_name -> google.protobuf.DoubleValue
	102, // 124: wfo.vanalytics.v2.TranscriptQuery.Call.AgentResponse.Numbers.gt:type_name -> google.protobuf.DoubleValue
	102, // 125: wfo.vanalytics.v2.TranscriptQuery.Call.AgentResponse.Numbers.lt:type_name -> google.protobuf.DoubleValue
	102, // 126: wfo.vanalytics.v2.TranscriptQuery.Call.AgentResponse.Numbers.eq:type_name -> google.protobuf.DoubleValue
	96,  // 127: wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver.DurationTotal.gte:type_name -> google.protobuf.Duration
	96,  // 128: wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver.DurationTotal.lte:type_name -> google.protobuf.Duration
	96,  // 129: wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver.DurationTotal.gt:type_name -> google.protobuf.Duration
	96,  // 130: wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver.DurationTotal.lt:type_name -> google.protobuf.Duration
	96,  // 131: wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver.DurationMax.gte:type_name -> google.protobuf.Duration
	96,  // 132: wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver.DurationMax.lte:type_name -> google.protobuf.Duration
	96,  // 133: wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver.DurationMax.gt:type_name -> google.protobuf.Duration
	96,  // 134: wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver.DurationMax.lt:type_name -> google.protobuf.Duration
	103, // 135: wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver.OccurrenceTotal.gte:type_name -> google.protobuf.UInt32Value
	103, // 136: wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver.OccurrenceTotal.lte:type_name -> google.protobuf.UInt32Value
	103, // 137: wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver.OccurrenceTotal.gt:type_name -> google.protobuf.UInt32Value
	103, // 138: wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver.OccurrenceTotal.lt:type_name -> google.protobuf.UInt32Value
	103, // 139: wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver.DurationPercentage.gte:type_name -> google.protobuf.UInt32Value
	103, // 140: wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver.DurationPercentage.lte:type_name -> google.protobuf.UInt32Value
	103, // 141: wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver.DurationPercentage.gt:type_name -> google.protobuf.UInt32Value
	103, // 142: wfo.vanalytics.v2.TranscriptQuery.Call.TalkOver.DurationPercentage.lt:type_name -> google.protobuf.UInt32Value
	96,  // 143: wfo.vanalytics.v2.TranscriptQuery.Call.Silence.DurationTotal.gte:type_name -> google.protobuf.Duration
	96,  // 144: wfo.vanalytics.v2.TranscriptQuery.Call.Silence.DurationTotal.lte:type_name -> google.protobuf.Duration
	96,  // 145: wfo.vanalytics.v2.TranscriptQuery.Call.Silence.DurationTotal.gt:type_name -> google.protobuf.Duration
	96,  // 146: wfo.vanalytics.v2.TranscriptQuery.Call.Silence.DurationTotal.lt:type_name -> google.protobuf.Duration
	96,  // 147: wfo.vanalytics.v2.TranscriptQuery.Call.Silence.DurationMax.gte:type_name -> google.protobuf.Duration
	96,  // 148: wfo.vanalytics.v2.TranscriptQuery.Call.Silence.DurationMax.lte:type_name -> google.protobuf.Duration
	96,  // 149: wfo.vanalytics.v2.TranscriptQuery.Call.Silence.DurationMax.gt:type_name -> google.protobuf.Duration
	96,  // 150: wfo.vanalytics.v2.TranscriptQuery.Call.Silence.DurationMax.lt:type_name -> google.protobuf.Duration
	103, // 151: wfo.vanalytics.v2.TranscriptQuery.Call.Silence.OccurrenceTotal.gte:type_name -> google.protobuf.UInt32Value
	103, // 152: wfo.vanalytics.v2.TranscriptQuery.Call.Silence.OccurrenceTotal.lte:type_name -> google.protobuf.UInt32Value
	103, // 153: wfo.vanalytics.v2.TranscriptQuery.Call.Silence.OccurrenceTotal.gt:type_name -> google.protobuf.UInt32Value
	103, // 154: wfo.vanalytics.v2.TranscriptQuery.Call.Silence.OccurrenceTotal.lt:type_name -> google.protobuf.UInt32Value
	103, // 155: wfo.vanalytics.v2.TranscriptQuery.Call.Silence.DurationPercentage.gte:type_name -> google.protobuf.UInt32Value
	103, // 156: wfo.vanalytics.v2.TranscriptQuery.Call.Silence.DurationPercentage.lte:type_name -> google.protobuf.UInt32Value
	103, // 157: wfo.vanalytics.v2.TranscriptQuery.Call.Silence.DurationPercentage.gt:type_name -> google.protobuf.UInt32Value
	103, // 158: wfo.vanalytics.v2.TranscriptQuery.Call.Silence.DurationPercentage.lt:type_name -> google.protobuf.UInt32Value
	13,  // 159: wfo.vanalytics.v2.TranscriptQuery.Threads.Text.match:type_name -> wfo.vanalytics.v2.Match
	14,  // 160: wfo.vanalytics.v2.TranscriptQuery.Threads.Text.span_near:type_name -> wfo.vanalytics.v2.SpanNear
	86,  // 161: wfo.vanalytics.v2.TranscriptQuery.Threads.Text.timespan:type_name -> wfo.vanalytics.v2.TranscriptQuery.Threads.Text.Timespan
	96,  // 162: wfo.vanalytics.v2.TranscriptQuery.Threads.Text.Timespan.head:type_name -> google.protobuf.Duration
	96,  // 163: wfo.vanalytics.v2.TranscriptQuery.Threads.Text.Timespan.tail:type_name -> google.protobuf.Duration
	91,  // 164: wfo.vanalytics.v2.TranscriptQuery.FlagSummary.NeedReview.flag_sids:type_name -> wfo.vanalytics.v2.TranscriptQuery.FlagSummary.NeedReview.FlagSids
	1,   // 165: wfo.vanalytics.v2.TranscriptQuery.FlagSummary.ReviewStatus.any:type_name -> wfo.vanalytics.v2.ReviewStatus
	92,  // 166: wfo.vanalytics.v2.TranscriptQuery.FlagSummary.Flags.flag_sid:type_name -> wfo.vanalytics.v2.TranscriptQuery.FlagSummary.Flags.FlagSid
	101, // 167: wfo.vanalytics.v2.TranscriptQuery.FlagSummary.Count.gte:type_name -> google.protobuf.Int32Value
	101, // 168: wfo.vanalytics.v2.TranscriptQuery.FlagSummary.Count.lte:type_name -> google.protobuf.Int32Value
	101, // 169: wfo.vanalytics.v2.TranscriptQuery.FlagSummary.Count.gt:type_name -> google.protobuf.Int32Value
	101, // 170: wfo.vanalytics.v2.TranscriptQuery.FlagSummary.Count.lt:type_name -> google.protobuf.Int32Value
	101, // 171: wfo.vanalytics.v2.TranscriptQuery.FlagSummary.Count.eq:type_name -> google.protobuf.Int32Value
	14,  // 172: wfo.vanalytics.v2.SpanNear.Clause.span_near:type_name -> wfo.vanalytics.v2.SpanNear
	16,  // 173: wfo.vanalytics.v2.SpanNear.Clause.span_fuzzy:type_name -> wfo.vanalytics.v2.SpanFuzzy
	15,  // 174: wfo.vanalytics.v2.SpanNear.Clause.span_term:type_name -> wfo.vanalytics.v2.SpanTerm
...
func file_wfo_vanalytics_v2_transcript_proto_init() {
	...
	file_wfo_vanalytics_v2_transcript_proto_msgTypes[91].OneofWrappers = []interface{}{
