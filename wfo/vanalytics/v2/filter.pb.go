...
func file_wfo_vanalytics_v2_filter_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_wfo_vanalytics_v2_filter_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_wfo_vanalytics_v2_filter_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_wfo_vanalytics_v2_filter_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_wfo_vanalytics_v2_filter_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_wfo_vanalytics_v2_filter_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Filter); i {
			case 0:
				return &v.state
			case 1:
	...
	file_wfo_vanalytics_v2_filter_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*ListFiltersRequest_Conflict)(nil),
		(*ListFiltersRequest_FlagSid)(nil),
	}
	file_wfo_vanalytics_v2_filter_proto_msgTypes[6].OneofWrappers = []interface{}{
