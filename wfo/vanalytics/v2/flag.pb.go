...
var file_wfo_vanalytics_v2_flag_proto_rawDesc = string([]byte{
...
var (
	...
	file_wfo_vanalytics_v2_flag_proto_rawDescData []byte
)

func file_wfo_vanalytics_v2_flag_proto_rawDescGZIP() []byte {
	file_wfo_vanalytics_v2_flag_proto_rawDescOnce.Do(func() {
		file_wfo_vanalytics_v2_flag_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_wfo_vanalytics_v2_flag_proto_rawDesc), len(file_wfo_vanalytics_v2_flag_proto_rawDesc)))
	})
...
func file_wfo_vanalytics_v2_flag_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wfo_vanalytics_v2_flag_proto_rawDesc), len(file_wfo_vanalytics_v2_flag_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
