...
const file_wfo_vanalytics_v2_flag_proto_rawDesc = "" +
	"\n" +
	...
	"\x04flag\x18\x01 \x01(\v2\x17.wfo.vanalytics.v2.FlagR\x04flag\"\xe1\x02\n" +
	...
	"\x05flags\x18\x02 \x03(\v2\x17.wfo.vanalytics.v2.FlagR\x05flags\x12\x14\n" +
	"\x05total\x18\x03 \x01(\x04R\x05total\"\x98\x01\n" +
	"\x11UpdateFlagRequest\x12\x19\n" +
	"\bflag_sid\x18\x01 \x01(\x03R\aflagSid\x12+\n" +
	"\x04flag\x18\x02 \x01(\v2\x17.wfo.vanalytics.v2.FlagR\x04flag\x12;\n" +
	"\vupdate_mask\x18\x03 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"F\n" +
	"\x11DeleteFlagRequest\x12\x19\n" +
	"\bflag_sid\x18\x01 \x01(\x03R\aflagSid\x12\x16\n" +
	"\x06return\x18\x03 \x01(\bR\x06return\"A\n" +
	"\x12DeleteFlagResponse\x12+\n" +
	"\x04flag\x18\x01 \x01(\v2\x17.wfo.vanalytics.v2.FlagR\x04flag\"L\n" +
	...
	"\aversion\x18\a \x01(\x03R\aversion\x123\n" +
	"\afilters\x18\b \x03(\v2\x19.wfo.vanalytics.v2.FilterR\afilters\x12\x1f\n" +
	"\vmust_review\x18\t \x01(\bR\n" +
	"mustReview\x12\x1f\n" +
	"\vmust_notify\x18\n" +
	" \x01(\bR\n" +
	"mustNotify\x12=\n" +
	"\tbool_expr\x18\v \x01(\v2 .wfo.vanalytics.v2.Flag.BoolExprR\bboolExpr\x128\n" +
	"\tdncl_list\x18\f \x03(\v2\x1b.wfo.vanalytics.v2.DnclListR\bdnclList\x1a\x8e\x02\n" +
	"\bBoolExpr\x122\n" +
	"\x03and\x18\x01 \x03(\v2 .wfo.vanalytics.v2.Flag.BoolExprR\x03and\x120\n" +
	"\x02or\x18\x02 \x03(\v2 .wfo.vanalytics.v2.Flag.BoolExprR\x02or\x12?\n" +
	"\x06filter\x18\x03 \x01(\v2'.wfo.vanalytics.v2.Flag.BoolExpr.FilterR\x06filter\x122\n" +
	"\x03not\x18\x04 \x01(\v2 .wfo.vanalytics.v2.Flag.BoolExprR\x03not\x1a'\n" +
	"\x06Filter\x12\x1d\n" +
	"\n" +
	"filter_sid\x18\x01 \x01(\x03R\tfilterSidB\xc3\x01\n" +
	"\x15com.wfo.vanalytics.v2B\tFlagProtoP\x01Z9github.com/tcncloud/api-go/wfo/vanalytics/v2;vanalyticsv2\xa2\x02\x03WVX\xaa\x02\x11Wfo.Vanalytics.V2\xca\x02\x11Wfo\\Vanalytics\\V2\xe2\x02\x1dWfo\\Vanalytics\\V2\\GPBMetadata\xea\x02\x13Wfo::Vanalytics::V2b\x06proto3"
